...
``sxm-apiserver-actual`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install sxm-apiserver-actual
...
`github releases <https://github.com/tendril-framework/sxm-apiserver-actual/releases>`_.
...
``sxm-apiserver-actual``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/sxm-apiserver-actual.git
    $ cd sxm-apiserver-actual
    $ pip install -e .
