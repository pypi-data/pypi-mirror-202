...
setup(
    ...
    description="StarXMedia Primary API Server",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/starxmedia/sxm-core',
    project_urls={
        'Documentation': 'https://sxm-core.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/starxmedia/sxm-core/issues',
        'Source Repository': 'https://github.com/starxmedia/sxm-core',
    },
