...
from hbshare.quant.Kevin.quant_room.RiskControlReport import save_mkt_data_to_csv
...
if __name__ == '__main__':
    update_daily(start_date='2023-03-06', end_date='2023-03-06')
    # update_monthly('2022-08-10', '2023-02-28')
    # update_weekly(start_date='2021-09-01', end_date='2023-02-28')
