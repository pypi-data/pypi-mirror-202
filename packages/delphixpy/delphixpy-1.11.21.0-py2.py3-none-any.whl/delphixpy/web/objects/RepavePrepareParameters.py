...
class RepavePrepareParameters(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The parameters to
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "unquiesce_sources_on_failure" == "type" or (self.unquiesce_sources_on_failure is not self.__undef__ and (not (dirty and not self._unquiesce_sources_on_failure[1]) or isinstance(self.unquiesce_sources_on_failure, list) or belongs_to_parent)):
