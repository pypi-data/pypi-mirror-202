...
class Archive(object):
    ...
    def __init__(self, path: str, os_type: Optional[str] = None):
        self.file_path = path
    ...
    def __extract_zip(self, to_directory) -> List[str]:
        ...
        try:
            ...
            if error.args[0] not in [26, 13] and error.args[1] not in ['Text file busy', 'Permission denied']:
                raise error
        return archive.namelist()

    def __extract_tar_file(self, to_directory) -> List[str]:
        try:
