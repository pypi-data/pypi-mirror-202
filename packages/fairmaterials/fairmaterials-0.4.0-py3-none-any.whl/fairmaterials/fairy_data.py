...
class fairy_data:
    ...
    def __init__(self,domain):
        ...
        if domain == "Buildings":
            name = "./jsonld/buildings.json"
        if domain == "GeospatialWell":
            name = "./jsonld/geospatial_well.json"
        if domain == "MetalAM":
            name = "./jsonld/metal_AM.json"
        if domain == "OpticalProfilometry":
            name = "./jsonld/opticalProfilometry.json"
        if domain == "PVSystem":
            name = "./jsonld/pv_system.json"
        if domain == " XCT":
            name = "./jsonld/xct.json"
        ...
        if domain == "Buildings":
            self.fair_csv('./csv/buildings_example.csv')
