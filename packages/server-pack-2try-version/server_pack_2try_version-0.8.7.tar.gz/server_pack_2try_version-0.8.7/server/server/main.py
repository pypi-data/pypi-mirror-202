...
class MessageProcessor(threading.Thread):
    ...
    def __init__(self, listen_address, listen_port, database):
        ...
        # Dict with names and their sockets.
        self.names = dict()
    ...
    def run(self):
        ...
        # Main loop server program
        while self.running:
            # Wait connection, if timeout, except exceptions.
            try:
            ...
            # Get message and if error, except client.
            if recv_data_lst:
    ...
    def remove_client(self, client):
        '''
        Method removing client with connection lose.
        Find client and remove him in list and db:
        '''
    ...
    def process_message(self, message):
        '''
        Method sending message to client.
        '''
    ...
    def process_client_message(self, message, client):
        '''Method process recv message to client.'''
    ...
    def service_update_lists(self):
        '''Method to send server message 205 to clients.'''
