from PyQt6.QtWidgets import QDialog, QPushButton, QLineEdit, QApplication, QLabel, QMessageBox
...
class RegisterUser(QDialog):
    ...
    def __init__(self, database, server):
        ...
        self.client_passwd.setEchoMode(QLineEdit.EchoMode.PasswordEchoOnEdit)
        ...
        self.client_conf.setEchoMode(QLineEdit.EchoMode.PasswordEchoOnEdit)
...
if __name__ == '__main__':
    app = QApplication([])
    app.setAttribute(Qt.WidgetAttribute.AA_DisableWindowContextHelpButton)
