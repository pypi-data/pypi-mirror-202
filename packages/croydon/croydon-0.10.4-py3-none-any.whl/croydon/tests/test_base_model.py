...
class TestBaseModel(IsolatedAsyncioTestCase):
    ...
    async def test_computed_fields(self):
        ...
        self.assertCountEqual([], BaseModel._computed_fields.keys())
        self.assertCountEqual(["full_name"], Person._computed_fields.keys())
        self.assertCountEqual(["full_name"], Singer._computed_fields.keys())
        self.assertCountEqual(["custom"], AnotherModel._computed_fields.keys())
