...
import dlmontepython.htk.sources.dlfeddat as dlfeddat
...
class DLMonteOutput(object):
    ...
    def __init__(self, ptfile, yamldata, feddat, nconfigs=1):
    ...
    def load(directory=os.curdir, nconfigs=1):
        ...
        feddat = None
        if os.path.exists(os.path.join(directory, "FEDDAT.000_001")):
            feddat = dlfeddat.load(directory)


        return DLMonteOutput(ptfile, yamldata, feddat, nconfigs)
