...
class SQL(AbstractClient):
    ...
    def _request(self):
        ...
        header["password"] = "******"
        logger.info(FormatOutput.format_request_output(self.__config, "SQL", self._interface_info.name,
        ...
        result = DB(db_config, self.__config).execute(sql)
        ...
        logger.info(FormatOutput.format_response_output(self.__config, "SQL", self._res))
