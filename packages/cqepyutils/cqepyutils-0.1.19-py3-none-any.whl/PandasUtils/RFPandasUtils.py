...
def create_comparison_df(match: List[Tuple[str, int, int]],
    ...
    """
       ...
       Examples:
       | ${match} = | [('file1.txt', 100, 100), ('file2.txt', 200, 200)] |
       | ${mismatch} = | [('file3.txt', 300, 400, 33.33), ('file4.txt', 500, 600, 20)] |
       | ${errors} = | [('file5.txt', 'File not found'), ('file6.txt', 'Permission denied')] |
       | ${only_in_src} = | ['file7.txt', 'file8.txt'] |
       | ${only_in_tgt} = | ['file9.txt', 'file10.txt'] |
       | ${result} = | Create Comparison DF | ${match} | ${mismatch} | ${errors} | ${only_in_src} | ${only_in_tgt} |
       | Should Be Equal | ${result.shape[0]} | 10 |
