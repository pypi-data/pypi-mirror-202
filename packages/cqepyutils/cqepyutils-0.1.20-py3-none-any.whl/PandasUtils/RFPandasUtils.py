...
def create_comparison_df(match: List[Tuple[str, int, int]],
    ...
    Examples:
    | ${match} = | Create List | ${file1} | ${src_size1} | ${tgt_size1} |
    | ...       |             | ${file2} | ${src_size2} | ${tgt_size2} |
    | ${mismatch} = | Create List | ${file3} | ${src_size3} | ${tgt_size3} | ${diff_percentage3} |
    | ...          |             | ${file4} | ${src_size4} | ${tgt_size4} | ${diff_percentage4} |
    | ${errors} = | Create List | ${file5} | ${error_msg5} |
    | ...        |             | ${file6} | ${error_msg6} |
    | ${only_in_src} = | Create List | ${file7} | ${file8} |
    | ${only_in_tgt} = | Create List | ${file9} | ${file10} |

    | ${result} = | Create Comparison DataFrame | ${match} | ${mismatch} | ${errors} | ${only_in_src} | ${only_in_tgt} |
    ...
    df = pd.DataFrame(df_rows, columns=["FileName", "Status", "Comments", "Src_Size", "Tgt_Size"])
    return df
