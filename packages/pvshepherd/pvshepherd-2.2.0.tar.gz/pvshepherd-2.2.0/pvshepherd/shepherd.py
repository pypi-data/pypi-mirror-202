...
DEFAULT_PORCUPINE_MODEL = dict(
    ...
    fr={
        'name': 'Bonjour Ordinateur',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/bonjour ordinateur_cortexm.ppn')
    },
    it={
        'name': 'Ciao Computer',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/ciao computer_cortexm.ppn')
    },
    ja={
        'name': 'こんにちはコンピュータ',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/konnichiwa konpyūtā_cortexm.ppn')
    },
    ko={
        'name': '안녕 컴퓨터',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/annyeong keompyuteo_cortexm.ppn')
    },
    pt={
        'name': 'Olá computador',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/olá computador_cortexm.ppn')
    },
    ru={
        'name': 'привет компьютер',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/privet kompyuter_cortexm.ppn')
    },
    nl={
        'name': 'hallo computer',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/hallo computer_cortexm.ppn')
    },
    hi={
        'name': 'नमस्ते पुत्र',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/namaste putra_cortexm.ppn')
    },
    ar={
        'name': 'coffee',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/coffee_cortexm.ppn')
    },
    pl={
        'name': 'cześć komputer',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/cześć komputer_cortexm.ppn')
    },
    sv={
        'name': 'hej dator',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/hej dator_cortexm.ppn')
    },
    vn={
        'name': 'xin chào máy tính',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/xin chào máy tính_cortexm.ppn')
    },
    zh={
        'name': '你好电脑',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/nǐ hǎo diànnǎo_cortexm.ppn')
    },
)
...
DEFAULT_RHINO_MODEL = dict(
    ...
    it={
        'name': 'illuminazione [it]',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/illuminazione_cortexm.rhn')
    },
    ja={
        'name': 'sumāto_shōmei [ja]',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/sumāto_shōmei_cortexm.rhn')
    },
    ko={
        'name': 'seumateu_jomyeong [ko]',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/seumateu_jomyeong_cortexm.rhn')
    },
    pt={
        'name': 'luz_inteligente [pt]',
        'path': os.path.join(
            os.path.abspath(os.path.dirname(__file__)),
            'sample_files/luz_inteligente_cortexm.rhn')
    },
    ru={
        'name': 'Simple Context [ru]',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/simple_context_ru_cortexm.rhn')
    },
    nl={
        'name': 'Simple Context [nl]',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/simple_context_nl_cortexm.rhn')
    },
    hi={
        'name': 'Simple Context [hi]',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/simple_context_hi_cortexm.rhn')
    },
    ar={
        'name': 'Simple Context [ar]',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/simple_context_ar_cortexm.rhn')
    },
    pl={
        'name': 'Simple Context [pl]',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/simple_context_pl_cortexm.rhn')
    },
    sv={
        'name': 'Simple Context [sv]',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/simple_context_sv_cortexm.rhn')
    },
    vn={
        'name': 'Simple Context [vn]',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/simple_context_vn_cortexm.rhn')
    },
    zh={
        'name': 'Simple Context [zh]',
        'path': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'sample_files/simple_context_zh_cortexm.rhn')
    },
)
...
class UploadFirmwareFrame(tk.Frame, PicoFrame):
    def __init__(self, master):
        ...
        self._languages_scrollbar = ttk.Scrollbar(self._languages_frame, orient='vertical', command=self._languages_tree_view.yview)
