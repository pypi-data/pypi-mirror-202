...
const RecipientItemAdded = class {
  ...
  render() {
    ...
    return (index.h("li", { class: "recipient-list-item" }, index.h("div", { class: "recipient-info-container" }, index.h("span", null, fullname), index.h("div", { class: "recipient-info-contact-data" }, index.h("span", null, email))), index.h("div", { class: "recipient-role-container" }, index.h("select", { class: "recipient-role-list", onInput: event => this.handleChangeRole(event) }, this.roles.map(role => {
