...
const DocumentListItem = class {
  ...
  render() {
    ...
    return (index.h("li", { class: "document-list-item", onClick: this.handleOpenDocument }, index.h("div", { class: documentIcon }, index.h("limel-icon", { name: this.getDocumentIcon(this.document.status), size: "small" })), index.h("div", { class: "document-info-container" }, index.h("div", { class: "document-name" }, this.document.name), index.h("div", { class: "document-status" }, index.h("span", null, this.document.status), index.h("span", { class: "document-created-date" }, hooks(this.document.created_at).format('YYYY-MM-DD'))))));
  }
  handleOpenDocument() {
