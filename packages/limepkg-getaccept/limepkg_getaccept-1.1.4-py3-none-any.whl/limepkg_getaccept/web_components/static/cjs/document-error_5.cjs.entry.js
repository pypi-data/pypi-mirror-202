...
const ShareDocumentLink = class {
  ...
  render() {
    return (index.h("li", { class: "share-document-list-item" }, index.h("div", { class: "recipient-info-container" }, index.h("div", { class: "recipient-icon" }, index.h("limel-icon", { name: "user", size: "small" })), index.h("div", { class: "recipient-info" }, index.h("span", { class: "recipient-info-name" }, this.recipient.fullname), index.h("span", { class: "recipient-info-role" }, this.recipient.role))), index.h("div", null, index.h("limel-input-field", { label: "Signing link", type: "email", value: this.recipient.document_url, trailingIcon: "copy_link", onAction: this.handleCopyLink }))));
  }
  handleCopyLink() {
