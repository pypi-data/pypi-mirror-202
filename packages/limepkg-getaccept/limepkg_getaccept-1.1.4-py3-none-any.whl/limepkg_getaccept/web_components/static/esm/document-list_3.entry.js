...
import { E as EnumDocumentStatuses } from './EnumDocumentStatuses-b9abda18.js';
...
const DocumentListItem = class {
  ...
  render() {
    ...
    return (h("li", { class: "document-list-item", onClick: this.handleOpenDocument }, h("div", { class: documentIcon }, h("limel-icon", { name: this.getDocumentIcon(this.document.status), size: "small" })), h("div", { class: "document-info-container" }, h("div", { class: "document-name" }, this.document.name), h("div", { class: "document-status" }, h("span", null, this.document.status), h("span", { class: "document-created-date" }, hooks(this.document.created_at).format('YYYY-MM-DD'))))));
  }
  handleOpenDocument() {
