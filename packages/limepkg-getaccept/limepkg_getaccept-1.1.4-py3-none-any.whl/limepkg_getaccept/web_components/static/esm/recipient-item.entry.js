...
const RecipientItem = class {
  ...
  render() {
    ...
    return (h("li", { class: recipientList }, h("div", { class: `recipient-icon ${limetype}` }, h("limel-icon", { name: icon, size: "small" })), h("div", { class: "recipient-info-container" }, h("span", null, fullname), h("div", null, h("span", null, company)), h("div", { class: contactInfoClasses }, h("span", { class: "recipient-email" }, email), h("span", { class: "recipient-phone" }, mobile))), this.renderAddIcon(this.showAdd)));
  }
  renderAddIcon(show) {
