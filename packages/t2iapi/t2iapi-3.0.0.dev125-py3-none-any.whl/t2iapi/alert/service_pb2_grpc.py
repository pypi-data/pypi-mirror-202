...
class AlertService(object):
    ...
    def AlertConditionEscalation(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/t2iapi.alert.AlertService/AlertConditionEscalation',
            t2iapi_dot_alert_dot_alert__requests__pb2.AlertConditionEscalationRequest.SerializeToString,
            t2iapi_dot_basic__responses__pb2.BasicResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
