    ...
    def performance(self, dict_init_arg: dict):
        ...
        try:
            ...
            result = {
                ...
                'model_name': dict_init_arg["model_id_lst"] + "-" + dict_init_arg["train_strat_time"],
...
TRAINING_REASON="%s"
    ...
    def error_arg_dict(self):
        ...
        try:
            ...
            train_strat_time = self.appollo_info.get("TRAIN_START_TIME")
        except Exception:
            model_id = None
            train_strat_time = None
        ...
        dict_init_arg = {
            ...
            "train_strat_time": train_strat_time,
    ...
    def input_arg_dict(self):
        ...
        dict_init_arg = {
            ...
            "train_strat_time": self.appollo_info["TRAIN_START_TIME"],
            # "profile_id_lst": self.appollo_info["PROFILE_ID"],
            # "tag_lst": self.appollo_info["tag"],
            "training_start_time_lst": self.training_start_time_lst,
            "total_training_time_lst": self.total_training_time_lst,
