...
def main(arguments):
    ...
    # add by Minghuan Ma
    add_parser.add_argument("--config_mode",help="s")

    add_parser.add_argument("--local_folder", help="enter local folder path that needs to be synchronized")

    add_parser.add_argument("--endpoint_url", help="enter endpoint url")

    add_parser.add_argument("--bucket", help="enter s3 bucket")

    add_parser.add_argument("--path", help="enter s3 path")

    add_parser.add_argument("--access_key", help="enter aws access key id")

    add_parser.add_argument("--secret_key", help="enter aws secret key id")

    add_parser.add_argument("--target_name", help="enter target name")
