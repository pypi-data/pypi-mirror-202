# Generated by Django 3.2.5 on 2023-02-02 08:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flow_name', models.CharField(db_index=True, help_text='必填', max_length=255, verbose_name='流程名称')),
                ('module_name', models.CharField(blank=True, choices=[('USER', '用户(USER)'), ('THREAD', '信息(THREAD)'), ('COMMENT', '评论(COMMENT)'), ('FINANCE', '资金(FINANCE)'), ('ENROLL', '报名(ENROLL)'), ('RESOURCE', '资源(RESOURCE)'), ('DICTIONARY', '字典(DICTIONARY)'), ('PAYMENT', '支付(PAYMENT)'), ('ROLE', '角色(ROLE)')], db_index=True, max_length=32, null=True, verbose_name='模块名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module_name', models.CharField(blank=True, choices=[('USER', '用户(USER)'), ('THREAD', '信息(THREAD)'), ('COMMENT', '评论(COMMENT)'), ('FINANCE', '资金(FINANCE)'), ('ENROLL', '报名(ENROLL)'), ('RESOURCE', '资源(RESOURCE)'), ('DICTIONARY', '字典(DICTIONARY)'), ('PAYMENT', '支付(PAYMENT)'), ('ROLE', '角色(ROLE)')], db_index=True, max_length=32, null=True, verbose_name='模块名称')),
                ('flow_number', models.IntegerField(blank=True, db_index=True, null=True, verbose_name='流程号')),
                ...
                ('summary', models.CharField(blank=True, db_index=True, max_length=1024, null=True, verbose_name='摘要')),
