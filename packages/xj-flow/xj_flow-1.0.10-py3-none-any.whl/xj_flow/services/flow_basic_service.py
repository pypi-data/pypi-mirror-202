...
class FlowBasicService:
    ...
    def get_flow_node_to_action_list(params=None, need_custom_serialize=False):
        ...
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=[
                "flow_id|int", "flow_node_id|int", "flow_action_id|int", "flow_node_value", "flow_action", 'flow_status_code_list'
            ],
            alias_dict={"flow_status_code_list": "flow_status_code__in"}
        )
        ...
        return FlowBasicService.custom_node_to_action_serialize(result_list) if need_custom_serialize else result_list, None
