...
class PackageManagerAPI(PackageManagerAPIBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Arguments:
            None
        """
        super(PackageManagerAPI, self).__init__(*args, **kwargs)
    ...
    def create_example(self, title, model_file, panel_file, output_path,
                       tags=None, description="", image_file="",
                       app_note_file="", tests=None, test_resources=None,
                       resources=None):
        """
    ...
    def create_package(self, package_name, version, output_path, author="",
                       description="", minimal_sw_version="",
                       library_paths=None, resource_paths=None,
                       example_paths=None, additional_files_paths=None,
                       python_packages_paths=None, documentation_paths=None,
                       documentation_landing_page="", release_notes_path=""):
        """
        ...
        **Example:**
        ...
        return clstub().create_package(
            ...
            minimal_sw_version=minimal_sw_version, library_paths=library_paths,
...
package_manager = PackageManagerAPI()
