...
from typhoon.api.constants import SCHEMATIC_API_NAME, HIL_API_NAME, \
    ...
    DEVICE_MANAGER_API_NAME, PACKAGE_MANAGER_API_NAME
...
def get_installation_dir_from_env():
    ...
    Returns:
        Path to the latest installation directory, empty string when
...
def get_server_location():
    ...
    Returns:
        str
    """
    return get_installation_dir_from_cfg() or get_installation_dir_from_env() \
        or ""
...
JSON_RPC_VER = "2.0"
API_VER = "1.0"
DEFAULT_PING_TIMEOUT = 1000     # In ms
DEFAULT_PING_RETRIES = 60       # Total timeout time = PING_TIMEOUT x PING_RETRIES
DEBUG = "DEBUG"
INFO = "INFO"
ERROR = "ERROR"
BAT_TEMPLATE = """
