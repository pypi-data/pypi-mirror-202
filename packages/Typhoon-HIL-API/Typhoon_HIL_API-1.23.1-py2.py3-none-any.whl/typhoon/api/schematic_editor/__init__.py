...
class SchematicAPI:
    ...
    def create_property(self, item_handle, name, label="", widget=WIDGET_EDIT,
                        ...
                        visible=True, serializable=True, tab_name="", unit="",
                        button_label="", previous_names=(), description="",
                        require="", type="", default_value=None, min_value=None,
                        max_value=None, keepline=False, skip=None,
                        skip_step=None, vector=False, tunable=False):
        """
    ...
    def get_property_value_type(self, prop_handle):
        ...
        **Example:**
        ...
        .. program-output:: python sch_api_examples/get_set_prop_value_type.example
        """
        return clstub().get_property_value_type(
            prop_handle=prop_handle
        )
    ...
    def precompile_fmu(self, fmu_file_path, precompiled_file_path=None, additional_definitions=None):
        """
        ...
        Returns:
            None
        """
        return clstub().precompile_fmu(self, 
