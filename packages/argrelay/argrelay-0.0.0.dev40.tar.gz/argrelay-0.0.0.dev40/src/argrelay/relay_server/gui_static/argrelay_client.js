...
class prototype_state_class {
    ...
    map_io_state_to_elem_class(some_io_state) {
        switch (some_io_state) {
            case "client_synced":
                return "io_state_client_synced"
            case "pending_request":
                return "io_state_pending_request"
            case "pending_response":
                return "io_state_pending_response"
        }
    }
...
class suggest_state_class extends prototype_state_class {
    ...
    map_io_state_to_gui_state() {
        ...
        for (const some_io_state of io_state_list) {
            if (some_io_state === this.io_state) {
                command_line_input_elem.classList.add(this.map_io_state_to_elem_class(some_io_state) + "_input");
                suggestion_output_elem.classList.add(this.map_io_state_to_elem_class(some_io_state) + "_output")
            } else {
                command_line_input_elem.classList.remove(this.map_io_state_to_elem_class(some_io_state) + "_input");
                suggestion_output_elem.classList.remove(this.map_io_state_to_elem_class(some_io_state) + "_output")
            }
        }
    }
...
class search_state_class extends prototype_state_class {
    ...
    map_io_state_to_gui_state() {
        ...
        for (const some_io_state of io_state_list) {
            if (some_io_state === this.io_state) {
                describe_output_elem.classList.add(this.map_io_state_to_elem_class(some_io_state) + "_output")
            } else {
                describe_output_elem.classList.remove(this.map_io_state_to_elem_class(some_io_state) + "_output")
            }
        }
    }
