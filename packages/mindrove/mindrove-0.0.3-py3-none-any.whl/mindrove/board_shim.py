...
class MindroveConfigMode():
    ...
    EEG_MODE =  struct.pack('BBBBB', *[0,0,0,0,0])
    BEEP =      struct.pack('BBBBB', *[1,0,0,0,0])
    BOOP =      struct.pack('BBBBB', *[2,0,0,0,0])
    IMP_MODE =  struct.pack('BBBBB', *[4,0,0,0,0])
    TEST_MODE = struct.pack('BBBBB', *[16,0,0,0,0])
