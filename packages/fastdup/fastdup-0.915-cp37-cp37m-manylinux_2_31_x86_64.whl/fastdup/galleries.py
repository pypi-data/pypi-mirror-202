...
if __name__ == "__main__":
    ...
    if False:
        ...
        print(df.head())
        fd.vis.component_gallery(load_crops=False, sort_by='comp_size', external_df=df, label_col='label')
        ...
        fd.run()
        fd.vis.outliers_gallery(label_col='automatic')
