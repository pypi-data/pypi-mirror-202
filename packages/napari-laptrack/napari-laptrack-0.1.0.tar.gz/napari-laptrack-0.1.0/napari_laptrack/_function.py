...
def track_labels_centroid_based(image_layer: "napari.layers.Image", labels_layer: "napari.layers.Labels", viewer: "napari.Viewer"):
    """
    ...
    # determine centroids
    if labels_layer_4d.features is None or "centroid-0" not in labels_layer_4d.features.keys():
        print("No centroids found in measured features; determining centroid using napari-skimage-regionprops...")
