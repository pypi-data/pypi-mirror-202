...
def decrypt_github_file(github_token, github_repo_name, password, select_file):
    # Get repository
    repo = get_github_repo(token=github_token, repo_name=github_repo_name)
...
def decrypt_data_from_github(filename, my_password, github_token, repo_name):
    ...
    download_file(repo=repo, github_file_path=filename)
...
def download_file(repo, github_file_path, download_path=None):
