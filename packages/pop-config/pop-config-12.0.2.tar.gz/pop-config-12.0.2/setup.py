...
NAME = "pop_config"
DESC = "The official tool to allow for creating and app-merging configuration options for pop projects."
...
setup(
    ...
    url="https://vmware.gitlab.io/pop/pop-config/en/latest/index.html",
    project_urls={
