...
def signal_frequency_SOGI_pll(input, initial_amp, frequency,
        initial_angle=0,
        max_freq_var=10,
    ...
    """
    Tf_kd_PLL = None
    return _impl.frequency_meas_SOGI_pll(input, initial_amp, frequency, angle_init=initial_angle, delta_Hz_max=max_freq_var, pll_filter_params=pll_filter_params)
