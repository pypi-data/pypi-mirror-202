...
def anonymize_text(input_text: str, confidence_threshold: Optional[float] = None) -> str:
...
def anonymize(input_text: str, pii_info: Optional[List[str]] = [], confidence_threshold: Optional[float] = None) -> str:
    anonymized_text = anonymize_text(input_text, confidence_threshold)
    redacted_text = redact_text(anonymized_text, pii_info)
