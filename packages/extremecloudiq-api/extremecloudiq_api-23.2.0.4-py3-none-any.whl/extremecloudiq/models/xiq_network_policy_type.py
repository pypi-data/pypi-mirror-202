...
class XiqNetworkPolicyType(object):
    ...
    allowable_values = [NETWORK_ACCESS_AND_SWITCHING, BRANCH_ROUTING, WIRELESS_ACCESS, SWITCHING, NETWORK_ACCESS_AND_SWITCHING_AND_BR, NETWORK_ACCESS_AND_BRANCH_ROUTING, SWITCHING_AND_BRANCH_ROUTING]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """XiqNetworkPolicyType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, XiqNetworkPolicyType):
            return False
