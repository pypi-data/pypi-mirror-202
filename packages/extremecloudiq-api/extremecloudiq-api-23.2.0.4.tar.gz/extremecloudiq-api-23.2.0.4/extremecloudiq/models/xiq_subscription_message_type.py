...
class XiqSubscriptionMessageType(object):
    ...
    allowable_values = [LOCATION_AP_CENTRIC, LOCATION_CLIENT_CENTRIC, AUDIT_LOG_ALL, GDPR_LOG_ALL, CREDENTIAL_LOG_ALL, ACCOUNTING_LOG_ALL, AUTHENTICATION_LOG_ALL, EMAIL_LOG_ALL, SMS_LOG_ALL]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """XiqSubscriptionMessageType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, XiqSubscriptionMessageType):
            return False
