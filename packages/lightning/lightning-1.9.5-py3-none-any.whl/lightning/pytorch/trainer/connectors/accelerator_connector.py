...
from lightning.pytorch.strategies.horovod import _HOROVOD_AVAILABLE
    ...
    def _set_devices_flag_if_auto_select_gpus_passed(self) -> None:
        if self._auto_select_gpus is not None:
            rank_zero_deprecation(
                ...
                " Please use the function `lightning.pytorch.accelerators.find_usable_cuda_devices` instead."
            )
