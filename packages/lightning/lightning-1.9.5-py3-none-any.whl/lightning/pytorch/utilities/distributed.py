...
from lightning.fabric.utilities.distributed import _all_gather_ddp_if_available as new_all_gather_ddp_if_available
from lightning.fabric.utilities.distributed import _distributed_available as new_distributed_available
from lightning.fabric.utilities.distributed import _gather_all_tensors as new_gather_all_tensors
from lightning.fabric.utilities.distributed import (
    _get_default_process_group_backend_for_device as new_get_default_process_group_backend_for_device,
)
from lightning.fabric.utilities.distributed import _init_dist_connection as new_init_dist_connection
from lightning.fabric.utilities.distributed import _sync_ddp as new_sync_ddp
from lightning.fabric.utilities.distributed import _sync_ddp_if_available as new_sync_ddp_if_available
...
def get_default_process_group_backend_for_device(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        ...
        " `lightning.fabric.utilities.distributed.get_default_process_group_backend_for_device` instead."
    )
...
def rank_zero_only(*args: Any, **kwargs: Any) -> Any:
    rank_zero_deprecation(
        ...
        " be removed in v2.0.0. You can import it from `lightning.pytorch.utilities` instead."
    )
