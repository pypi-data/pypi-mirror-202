...
def _patch_sys_modules() -> None:
    ...
    sys.modules["lightning.pytorch.callbacks.base"] = self
...
class Callback:
    ...
    def __init__(self, *_: Any, **__: Any) -> None:
        raise NotImplementedError(
            "Importing `lightning.pytorch.callbacks.base.Callback` was deprecated in v1.7.0 and removed as of"
            " v1.9.0. Please use `from lightning.pytorch import Callback` instead"
        )
