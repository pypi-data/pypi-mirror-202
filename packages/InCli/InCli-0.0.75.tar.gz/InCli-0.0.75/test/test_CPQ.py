...
#          print(f"{code}  {lineItem['vlocity_cmt__ServiceAccountId__c']['value']}  {lineItem['vlocity_cmt__BillingAccountId__c']['value']}   {account2Id}")
   ...
   #       obj['vlocity_cmt__BillingAccountId__c'] = account2Id
    ...
    def test_do_all_puts(self):
        ...
        cartId = self.create_cart_with_promo(accountname=accountname,cartName='testa_18',promoName='NOS4u 100Mb + Móvel',create=True,pricelistF='Name:B2C Price List')
   ...
   #       print(key)
    ...
    def create_cart_with_offer(self,accountname,cartName,offerName,create=False,pricelistF='Name:B2C Price List'):
    ...
    def test_get_cart_items(seld):
        #restClient.init('NOSDEV')
        #cartId = "8013O000003lSDCQA2"
        restClient.init('DEVNOSCAT4')
        cartId = "8013O000003vgK8QAI"
    ...
    def test_post_cart_items(self):
       ...
       # cartId = self.create_cart_with_promo('account_2','cart_7a4','NOS4u 100Mb + Móvel',pricelistF=pricelistF,create=True)
        ...
        items = CPQ.getCartItems_api(cartId,price=False,validate=False)
     #   while 1==1:
        #items = CPQ.getCartItems_api_bt(cartId,price=False,validate=False)
      ...
      #  return
        ...
        for x in range(0,10):
          ...
          call = CPQ.addItemstoCart_api_bt(cartId,priceBookEntryId,parentRecord=parentRecord,parentId=parentId,parentHierarchyPath=parentHierarchyPath,noResponseNeeded=False,price=False,validate=False)
