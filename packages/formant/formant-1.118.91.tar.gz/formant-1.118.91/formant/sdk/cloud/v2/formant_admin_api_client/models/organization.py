...
class Organization:
    ...
    Attributes:
        ...
        analytics_softbank (Union[Unset, bool]):
        id (Union[Unset, str]):
    ...
    analytics_softbank: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        analytics_softbank = self.analytics_softbank
        id = self.id
        ...
        if analytics_softbank is not UNSET:
            field_dict["analyticsSoftbank"] = analytics_softbank
        if id is not UNSET:
            field_dict["id"] = id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        analytics_softbank = d.pop("analyticsSoftbank", UNSET)
        ...
        organization = cls(
            ...
            analytics_softbank=analytics_softbank,
            id=id,
