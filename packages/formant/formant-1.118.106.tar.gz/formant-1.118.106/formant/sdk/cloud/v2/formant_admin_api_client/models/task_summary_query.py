...
from ..models.task_summary_query_event_types_item import TaskSummaryQueryEventTypesItem
from ..models.task_summary_query_severities_item import TaskSummaryQuerySeveritiesItem
from ..models.task_summary_query_types_item import TaskSummaryQueryTypesItem
...
T = TypeVar("T", bound="TaskSummaryQuery")
...
class TaskSummaryQuery:
    ...
    Attributes:
        ...
        event_types (Union[Unset, List[TaskSummaryQueryEventTypesItem]]):
        ...
        severities (Union[Unset, List[TaskSummaryQuerySeveritiesItem]]):
    ...
    event_types: Union[Unset, List[TaskSummaryQueryEventTypesItem]] = UNSET
    ...
    severities: Union[Unset, List[TaskSummaryQuerySeveritiesItem]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        field_dict.update({})
        if task_summary_format_id is not UNSET:
            field_dict["taskSummaryFormatId"] = task_summary_format_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        task_summary_format_id = d.pop("taskSummaryFormatId", UNSET)
        ...
        for types_item_data in _types or []:
            types_item = TaskSummaryQueryTypesItem(types_item_data)
        ...
        for event_types_item_data in _event_types or []:
            event_types_item = TaskSummaryQueryEventTypesItem(event_types_item_data)
        ...
        for severities_item_data in _severities or []:
            severities_item = TaskSummaryQuerySeveritiesItem(severities_item_data)
        ...
        task_summary_query.additional_properties = d
        return task_summary_query
