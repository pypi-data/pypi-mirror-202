...
See: [Config](https://github.com/robocorp/robotframework-lsp/tree/robotframework-lsp-1.10.0/robotframework-ls/docs/config.md) for details.

See: [FAQ](https://github.com/robocorp/robotframework-lsp/tree/robotframework-lsp-1.10.0/robotframework-ls/docs/faq.md) for common issues encountered while configuring the language server.

## Contributing

See: [Contributing](https://github.com/robocorp/robotframework-lsp/tree/robotframework-lsp-1.10.0/robotframework-ls/docs/contributing.md) for how to help in the development of `Robot Framework Language Server`.

## Reporting Issues

See: [Reporting Issue](https://github.com/robocorp/robotframework-lsp/tree/robotframework-lsp-1.10.0/robotframework-ls/docs/reporting_issues.md) for details on how to report some issue in the `Robot Framework Language Server`.
...
See: [Changelog](https://github.com/robocorp/robotframework-lsp/tree/robotframework-lsp-1.10.0/robotframework-ls/docs/changelog.md) for details.
