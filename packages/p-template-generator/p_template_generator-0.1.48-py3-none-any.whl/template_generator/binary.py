...
def checkFileMd5(rootDir):
    data = {
        "fonts.zip.py" : "c084fab5bbe30483b8345e8bdf64457c",
...
def updateBin(rootDir):
    ...
    getOssResource(rootDir, "http://mecord-m.2tianxin.com/res/skymedia_2023041215.zip", "05547eaa603d5f4c0d7b92eacc244225", "skymedia.zip.py")
