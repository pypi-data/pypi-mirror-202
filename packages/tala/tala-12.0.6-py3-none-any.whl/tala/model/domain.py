...
class Domain(AsJSONMixin):
    ...
    def __init__(
            self, ddd_name, name, ontology, plans=[], default_questions=[], parameters={},
            validators={}, dependencies={}, queries=[]
    ):  # yapf: disable
    ...
    def _query_list_to_dict_indexed_by_question(self, query_list):
        ...
        for query_info in query_list:
            ...
            if query in plans:
                raise InvalidPlansException(f"multiple plans for query {query}")
