...
from tala.model.plan_item import AssumePlanItem, AssumeSharedPlanItem, AssumeIssuePlanItem, RespondPlanItem, DoPlanItem, BindPlanItem, JumpToPlanItem, IfThenElse, ForgetAllPlanItem, ForgetPlanItem, ForgetSharedPlanItem, ForgetIssuePlanItem, InvokeServiceQueryPlanItem, InvokeServiceActionPlanItem, LogPlanItem, GoalPerformedPlanItem, GoalAbortedPlanItem, ChangeDDDPlanItem
...
from tala.ddd.json_parser import JSONParser, JSONParseFailure
...
class Parser:
    ...
    def _cacheable_parse(self, string):
        try:
            json_parser = JSONParser(self._ddd_name, self.ontology, self.domain_name)
