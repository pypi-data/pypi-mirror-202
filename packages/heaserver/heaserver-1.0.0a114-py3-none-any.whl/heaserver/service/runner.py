...
def start(db: Optional[Type[MicroserviceDatabaseManager]] = None,
    ...
    """
    app = get_application(db=db() if db is not None else None, wstl_builder_factory=wstl_builder_factory,
...
def get_application(db: Optional[MicroserviceDatabaseManager] = None,
