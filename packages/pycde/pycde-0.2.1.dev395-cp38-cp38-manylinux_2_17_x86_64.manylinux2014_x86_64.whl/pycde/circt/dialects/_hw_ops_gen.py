...
class ArrayGetOp(_ods_ir.OpView):
  ...
  def __init__(self, input, index, *, loc=None, ip=None):
    ...
    _ods_context = _ods_get_default_loc_context(loc)
    results = _ods_ir.InferTypeOpInterface(ArrayGetOp).inferReturnTypes(
        operands=operands,
...
class StructInjectOp(_ods_ir.OpView):
  ...
  def __init__(self, input, field, newValue, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('StrAttr')) else
      _ods_ir.AttrBuilder.get('StrAttr')(field, context=_ods_context))
    results = _ods_ir.InferTypeOpInterface(StructInjectOp).inferReturnTypes(
        operands=operands,
        attributes=_ods_ir.DictAttr.get(attributes, context=_ods_context),
        context=_ods_context,
        loc=loc)
...
class UnionExtractOp(_ods_ir.OpView):
  ...
  def __init__(self, input, field, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('StrAttr')) else
      _ods_ir.AttrBuilder.get('StrAttr')(field, context=_ods_context))
    results = _ods_ir.InferTypeOpInterface(UnionExtractOp).inferReturnTypes(
        operands=operands,
        attributes=_ods_ir.DictAttr.get(attributes, context=_ods_context),
        context=_ods_context,
        loc=loc)
