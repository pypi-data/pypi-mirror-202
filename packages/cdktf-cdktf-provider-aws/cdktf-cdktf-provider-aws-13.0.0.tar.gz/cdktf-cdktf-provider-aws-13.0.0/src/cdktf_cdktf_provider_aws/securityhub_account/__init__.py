...
class SecurityhubAccount(
    ...
    def __init__(
        ...
        *,
        ...
        :param enable_default_standards: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/securityhub_account#enable_default_standards SecurityhubAccount#enable_default_standards}.
