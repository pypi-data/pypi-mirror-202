...
class LoadBalancerListenerPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param triggers: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/load_balancer_listener_policy#triggers LoadBalancerListenerPolicy#triggers}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
