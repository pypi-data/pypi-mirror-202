...
class EmrserverlessApplication(
    ...
    def __init__(
        ...
        *,
        ...
        :param image_configuration: image_configuration block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/emrserverless_application#image_configuration EmrserverlessApplication#image_configuration}
    ...
    def put_image_configuration(self, *, image_uri: builtins.str) -> None:
        '''
        :param image_uri: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/emrserverless_application#image_uri EmrserverlessApplication#image_uri}.
        '''
