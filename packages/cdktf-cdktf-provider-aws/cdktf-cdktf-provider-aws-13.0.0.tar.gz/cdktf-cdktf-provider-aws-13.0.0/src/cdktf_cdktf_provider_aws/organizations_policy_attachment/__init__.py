...
class OrganizationsPolicyAttachment(
    ...
    def __init__(
        ...
        *,
        ...
        :param skip_destroy: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/organizations_policy_attachment#skip_destroy OrganizationsPolicyAttachment#skip_destroy}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
