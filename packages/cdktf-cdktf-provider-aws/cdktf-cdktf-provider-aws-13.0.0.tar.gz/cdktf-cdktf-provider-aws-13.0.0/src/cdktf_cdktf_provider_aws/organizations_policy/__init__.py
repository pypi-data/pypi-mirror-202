...
class OrganizationsPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param skip_destroy: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/organizations_policy#skip_destroy OrganizationsPolicy#skip_destroy}.
