...
class NetworkfirewallFirewallSubnetMapping:
    def __init__(
        ...
        *,
        ...
        :param ip_address_type: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/networkfirewall_firewall#ip_address_type NetworkfirewallFirewall#ip_address_type}.
        '''
        if __debug__:
