...
class LbSslNegotiationPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param triggers: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/lb_ssl_negotiation_policy#triggers LbSslNegotiationPolicy#triggers}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
