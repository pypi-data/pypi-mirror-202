...
class DbProxyAuth:
    def __init__(
        ...
        *,
        ...
        :param client_password_auth_type: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/db_proxy#client_password_auth_type DbProxy#client_password_auth_type}.
