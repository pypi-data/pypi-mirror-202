...
class RedshiftdataStatement(
    ...
    def __init__(
        ...
        *,
        ...
        :param workgroup_name: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/redshiftdata_statement#workgroup_name RedshiftdataStatement#workgroup_name}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
