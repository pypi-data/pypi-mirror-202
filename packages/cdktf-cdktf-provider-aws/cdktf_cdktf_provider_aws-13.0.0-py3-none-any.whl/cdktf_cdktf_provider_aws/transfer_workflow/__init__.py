...
class TransferWorkflowOnExceptionSteps:
    def __init__(
        ...
        *,
        ...
        :param decrypt_step_details: decrypt_step_details block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/transfer_workflow#decrypt_step_details TransferWorkflow#decrypt_step_details}
