...
class AcmpcaCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        :param api_passthrough: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/acmpca_certificate#api_passthrough AcmpcaCertificate#api_passthrough}.
