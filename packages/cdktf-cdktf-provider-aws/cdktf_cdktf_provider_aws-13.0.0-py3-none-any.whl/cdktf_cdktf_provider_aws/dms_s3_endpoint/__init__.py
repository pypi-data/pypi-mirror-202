...
class DmsS3Endpoint(
    ...
    def __init__(
        ...
        *,
        ...
        :param detach_target_on_lob_lookup_failure_parquet: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/dms_s3_endpoint#detach_target_on_lob_lookup_failure_parquet DmsS3Endpoint#detach_target_on_lob_lookup_failure_parquet}.
