...
def gltf(
    ...
    ''' Export scene as glTF 2.0 file :File: `addons/io_scene_gltf2/__init__.py\:666 <https://projects.blender.org/blender/blender-addons/addons/io_scene_gltf2/__init__.py#L666>`__
    ...
    :param export_hierarchy_flatten_bones: Flatten Bone Hierarchy, Flatten Bone Hierarchy. Usefull in case of non decomposable TRS matrix
    ...
    :param export_optimize_animation_keep_anim_armature: Force keeping channel for armature / bones, if all keyframes are identical in a rig force keeping the minimal animation
    ...
    :param export_negative_frame: Negative Frames, Negative Frames are slided or cropped * ``SLIDE`` Slide -- Slide animation to start at frame 0. * ``CROP`` Crop -- Keep only frames above frame 0.
    :type export_negative_frame: typing.Optional[typing.Any]
    :param export_anim_slide_to_zero: Set all glTF Animation starting at 0, Set all glTF animation starting at 0.0s. Can be usefull for looping animations
    :type export_anim_slide_to_zero: typing.Union[bool, typing.Any]
    :param export_bake_animation: Bake All Objects Animations, Force exporting animation on every objects. Can be usefull when using constraints or driver. Also useful when exporting only selection
    ...
    :param export_current_frame: Use Current Frame as Object Rest Transformations, Export the scene in the current animation frame. When off, frame O is used as rest transformations for objects
    :type export_current_frame: typing.Union[bool, typing.Any]
    :param export_rest_position_armature: Use Rest Position Armature, Export armatures using rest position as joins rest pose. When off, current frame pose is used as rest pose
