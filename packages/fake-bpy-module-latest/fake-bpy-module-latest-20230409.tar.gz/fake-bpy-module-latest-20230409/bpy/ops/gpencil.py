...
def tint_flip(override_context: typing.Union[typing.
              ...
              execution_context: typing.Union[str, int] = None,
              undo: typing.Optional[bool] = None):
    ''' Switch tint colors :File: `startup/bl_ui/properties_grease_pencil_common.py\:871 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_ui/properties_grease_pencil_common.py#L871>`__
