...
def fades_add(override_context: typing.Union[typing.
    ...
    ''' Adds or updates a fade animation for either visual or audio strips :File: `startup/bl_operators/sequencer.py\:190 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/sequencer.py#L190>`__
