...
def play_rendered_anim(override_context: typing.
                       ...
                       execution_context: typing.Union[str, int] = None,
                       undo: typing.Optional[bool] = None):
    ''' Play back rendered frames/movies using an external player :File: `startup/bl_operators/screen_play_rendered_anim.py\:64 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/screen_play_rendered_anim.py#L64>`__
