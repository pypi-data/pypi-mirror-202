    ...
    return (react_1.default.createElement("thead", null,
        react_1.default.createElement("tr", null,
            ...
            header.map((item, index) => react_1.default.createElement("th", { key: index, style: {
                ...
                headerContent ?
                    react_1.default.createElement(react_1.default.Fragment, null, headerContent.filter(header => header.columnName === item && (header.dtype.includes("int") || header.dtype.includes("float"))).length !== 0 ?
...
//# sourceMappingURL=lib_WidgetModel_js.0e5a21e73563aff981fa.js.map