...
class LimitedPriorityLevelConfiguration(google.protobuf.message.Message):
    ...
    ASSURED_CONCURRENCY_SHARES_FIELD_NUMBER: builtins.int
    ...
    RESOURCE_INFO_FIELD_NUMBER: builtins.int
    assured_concurrency_shares: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal["assured_concurrency_shares", b"assured_concurrency_shares", "borrowing_limit_percent", b"borrowing_limit_percent", "lendable_percent", b"lendable_percent", "limit_response", b"limit_response", "resource_info", b"resource_info"]) -> None: ...
