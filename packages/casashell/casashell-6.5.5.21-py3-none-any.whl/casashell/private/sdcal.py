...
##################### 29a5e4b9883214251585a252bf79c0b8 ##############################
...
class _sdcal:
    ...
    def __calmode_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-13.13s =\x1B[0m %s%-23s%s' % ('calmode',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __fraction_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__fraction_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return '10%'
        if self.__fraction_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'fraction': value},{'fraction': self.__schema['fraction']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('fraction',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __noff_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__noff_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(-1)
        if self.__noff_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'noff': value},{'noff': self.__schema['noff']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('noff',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __width_inp(self):
        ...
        if self.__width_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('width',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __elongated_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__elongated_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__elongated_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'elongated': value},{'elongated': self.__schema['elongated']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('elongated',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __applytable_inp(self):
        ...
        if self.__applytable_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('applytable',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __interp_inp(self):
        ...
        if self.__interp_dflt( self.__globals_( ) ) is not None:
             description = 'Interpolation type in time[,freq]. Valid options for time are "nearest", "linear", and "cubic", while valid options for frequency include "nearest", "linear", "cspline", or any numeric string that indicates an order of polynomial interpolation. You can specify interpolation type for time and frequency separately by joining two of the above options by comma (e.g., "linear,cspline").'
             ...
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('interp',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __spwmap_inp(self):
        ...
        if self.__spwmap_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('spwmap',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    ...
    def __intent_inp(self):
        ...
        if self.__intent_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('intent',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# sdcal -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "sdcal.last" if os.path.isfile("sdcal.last") else "sdcal.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('sdcal.last')
