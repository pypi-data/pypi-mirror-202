...
class _bandpass:
    ...
    def __bandtype_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__bandtype_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'B'
        description = 'Type of bandpass solution (B or BPOLY)'
        value = self.__bandtype( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'bandtype': value},{'bandtype': self.__schema['bandtype']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('\x1B[1m\x1B[47m%-14.14s =\x1B[0m %s%-23s%s' % ('bandtype',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    ...
    def __fillgaps_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__fillgaps_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(0)
        if self.__fillgaps_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'fillgaps': value},{'fillgaps': self.__schema['fillgaps']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('fillgaps',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __degamp_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__degamp_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(3)
        if self.__degamp_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'degamp': value},{'degamp': self.__schema['degamp']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('degamp',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __degphase_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__degphase_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(3)
        if self.__degphase_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'degphase': value},{'degphase': self.__schema['degphase']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('degphase',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __visnorm_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__visnorm_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__visnorm_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'visnorm': value},{'visnorm': self.__schema['visnorm']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('visnorm',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __maskcenter_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__maskcenter_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(0)
        if self.__maskcenter_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'maskcenter': value},{'maskcenter': self.__schema['maskcenter']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('maskcenter',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __maskedge_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__maskedge_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(5)
        if self.__maskedge_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'maskedge': value},{'maskedge': self.__schema['maskedge']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('maskedge',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# bandpass -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "bandpass.last" if os.path.isfile("bandpass.last") else "bandpass.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('bandpass.last')
    ...
    def __call__( self, vis=None, caltable=None, field=None, spw=None, intent=None, selectdata=None, timerange=None, uvrange=None, antenna=None, scan=None, observation=None, msselect=None, solint=None, combine=None, refant=None, minblperant=None, minsnr=None, solnorm=None, bandtype=None, smodel=None, corrdepflags=None, append=None, fillgaps=None, degamp=None, degphase=None, visnorm=None, maskcenter=None, maskedge=None, docallib=None, callib=None, gaintable=None, gainfield=None, interp=None, spwmap=None, parang=None ):
        def noobj(s):
           if s.startswith('<') and s.endswith('>'):
               return "None"
           else:
