...
##################### dc02ad8c4633d77885a7648f84e53313 ##############################
...
class _flagdata:
    ...
    channelavg         Pre-average data across channels before analyzing
                       ...
                       NOTE: Pre-average across channels is not
    ...
    chanbin            Bin width for channel average in number of input channels
                       ...
                       1 all input channels are used for the average
                       to produce a single output channel, this
                       behaviour aims to preserve backwards
    ...
    timeavg            Pre-average data across time before analyzing
                       ...
                       NOTE: Pre-average across time is not
                       supported for calibration tables
    ...
    quackinterval      Time in seconds from scan beginning or end to flag.
                       ...
                       time.
    quackmode          Quack mode flags the region of the scan given by one of the
    ...
    def __mode_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-21.21s =\x1B[0m %s%-23s%s' % ('mode',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __autocorr_inp(self):
        ...
        if self.__autocorr_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('autocorr',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __inpfile_inp(self):
        ...
        if self.__inpfile_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('inpfile',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __reason_inp(self):
        ...
        if self.__reason_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('reason',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __tbuff_inp(self):
        ...
        if self.__tbuff_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('tbuff',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __spw_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        if self.__spw_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('spw',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __field_inp(self):
        ...
        if self.__field_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('field',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __antenna_inp(self):
        ...
        if self.__antenna_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('antenna',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __uvrange_inp(self):
        ...
        if self.__uvrange_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('uvrange',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __timerange_inp(self):
        ...
        if self.__timerange_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('timerange',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __correlation_inp(self):
        ...
        if self.__correlation_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('correlation',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __scan_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        if self.__scan_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('scan',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __intent_inp(self):
        ...
        if self.__intent_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('intent',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __array_inp(self):
        ...
        if self.__array_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('array',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __observation_inp(self):
        ...
        if self.__observation_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('observation',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __feed_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        if self.__feed_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('feed',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __clipminmax_inp(self):
        ...
        if self.__clipminmax_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('clipminmax',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __datacolumn_inp(self):
        ...
        if self.__datacolumn_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('datacolumn',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __clipoutside_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__clipoutside_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return True
        if self.__clipoutside_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'clipoutside': value},{'clipoutside': self.__schema['clipoutside']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('clipoutside',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __channelavg_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__channelavg_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__channelavg_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'channelavg': value},{'channelavg': self.__schema['channelavg']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('channelavg',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __chanbin_inp(self):
        ...
        if self.__chanbin_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('chanbin',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __timeavg_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__timeavg_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__timeavg_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'timeavg': value},{'timeavg': self.__schema['timeavg']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('timeavg',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __timebin_inp(self):
        ...
        if self.__timebin_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('timebin',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __clipzeros_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__clipzeros_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__clipzeros_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'clipzeros': value},{'clipzeros': self.__schema['clipzeros']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('clipzeros',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __quackinterval_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__quackinterval_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(1.0)
        if self.__quackinterval_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'quackinterval': value},{'quackinterval': self.__schema['quackinterval']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('quackinterval',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __quackmode_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__quackmode_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'beg'
        if self.__quackmode_dflt( self.__globals_( ) ) is not None:
             description = 'Quack mode. Flag intervals of the scan according to given mode.'
             value = self.__quackmode( self.__globals_( ) )
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'quackmode': value},{'quackmode': self.__schema['quackmode']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('quackmode',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __quackincrement_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__quackincrement_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__quackincrement_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'quackincrement': value},{'quackincrement': self.__schema['quackincrement']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('quackincrement',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __tolerance_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__tolerance_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(0.0)
        if self.__tolerance_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'tolerance': value},{'tolerance': self.__schema['tolerance']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('tolerance',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __addantenna_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__addantenna_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__addantenna_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'addantenna': value},{'addantenna': self.__schema['addantenna']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('addantenna',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __lowerlimit_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__lowerlimit_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(0.0)
        if self.__lowerlimit_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'lowerlimit': value},{'lowerlimit': self.__schema['lowerlimit']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('lowerlimit',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __upperlimit_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__upperlimit_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(90.0)
        if self.__upperlimit_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'upperlimit': value},{'upperlimit': self.__schema['upperlimit']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('upperlimit',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __ntime_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__ntime_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'scan'
        if self.__ntime_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'ntime': value},{'ntime': self.__schema['ntime']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('ntime',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __combinescans_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__combinescans_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__combinescans_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'combinescans': value},{'combinescans': self.__schema['combinescans']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('combinescans',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __timecutoff_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__timecutoff_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(4.0)
        if self.__timecutoff_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'timecutoff': value},{'timecutoff': self.__schema['timecutoff']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('timecutoff',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __freqcutoff_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__freqcutoff_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(3.0)
        if self.__freqcutoff_dflt( self.__globals_( ) ) is not None:
             description = 'Flagging thresholds in units of deviation from the fit'
             value = self.__freqcutoff( self.__globals_( ) )
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'freqcutoff': value},{'freqcutoff': self.__schema['freqcutoff']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('freqcutoff',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __timefit_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__timefit_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'line'
        if self.__timefit_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'timefit': value},{'timefit': self.__schema['timefit']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('timefit',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __freqfit_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__freqfit_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'poly'
        if self.__freqfit_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'freqfit': value},{'freqfit': self.__schema['freqfit']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('freqfit',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __maxnpieces_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__maxnpieces_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(7)
        if self.__maxnpieces_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'maxnpieces': value},{'maxnpieces': self.__schema['maxnpieces']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('maxnpieces',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __flagdimension_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__flagdimension_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'freqtime'
        if self.__flagdimension_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'flagdimension': value},{'flagdimension': self.__schema['flagdimension']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('flagdimension',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __usewindowstats_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__usewindowstats_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'none'
        if self.__usewindowstats_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'usewindowstats': value},{'usewindowstats': self.__schema['usewindowstats']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('usewindowstats',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __halfwin_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__halfwin_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(1)
        if self.__halfwin_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'halfwin': value},{'halfwin': self.__schema['halfwin']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('halfwin',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __extendflags_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__extendflags_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return True
        if self.__extendflags_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'extendflags': value},{'extendflags': self.__schema['extendflags']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('extendflags',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __winsize_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__winsize_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(3)
        if self.__winsize_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'winsize': value},{'winsize': self.__schema['winsize']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('winsize',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __timedev_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__timedev_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__timedev_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'timedev': value},{'timedev': self.__schema['timedev']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('timedev',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __freqdev_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__freqdev_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__freqdev_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'freqdev': value},{'freqdev': self.__schema['freqdev']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('freqdev',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __timedevscale_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__timedevscale_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(5.0)
        if self.__timedevscale_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'timedevscale': value},{'timedevscale': self.__schema['timedevscale']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('timedevscale',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __freqdevscale_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__freqdevscale_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(5.0)
        if self.__freqdevscale_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'freqdevscale': value},{'freqdevscale': self.__schema['freqdevscale']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('freqdevscale',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __spectralmax_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__spectralmax_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(1E6)
        if self.__spectralmax_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'spectralmax': value},{'spectralmax': self.__schema['spectralmax']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('spectralmax',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __spectralmin_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__spectralmin_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(0.0)
        if self.__spectralmin_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'spectralmin': value},{'spectralmin': self.__schema['spectralmin']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('spectralmin',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __antint_ref_antenna_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__antint_ref_antenna_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__antint_ref_antenna_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'antint_ref_antenna': value},{'antint_ref_antenna': self.__schema['antint_ref_antenna']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('antint_ref_antenna',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __minchanfrac_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__minchanfrac_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(0.6)
        if self.__minchanfrac_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'minchanfrac': value},{'minchanfrac': self.__schema['minchanfrac']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('minchanfrac',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __verbose_inp(self):
        ...
        if self.__verbose_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('verbose',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __extendpols_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__extendpols_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return True
        if self.__extendpols_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'extendpols': value},{'extendpols': self.__schema['extendpols']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('extendpols',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __growtime_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__growtime_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(50.0)
        if self.__growtime_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'growtime': value},{'growtime': self.__schema['growtime']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('growtime',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __growfreq_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__growfreq_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(50.0)
        if self.__growfreq_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'growfreq': value},{'growfreq': self.__schema['growfreq']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('growfreq',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __growaround_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__growaround_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__growaround_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'growaround': value},{'growaround': self.__schema['growaround']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('growaround',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __flagneartime_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__flagneartime_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__flagneartime_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'flagneartime': value},{'flagneartime': self.__schema['flagneartime']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('flagneartime',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __flagnearfreq_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__flagnearfreq_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__flagnearfreq_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'flagnearfreq': value},{'flagnearfreq': self.__schema['flagnearfreq']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('flagnearfreq',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __minrel_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__minrel_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(0.0)
        if self.__minrel_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'minrel': value},{'minrel': self.__schema['minrel']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('minrel',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __maxrel_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__maxrel_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(1.0)
        if self.__maxrel_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'maxrel': value},{'maxrel': self.__schema['maxrel']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('maxrel',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __minabs_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__minabs_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(0)
        if self.__minabs_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'minabs': value},{'minabs': self.__schema['minabs']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('minabs',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __maxabs_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__maxabs_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(-1)
        if self.__maxabs_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'maxabs': value},{'maxabs': self.__schema['maxabs']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('maxabs',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __spwchan_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__spwchan_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__spwchan_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'spwchan': value},{'spwchan': self.__schema['spwchan']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('spwchan',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __spwcorr_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__spwcorr_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__spwcorr_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'spwcorr': value},{'spwcorr': self.__schema['spwcorr']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('spwcorr',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __basecnt_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__basecnt_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__basecnt_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'basecnt': value},{'basecnt': self.__schema['basecnt']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('basecnt',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __fieldcnt_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__fieldcnt_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__fieldcnt_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'fieldcnt': value},{'fieldcnt': self.__schema['fieldcnt']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('fieldcnt',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __name_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__name_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'Summary'
        if self.__name_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'name': value},{'name': self.__schema['name']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('name',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __action_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-21.21s =\x1B[0m %s%-23s%s' % ('action',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __display_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__display_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__display_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'display': value},{'display': self.__schema['display']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('display',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __flagbackup_inp(self):
        ...
        if self.__flagbackup_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('flagbackup',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __savepars_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-21.21s =\x1B[0m %s%-23s%s' % ('savepars',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __cmdreason_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__cmdreason_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__cmdreason_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'cmdreason': value},{'cmdreason': self.__schema['cmdreason']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('cmdreason',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __outfile_inp(self):
        ...
        if self.__outfile_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('outfile',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __overwrite_inp(self):
        ...
        if self.__overwrite_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('overwrite',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __writeflags_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__writeflags_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return True
        if self.__writeflags_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'writeflags': value},{'writeflags': self.__schema['writeflags']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-18.18s =\x1B[0m %s%-23s%s' % ('writeflags',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# flagdata -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "flagdata.last" if os.path.isfile("flagdata.last") else "flagdata.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('flagdata.last')
