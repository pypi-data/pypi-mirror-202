...
##################### 679654f67f2a3d1872f004dbc2ef87ed ##############################
...
class _sdfit:
    ...
    def __datacolumn_inp(self):
        ...
        self.__do_inp_output('%-12.12s = %s%-23s%s' % ('datacolumn',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __antenna_inp(self):
        ...
        self.__do_inp_output('%-12.12s = %s%-23s%s' % ('antenna',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    ...
    def __timerange_inp(self):
        ...
        self.__do_inp_output('%-12.12s = %s%-23s%s' % ('timerange',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __scan_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        self.__do_inp_output('%-12.12s = %s%-23s%s' % ('scan',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __pol_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        self.__do_inp_output('%-12.12s = %s%-23s%s' % ('pol',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __intent_inp(self):
        ...
        self.__do_inp_output('%-12.12s = %s%-23s%s' % ('intent',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __timebin_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-12.12s =\x1B[0m %s%-23s%s' % ('timebin',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __timespan_inp(self):
        ...
        if self.__timespan_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-9.9s =\x1B[0m %s%-23s%s' % ('timespan',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __polaverage_inp(self):
        ...
        self.__do_inp_output('%-12.12s = %s%-23s%s' % ('polaverage',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __fitfunc_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__fitfunc_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'gaussian'
        description = 'function for fitting ["gaussian", "lorentzian"]'
        value = self.__fitfunc( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'fitfunc': value},{'fitfunc': self.__schema['fitfunc']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-12.12s = %s%-23s%s' % ('fitfunc',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __fitmode_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__fitmode_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'list'
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'fitmode': value},{'fitmode': self.__schema['fitmode']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('\x1B[1m\x1B[47m%-12.12s =\x1B[0m %s%-23s%s' % ('fitmode',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __nfit_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__nfit_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return [ int(0) ]
        if self.__nfit_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'nfit': value},{'nfit': self.__schema['nfit']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-9.9s =\x1B[0m %s%-23s%s' % ('nfit',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __thresh_inp(self):
        ...
        if self.__thresh_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-9.9s =\x1B[0m %s%-23s%s' % ('thresh',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __avg_limit_inp(self):
        ...
        if self.__avg_limit_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-9.9s =\x1B[0m %s%-23s%s' % ('avg_limit',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __minwidth_inp(self):
        ...
        if self.__minwidth_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-9.9s =\x1B[0m %s%-23s%s' % ('minwidth',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __edge_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        if self.__edge_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-9.9s =\x1B[0m %s%-23s%s' % ('edge',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# sdfit -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "sdfit.last" if os.path.isfile("sdfit.last") else "sdfit.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('sdfit.last')
