...
##################### de160979a5e31e9f22ba9e7cfd7db8f9 ##############################
...
class _statwt:
    ...
    def __slidetimebin_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__slidetimebin_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'slidetimebin': value},{'slidetimebin': self.__schema['slidetimebin']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('slidetimebin',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __chanbin_inp(self):
        ...
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('chanbin',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __minsamp_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__minsamp_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(2)
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'minsamp': value},{'minsamp': self.__schema['minsamp']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('minsamp',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __statalg_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-14.14s =\x1B[0m %s%-23s%s' % ('statalg',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __fence_inp(self):
        ...
        if self.__fence_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('fence',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __center_inp(self):
        ...
        if self.__center_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('center',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __lside_inp(self):
        ...
        if self.__lside_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('lside',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __zscore_inp(self):
        ...
        if self.__zscore_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('zscore',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __maxiter_inp(self):
        ...
        if self.__maxiter_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('maxiter',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __fitspw_inp(self):
        ...
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('fitspw',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __excludechans_inp(self):
        ...
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('excludechans',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __wtrange_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__wtrange_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return [  ]
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'wtrange': value},{'wtrange': self.__schema['wtrange']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('wtrange',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    ...
    def __preview_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__preview_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'preview': value},{'preview': self.__schema['preview']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('preview',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# statwt -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "statwt.last" if os.path.isfile("statwt.last") else "statwt.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('statwt.last')
