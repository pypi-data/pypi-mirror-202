...
class _asdmsummary:
    ...
    def __asdm_inp(self):
        ...
        self.__do_inp_output('%-4.4s = %s%-23s%s' % ('asdm',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# asdmsummary -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "asdmsummary.last" if os.path.isfile("asdmsummary.last") else "asdmsummary.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('asdmsummary.last')
