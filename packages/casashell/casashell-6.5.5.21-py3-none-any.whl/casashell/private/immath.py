...
##################### cd5491adbb52564df09390ab9c67dee0 ##############################
...
class _immath:
    ...
    def __expr_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__expr_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'IM0'
        if self.__expr_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'expr': value},{'expr': self.__schema['expr']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('expr',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __varnames_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__varnames_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__varnames_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'varnames': value},{'varnames': self.__schema['varnames']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('varnames',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __sigma_inp(self):
        ...
        if self.__sigma_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('sigma',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __polithresh_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__polithresh_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__polithresh_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'polithresh': value},{'polithresh': self.__schema['polithresh']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-10.10s =\x1B[0m %s%-23s%s' % ('polithresh',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __mask_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
    ...
    def __imagemd_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__imagemd_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'imagemd': value},{'imagemd': self.__schema['imagemd']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-13.13s = %s%-23s%s' % ('imagemd',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __prec_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__prec_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'float'
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'prec': value},{'prec': self.__schema['prec']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-13.13s = %s%-23s%s' % ('prec',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# immath -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "immath.last" if os.path.isfile("immath.last") else "immath.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('immath.last')
