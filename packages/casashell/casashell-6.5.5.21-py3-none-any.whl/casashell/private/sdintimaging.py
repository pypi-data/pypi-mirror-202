...
##################### fe574e16457cf169f51c6448e2cfefe0 ##############################
...
class _sdintimaging:
    ...
    dishdia              (Optional) effective dish diameter (if sdpsf is given as a dish diameter this will be ignored)
    ...
    def __dishdia_dflt( self, glb ):
        if self.__usedata( glb ) == "sd": return float(100.0)
        if self.__usedata( glb ) == "sdint": return float(100.0)
        return None
    ...
    def __dishdia_inp(self):
        ...
        if self.__dishdia_dflt( self.__globals_( ) ) is not None:
             description = 'Effective dish diameter'
