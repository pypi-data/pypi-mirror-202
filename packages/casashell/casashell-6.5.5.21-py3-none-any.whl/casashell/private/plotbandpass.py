...
##################### 6e5fc5594be7f2b7f3b7377f38fdecc1 ##############################
...
class _plotbandpass:
    ...
    def __caltable_inp(self):
        ...
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('caltable',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __antenna_inp(self):
        ...
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('antenna',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __field_inp(self):
        ...
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('field',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __spw_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('spw',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __yaxis_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-28.28s =\x1B[0m %s%-23s%s' % ('yaxis',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __xaxis_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-28.28s =\x1B[0m %s%-23s%s' % ('xaxis',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __figfile_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-28.28s =\x1B[0m %s%-23s%s' % ('figfile',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __plotrange_inp(self):
        def xml_default( ):
            ...
            if dflt is not None: return dflt
            return [ float(0),float(0),float(0),float(0) ]
        description = 'The axes limits to use [x0,x1,y0,y1].'
        ...
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('plotrange',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __caltable2_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__caltable2_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        description = 'A second cal table, of type BPOLY or B, to overlay on a B table'
        value = self.__caltable2( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'caltable2': value},{'caltable2': self.__schema['caltable2']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('\x1B[1m\x1B[47m%-28.28s =\x1B[0m %s%-23s%s' % ('caltable2',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __overlay_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__overlay_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'overlay': value},{'overlay': self.__schema['overlay']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('\x1B[1m\x1B[47m%-28.28s =\x1B[0m %s%-23s%s' % ('overlay',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __showflagged_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__showflagged_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        description = 'Show the values of the solution, even if flagged'
        value = self.__showflagged( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'showflagged': value},{'showflagged': self.__schema['showflagged']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('showflagged',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __timeranges_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__timeranges_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        description = 'Show only these timeranges, the first timerange being 0'
        value = self.__timeranges( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'timeranges': value},{'timeranges': self.__schema['timeranges']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('timeranges',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __buildpdf_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__buildpdf_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__buildpdf_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'buildpdf': value},{'buildpdf': self.__schema['buildpdf']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('buildpdf',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __caltable3_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__caltable3_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__caltable3_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'caltable3': value},{'caltable3': self.__schema['caltable3']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('caltable3',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __markersize_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__markersize_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(3)
        description = 'Size of points'
        value = self.__markersize( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'markersize': value},{'markersize': self.__schema['markersize']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('markersize',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __density_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__density_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(108)
        if self.__density_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'density': value},{'density': self.__schema['density']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('density',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __interactive_inp(self):
        ...
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('interactive',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __showpoints_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__showpoints_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'auto'
        description = 'Draw points for the data (default=F for amp, T for phase)'
        value = self.__showpoints( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'showpoints': value},{'showpoints': self.__schema['showpoints']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('showpoints',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __showlines_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__showlines_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'auto'
        description = 'Draw lines connecting the data (default=T for amp, F for phase)'
        value = self.__showlines( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'showlines': value},{'showlines': self.__schema['showlines']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('showlines',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __subplot_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__subplot_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return '22'
        description = '11..81,22,32 or 42 for RowsxColumns (default=22), any 3rd digit is ignored'
        value = self.__subplot( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'subplot': value},{'subplot': self.__schema['subplot']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('subplot',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __zoom_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        if self.__zoom_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('zoom',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __poln_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__poln_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        description = 'Polarizations to plot: "" = all, or "RR","RL","LR","LL","XX","XY","YX","YY","RR,LL","XX,YY"'
        value = self.__poln( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'poln': value},{'poln': self.__schema['poln']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('poln',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __showatm_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-28.28s =\x1B[0m %s%-23s%s' % ('showatm',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __pwv_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        if self.__pwv_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('pwv',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __gs_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__gs_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'gs'
        if self.__gs_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'gs': value},{'gs': self.__schema['gs']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('gs',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __convert_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__convert_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'convert'
        if self.__convert_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'convert': value},{'convert': self.__schema['convert']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('convert',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __chanrange_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__chanrange_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__chanrange_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'chanrange': value},{'chanrange': self.__schema['chanrange']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('chanrange',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __solutionTimeThresholdSeconds_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__solutionTimeThresholdSeconds_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(30.0)
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'solutionTimeThresholdSeconds': value},{'solutionTimeThresholdSeconds': self.__schema['solutionTimeThresholdSeconds']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('solutionTimeThresholdSeconds',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __debug_inp(self):
        ...
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('debug',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __phase_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__phase_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__phase_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'phase': value},{'phase': self.__schema['phase']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('phase',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __vis_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('vis',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __showtsky_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-28.28s =\x1B[0m %s%-23s%s' % ('showtsky',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __showfdm_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__showfdm_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__showfdm_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'showfdm': value},{'showfdm': self.__schema['showfdm']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('showfdm',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __showatmfield_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__showatmfield_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__showatmfield_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'showatmfield': value},{'showatmfield': self.__schema['showatmfield']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('showatmfield',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __lo1_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__lo1_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__lo1_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'lo1': value},{'lo1': self.__schema['lo1']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('lo1',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __showimage_inp(self):
        ...
        if self.__showimage_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('showimage',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __showatmpoints_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__showatmpoints_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__showatmpoints_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'showatmpoints': value},{'showatmpoints': self.__schema['showatmpoints']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('showatmpoints',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __parentms_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__parentms_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__parentms_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'parentms': value},{'parentms': self.__schema['parentms']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('parentms',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __pdftk_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__pdftk_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'pdftk'
        if self.__pdftk_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'pdftk': value},{'pdftk': self.__schema['pdftk']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('pdftk',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __channeldiff_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__channeldiff_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        description = 'Set to a value > 0 (sigma) to plot derivatives of the solutions'
        value = self.__channeldiff( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'channeldiff': value},{'channeldiff': self.__schema['channeldiff']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('\x1B[1m\x1B[47m%-28.28s =\x1B[0m %s%-23s%s' % ('channeldiff',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __edge_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        if self.__edge_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('edge',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __resample_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__resample_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(1)
        if self.__resample_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'resample': value},{'resample': self.__schema['resample']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('resample',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __platformingThreshold_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__platformingThreshold_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(10.0)
        if self.__platformingThreshold_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'platformingThreshold': value},{'platformingThreshold': self.__schema['platformingThreshold']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('platformingThreshold',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __platformingSigma_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__platformingSigma_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(10.0)
        if self.__platformingSigma_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'platformingSigma': value},{'platformingSigma': self.__schema['platformingSigma']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('platformingSigma',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __basebands_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__basebands_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'basebands': value},{'basebands': self.__schema['basebands']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('basebands',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __showBasebandNumber_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__showBasebandNumber_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'showBasebandNumber': value},{'showBasebandNumber': self.__schema['showBasebandNumber']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('showBasebandNumber',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __scans_inp(self):
        ...
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('scans',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __figfileSequential_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__figfileSequential_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        ...
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'figfileSequential': value},{'figfileSequential': self.__schema['figfileSequential']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-28.28s = %s%-23s%s' % ('figfileSequential',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __chanrangeSetXrange_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__chanrangeSetXrange_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        if self.__chanrangeSetXrange_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'chanrangeSetXrange': value},{'chanrangeSetXrange': self.__schema['chanrangeSetXrange']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-25.25s =\x1B[0m %s%-23s%s' % ('chanrangeSetXrange',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# plotbandpass -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "plotbandpass.last" if os.path.isfile("plotbandpass.last") else "plotbandpass.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('plotbandpass.last')
