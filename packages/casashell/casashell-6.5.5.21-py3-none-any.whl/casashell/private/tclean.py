...
##################### bf447fef8892e7d8ff7f12de3755a619 ##############################
...
class _tclean:
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# tclean -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "tclean.last" if os.path.isfile("tclean.last") else "tclean.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('tclean.last')
