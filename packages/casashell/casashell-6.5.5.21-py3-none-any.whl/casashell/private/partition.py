...
##################### 481ec27094e49adbbed45f6cf2c5ce2a ##############################
...
class _partition:
    ...
    def __outputvis_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('outputvis',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __createmms_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-18.18s =\x1B[0m %s%-23s%s' % ('createmms',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __separationaxis_inp(self):
        ...
        if self.__separationaxis_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('separationaxis',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __numsubms_inp(self):
        ...
        if self.__numsubms_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('numsubms',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    ...
    def __datacolumn_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('datacolumn',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __field_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('field',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __spw_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
    ...
    def __scan_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('scan',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    ...
    def __correlation_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('correlation',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __timerange_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('timerange',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __intent_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('intent',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __array_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('array',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __uvrange_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('uvrange',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __observation_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('observation',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __feed_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('feed',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __disableparallel_inp(self):
        ...
        if self.__disableparallel_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('disableparallel',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __ddistart_inp(self):
        ...
        if self.__ddistart_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('ddistart',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __taql_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        if self.__taql_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('taql',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# partition -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "partition.last" if os.path.isfile("partition.last") else "partition.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('partition.last')
