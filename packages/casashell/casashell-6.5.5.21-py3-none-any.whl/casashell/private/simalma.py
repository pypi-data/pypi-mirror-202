...
##################### 4a3ac82c1288b5699e222ce63d959cad ##############################
...
class _simalma:
    ...
    * uses Cotton-Schwab clean for single fields and Mosaic gridding
    ...
    def __project_inp(self):
        ...
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('project',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __dryrun_inp(self):
        ...
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('dryrun',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __skymodel_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-14.14s =\x1B[0m %s%-23s%s' % ('skymodel',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __inbright_inp(self):
        ...
        if self.__inbright_dflt( self.__globals_( ) ) is not None:
             description = 'scale surface brightness of brightest pixel e.g. "1.2Jy/pixel"'
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('inbright',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __indirection_inp(self):
        ...
        if self.__indirection_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('indirection',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __incell_inp(self):
        ...
        if self.__incell_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('incell',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __incenter_inp(self):
        ...
        if self.__incenter_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('incenter',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __inwidth_inp(self):
        ...
        if self.__inwidth_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('inwidth',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __complist_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-14.14s =\x1B[0m %s%-23s%s' % ('complist',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __compwidth_inp(self):
        ...
        if self.__compwidth_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('compwidth',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __setpointings_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-14.14s =\x1B[0m %s%-23s%s' % ('setpointings',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __ptgfile_inp(self):
        ...
        if self.__ptgfile_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('ptgfile',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __integration_inp(self):
        ...
        if self.__integration_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('integration',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __direction_inp(self):
        ...
        if self.__direction_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('direction',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __mapsize_inp(self):
        ...
        if self.__mapsize_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('mapsize',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __antennalist_inp(self):
        ...
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('antennalist',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __hourangle_inp(self):
        ...
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('hourangle',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __totaltime_inp(self):
        ...
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('totaltime',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __tpnant_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__tpnant_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(0)
        description = 'Number of total power antennas to use (0-4)'
        value = self.__tpnant( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'tpnant': value},{'tpnant': self.__schema['tpnant']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('\x1B[1m\x1B[47m%-14.14s =\x1B[0m %s%-23s%s' % ('tpnant',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __tptime_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__tptime_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return '0s'
        if self.__tptime_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'tptime': value},{'tptime': self.__schema['tptime']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('tptime',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __pwv_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('pwv',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __image_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-14.14s =\x1B[0m %s%-23s%s' % ('image',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __imsize_inp(self):
        ...
        if self.__imsize_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('imsize',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __imdirection_inp(self):
        ...
        if self.__imdirection_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('imdirection',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __cell_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
        ...
        if self.__cell_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('cell',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __niter_inp(self):
        ...
        if self.__niter_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('niter',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __threshold_inp(self):
        ...
        if self.__threshold_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-11.11s =\x1B[0m %s%-23s%s' % ('threshold',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __graphics_inp(self):
        ...
        self.__do_inp_output('%-14.14s = %s%-23s%s' % ('graphics',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# simalma -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "simalma.last" if os.path.isfile("simalma.last") else "simalma.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('simalma.last')
