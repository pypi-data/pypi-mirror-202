...
##################### 0561845b7bb2e5d5e850c691f92c82e4 ##############################
...
class _deconvolve:
    ...
    deconvolver       Name of minor cycle algorithm (hogbom,clark,multiscale,mem,clarkstokes)
    ...
    def __deconvolver_inp(self):
        def xml_default( ):
            ...
            if dflt is not None: return dflt
            return 'hogbom'
        description = 'Minor cycle algorithm (hogbom,clark,multiscale,mem,clarkstokes)'
