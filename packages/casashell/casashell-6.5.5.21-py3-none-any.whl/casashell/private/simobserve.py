...
class _simobserve:
    ...
    antennalist     Text file containing antenna positions.
    ...
    def __project_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('project',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __skymodel_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-18.18s =\x1B[0m %s%-23s%s' % ('skymodel',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __inbright_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__inbright_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__inbright_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'inbright': value},{'inbright': self.__schema['inbright']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('inbright',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __indirection_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__indirection_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__indirection_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'indirection': value},{'indirection': self.__schema['indirection']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('indirection',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __incell_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__incell_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__incell_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'incell': value},{'incell': self.__schema['incell']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('incell',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __incenter_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__incenter_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__incenter_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'incenter': value},{'incenter': self.__schema['incenter']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('incenter',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __inwidth_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__inwidth_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__inwidth_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'inwidth': value},{'inwidth': self.__schema['inwidth']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('inwidth',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __complist_inp(self):
        ...
        self.__do_inp_output('\x1B[1m\x1B[47m%-18.18s =\x1B[0m %s%-23s%s' % ('complist',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __compwidth_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__compwidth_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return '"8GHz"'
        if self.__compwidth_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'compwidth': value},{'compwidth': self.__schema['compwidth']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('compwidth',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __comp_nchan_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__comp_nchan_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(1)
        if self.__comp_nchan_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'comp_nchan': value},{'comp_nchan': self.__schema['comp_nchan']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('comp_nchan',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __setpointings_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__setpointings_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return True
        description = 'Calculate a map of pointings?'
        value = self.__setpointings( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'setpointings': value},{'setpointings': self.__schema['setpointings']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('\x1B[1m\x1B[47m%-18.18s =\x1B[0m %s%-23s%s' % ('setpointings',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __ptgfile_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__ptgfile_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return '$project.ptg.txt'
        if self.__ptgfile_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'ptgfile': value},{'ptgfile': self.__schema['ptgfile']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('ptgfile',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __integration_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__integration_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return '10s'
        if self.__integration_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'integration': value},{'integration': self.__schema['integration']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('integration',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __direction_inp(self):
        ...
        if self.__direction_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('direction',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __mapsize_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__mapsize_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return [ '','' ]
        if self.__mapsize_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'mapsize': value},{'mapsize': self.__schema['mapsize']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('mapsize',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __maptype_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__maptype_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'hexagonal'
        if self.__maptype_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'maptype': value},{'maptype': self.__schema['maptype']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('maptype',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __pointingspacing_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__pointingspacing_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__pointingspacing_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'pointingspacing': value},{'pointingspacing': self.__schema['pointingspacing']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('pointingspacing',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __caldirection_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__caldirection_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return ''
        if self.__caldirection_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'caldirection': value},{'caldirection': self.__schema['caldirection']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('caldirection',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __calflux_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__calflux_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return '1Jy'
        if self.__calflux_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'calflux': value},{'calflux': self.__schema['calflux']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('calflux',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __obsmode_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__obsmode_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'int'
        description = 'Observation mode to simulate [int(interferometer)|sd(singledish)|(none)]'
        value = self.__obsmode( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'obsmode': value},{'obsmode': self.__schema['obsmode']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('\x1B[1m\x1B[47m%-18.18s =\x1B[0m %s%-23s%s' % ('obsmode',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __refdate_inp(self):
        ...
        if self.__refdate_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('refdate',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __hourangle_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__hourangle_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'transit'
        if self.__hourangle_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'hourangle': value},{'hourangle': self.__schema['hourangle']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('hourangle',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __totaltime_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__totaltime_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return '7200s'
        if self.__totaltime_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'totaltime': value},{'totaltime': self.__schema['totaltime']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('totaltime',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __antennalist_inp(self):
        ...
        if self.__antennalist_dflt( self.__globals_( ) ) is not None:
             ...
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('antennalist',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __sdantlist_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__sdantlist_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'aca.tp.cfg'
        if self.__sdantlist_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'sdantlist': value},{'sdantlist': self.__schema['sdantlist']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('sdantlist',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __sdant_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__sdant_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(0)
        if self.__sdant_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'sdant': value},{'sdant': self.__schema['sdant']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('sdant',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __outframe_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('outframe',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __thermalnoise_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__thermalnoise_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'tsys-atm'
        description = 'add thermal noise: [tsys-atm|tsys-manual|(none)]'
        value = self.__thermalnoise( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'thermalnoise': value},{'thermalnoise': self.__schema['thermalnoise']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('\x1B[1m\x1B[47m%-18.18s =\x1B[0m %s%-23s%s' % ('thermalnoise',pre,self.__to_string_(value),post),description,13+len(pre)+len(post))
    def __user_pwv_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__user_pwv_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(0.5)
        if self.__user_pwv_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'user_pwv': value},{'user_pwv': self.__schema['user_pwv']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('user_pwv',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __t_ground_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__t_ground_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(270.)
        if self.__t_ground_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'t_ground': value},{'t_ground': self.__schema['t_ground']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('t_ground',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __t_sky_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__t_sky_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(260.)
        if self.__t_sky_dflt( self.__globals_( ) ) is not None:
             ...
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'t_sky': value},{'t_sky': self.__schema['t_sky']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('t_sky',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __tau0_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__tau0_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(0.1)
        if self.__tau0_dflt( self.__globals_( ) ) is not None:
             description = 'Zenith opacity'
             value = self.__tau0( self.__globals_( ) )
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'tau0': value},{'tau0': self.__schema['tau0']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('tau0',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __seed_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__seed_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return int(11111)
        if self.__seed_dflt( self.__globals_( ) ) is not None:
             description = 'Random number seed'
             value = self.__seed( self.__globals_( ) )
             (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'seed': value},{'seed': self.__schema['seed']}) else ('\x1B[91m','\x1B[0m')
             self.__do_inp_output('   \x1B[92m%-15.15s =\x1B[0m %s%-23s%s' % ('seed',pre,self.__to_string_(value),post),description,9+len(pre)+len(post))
    def __leakage_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__leakage_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return float(0.0)
        description = 'Cross polarization (interferometer only)'
        value = self.__leakage( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'leakage': value},{'leakage': self.__schema['leakage']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('leakage',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __graphics_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('graphics',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __verbose_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('verbose',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __overwrite_inp(self):
        ...
        self.__do_inp_output('%-18.18s = %s%-23s%s' % ('overwrite',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    ...
    #--------- inp function -----------------------------------------------------------
    def inp(self):
        print("# simobserve -- %s" % self._info_desc_)
    ...
    def tget(self,savefile=None):
        ...
        filename = savefile
        if filename is None:
            filename = "simobserve.last" if os.path.isfile("simobserve.last") else "simobserve.saved"
    ...
    def tput(self,outfile=None):
        ...
        _postfile = outfile if outfile is not None else os.path.realpath('simobserve.last')
