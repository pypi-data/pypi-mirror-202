...
class AudioTranscriber:
    ...
    def transcribe(
        ...
        """
            ...
            Parameters:
            dataset: CustomDataset -> dataset used for transcription
            batchSize: int -> size of the chunk extracted for transcription
            ignoreCache: bool -> if True cached dataset is ignored
