from typing import Any, Dict, Tuple, Literal, List, Union, TypedDict
...
class _BaseGen471694(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
