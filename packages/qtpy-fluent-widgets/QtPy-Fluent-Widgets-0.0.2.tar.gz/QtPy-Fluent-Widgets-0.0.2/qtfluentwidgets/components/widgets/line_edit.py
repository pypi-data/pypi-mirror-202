...
from qtpy.QtCore import QSize, Qt, QRectF, Signal
from qtpy.QtGui import QPainter, QPainterPath, QIcon
from qtpy.QtWidgets import QHBoxLayout, QLineEdit, QToolButton, QTextEdit, QPlainTextEdit
