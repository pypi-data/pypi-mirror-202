...
def read_excel(excel_path, na_values=None, drop_na_cols=True, return_df_if_one=True):
    """
...
def read_db_table(conn_str, table_name):
    df = cx.read_sql(conn_str, f"select * from {table_name}")
