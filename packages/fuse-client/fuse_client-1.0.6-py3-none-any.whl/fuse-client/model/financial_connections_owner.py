...
class FinancialConnectionsOwner(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'addresses': ([FinancialConnectionsOwnerAddresses],),  # noqa: E501
            'emails': ([FinancialConnectionsOwnerEmails],),  # noqa: E501
            'names': ([FinancialConnectionsOwnerNames],),  # noqa: E501
            'phone_numbers': ([FinancialConnectionsOwnerPhoneNumbers],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, addresses, emails, names, phone_numbers, *args, **kwargs):  # noqa: E501
        """FinancialConnectionsOwner - a model defined in OpenAPI

        Args:
            addresses ([FinancialConnectionsOwnerAddresses]):
            emails ([FinancialConnectionsOwnerEmails]):
            names ([FinancialConnectionsOwnerNames]): List of names associated with the owner
            phone_numbers ([FinancialConnectionsOwnerPhoneNumbers]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, addresses, emails, names, phone_numbers, *args, **kwargs):  # noqa: E501
        """FinancialConnectionsOwner - a model defined in OpenAPI
