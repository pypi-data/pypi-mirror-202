...
class GetInvestmentHoldingsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'holdings': ([FinancialConnectionsHolding],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, accounts, holdings, request_id, *args, **kwargs):  # noqa: E501
        """GetInvestmentHoldingsResponse - a model defined in OpenAPI

        Args:
            accounts ([FinancialConnectionsAccount]):
            holdings ([FinancialConnectionsHolding]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, accounts, holdings, request_id, *args, **kwargs):  # noqa: E501
        """GetInvestmentHoldingsResponse - a model defined in OpenAPI
