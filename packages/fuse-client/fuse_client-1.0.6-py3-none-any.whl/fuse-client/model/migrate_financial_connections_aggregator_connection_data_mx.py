...
class MigrateFinancialConnectionsAggregatorConnectionDataMx(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_guid, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            member_guid (str): The unique identifier (GUID) of the member (connection) associated with the user within the MX platform.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_guid, *args, **kwargs):  # noqa: E501
        """MigrateFinancialConnectionsAggregatorConnectionDataMx - a model defined in OpenAPI
