...
class GetFinancialConnectionsTransactionsRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, access_token, start_date, end_date, page, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            records_per_page (int): Number of items per page.. defaults to 25  # noqa: E501
        ...
        records_per_page = kwargs.get('records_per_page', 25)
    ...
    @convert_js_args_to_python_args
    def __init__(self, access_token, start_date, end_date, page, *args, **kwargs):  # noqa: E501
        """GetFinancialConnectionsTransactionsRequest - a model defined in OpenAPI
