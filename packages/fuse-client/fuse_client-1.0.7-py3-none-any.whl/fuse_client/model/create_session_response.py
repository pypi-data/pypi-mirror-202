...
class CreateSessionResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, expiration, client_secret, request_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, expiration, client_secret, request_id, *args, **kwargs):  # noqa: E501
        """CreateSessionResponse - a model defined in OpenAPI
