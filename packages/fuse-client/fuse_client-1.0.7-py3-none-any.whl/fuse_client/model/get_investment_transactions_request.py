...
class GetInvestmentTransactionsRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'page': (int,),  # noqa: E501
            'records_per_page': (int,),  # noqa: E501
            'options': (GetInvestmentTransactionsRequestOptions,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'page': 'page',  # noqa: E501
        'records_per_page': 'records_per_page',  # noqa: E501
    ...
    def _from_openapi_data(cls, access_token, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            start_date (str): The earliest date for which data should be returned. Dates should be formatted as YYYY-MM-DD.. [optional]  # noqa: E501
            end_date (str): The latest date for which data should be returned. Dates should be formatted as YYYY-MM-DD.. [optional]  # noqa: E501
            page (int): Specify current page.. [optional]  # noqa: E501
            records_per_page (int): Number of items per page.. [optional] if omitted the server will use the default value of 25  # noqa: E501
            options (GetInvestmentTransactionsRequestOptions): [optional]  # noqa: E501
        """
