...
class GetFinancialConnectionsTransactionsResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, transactions, total_transactions, request_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, transactions, total_transactions, request_id, *args, **kwargs):  # noqa: E501
        """GetFinancialConnectionsTransactionsResponse - a model defined in OpenAPI
