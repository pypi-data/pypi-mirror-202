...
request_body_create_asset_report_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_asset_report_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_asset_report_request.serialize(body, content_type)
...
class CreateAssetReport(BaseApi):
    ...
    def create_asset_report(
        ...
        return self._create_asset_report_oapg(
            body=body,
