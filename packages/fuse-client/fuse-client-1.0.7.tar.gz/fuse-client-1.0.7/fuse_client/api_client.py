...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FuseApi()
        api_instance.create_asset_report  # this is an instance of the class Endpoint
        api_instance.create_asset_report()  # this invokes api_instance.create_asset_report.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_asset_report.callable or self.callable in this class
