...
class FinancialConnectionsAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, remote_id, fingerprint, name, type, balance, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, remote_id, fingerprint, name, type, balance, *args, **kwargs):  # noqa: E501
        """FinancialConnectionsAccount - a model defined in OpenAPI
