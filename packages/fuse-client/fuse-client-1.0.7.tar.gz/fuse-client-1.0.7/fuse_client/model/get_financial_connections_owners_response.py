...
class GetFinancialConnectionsOwnersResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'accounts': ([GetFinancialConnectionsOwnersResponseAccounts],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, accounts, *args, **kwargs):  # noqa: E501
        """GetFinancialConnectionsOwnersResponse - a model defined in OpenAPI

        Args:
            accounts ([GetFinancialConnectionsOwnersResponseAccounts]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, accounts, *args, **kwargs):  # noqa: E501
        """GetFinancialConnectionsOwnersResponse - a model defined in OpenAPI
