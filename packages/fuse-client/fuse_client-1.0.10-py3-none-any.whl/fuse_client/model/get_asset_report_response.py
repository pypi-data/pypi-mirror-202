...
class GetAssetReportResponse(
            ...
            class report(
                ...
                class MetaOapg:
                    ...
                    class properties:
                        ...
                        client_report_id = schemas.StrSchema
                        ...
                        class accounts(
                            ...
                            class MetaOapg:
                                ...
                                class items(
                                    ...
                                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["remote_account_id", "balances", "historical_balances", "owners", ], str]):
                                        # dict_instance[name] accessor
                                        return super().__getitem__(name)
                                    
                                    
                                    @typing.overload
                                    def get_item_oapg(self, name: typing_extensions.Literal["remote_account_id"]) -> typing.Union[MetaOapg.properties.remote_account_id, schemas.Unset]: ...
                                    ...
                                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["remote_account_id", "balances", "historical_balances", "owners", ], str]):
                                        return super().get_item_oapg(name)
                                    ...
                                    def __new__(
                                        cls,
                                        *_args: typing.Union[dict, frozendict.frozendict, ],
                                        remote_account_id: typing.Union[MetaOapg.properties.remote_account_id, str, schemas.Unset] = schemas.unset,
                        ...
                        class warnings(
                            ...
                            class MetaOapg:
                                ...
                                @staticmethod
                                def items() -> typing.Type['FuseApiWarning']:
                                    return FuseApiWarning
                        
                            def __new__(
                                cls,
                                _arg: typing.Union[typing.Tuple['FuseApiWarning'], typing.List['FuseApiWarning']],
                                _configuration: typing.Optional[schemas.Configuration] = None,
                            ) -> 'warnings':
                                return super().__new__(
                                    cls,
                            ...
                            def __getitem__(self, i: int) -> 'FuseApiWarning':
                                return super().__getitem__(i)
                        __annotations__ = {
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["asset_report_id", "client_report_id", "date_generated", "days_requested", "accounts", "warnings", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["asset_report_id", "client_report_id", "date_generated", "days_requested", "accounts", "warnings", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    ...
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    ...
                    client_report_id: typing.Union[MetaOapg.properties.client_report_id, str, schemas.Unset] = schemas.unset,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["report", "request_id", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["report", "request_id", ], str]):
        return super().get_item_oapg(name)
