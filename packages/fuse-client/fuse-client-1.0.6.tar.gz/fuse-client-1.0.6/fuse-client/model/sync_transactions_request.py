...
class SyncTransactionsRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, access_token, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            cursor (str): The cursor value represents the last update requested. Providing it will cause the response to only return changes after this update. If omitted, the entire history of updates will be returned, starting with the first-added transactions on the item.. [optional]  # noqa: E501
            count (int): The number of transaction updates to fetch.. [optional]  # noqa: E501
        """
