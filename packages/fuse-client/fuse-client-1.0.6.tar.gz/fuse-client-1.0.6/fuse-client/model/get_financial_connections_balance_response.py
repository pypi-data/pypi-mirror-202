...
class GetFinancialConnectionsBalanceResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'balances': ([FinancialConnectionsAccountBalance],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, balances, request_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, balances, request_id, *args, **kwargs):  # noqa: E501
        """GetFinancialConnectionsBalanceResponse - a model defined in OpenAPI
