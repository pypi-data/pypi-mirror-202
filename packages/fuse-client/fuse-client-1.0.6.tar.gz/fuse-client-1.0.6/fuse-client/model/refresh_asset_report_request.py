...
class RefreshAssetReportRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, days_requested, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            access_token (str): The asset_report_token returned by the original call to /asset_report/create. [optional]  # noqa: E501
            include_identity (bool): Indicates whether to include identity data in the Asset Report. [optional] if omitted the server will use the default value of True  # noqa: E501
        """
