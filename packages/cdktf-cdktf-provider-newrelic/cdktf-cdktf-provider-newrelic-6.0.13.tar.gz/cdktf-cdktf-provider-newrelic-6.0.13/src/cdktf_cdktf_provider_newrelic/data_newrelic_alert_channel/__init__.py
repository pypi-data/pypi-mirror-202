...
class DataNewrelicAlertChannel(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: The New Relic account ID where you want to retrieve the alert channel. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/newrelic/d/alert_channel#account_id DataNewrelicAlertChannel#account_id}
