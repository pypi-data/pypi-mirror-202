...
class ServiceLevelEventsBadEventsOutputReference(
    ...
    def put_select(
        ...
        *,
        ...
        :param threshold: The event threshold to use in the SELECT clause. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/newrelic/r/service_level#threshold ServiceLevel#threshold}
        '''
