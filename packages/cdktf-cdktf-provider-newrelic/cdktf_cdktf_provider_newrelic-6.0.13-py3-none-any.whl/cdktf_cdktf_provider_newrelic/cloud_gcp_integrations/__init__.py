...
class CloudGcpIntegrations(
    ...
    def __init__(
        ...
        *,
        ...
        :param alloy_db: alloy_db block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/newrelic/r/cloud_gcp_integrations#alloy_db CloudGcpIntegrations#alloy_db}
