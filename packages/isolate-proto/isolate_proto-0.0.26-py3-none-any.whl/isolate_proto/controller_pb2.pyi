...
@typing_extensions.final
class RegisterCronRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "application_id", b"application_id", "cron", b"cron"
        ],
    ) -> None: ...

global___RegisterCronRequest = RegisterCronRequest

@typing_extensions.final
class RegisterCronResult(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    RESULT_FIELD_NUMBER: builtins.int
    @property
    def result(self) -> global___RegisterCronResultType: ...
    def __init__(
        self,
        *,
        result: global___RegisterCronResultType | None = ...,
    ) -> None: ...
    def HasField(
...
global___RegisterCronResult = RegisterCronResult

@typing_extensions.final
class RegisterCronResultType(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    CRON_ID_FIELD_NUMBER: builtins.int
    cron_id: builtins.str
    def __init__(
        self,
        *,
        cron_id: builtins.str = ...,
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["cron_id", b"cron_id"]
    ) -> None: ...

global___RegisterCronResultType = RegisterCronResultType

@typing_extensions.final
class CronResultType(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    CRON_STRING_FIELD_NUMBER: builtins.int
    CRON_ID_FIELD_NUMBER: builtins.int
    NEXT_RUN_FIELD_NUMBER: builtins.int
    IS_ACTIVE_FIELD_NUMBER: builtins.int
    cron_string: builtins.str
    cron_id: builtins.str
    @property
    def next_run(self) -> google.protobuf.timestamp_pb2.Timestamp: ...
    ...
    def __init__(
        ...
        *,
        cron_string: builtins.str = ...,
        cron_id: builtins.str = ...,
        next_run: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        is_active: builtins.bool = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["next_run", b"next_run"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
global___CronResultType = CronResultType

@typing_extensions.final
class ListCronsResult(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    CRONS_FIELD_NUMBER: builtins.int
    @property
    def crons(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___CronResultType
    ]: ...
    def __init__(
        self,
        *,
        crons: collections.abc.Iterable[global___CronResultType] | None = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["crons", b"crons"]
    ) -> None: ...

global___ListCronsResult = ListCronsResult

@typing_extensions.final
class ListCronsRequest(google.protobuf.message.Message):
    """Empty. For future use."""
...
global___ListCronsRequest = ListCronsRequest

@typing_extensions.final
class ActivationResultType(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "finished_at", b"finished_at", "started_at", b"started_at"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
global___ActivationResultType = ActivationResultType

@typing_extensions.final
class ListActivationsResult(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    ACTIVATIONS_FIELD_NUMBER: builtins.int
    @property
    def activations(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___ActivationResultType
    ]: ...
    def __init__(
        self,
        *,
        activations: collections.abc.Iterable[global___ActivationResultType]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["activations", b"activations"]
    ) -> None: ...

global___ListActivationsResult = ListActivationsResult

@typing_extensions.final
class ListActivationsRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ListActivationsRequest = ListActivationsRequest

@typing_extensions.final
class CancelCronResult(google.protobuf.message.Message):
    """Empty. For future use."""
...
global___CancelCronResult = CancelCronResult

@typing_extensions.final
class CancelCronRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___CancelCronRequest = CancelCronRequest
...
class SetSecretRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "_value", b"_value", "name", b"name", "value", b"value"
        ],
    ) -> None: ...
    def WhichOneof(
...
class Secret(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_created_time", b"_created_time", "created_time", b"created_time"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_created_time", b"_created_time"]
    ) -> typing_extensions.Literal["created_time"] | None: ...
...
class ListSecretsResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["secrets", b"secrets"]
    ) -> None: ...
