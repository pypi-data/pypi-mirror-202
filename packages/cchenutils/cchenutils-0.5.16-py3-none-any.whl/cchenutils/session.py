...
class Session(requests.Session):
    ...
    def get(self, url, session_cookie=False, **kwargs):
        ...
        if session_cookie and 'cookies' not in kwargs and 'cookies' not in kwargs.get('headers', {}):
    ...
    def post(self, url, session_cookie=False, **kwargs):
        if session_cookie and 'cookies' not in kwargs and 'cookies' not in kwargs.get('headers', {}):
            kwargs['cookies'] = self.cookies
        if 'headers' in kwargs:
            kwargs['headers'] |= self.headers
