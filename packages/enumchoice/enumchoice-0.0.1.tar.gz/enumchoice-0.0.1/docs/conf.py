#!/usr/bin/env python
#
# enumchoice documentation build configuration file, created by sphinx-quickstart.
#
...
version = enumchoice.__version__
# The full version, including alpha/beta/rc tags.
release = enumchoice.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(enumchoice.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "enumchoice/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/enumchoice/blob/%s/%s" % (tag, filename)
...
htmlhelp_basename = "enumchoicedoc"
