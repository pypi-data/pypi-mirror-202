...
def	LipIntValuesAuto( n, Dim, Ndata, x,Xd, y, Index, num, id = 0):
    ...
    fm.LipIntValuesAuto( id, pDim, pNdata, px , pXd, py, pIndex, n, ppred)
    return pred
...
def	LipIntValuesCons( n, Dim, Ndata, Cons, x, Xd,y,  Lipconst, Index, num, id = 0):
    ...
    fm.LipIntValuesCons( id, pDim, pNdata, pCons, px , pXd, py, pLipconst, pIndex,n,ppred)
    return pred
...
def	LipIntValuesConsLeftRegion( n, Dim, Ndata, Cons, x, Xd, y, Lipconst, Region, Index, num, id = 0):
    ...
    fm.LipIntValuesConsLeftRegion( id, pDim, pNdata, pCons, px , pXd, py, pLipconst, pRegion, pIndex,n,ppred)
    return pred
...
def	LipIntValuesConsRightRegion( n, Dim, Ndata, Cons, x, Xd,y,  Lipconst, Region, Index, num, id = 0):
    ...
    fm.LipIntValuesConsRightRegion( id, pDim, pNdata, pCons, px , pXd, py, pLipconst, pRegion, pIndex,n,ppred)
    return pred
...
def	LipIntValuesLocal( n, Dim, Ndata, x, Xd,y, num, id = 0):
    ...
    fm.LipIntValuesLocal( id, pDim, pNdata, px , pXd, py,n,ppred)
    return pred
...
def	LipIntValuesLocalCons( n, Dim, Ndata, Cons, x, Xd, y, num, id = 0):
    ...
    fm.LipIntValuesLocalCons( id, pDim, pNdata, pCons, px, pXd, py, n, ppred)
    return pred
...
def	LipIntValuesLocalConsLeftRegion( n, Dim, Ndata,Cons, x, Xd,y, Region, num, id = 0):
    ...
    fm.LipIntValuesLocalConsLeftRegion( id, pDim, pNdata, pCons, px, pXd, py, pRegion, n, ppred)
    return pred
...
def	LipIntValuesLocalConsRightRegion( n, Dim, Ndata,Cons, x, Xd,y, Region, num, id = 0):
    ...
    fm.LipIntValueLocalConsLeftRegion( id, pDim, pNdata, pCons, px , pXd, py, pRegion, n, ppred)
    return pred
...
def	LipIntInfValues( n, Dim, Ndata, x, Xd,y,  Lipconst, Index, num, id = 0):
    ...
    fm.LipIntInfValues( id, pDim, pNdata, px , pXd, py, pLipconst, pIndex, n, ppred)
    return pred
...
def	LipIntInfValuesAuto( n, Dim, Ndata, x,Xd, y, Index, num, id = 0):
    ...
    fm.LipIntInfValuesAuto( id, pDim, pNdata, px , pXd, py, pIndex, n, ppred)
    return pred
...
def	LipIntInfValuesCons( n, Dim, Ndata, Cons, x, Xd,y,  Lipconst, Index, num, id = 0):
    ...
    fm.LipIntInfValuesCons( id, pDim, pNdata, pCons, px, pXd, py, pLipconst, pIndex, n, ppred)
    return pred
...
def	LipIntInfValuesConsLeftRegion( n, Dim, Ndata, Cons, x, Xd,y,  Lipconst, Region, Index, num, id = 0):
    ...
    fm.LipIntInfValuesConsLeftRegion( id, pDim, pNdata, pCons, px , pXd, py, pLipconst, pRegion, pIndex, n, ppred)
    return pred
...
def	LipIntInfValuesConsRightRegion( n, Dim, Ndata, Cons, x, Xd,y,  Lipconst, Region, Index, num, id = 0):
    ...
    fm.LipIntInfValuesConsRightRegion( id, pDim, pNdata, pCons, px , pXd, py, pLipconst, pRegion, pIndex, n, ppred)
...
def	LipIntInfValuesLocal( n, Dim, Ndata, x, Xd,y, num, id = 0):
    ...
    fm.LipIntInfValuesLocal( id, pDim, pNdata, px , pXd, py, n, ppred)
    return pred
...
def	LipIntInfValuesLocalCons( n, Dim, Ndata,Cons, x, Xd,y, num, id = 0):
    ...
    pynp, py = convert_py_float_to_cffi( y)
    pred, ppred = create_float_zeros_as_CFFI_double( n)
    fm.LipIntInfValuesLocalCons( id, pDim, pNdata, pCons, px , pXd, py, n, ppred)
    return pred
...
def	LipIntInfValuesLocalConsLeftRegion( n, Dim, Ndata,Cons, x, Xd,y, Region, num, id = 0):
    ...
    pRegionnp, pRegion = convert_py_float_to_cffi( Region)
    pred, ppred = create_float_zeros_as_CFFI_double( n)
    fm.LipIntInfValuesLocalConsLeftRegion( id, pDim, pNdata, pCons, px , pXd, py, pRegion, n, ppred)
    return pred
...
def	LipIntInfValuesLocalConsRightRegion( n, Dim, Ndata,Cons, x, Xd,y, Region, num, id = 0):
    ...
    pynp, py = convert_py_float_to_cffi( y)
    pRegionnp, pRegion = convert_py_float_to_cffi( Region)
    fm.LipIntInfValuesLocalConsRightRegion( id, pDim, pNdata, pCons, px , pXd, py, pRegion, n, ppred)
...
def STCValuesExplicit( n, x, num, id = 0 ):
    ...
    fm.STCValuesExplicit( id, px , n, ppred)
    return pred
...
def LipIntValuesExplicitDim( n, dim, x, num, id = 0):
    ...
    fm.LipIntValuesExplicitDim( id, dim, px, n, ppred)
    return pred
...
def LipIntValuesDim( n, dim, x, num, id = 0):
    ...
    fm.LipIntValuesDim( id, dim, px , n, ppred)
    return pred
###############################################################################
