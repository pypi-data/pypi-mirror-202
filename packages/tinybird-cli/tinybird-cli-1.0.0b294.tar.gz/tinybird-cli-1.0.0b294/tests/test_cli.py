...
from tinybird.tb_cli_modules.telemetry import flush_telemetry, _get_helper as get_telemetry_helper
...
SQL >
    ...
    async def test_regression_tests_branch_vs_main_all_pipes_coverage(self) -> None:
        ...
        for args in [["branch", "regression-tests", "coverage", "--wait"], ["branch", "regression-tests", "--wait"]]:
    ...
    async def test_regression_tests_branch_vs_main_pipe_argument_manual(self) -> None:
        ...
        expected = [
            FeedbackManager.info_regression_tests_branch_job_url(url=''),
            "test_pipe_a_good.json?param=1&pipe_checker=true ... ok",
            "Passed",
            "Performance metrics"
        ]
        self._assert_feedback_output(expected, output)
    ...
    async def test_regression_tests_branch_vs_main_filename(self) -> None:
        ...
        expected = [
            FeedbackManager.info_regression_tests_branch_job_url(url=''),
            "test_pipe_a_good.json?date_from=2020-01-01&date_to=2021-01-01&pipe_checker=true ... ok",
            "Passed",
            "Performance metrics"
        ]
        self._assert_feedback_output(expected, output)
