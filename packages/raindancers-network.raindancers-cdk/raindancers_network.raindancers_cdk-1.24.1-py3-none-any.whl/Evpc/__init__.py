...
class AwsManagedDNSFirewallRuleGroup(
    ...
    def __init__(self, scope: constructs.Construct, id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AwsManagedDNSFirewallRuleGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def resolver_rule_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(AwsManagedDNSFirewallRuleGroup, "resolver_rule_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CrossRegionParameterReader(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrossRegionParameterReader.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
...
class CrossRegionParameterReaderProps:
    def __init__(self, *, parameter_name: builtins.str, region: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrossRegionParameterReaderProps.__init__)
...
class CrossRegionParameterWriter(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrossRegionParameterWriter.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class CrossRegionParameterWriterProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrossRegionParameterWriterProps.__init__)
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
            check_type(argname="argument parameter_name", value=parameter_name, expected_type=type_hints["parameter_name"])
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        self._values: typing.Dict[str, typing.Any] = {
...
@jsii.data_type(
    jsii_type="raindancers-network.CrossRegionVpc",
    jsii_struct_bases=[],
    name_mapping={
        "vpc_id_s_sm_paramter": "vpcIdSSmParamter",
        "vpc_region": "vpcRegion",
    },
)
class CrossRegionVpc:
    def __init__(
        self,
        *,
        vpc_id_s_sm_paramter: builtins.str,
        vpc_region: builtins.str,
    ) -> None:
        '''
        :param vpc_id_s_sm_paramter: 
        :param vpc_region: 

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrossRegionVpc.__init__)
            check_type(argname="argument vpc_id_s_sm_paramter", value=vpc_id_s_sm_paramter, expected_type=type_hints["vpc_id_s_sm_paramter"])
            check_type(argname="argument vpc_region", value=vpc_region, expected_type=type_hints["vpc_region"])
        self._values: typing.Dict[str, typing.Any] = {
            "vpc_id_s_sm_paramter": vpc_id_s_sm_paramter,
            "vpc_region": vpc_region,
        }

    @builtins.property
    def vpc_id_s_sm_paramter(self) -> builtins.str:
        '''
        :stability: experimental
        '''
        result = self._values.get("vpc_id_s_sm_paramter")
        assert result is not None, "Required property 'vpc_id_s_sm_paramter' is missing"
        return typing.cast(builtins.str, result)
...
class EnterpriseZone(
    ...
    def __init__(
        ...
        *,
        ...
        cross_region_vpc: typing.Optional[typing.Sequence[typing.Union[CrossRegionVpc, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
        ...
        props = EnterpriseZoneProps(
            ...
            cross_region_vpc=cross_region_vpc,
        )
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "cross_region_vpc": "crossRegionVpc",
    },
)
class EnterpriseZoneProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument cross_region_vpc", value=cross_region_vpc, expected_type=type_hints["cross_region_vpc"])
        self._values: typing.Dict[str, typing.Any] = {
            "central_account": central_account,
            "enterprise_domain_name": enterprise_domain_name,
            "local_vpc": local_vpc,
        ...
        if cross_region_vpc is not None:
            self._values["cross_region_vpc"] = cross_region_vpc
    ...
    @builtins.property
    def cross_region_vpc(self) -> typing.Optional[typing.List[CrossRegionVpc]]:
        '''
        :stability: experimental
        '''
        result = self._values.get("cross_region_vpc")
        return typing.cast(typing.Optional[typing.List[CrossRegionVpc]], result)
