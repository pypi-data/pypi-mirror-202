...
def _clean_state_from_excluded_paths(hub, state, exclude_paths):
...
def compare_changes(
    ...
    cleaned_old_state = _clean_state_from_excluded_paths(hub, old_state, exclude_paths)
    cleaned_new_state = _clean_state_from_excluded_paths(hub, new_state, exclude_paths)
