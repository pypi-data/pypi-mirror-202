...
收录所有有关中文的库。
'''
def xingshi(start:int|bool=None,end:int|bool=None):
    '''
    显示出姓氏列表。
    本列表里收录了508个姓氏，包括两个文字的姓氏。
    start：从哪里作为开头。
    end：从哪里作为结尾。
    '''
    try:
        xs = ['赵','钱','孙','李','周','吴','郑','王','冯','陈','褚','卫',
              ...
              '卓','蔺','屠','蒙','池','乔','阴','欎','胥','能','苍','双',
              '闻','莘','党','翟','谭','贡','劳','逄','姬','申','扶','堵',
              '冉','宰','郦','雍','舄','璩','桑','桂','濮','牛','寿','通',
              ...
              '夹谷','宰父','谷梁','晋','楚','闫','法','汝','鄢','涂','钦','段干'
              ,'百里','东郭','南门','呼延','归','海','羊舌','微生','岳','帅','缑',
              '亢','况','后','有','琴','梁丘','左丘','东门','西门','商','牟','佘',
