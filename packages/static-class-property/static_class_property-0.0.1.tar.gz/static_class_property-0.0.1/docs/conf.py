#!/usr/bin/env python
#
# static_class_property documentation build configuration file, created by sphinx-quickstart.
#
...
version = static_class_property.__version__
# The full version, including alpha/beta/rc tags.
release = static_class_property.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(static_class_property.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "static_class_property/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/static-class-property/blob/%s/%s" % (
        tag,
        filename,
    )
...
html_theme_options = {
    ...
    "github_user": "maximz",
    "github_repo": "static-class-property",
    "github_banner": True,
    "github_type": "star",
    "show_related": False,
    "note_bg": "#FFF59C",
...
htmlhelp_basename = "static_class_propertydoc"
...
latex_documents = [
    (
        master_doc,
        "static_class_property.tex",
        "static-class-property Documentation",
        author,
        "manual",
    ),
]
