#!/usr/bin/env python
#
# regressout documentation build configuration file, created by sphinx-quickstart.
#
...
version = regressout.__version__
# The full version, including alpha/beta/rc tags.
release = regressout.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(regressout.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "regressout/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/regressout/blob/%s/%s" % (tag, filename)
...
htmlhelp_basename = "regressoutdoc"
