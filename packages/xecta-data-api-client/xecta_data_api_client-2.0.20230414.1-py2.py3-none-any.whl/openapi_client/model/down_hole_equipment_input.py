...
class DownHoleEquipmentInput(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, source_well_id, source_wellbore_id, source_id, type, top_md, bottom_md, run_date, pull_date, *args, **kwargs):  # noqa: E501
        """DownHoleEquipmentInput - a model defined in OpenAPI
