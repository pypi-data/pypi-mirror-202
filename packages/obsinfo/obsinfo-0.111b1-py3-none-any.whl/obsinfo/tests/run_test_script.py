...
class TestObsinfo(unittest.TestCase):
    ...
    def test_change_modifications(self):
        ...
        if verbose:
            print(f'Processing subnetwork file with channel modifications: TEST-channel-mods-1.subnetwork.yaml')
        ...
        if verbose:
            print(f'Processing subnetwork file with channel modifications: TEST-channel-mods-2.subnetwork.yaml')
        ...
        if verbose:
            print(f'Processing subnetwork file with channel modifications: TEST-channel-mods-3.subnetwork.yaml')
        ...
        if verbose:
            print(f'Processing subnetwork file with channel modifications: TEST-channel-mods-4.subnetwork.yaml')
        ...
        if verbose:
            print(f'Processing network file with channel modifications: TEST-channel-mods-5.subnetwork.yaml')
        ...
        if verbose:
            print(f'Processing subnetwork file with stage modifications: TEST-stage-mods-1.subnetwork.yaml')
