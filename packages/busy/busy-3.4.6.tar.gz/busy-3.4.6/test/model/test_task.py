...
class TestTask(TestCase):
    ...
    def test_base(self):
        t = Task("a at https://b.us #f --> foo")
        self.assertEqual(t.base, 'a')

    def test_base_without_resource(self):
        t = Task("f #k --> p")
        self.assertEqual(t.base, "f")

    def test_tags_only_first_part(self):
        t = Task("a #b --> c #d")
        self.assertEqual(t.tags, {'b'})