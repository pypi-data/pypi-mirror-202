...
class CreateApprovalRequestRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resource_id, description, instructions, *args, **kwargs):  # noqa: E501
        """CreateApprovalRequestRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, resource_id, description, instructions, *args, **kwargs):  # noqa: E501
        """CreateApprovalRequestRequest - a model defined in OpenAPI
