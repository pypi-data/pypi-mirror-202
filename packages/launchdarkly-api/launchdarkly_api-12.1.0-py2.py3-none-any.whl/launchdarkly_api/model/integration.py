...
def lazy_import():
    ...
    globals()['IntegrationSubscriptionStatusRep'] = IntegrationSubscriptionStatusRep
    globals()['Link'] = Link
...
class Integration(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'statements': ([Statement],),  # noqa: E501
            'on': (bool,),  # noqa: E501
            'tags': ([str],),  # noqa: E501
            'access': (Access,),  # noqa: E501
            'status': (IntegrationSubscriptionStatusRep,),  # noqa: E501
            'url': (str,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            links ({str: (Link,)}): The location and content type of related resources. [optional]  # noqa: E501
            id (str): The ID for this integration audit log subscription. [optional]  # noqa: E501
            kind (str): The type of integration. [optional]  # noqa: E501
            name (str): A human-friendly name for the integration. [optional]  # noqa: E501
            config ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Details on configuration for an integration of this type. Refer to the <code>formVariables</code> field in the corresponding <code>manifest.json</code> for a full list of fields for each integration.. [optional]  # noqa: E501
            statements ([Statement]): Represents a Custom role policy, defining a resource kinds filter the integration audit log subscription responds to.. [optional]  # noqa: E501
            on (bool): Whether the integration is currently active. [optional]  # noqa: E501
            tags ([str]): An array of tags for this integration. [optional]  # noqa: E501
            access (Access): [optional]  # noqa: E501
            status (IntegrationSubscriptionStatusRep): [optional]  # noqa: E501
            url (str): Slack webhook receiver URL. Only used for legacy Slack webhook integrations.. [optional]  # noqa: E501
            api_key (str): Datadog API key. Only used for legacy Datadog webhook integrations.. [optional]  # noqa: E501
        """
