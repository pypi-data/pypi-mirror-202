...
def lazy_import():
    ...
    globals()['ContextInstanceSegmentMembership'] = ContextInstanceSegmentMembership
    globals()['Link'] = Link


class ContextInstanceSegmentMemberships(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ContextInstanceSegmentMembership],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, links, *args, **kwargs):  # noqa: E501
        """ContextInstanceSegmentMemberships - a model defined in OpenAPI
