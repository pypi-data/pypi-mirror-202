...
def lazy_import():
    ...
    globals()['Extinction'] = Extinction
    globals()['Link'] = Link


class ExtinctionCollectionRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ({str: ([Extinction],)},),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, links, items, *args, **kwargs):  # noqa: E501
        """ExtinctionCollectionRep - a model defined in OpenAPI
