...
class AuditLogEntryListingRepCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([AuditLogEntryListingRep],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, links, *args, **kwargs):  # noqa: E501
        """AuditLogEntryListingRepCollection - a model defined in OpenAPI

        Args:
            items ([AuditLogEntryListingRep]): An array of audit log entries
