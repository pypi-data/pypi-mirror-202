...
def lazy_import():
    ...
    globals()['ContextAttributeNames'] = ContextAttributeNames


class ContextAttributeNamesCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ContextAttributeNames],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """ContextAttributeNamesCollection - a model defined in OpenAPI

        Args:
            items ([ContextAttributeNames]): A collection of context attribute name data grouped by kind.
