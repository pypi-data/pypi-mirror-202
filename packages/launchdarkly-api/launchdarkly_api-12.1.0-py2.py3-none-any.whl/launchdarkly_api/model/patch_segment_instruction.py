...
class PatchSegmentInstruction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, kind, user_key, target_type, *args, **kwargs):  # noqa: E501
        """PatchSegmentInstruction - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            value (int): The time, in Unix milliseconds, when the user should be removed from this segment. Required if <code>kind</code> is <code>addExpireUserTargetDate</code> or <code>updateExpireUserTargetDate</code>.. [optional]  # noqa: E501
            version (int): The version of the segment to update. Required if <code>kind</code> is <code>updateExpireUserTargetDate</code>.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, kind, user_key, target_type, *args, **kwargs):  # noqa: E501
        """PatchSegmentInstruction - a model defined in OpenAPI
