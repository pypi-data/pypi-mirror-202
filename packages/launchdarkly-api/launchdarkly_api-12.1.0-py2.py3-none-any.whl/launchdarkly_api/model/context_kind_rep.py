...
class ContextKindRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, name, description, version, creation_date, last_modified, created_from, *args, **kwargs):  # noqa: E501
        """ContextKindRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            last_seen (int): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, name, description, version, creation_date, last_modified, created_from, *args, **kwargs):  # noqa: E501
        """ContextKindRep - a model defined in OpenAPI
