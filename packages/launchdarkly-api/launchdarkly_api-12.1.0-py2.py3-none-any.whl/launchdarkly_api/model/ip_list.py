...
class IpList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'outbound_addresses': ([str],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'outbound_addresses': 'outboundAddresses',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, addresses, outbound_addresses, *args, **kwargs):  # noqa: E501
        """IpList - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, addresses, outbound_addresses, *args, **kwargs):  # noqa: E501
        """IpList - a model defined in OpenAPI
