...
class FlagLinkPost(ModelNormal):
    ...
    attribute_map = {
        'key': 'key',  # noqa: E501
        'integration_key': 'integrationKey',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FlagLinkPost - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            integration_key (str): The integration key for an integration whose <code>manifest.json</code> includes the <code>flagLink</code> capability, if this is a flag link for an existing integration. Do not include for URL flag links.. [optional]  # noqa: E501
            timestamp (int): [optional]  # noqa: E501
            deep_link (str): The URL for the external resource you are linking the flag to. [optional]  # noqa: E501
