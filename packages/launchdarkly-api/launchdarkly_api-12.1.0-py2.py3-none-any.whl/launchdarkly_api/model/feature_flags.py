...
class FeatureFlags(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([FeatureFlag],),  # noqa: E501
            'links': ({str: (Link,)},),  # noqa: E501
            'total_count': (int,),  # noqa: E501
            'total_count_with_differences': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'total_count_with_differences': 'totalCountWithDifferences',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, items, links, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            total_count (int): The total number of flags. [optional]  # noqa: E501
            total_count_with_differences (int): The number of flags that have differences between environments. Only shown when query parameter <code>compare</code> is <code>true</code>.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, items, links, *args, **kwargs):  # noqa: E501
        """FeatureFlags - a model defined in OpenAPI
