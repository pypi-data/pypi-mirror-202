...
class SegmentBody(ModelNormal):
    ...
    def _from_openapi_data(cls, name, key, *args, **kwargs):  # noqa: E501
        """SegmentBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            tags ([str]): Tags for the segment. [optional]  # noqa: E501
            unbounded (bool): Whether to create a standard segment (false) or a Big Segment (true). Only use a Big Segment if you need to add more than 15,000 individual targets.. [optional]  # noqa: E501
            unbounded_context_kind (str): If unbounded is true, you can use this field to set the Big Segment's context kind. [optional]  # noqa: E501
        """
