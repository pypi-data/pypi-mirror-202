...
def lazy_import():
    ...
    globals()['ContextAttributeValues'] = ContextAttributeValues


class ContextAttributeValuesCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ContextAttributeValues],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """ContextAttributeValuesCollection - a model defined in OpenAPI

        Args:
            items ([ContextAttributeValues]): A collection of context attribute value data grouped by kind.
