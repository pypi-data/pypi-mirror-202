...
class TreatmentParameterInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, flag_key, variation_id, *args, **kwargs):  # noqa: E501
        """TreatmentParameterInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, flag_key, variation_id, *args, **kwargs):  # noqa: E501
        """TreatmentParameterInput - a model defined in OpenAPI
