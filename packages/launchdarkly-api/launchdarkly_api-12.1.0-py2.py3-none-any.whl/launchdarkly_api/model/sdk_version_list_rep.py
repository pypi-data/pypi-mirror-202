...
def lazy_import():
    ...
    globals()['SdkVersionRep'] = SdkVersionRep


class SdkVersionListRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sdk_versions': ([SdkVersionRep],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'sdk_versions': 'sdkVersions',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, sdk_versions, *args, **kwargs):  # noqa: E501
        """SdkVersionListRep - a model defined in OpenAPI

        Args:
            links ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The location and content type of related resources
            sdk_versions ([SdkVersionRep]): The list of SDK names and versions
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, sdk_versions, *args, **kwargs):  # noqa: E501
        """SdkVersionListRep - a model defined in OpenAPI
