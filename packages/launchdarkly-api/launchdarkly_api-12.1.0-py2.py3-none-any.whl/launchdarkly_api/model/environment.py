...
class Environment(ModelNormal):
    ...
    attribute_map = {
        ...
        'mobile_key': 'mobileKey',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, id, key, name, api_key, mobile_key, color, default_ttl, secure_mode, default_track_events, require_comments, confirm_changes, tags, *args, **kwargs):  # noqa: E501
        """Environment - a model defined in OpenAPI

        Args:
            links ({str: (Link,)}): Links to other resources within the API. Includes the URL and content type of those resources
            id (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, id, key, name, api_key, mobile_key, color, default_ttl, secure_mode, default_track_events, require_comments, confirm_changes, tags, *args, **kwargs):  # noqa: E501
        """Environment - a model defined in OpenAPI
