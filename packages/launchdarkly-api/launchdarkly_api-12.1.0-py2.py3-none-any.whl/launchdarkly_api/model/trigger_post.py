...
class TriggerPost(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'instructions': ([Instruction],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, integration_key, *args, **kwargs):  # noqa: E501
        """TriggerPost - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            comment (str): Optional comment describing the trigger. [optional]  # noqa: E501
            instructions ([Instruction]): The action to perform when triggering. This should be an array with a single object that looks like <code>{\"kind\": \"flag_action\"}</code>. Supported flag actions are <code>turnFlagOn</code> and <code>turnFlagOff</code>.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, integration_key, *args, **kwargs):  # noqa: E501
        """TriggerPost - a model defined in OpenAPI
