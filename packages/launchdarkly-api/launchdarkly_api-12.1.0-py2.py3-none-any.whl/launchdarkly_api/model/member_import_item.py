...
class MemberImportItem(ModelNormal):
    ...
    def _from_openapi_data(cls, status, value, *args, **kwargs):  # noqa: E501
        """MemberImportItem - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            message (str): An error message, including CSV line number, if the <code>status</code> is <code>error</code>. [optional]  # noqa: E501
        """
