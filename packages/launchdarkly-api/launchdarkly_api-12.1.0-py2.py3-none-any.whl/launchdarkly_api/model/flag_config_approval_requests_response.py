...
def lazy_import():
    ...
    globals()['FlagConfigApprovalRequestResponse'] = FlagConfigApprovalRequestResponse
    globals()['Link'] = Link


class FlagConfigApprovalRequestsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([FlagConfigApprovalRequestResponse],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, links, *args, **kwargs):  # noqa: E501
        """FlagConfigApprovalRequestsResponse - a model defined in OpenAPI

        Args:
            items ([FlagConfigApprovalRequestResponse]): An array of approval requests
