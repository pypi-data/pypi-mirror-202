...
class SourceEnv(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SourceEnv - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            key (str): The key of the source environment to clone from. [optional]  # noqa: E501
            version (int): (Optional) The version number of the source environment to clone from. Used for optimistic locking. [optional]  # noqa: E501
        """
