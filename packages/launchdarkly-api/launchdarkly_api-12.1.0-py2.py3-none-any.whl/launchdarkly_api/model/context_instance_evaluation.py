...
def lazy_import():
    ...
    globals()['ContextInstanceEvaluationReason'] = ContextInstanceEvaluationReason
    globals()['Link'] = Link


class ContextInstanceEvaluation(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'reason': (ContextInstanceEvaluationReason,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, key, value, links, *args, **kwargs):  # noqa: E501
        """ContextInstanceEvaluation - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            reason (ContextInstanceEvaluationReason): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, key, value, links, *args, **kwargs):  # noqa: E501
        """ContextInstanceEvaluation - a model defined in OpenAPI
