...
class FeatureFlagScheduledChange(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'conflicts': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, creation_date, maintainer_id, version, execution_date, instructions, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            conflicts (bool, date, datetime, dict, float, int, list, str, none_type): Details on any conflicting scheduled changes. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, creation_date, maintainer_id, version, execution_date, instructions, *args, **kwargs):  # noqa: E501
        """FeatureFlagScheduledChange - a model defined in OpenAPI
