...
class SeriesIntervalsRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, series, links, *args, **kwargs):  # noqa: E501
        """SeriesIntervalsRep - a model defined in OpenAPI

        Args:
            series ([Series]): An array of timestamps and values for a given meter
    ...
    @convert_js_args_to_python_args
    def __init__(self, series, links, *args, **kwargs):  # noqa: E501
        """SeriesIntervalsRep - a model defined in OpenAPI
