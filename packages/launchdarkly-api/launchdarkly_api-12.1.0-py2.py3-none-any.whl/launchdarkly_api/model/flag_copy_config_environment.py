...
class FlagCopyConfigEnvironment(ModelNormal):
    ...
    def _from_openapi_data(cls, key, *args, **kwargs):  # noqa: E501
        """FlagCopyConfigEnvironment - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            current_version (int): Optional flag version. If you include this, the operation only succeeds if the current flag version in the environment matches this version.. [optional]  # noqa: E501
        """
