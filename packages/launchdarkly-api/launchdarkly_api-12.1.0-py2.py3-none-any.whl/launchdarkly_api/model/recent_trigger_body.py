...
class RecentTriggerBody(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'json_body': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RecentTriggerBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            json_body ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The marshalled JSON request body for the incoming trigger webhook. If this is empty or contains invalid JSON, the timestamp is recorded but this field will be empty.. [optional]  # noqa: E501
        """
