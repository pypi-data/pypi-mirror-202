...
class ReviewResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, kind, *args, **kwargs):  # noqa: E501
        """ReviewResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            comment (str): A comment describing the approval response. [optional]  # noqa: E501
            member_id (str): ID of account member that reviewed request. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, kind, *args, **kwargs):  # noqa: E501
        """ReviewResponse - a model defined in OpenAPI
