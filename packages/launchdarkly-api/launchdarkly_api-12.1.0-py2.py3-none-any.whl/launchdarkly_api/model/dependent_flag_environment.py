...
class DependentFlagEnvironment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, links, site, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): The environment name. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, links, site, *args, **kwargs):  # noqa: E501
        """DependentFlagEnvironment - a model defined in OpenAPI
