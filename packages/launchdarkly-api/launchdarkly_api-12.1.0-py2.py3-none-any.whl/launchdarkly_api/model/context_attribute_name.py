...
class ContextAttributeName(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, weight, *args, **kwargs):  # noqa: E501
        """ContextAttributeName - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            redacted (bool): Whether or not the attribute has one or more redacted values.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, weight, *args, **kwargs):  # noqa: E501
        """ContextAttributeName - a model defined in OpenAPI
