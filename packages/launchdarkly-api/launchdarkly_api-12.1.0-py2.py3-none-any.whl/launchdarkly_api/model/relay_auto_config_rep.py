...
class RelayAutoConfigRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, policy, full_key, display_key, creation_date, last_modified, *args, **kwargs):  # noqa: E501
        """RelayAutoConfigRep - a model defined in OpenAPI

        Args:
            id (str):
            name (str): A human-friendly name for the Relay Proxy configuration
            policy ([Statement]): A description of what environments and projects the Relay Proxy should include or exclude
        ...
        Keyword Args:
            ...
            creator (MemberSummary): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, policy, full_key, display_key, creation_date, last_modified, *args, **kwargs):  # noqa: E501
        """RelayAutoConfigRep - a model defined in OpenAPI
