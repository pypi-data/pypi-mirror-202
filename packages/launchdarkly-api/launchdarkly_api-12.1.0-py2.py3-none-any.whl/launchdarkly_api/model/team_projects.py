...
def lazy_import():
    ...
    globals()['ProjectSummary'] = ProjectSummary


class TeamProjects(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([ProjectSummary],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TeamProjects - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            items ([ProjectSummary]): Details on each project where team members have write privileges on at least one resource type (e.g. flags). [optional]  # noqa: E501
        """
