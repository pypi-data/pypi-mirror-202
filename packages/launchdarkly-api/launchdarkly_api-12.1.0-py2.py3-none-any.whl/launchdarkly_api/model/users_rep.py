...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['UserRecord'] = UserRecord


class UsersRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, total_count, items, *args, **kwargs):  # noqa: E501
        """UsersRep - a model defined in OpenAPI

        Args:
            total_count (int): The total number of users in the environment
            items ([UserRecord]): Details on the users
    ...
    @convert_js_args_to_python_args
    def __init__(self, total_count, items, *args, **kwargs):  # noqa: E501
        """UsersRep - a model defined in OpenAPI
