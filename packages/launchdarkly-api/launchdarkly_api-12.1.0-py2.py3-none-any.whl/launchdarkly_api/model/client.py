...
class Client(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, name, account_id, client_id, redirect_uri, creation_date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            description (str): Client description. [optional]  # noqa: E501
            client_secret (str): The client secret. This will only be shown upon creation.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, name, account_id, client_id, redirect_uri, creation_date, *args, **kwargs):  # noqa: E501
        """Client - a model defined in OpenAPI
