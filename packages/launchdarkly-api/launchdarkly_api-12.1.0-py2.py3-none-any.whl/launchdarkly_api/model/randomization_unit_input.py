...
class RandomizationUnitInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, randomization_unit, default, standard_randomization_unit, *args, **kwargs):  # noqa: E501
        ...
        self.standard_randomization_unit = standard_randomization_unit
    ...
    @convert_js_args_to_python_args
    def __init__(self, randomization_unit, default, standard_randomization_unit, *args, **kwargs):  # noqa: E501
        """RandomizationUnitInput - a model defined in OpenAPI
