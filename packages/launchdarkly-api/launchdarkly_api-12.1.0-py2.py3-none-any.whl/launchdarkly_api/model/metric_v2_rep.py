...
class MetricV2Rep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, name, kind, links, *args, **kwargs):  # noqa: E501
        """MetricV2Rep - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, name, kind, links, *args, **kwargs):  # noqa: E501
        """MetricV2Rep - a model defined in OpenAPI
