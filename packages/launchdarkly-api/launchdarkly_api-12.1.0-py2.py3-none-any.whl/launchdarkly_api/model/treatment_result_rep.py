...
def lazy_import():
    ...
    globals()['CredibleIntervalRep'] = CredibleIntervalRep
    globals()['RelativeDifferenceRep'] = RelativeDifferenceRep


class TreatmentResultRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'credible_interval': (CredibleIntervalRep,),  # noqa: E501
            'p_best': (float,),  # noqa: E501
            'relative_differences': ([RelativeDifferenceRep],),  # noqa: E501
            'units': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'mean': 'mean',  # noqa: E501
        'credible_interval': 'credibleInterval',  # noqa: E501
        'p_best': 'pBest',  # noqa: E501
        'relative_differences': 'relativeDifferences',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TreatmentResultRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            treatment_id (str): The ID of the treatment. [optional]  # noqa: E501
            treatment_name (str): The name of the treatment. [optional]  # noqa: E501
            mean (float): The average value of the variation in this sample. It doesn’t capture the uncertainty in the measurement, so it should not be the only measurement you use to make decisions.. [optional]  # noqa: E501
            credible_interval (CredibleIntervalRep): [optional]  # noqa: E501
            p_best (float): The likelihood that this variation has the biggest effect on the primary metric. The variation with the highest probability is likely the best of the variations you're testing. [optional]  # noqa: E501
            relative_differences ([RelativeDifferenceRep]): A list of the ranges of the metric that you should have 90% confidence in, for each treatment ID. For example, if the range of the relative differences is [-1%, 4%], you can have 90% confidence that the population difference is a number between 1% lower and 4% higher than the control.. [optional]  # noqa: E501
            units (int): The number of end users in this variation of the experiment. [optional]  # noqa: E501
        """
