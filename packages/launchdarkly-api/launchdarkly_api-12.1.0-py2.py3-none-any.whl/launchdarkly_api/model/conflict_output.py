...
class ConflictOutput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, stage_id, message, *args, **kwargs):  # noqa: E501
        """ConflictOutput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, stage_id, message, *args, **kwargs):  # noqa: E501
        """ConflictOutput - a model defined in OpenAPI
