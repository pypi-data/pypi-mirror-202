...
def lazy_import():
    ...
    globals()['InstructionUserRequest'] = InstructionUserRequest


class PatchUsersRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'instructions': ([InstructionUserRequest],),  # noqa: E501
    ...
    def _from_openapi_data(cls, instructions, *args, **kwargs):  # noqa: E501
        """PatchUsersRequest - a model defined in OpenAPI

        Args:
            instructions ([InstructionUserRequest]): The instructions to perform when updating
        ...
        Keyword Args:
            ...
            comment (str): Optional comment describing the change. [optional]  # noqa: E501
        """
