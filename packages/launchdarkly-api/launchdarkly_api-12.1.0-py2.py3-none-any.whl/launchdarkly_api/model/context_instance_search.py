...
class ContextInstanceSearch(ModelNormal):
    ...
    attribute_map = {
        ...
        'continuation_token': 'continuationToken',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ContextInstanceSearch - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            filter (str): A collection of context instance filters. [optional]  # noqa: E501
            sort (str): Specifies a field by which to sort. LaunchDarkly supports sorting by timestamp in ascending order by specifying <code>ts</code> for this value, or descending order by specifying <code>-ts</code>.. [optional]  # noqa: E501
            limit (int): Specifies the maximum number of items in the collection to return (max: 50, default: 20). [optional]  # noqa: E501
            continuation_token (str): Limits results to context instances with sort values after the value specified. You can use this for pagination, however, we recommend using the <code>next</code> link instead, because this value is an obfuscated string.. [optional]  # noqa: E501
        """
