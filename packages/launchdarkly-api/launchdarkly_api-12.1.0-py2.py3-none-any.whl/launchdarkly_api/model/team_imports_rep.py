...
def lazy_import():
    ...
    globals()['MemberImportItem'] = MemberImportItem


class TeamImportsRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([MemberImportItem],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TeamImportsRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            items ([MemberImportItem]): An array of details about the members requested to be added to this team. [optional]  # noqa: E501
        """
