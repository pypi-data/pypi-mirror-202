...
class InstructionUserRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, kind, flag_key, variation_id, *args, **kwargs):  # noqa: E501
        """InstructionUserRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            value (int): The time, in Unix milliseconds, when LaunchDarkly should remove the user from individual targeting for this flag. Required if <code>kind</code> is <code>addExpireUserTargetDate</code> or <code>updateExpireUserTargetDate</code>.. [optional]  # noqa: E501
            version (int): The version of the flag variation to update. You can retrieve this by making a GET request for the flag. Required if <code>kind</code> is <code>updateExpireUserTargetDate</code>.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, kind, flag_key, variation_id, *args, **kwargs):  # noqa: E501
        """InstructionUserRequest - a model defined in OpenAPI
