...
class UserRecord(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'last_ping': (datetime,),  # noqa: E501
            'environment_id': (str,),  # noqa: E501
            'owner_id': (str,),  # noqa: E501
            'user': (User,),  # noqa: E501
            'sort_value': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
