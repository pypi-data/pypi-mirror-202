...
def lazy_import():
    ...
    globals()['ContextAttributeValue'] = ContextAttributeValue


class ContextAttributeValues(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'kind': (str,),  # noqa: E501
            'values': ([ContextAttributeValue],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, kind, values, *args, **kwargs):  # noqa: E501
        """ContextAttributeValues - a model defined in OpenAPI

        Args:
            kind (str): The kind associated with this collection of context attribute values.
            values ([ContextAttributeValue]): A collection of context attribute values.
    ...
    @convert_js_args_to_python_args
    def __init__(self, kind, values, *args, **kwargs):  # noqa: E501
        """ContextAttributeValues - a model defined in OpenAPI
