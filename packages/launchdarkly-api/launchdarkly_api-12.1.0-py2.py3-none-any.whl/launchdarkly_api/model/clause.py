...
class Clause(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, attribute, op, values, negate, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, attribute, op, values, negate, *args, **kwargs):  # noqa: E501
        """Clause - a model defined in OpenAPI
