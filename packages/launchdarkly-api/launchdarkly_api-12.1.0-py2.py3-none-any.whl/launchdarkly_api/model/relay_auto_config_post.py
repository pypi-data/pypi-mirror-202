...
class RelayAutoConfigPost(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, policy, *args, **kwargs):  # noqa: E501
        """RelayAutoConfigPost - a model defined in OpenAPI

        Args:
            name (str): A human-friendly name for the Relay Proxy configuration
            policy ([Statement]): A description of what environments and projects the Relay Proxy should include or exclude. To learn more, read [Writing an inline policy](https://docs.launchdarkly.com/home/relay-proxy/automatic-configuration#writing-an-inline-policy).
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, policy, *args, **kwargs):  # noqa: E501
        """RelayAutoConfigPost - a model defined in OpenAPI
