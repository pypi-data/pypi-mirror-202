...
class IntegrationDeliveryConfigurationResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IntegrationDeliveryConfigurationResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status_code (int): The status code returned by the validation. [optional]  # noqa: E501
            error (str): [optional]  # noqa: E501
            timestamp (int): [optional]  # noqa: E501
            response_body (str): JSON response to the validation request. [optional]  # noqa: E501
        """
