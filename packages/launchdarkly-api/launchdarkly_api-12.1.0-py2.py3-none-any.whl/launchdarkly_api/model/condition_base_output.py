...
class ConditionBaseOutput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, execution, *args, **kwargs):  # noqa: E501
        """ConditionBaseOutput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, execution, *args, **kwargs):  # noqa: E501
        """ConditionBaseOutput - a model defined in OpenAPI
