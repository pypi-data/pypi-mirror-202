...
def lazy_import():
    ...
    globals()['DependentFlag'] = DependentFlag
    globals()['Link'] = Link


class DependentFlagsByEnvironment(ModelNormal):
    ...
    def _from_openapi_data(cls, items, links, site, *args, **kwargs):  # noqa: E501
        ...
        Args:
            items ([DependentFlag]): A list of dependent flags, which are flags that use the requested flag as a prerequisite
