...
class Webhook(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, id, url, on, tags, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): A human-readable name for this webhook. [optional]  # noqa: E501
            secret (str): The secret for this webhook. [optional]  # noqa: E501
            statements ([Statement]): Represents a Custom role policy, defining a resource kinds filter the webhook responds to.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, id, url, on, tags, *args, **kwargs):  # noqa: E501
        """Webhook - a model defined in OpenAPI
