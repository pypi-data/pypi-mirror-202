...
def lazy_import():
    ...
    globals()['DependentFlagEnvironment'] = DependentFlagEnvironment


class MultiEnvironmentDependentFlag(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'key': (str,),  # noqa: E501
            'environments': ([DependentFlagEnvironment],),  # noqa: E501
            'name': (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, environments, *args, **kwargs):  # noqa: E501
        """MultiEnvironmentDependentFlag - a model defined in OpenAPI

        Args:
            key (str): The flag key
            environments ([DependentFlagEnvironment]): A list of environments in which the dependent flag appears
        ...
        Keyword Args:
            ...
            name (str): The flag name. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, environments, *args, **kwargs):  # noqa: E501
        """MultiEnvironmentDependentFlag - a model defined in OpenAPI
