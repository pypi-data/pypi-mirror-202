...
class BigSegmentTarget(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_key, included, excluded, *args, **kwargs):  # noqa: E501
        """BigSegmentTarget - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_key, included, excluded, *args, **kwargs):  # noqa: E501
        """BigSegmentTarget - a model defined in OpenAPI
