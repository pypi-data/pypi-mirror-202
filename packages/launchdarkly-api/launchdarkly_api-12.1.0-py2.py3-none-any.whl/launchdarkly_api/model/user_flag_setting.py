...
def lazy_import():
    ...
    globals()['EvaluationReason'] = EvaluationReason
    globals()['Link'] = Link


class UserFlagSetting(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'setting': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'reason': (EvaluationReason,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, value, setting, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            reason (EvaluationReason): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, value, setting, *args, **kwargs):  # noqa: E501
        """UserFlagSetting - a model defined in OpenAPI
