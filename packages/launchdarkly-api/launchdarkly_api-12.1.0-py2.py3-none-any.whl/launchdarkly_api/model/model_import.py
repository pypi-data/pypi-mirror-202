...
def lazy_import():
    ...
    globals()['FileRep'] = FileRep
    globals()['Link'] = Link


class ModelImport(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, segment_key, creation_time, mode, status, links, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            files ([FileRep]): The imported files and their status. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, segment_key, creation_time, mode, status, links, *args, **kwargs):  # noqa: E501
        """ModelImport - a model defined in OpenAPI
