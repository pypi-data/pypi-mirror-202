...
def lazy_import():
    ...
    globals()['SeriesMetadataRep'] = SeriesMetadataRep
    globals()['SeriesTimeSliceRep'] = SeriesTimeSliceRep


class SeriesListRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'metadata': ([SeriesMetadataRep],),  # noqa: E501
            'series': ([SeriesTimeSliceRep],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, metadata, series, *args, **kwargs):  # noqa: E501
        """SeriesListRep - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, metadata, series, *args, **kwargs):  # noqa: E501
        """SeriesListRep - a model defined in OpenAPI
