...
def lazy_import():
    ...
    globals()['BranchRep'] = BranchRep


class RepositoryRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, type, default_branch, enabled, version, links, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, type, default_branch, enabled, version, links, *args, **kwargs):  # noqa: E501
        """RepositoryRep - a model defined in OpenAPI
