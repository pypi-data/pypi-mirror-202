...
def lazy_import():
    ...
    globals()['ConditionOutput'] = ConditionOutput
    globals()['ExecutionOutput'] = ExecutionOutput


class StageOutput(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'conditions': ([ConditionOutput],),  # noqa: E501
            'action': (ActionOutput,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, conditions, action, execution, *args, **kwargs):  # noqa: E501
        """StageOutput - a model defined in OpenAPI

        Args:
            id (str): The ID of this stage
            conditions ([ConditionOutput]): An array of conditions for the stage
            action (ActionOutput):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, conditions, action, execution, *args, **kwargs):  # noqa: E501
        """StageOutput - a model defined in OpenAPI
