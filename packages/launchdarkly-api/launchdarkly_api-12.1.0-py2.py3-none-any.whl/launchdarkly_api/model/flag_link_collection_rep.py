...
def lazy_import():
    ...
    globals()['FlagLinkRep'] = FlagLinkRep
    globals()['Link'] = Link


class FlagLinkCollectionRep(ModelNormal):
    ...
    def _from_openapi_data(cls, items, links, *args, **kwargs):  # noqa: E501
        """FlagLinkCollectionRep - a model defined in OpenAPI

        Args:
            items ([FlagLinkRep]): An array of flag links
