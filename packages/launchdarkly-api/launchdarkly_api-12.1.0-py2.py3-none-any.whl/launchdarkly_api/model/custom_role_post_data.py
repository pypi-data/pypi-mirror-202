...
class CustomRolePostData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, key, policy, *args, **kwargs):  # noqa: E501
        """CustomRolePostData - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, key, policy, *args, **kwargs):  # noqa: E501
        """CustomRolePostData - a model defined in OpenAPI
