...
class Extinction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, revision, message, time, flag_key, proj_key, *args, **kwargs):  # noqa: E501
        """Extinction - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, revision, message, time, flag_key, proj_key, *args, **kwargs):  # noqa: E501
        """Extinction - a model defined in OpenAPI
