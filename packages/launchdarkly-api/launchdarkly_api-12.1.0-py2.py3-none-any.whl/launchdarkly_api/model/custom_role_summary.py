...
class CustomRoleSummary(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, links, *args, **kwargs):  # noqa: E501
        """CustomRoleSummary - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, links, *args, **kwargs):  # noqa: E501
        """CustomRoleSummary - a model defined in OpenAPI
