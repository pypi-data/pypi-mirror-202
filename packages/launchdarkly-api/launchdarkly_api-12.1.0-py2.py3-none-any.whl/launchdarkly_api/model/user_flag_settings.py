...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['UserFlagSetting'] = UserFlagSetting


class UserFlagSettings(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ({str: (UserFlagSetting,)},),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, links, *args, **kwargs):  # noqa: E501
        ...
        Args:
            items ({str: (UserFlagSetting,)}): An array of flag settings for the user
