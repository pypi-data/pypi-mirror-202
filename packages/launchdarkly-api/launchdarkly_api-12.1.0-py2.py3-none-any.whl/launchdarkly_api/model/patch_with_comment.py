...
class PatchWithComment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, patch, *args, **kwargs):  # noqa: E501
        """PatchWithComment - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, patch, *args, **kwargs):  # noqa: E501
        """PatchWithComment - a model defined in OpenAPI
