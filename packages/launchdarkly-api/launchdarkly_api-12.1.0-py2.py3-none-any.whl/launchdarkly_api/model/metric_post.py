...
class MetricPost(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'tags': ([str],),  # noqa: E501
            'randomization_units': ([str],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'tags': 'tags',  # noqa: E501
        'randomization_units': 'randomizationUnits',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, kind, *args, **kwargs):  # noqa: E501
        """MetricPost - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): A human-friendly name for the metric. [optional]  # noqa: E501
            description (str): Description of the metric. [optional]  # noqa: E501
            selector (str): One or more CSS selectors. Required for click metrics only.. [optional]  # noqa: E501
            urls ([UrlPost]): One or more target URLs. Required for click and pageview metrics only.. [optional]  # noqa: E501
            is_active (bool): Whether the metric is active. Set to <code>true</code> to record click or pageview metrics. Not applicable for custom metrics.. [optional]  # noqa: E501
            is_numeric (bool): Whether to track numeric changes in value against a baseline (<code>true</code>) or to track a conversion when an end user takes an action (<code>false</code>). Required for custom metrics only.. [optional]  # noqa: E501
            unit (str): The unit of measure. Applicable for numeric custom metrics only.. [optional]  # noqa: E501
            event_key (str): The event name to use in your code. Required for custom metrics only.. [optional]  # noqa: E501
            success_criteria (str): Success criteria. Required for custom numeric metrics, optional for custom conversion metrics.. [optional]  # noqa: E501
            tags ([str]): Tags for the metric. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, kind, *args, **kwargs):  # noqa: E501
        """MetricPost - a model defined in OpenAPI
