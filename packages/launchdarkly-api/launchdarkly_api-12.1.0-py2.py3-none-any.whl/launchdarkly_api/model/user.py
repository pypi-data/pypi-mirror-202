...
class User(ModelNormal):
    ...
    attribute_map = {
        ...
        'private_attrs': 'privateAttrs',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            key (str): The user key. This is the only mandatory user attribute.. [optional]  # noqa: E501
            secondary (str): If provided, used with the user key to generate a variation in percentage rollouts. [optional]  # noqa: E501
            ip (str): The user's IP address. [optional]  # noqa: E501
            country (str): The user's country. [optional]  # noqa: E501
            email (str): The user's email. [optional]  # noqa: E501
            first_name (str): The user's first name. [optional]  # noqa: E501
            last_name (str): The user's last name. [optional]  # noqa: E501
            avatar (str): An absolute URL to an avatar image.. [optional]  # noqa: E501
            name (str): The user's full name. [optional]  # noqa: E501
            anonymous (bool): Whether the user is anonymous. If true, this user does not appear on the Contexts list in the LaunchDarkly user interface.. [optional]  # noqa: E501
            custom ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Any other custom attributes for this user. Custom attributes contain any other user data that you would like to use to conditionally target your users.. [optional]  # noqa: E501
            private_attrs ([str]): A list of attribute names that are marked as private. You can use these attributes in targeting rules and segments. If you are using a server-side SDK, the SDK will not send the private attribute back to LaunchDarkly. If you are using a client-side SDK, the SDK will send the private attribute back to LaunchDarkly for evaluation. However, the SDK won't send the attribute to LaunchDarkly in events data, LaunchDarkly won't store the private attribute, and the private attribute will not appear on the Contexts list.. [optional]  # noqa: E501
        """
