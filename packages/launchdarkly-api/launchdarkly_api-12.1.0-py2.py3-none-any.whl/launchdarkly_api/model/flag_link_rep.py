...
def lazy_import():
    ...
    globals()['FlagLinkMember'] = FlagLinkMember
    globals()['Link'] = Link
    globals()['TimestampRep'] = TimestampRep


class FlagLinkRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'timestamp': (TimestampRep,),  # noqa: E501
            ...
            'member': (FlagLinkMember,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'id': '_id',  # noqa: E501
        'deep_link': '_deepLink',  # noqa: E501
        'timestamp': '_timestamp',  # noqa: E501
        'created_at': '_createdAt',  # noqa: E501
        'key': '_key',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, id, deep_link, timestamp, created_at, *args, **kwargs):  # noqa: E501
        """FlagLinkRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            key (str): The flag link key. [optional]  # noqa: E501
            integration_key (str): The integration key for an integration whose <code>manifest.json</code> includes the <code>flagLink</code> capability, if this is a flag link for an existing integration. [optional]  # noqa: E501
            title (str): The title of the flag link. [optional]  # noqa: E501
            description (str): The description of the flag link. [optional]  # noqa: E501
            metadata ({str: (str,)}): The metadata required by this integration in order to create a flag link, if this is a flag link for an existing integration. Defined in the integration's <code>manifest.json</code> file under <code>flagLink</code>.. [optional]  # noqa: E501
            member (FlagLinkMember): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, id, deep_link, timestamp, created_at, *args, **kwargs):  # noqa: E501
        """FlagLinkRep - a model defined in OpenAPI
