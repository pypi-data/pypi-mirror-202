...
class Variation(ModelNormal):
    ...
    def _from_openapi_data(cls, value, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): The ID of the variation. Leave empty when you are creating a flag.. [optional]  # noqa: E501
            description (str): Description of the variation. Defaults to an empty string, but is omitted from the response if not set.. [optional]  # noqa: E501
            name (str): A human-friendly name for the variation. Defaults to an empty string, but is omitted from the response if not set.. [optional]  # noqa: E501
        """
