...
def lazy_import():
    ...
    globals()['ExpandableApprovalRequestResponse'] = ExpandableApprovalRequestResponse
    globals()['Link'] = Link


class ExpandableApprovalRequestsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ExpandableApprovalRequestResponse],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, items, total_count, links, *args, **kwargs):  # noqa: E501
        """ExpandableApprovalRequestsResponse - a model defined in OpenAPI

        Args:
            items ([ExpandableApprovalRequestResponse]): An array of approval requests
    ...
    @convert_js_args_to_python_args
    def __init__(self, items, total_count, links, *args, **kwargs):  # noqa: E501
        """ExpandableApprovalRequestsResponse - a model defined in OpenAPI
