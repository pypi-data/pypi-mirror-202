...
class ProjectListingRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, id, key, include_in_snippet_by_default, name, tags, *args, **kwargs):  # noqa: E501
        """ProjectListingRep - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, id, key, include_in_snippet_by_default, name, tags, *args, **kwargs):  # noqa: E501
        """ProjectListingRep - a model defined in OpenAPI
