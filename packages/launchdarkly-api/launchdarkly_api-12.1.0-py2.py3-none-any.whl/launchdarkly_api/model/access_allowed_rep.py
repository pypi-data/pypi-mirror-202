...
def lazy_import():
    ...
    globals()['AccessAllowedReason'] = AccessAllowedReason


class AccessAllowedRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'reason': (AccessAllowedReason,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action, reason, *args, **kwargs):  # noqa: E501
        """AccessAllowedRep - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, action, reason, *args, **kwargs):  # noqa: E501
        """AccessAllowedRep - a model defined in OpenAPI
