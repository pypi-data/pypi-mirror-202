...
def lazy_import():
    ...
    globals()['IterationInput'] = IterationInput


class ExperimentPost(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'key': (str,),  # noqa: E501
            'iteration': (IterationInput,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, maintainer_id, key, iteration, *args, **kwargs):  # noqa: E501
        """ExperimentPost - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, maintainer_id, key, iteration, *args, **kwargs):  # noqa: E501
        """ExperimentPost - a model defined in OpenAPI
