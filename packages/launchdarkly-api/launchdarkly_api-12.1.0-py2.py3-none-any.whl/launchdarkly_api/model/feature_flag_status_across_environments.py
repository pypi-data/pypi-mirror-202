...
def lazy_import():
    ...
    globals()['FeatureFlagStatus'] = FeatureFlagStatus
    globals()['Link'] = Link


class FeatureFlagStatusAcrossEnvironments(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'environments': ({str: (FeatureFlagStatus,)},),  # noqa: E501
            'key': (str,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            environments ({str: (FeatureFlagStatus,)}): Flag status for environment.. [optional]  # noqa: E501
            key (str): feature flag key. [optional]  # noqa: E501
