...
def lazy_import():
    ...
    globals()['FeatureFlagScheduledChange'] = FeatureFlagScheduledChange
    globals()['Link'] = Link


class FeatureFlagScheduledChanges(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([FeatureFlagScheduledChange],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        ...
        Args:
            items ([FeatureFlagScheduledChange]): Array of scheduled changes
