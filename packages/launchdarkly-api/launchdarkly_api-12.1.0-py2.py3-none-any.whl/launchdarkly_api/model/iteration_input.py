...
def lazy_import():
    ...
    globals()['FlagsInput'] = FlagsInput
    globals()['MetricsInput'] = MetricsInput
    globals()['TreatmentsInput'] = TreatmentsInput


class IterationInput(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'metrics': (MetricsInput,),  # noqa: E501
            'treatments': (TreatmentsInput,),  # noqa: E501
            'flags': (FlagsInput,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, hypothesis, metrics, treatments, flags, *args, **kwargs):  # noqa: E501
        """IterationInput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            can_reshuffle_traffic (bool): Whether to allow the experiment to reassign traffic to different variations when you increase or decrease the traffic in your experiment audience (true) or keep all traffic assigned to its initial variation (false). Defaults to true.. [optional]  # noqa: E501
            randomization_unit (str): The unit of randomization for this iteration. Defaults to user.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, hypothesis, metrics, treatments, flags, *args, **kwargs):  # noqa: E501
        """IterationInput - a model defined in OpenAPI
