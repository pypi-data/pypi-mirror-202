...
class StatisticCollectionRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'flags': ({str: ([StatisticRep],)},),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, flags, links, *args, **kwargs):  # noqa: E501
        """StatisticCollectionRep - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, flags, links, *args, **kwargs):  # noqa: E501
        """StatisticCollectionRep - a model defined in OpenAPI
