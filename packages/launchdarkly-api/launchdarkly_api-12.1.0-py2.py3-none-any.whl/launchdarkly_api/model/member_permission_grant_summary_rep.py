...
class MemberPermissionGrantSummaryRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action_set, actions, resource, *args, **kwargs):  # noqa: E501
        """MemberPermissionGrantSummaryRep - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, action_set, actions, resource, *args, **kwargs):  # noqa: E501
        """MemberPermissionGrantSummaryRep - a model defined in OpenAPI
