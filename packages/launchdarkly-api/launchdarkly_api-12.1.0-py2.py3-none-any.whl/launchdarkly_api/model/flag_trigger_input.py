...
class FlagTriggerInput(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FlagTriggerInput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            comment (str): Optional comment describing the update. [optional]  # noqa: E501
            instructions ([Instruction]): The instructions to perform when updating. This should be an array with objects that look like <code>{\"kind\": \"trigger_action\"}</code>.. [optional]  # noqa: E501
        """
