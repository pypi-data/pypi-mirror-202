...
def lazy_import():
    ...
    globals()['PatchSegmentInstruction'] = PatchSegmentInstruction


class PatchSegmentRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'instructions': ([PatchSegmentInstruction],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, instructions, *args, **kwargs):  # noqa: E501
        """PatchSegmentRequest - a model defined in OpenAPI

        Args:
            instructions ([PatchSegmentInstruction]): Semantic patch instructions for the desired changes to the resource
        ...
        Keyword Args:
            ...
            comment (str): Optional description of changes. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, instructions, *args, **kwargs):  # noqa: E501
        """PatchSegmentRequest - a model defined in OpenAPI
