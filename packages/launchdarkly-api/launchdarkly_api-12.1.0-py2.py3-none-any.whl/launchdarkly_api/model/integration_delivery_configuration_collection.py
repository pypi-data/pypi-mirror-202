...
def lazy_import():
    ...
    globals()['IntegrationDeliveryConfiguration'] = IntegrationDeliveryConfiguration
    globals()['IntegrationDeliveryConfigurationCollectionLinks'] = IntegrationDeliveryConfigurationCollectionLinks


class IntegrationDeliveryConfigurationCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'links': (IntegrationDeliveryConfigurationCollectionLinks,),  # noqa: E501
            'items': ([IntegrationDeliveryConfiguration],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, items, *args, **kwargs):  # noqa: E501
        """IntegrationDeliveryConfigurationCollection - a model defined in OpenAPI

        Args:
            links (IntegrationDeliveryConfigurationCollectionLinks):
            items ([IntegrationDeliveryConfiguration]): An array of integration delivery configurations
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, items, *args, **kwargs):  # noqa: E501
        """IntegrationDeliveryConfigurationCollection - a model defined in OpenAPI
