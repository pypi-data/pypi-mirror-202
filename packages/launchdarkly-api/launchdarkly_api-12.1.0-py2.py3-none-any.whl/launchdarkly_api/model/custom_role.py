...
class CustomRole(ModelNormal):
    ...
    def _from_openapi_data(cls, id, links, key, name, policy, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            policy ([Statement]): An array of the policies that comprise this custom role
        ...
        Keyword Args:
            ...
            description (str): The description of the custom role. [optional]  # noqa: E501
