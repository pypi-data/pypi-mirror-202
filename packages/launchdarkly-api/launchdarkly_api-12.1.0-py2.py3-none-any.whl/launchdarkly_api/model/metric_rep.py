...
def lazy_import():
    ...
    globals()['DependentExperimentListRep'] = DependentExperimentListRep
...
class MetricRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'experiment_count': (int,),  # noqa: E501
            ...
            'experiments': (DependentExperimentListRep,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'experiment_count': 'experimentCount',  # noqa: E501
    ...
    def _from_openapi_data(cls, id, key, name, kind, links, tags, creation_date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            experiment_count (int): The number of experiments using this metric. [optional]  # noqa: E501
            attached_flag_count (int): The number of feature flags currently attached to this metric. [optional]  # noqa: E501
            site (Link): [optional]  # noqa: E501
            access (Access): [optional]  # noqa: E501
            last_modified (Modification): [optional]  # noqa: E501
            maintainer_id (str): The ID of the member who maintains this metric. [optional]  # noqa: E501
            maintainer (MemberSummary): [optional]  # noqa: E501
            description (str): Description of the metric. [optional]  # noqa: E501
            is_numeric (bool): For custom metrics, whether to track numeric changes in value against a baseline (<code>true</code>) or to track a conversion when an end user takes an action (<code>false</code>).. [optional]  # noqa: E501
            success_criteria (str): For custom metrics, the success criteria. [optional]  # noqa: E501
            unit (str): For numeric custom metrics, the unit of measure. [optional]  # noqa: E501
            event_key (str): For custom metrics, the event name to use in your code. [optional]  # noqa: E501
            ...
            is_active (bool): Whether the metric is active. [optional]  # noqa: E501
            attached_features ([FlagListingRep]): Details on the flags attached to this metric. [optional]  # noqa: E501
            version (int): Version of the metric. [optional]  # noqa: E501
            selector (str): For click metrics, the CSS selectors. [optional]  # noqa: E501
