...
def lazy_import():
    ...
    globals()['TreatmentParameterInput'] = TreatmentParameterInput


class TreatmentInput(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'parameters': ([TreatmentParameterInput],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, baseline, allocation_percent, parameters, *args, **kwargs):  # noqa: E501
        """TreatmentInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, baseline, allocation_percent, parameters, *args, **kwargs):  # noqa: E501
        """TreatmentInput - a model defined in OpenAPI
