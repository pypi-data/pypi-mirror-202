...
def lazy_import():
    ...
    globals()['FollowersPerFlag'] = FollowersPerFlag
    globals()['Link'] = Link


class FlagFollowersByProjEnvGetRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([FollowersPerFlag],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, links, *args, **kwargs):  # noqa: E501
        """FlagFollowersByProjEnvGetRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            items ([FollowersPerFlag]): An array of flags and their followers. [optional]  # noqa: E501
        """
