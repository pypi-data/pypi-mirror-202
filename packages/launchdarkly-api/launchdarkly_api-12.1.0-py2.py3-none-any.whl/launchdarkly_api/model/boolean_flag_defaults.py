...
class BooleanFlagDefaults(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, true_display_name, false_display_name, true_description, false_description, on_variation, off_variation, *args, **kwargs):  # noqa: E501
        """BooleanFlagDefaults - a model defined in OpenAPI
        ...
        self.true_display_name = true_display_name
        self.false_display_name = false_display_name
    ...
    @convert_js_args_to_python_args
    def __init__(self, true_display_name, false_display_name, true_description, false_description, on_variation, off_variation, *args, **kwargs):  # noqa: E501
        """BooleanFlagDefaults - a model defined in OpenAPI
