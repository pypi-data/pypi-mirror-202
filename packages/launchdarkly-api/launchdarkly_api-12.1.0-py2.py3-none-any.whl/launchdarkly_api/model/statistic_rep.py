...
class StatisticRep(ModelNormal):
    ...
    attribute_map = {
        ...
        'hunk_count': 'hunkCount',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, source_link, default_branch, enabled, version, hunk_count, file_count, links, *args, **kwargs):  # noqa: E501
        """StatisticRep - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, source_link, default_branch, enabled, version, hunk_count, file_count, links, *args, **kwargs):  # noqa: E501
        """StatisticRep - a model defined in OpenAPI
