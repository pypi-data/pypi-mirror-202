...
def lazy_import():
    ...
    globals()['NewMemberForm'] = NewMemberForm


class NewMemberFormListPost(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NewMemberFormListPost - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([NewMemberForm]):  # noqa: E501

        Keyword Args:
            value ([NewMemberForm]):  # noqa: E501
