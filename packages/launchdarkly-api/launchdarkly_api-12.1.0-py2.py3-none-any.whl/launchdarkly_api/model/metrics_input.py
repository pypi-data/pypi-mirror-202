...
def lazy_import():
    ...
    globals()['MetricInput'] = MetricInput


class MetricsInput(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MetricsInput - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([MetricInput]):  # noqa: E501

        Keyword Args:
            value ([MetricInput]):  # noqa: E501
