...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['StatisticRep'] = StatisticRep


class StatisticsRep(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StatisticsRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            items ([StatisticRep]): A list of code reference statistics for each code repository. [optional]  # noqa: E501
