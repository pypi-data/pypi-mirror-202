...
def lazy_import():
    ...
    globals()['WorkflowTemplateOutput'] = WorkflowTemplateOutput


class WorkflowTemplatesListingOutputRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([WorkflowTemplateOutput],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """WorkflowTemplatesListingOutputRep - a model defined in OpenAPI
