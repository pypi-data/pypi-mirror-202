...
class FollowFlagMember(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, id, role, email, *args, **kwargs):  # noqa: E501
        """FollowFlagMember - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, id, role, email, *args, **kwargs):  # noqa: E501
        """FollowFlagMember - a model defined in OpenAPI
