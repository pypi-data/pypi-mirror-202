...
class FlagStatusRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'last_requested': (datetime,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'name': 'name',  # noqa: E501
        'last_requested': 'lastRequested',  # noqa: E501
    ...
    def _from_openapi_data(cls, links, *args, **kwargs):  # noqa: E501
        """FlagStatusRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): Status of the flag. [optional]  # noqa: E501
            last_requested (datetime): Timestamp of last time flag was requested. [optional]  # noqa: E501
            default (bool, date, datetime, dict, float, int, list, str, none_type): Default value seen from code. [optional]  # noqa: E501
        """
