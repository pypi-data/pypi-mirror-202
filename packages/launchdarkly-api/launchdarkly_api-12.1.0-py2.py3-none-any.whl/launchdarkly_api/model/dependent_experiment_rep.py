...
class DependentExperimentRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, name, environment_id, creation_date, links, *args, **kwargs):  # noqa: E501
        """DependentExperimentRep - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, name, environment_id, creation_date, links, *args, **kwargs):  # noqa: E501
        """DependentExperimentRep - a model defined in OpenAPI
