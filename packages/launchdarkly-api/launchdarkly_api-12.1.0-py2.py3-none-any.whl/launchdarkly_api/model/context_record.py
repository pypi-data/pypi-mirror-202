...
class ContextRecord(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'associated_contexts': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'associated_contexts': 'associatedContexts',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, context, *args, **kwargs):  # noqa: E501
        """ContextRecord - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            last_seen (datetime): Timestamp of the last time an evaluation occurred for this context. [optional]  # noqa: E501
            application_id (str): An identifier representing the application where the LaunchDarkly SDK is running. [optional]  # noqa: E501
            links ({str: (Link,)}): The location and content type of related resources. [optional]  # noqa: E501
            access (Access): [optional]  # noqa: E501
            associated_contexts (int): The total number of associated contexts. Associated contexts are contexts that have appeared in the same context instance, that is, they were part of the same flag evaluation.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, context, *args, **kwargs):  # noqa: E501
        """ContextRecord - a model defined in OpenAPI
