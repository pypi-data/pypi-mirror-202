...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['RepositoryRep'] = RepositoryRep


class RepositoryCollectionRep(ModelNormal):
    ...
    def _from_openapi_data(cls, links, items, *args, **kwargs):  # noqa: E501
        """RepositoryCollectionRep - a model defined in OpenAPI
