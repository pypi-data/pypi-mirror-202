...
class FlagGlobalAttributesRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, kind, key, version, creation_date, variations, temporary, tags, links, experiments, custom_properties, archived, *args, **kwargs):  # noqa: E501
        """FlagGlobalAttributesRep - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, kind, key, version, creation_date, variations, temporary, tags, links, experiments, custom_properties, archived, *args, **kwargs):  # noqa: E501
        """FlagGlobalAttributesRep - a model defined in OpenAPI
