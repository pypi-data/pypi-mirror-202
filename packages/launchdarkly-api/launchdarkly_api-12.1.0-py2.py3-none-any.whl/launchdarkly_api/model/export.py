...
def lazy_import():
    ...
    globals()['InitiatorRep'] = InitiatorRep
    globals()['Link'] = Link


class Export(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'segment_key': (str,),  # noqa: E501
            'creation_time': (int,),  # noqa: E501
            'status': (str,),  # noqa: E501
            'size_bytes': (int,),  # noqa: E501
            'size': (str,),  # noqa: E501
            'initiator': (InitiatorRep,),  # noqa: E501
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'segment_key': 'segmentKey',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, segment_key, creation_time, status, size_bytes, size, initiator, links, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            links ({str: (Link,)}): The location and content type of related resources, including the location of the exported file
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, segment_key, creation_time, status, size_bytes, size, initiator, links, *args, **kwargs):  # noqa: E501
        """Export - a model defined in OpenAPI
