...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['MultiEnvironmentDependentFlag'] = MultiEnvironmentDependentFlag


class MultiEnvironmentDependentFlags(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([MultiEnvironmentDependentFlag],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, items, links, site, *args, **kwargs):  # noqa: E501
        """MultiEnvironmentDependentFlags - a model defined in OpenAPI

        Args:
            items ([MultiEnvironmentDependentFlag]): An array of dependent flags with their environment information
    ...
    @convert_js_args_to_python_args
    def __init__(self, items, links, site, *args, **kwargs):  # noqa: E501
        """MultiEnvironmentDependentFlags - a model defined in OpenAPI
