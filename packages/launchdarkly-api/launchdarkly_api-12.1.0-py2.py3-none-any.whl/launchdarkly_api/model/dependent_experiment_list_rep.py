...
def lazy_import():
    ...
    globals()['DependentExperimentRep'] = DependentExperimentRep


class DependentExperimentListRep(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """DependentExperimentListRep - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([DependentExperimentRep]):  # noqa: E501

        Keyword Args:
            value ([DependentExperimentRep]):  # noqa: E501
