...
def lazy_import():
    ...
    globals()['ContextInstanceEvaluation'] = ContextInstanceEvaluation
    globals()['Link'] = Link


class ContextInstanceEvaluations(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ContextInstanceEvaluation],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, links, *args, **kwargs):  # noqa: E501
        """ContextInstanceEvaluations - a model defined in OpenAPI

        Args:
            items ([ContextInstanceEvaluation]): Details on the flag evaluations for this context instance
        ...
        Keyword Args:
            ...
            total_count (int): The number of flags. [optional]  # noqa: E501
        """
