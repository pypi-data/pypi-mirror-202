...
class MemberTeamSummaryRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, custom_role_keys, key, name, *args, **kwargs):  # noqa: E501
        """MemberTeamSummaryRep - a model defined in OpenAPI
        ...
        self.custom_role_keys = custom_role_keys
        self.key = key
        self.name = name
    ...
    @convert_js_args_to_python_args
    def __init__(self, custom_role_keys, key, name, *args, **kwargs):  # noqa: E501
        """MemberTeamSummaryRep - a model defined in OpenAPI
