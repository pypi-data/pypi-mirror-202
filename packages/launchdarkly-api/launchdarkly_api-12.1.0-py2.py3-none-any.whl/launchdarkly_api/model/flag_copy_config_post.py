...
def lazy_import():
    ...
    globals()['FlagCopyConfigEnvironment'] = FlagCopyConfigEnvironment


class FlagCopyConfigPost(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'source': (FlagCopyConfigEnvironment,),  # noqa: E501
            'target': (FlagCopyConfigEnvironment,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, source, target, *args, **kwargs):  # noqa: E501
        """FlagCopyConfigPost - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            comment (str): Optional comment. [optional]  # noqa: E501
            included_actions ([str]): Optional list of the flag changes to copy from the source environment to the target environment. You may include either <code>includedActions</code> or <code>excludedActions</code>, but not both. If you include neither, then all flag changes will be copied.. [optional]  # noqa: E501
            excluded_actions ([str]): Optional list of the flag changes NOT to copy from the source environment to the target environment. You may include either  <code>includedActions</code> or <code>excludedActions</code>, but not both. If you include neither, then all flag changes will be copied.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, source, target, *args, **kwargs):  # noqa: E501
        """FlagCopyConfigPost - a model defined in OpenAPI
