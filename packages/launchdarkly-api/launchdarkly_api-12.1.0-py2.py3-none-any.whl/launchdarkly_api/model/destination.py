...
class Destination(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): The ID of this Data Export destination. [optional]  # noqa: E501
            links ({str: (Link,)}): The location and content type of related resources. [optional]  # noqa: E501
            name (str): A human-readable name for your Data Export destination. [optional]  # noqa: E501
            kind (str): The type of Data Export destination. [optional]  # noqa: E501
            version (float): [optional]  # noqa: E501
            config (bool, date, datetime, dict, float, int, list, str, none_type): An object with the configuration parameters required for the destination type. [optional]  # noqa: E501
            on (bool): Whether the export is on, that is, the status of the integration. [optional]  # noqa: E501
