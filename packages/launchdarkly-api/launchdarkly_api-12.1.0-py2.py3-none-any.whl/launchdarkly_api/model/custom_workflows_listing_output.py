...
def lazy_import():
    ...
    globals()['CustomWorkflowOutput'] = CustomWorkflowOutput


class CustomWorkflowsListingOutput(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([CustomWorkflowOutput],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """CustomWorkflowsListingOutput - a model defined in OpenAPI

        Args:
            items ([CustomWorkflowOutput]): An array of workflows
