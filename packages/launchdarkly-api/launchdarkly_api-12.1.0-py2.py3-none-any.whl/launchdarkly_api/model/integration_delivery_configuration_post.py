...
class IntegrationDeliveryConfigurationPost(ModelNormal):
    ...
    def _from_openapi_data(cls, config, *args, **kwargs):  # noqa: E501
        """IntegrationDeliveryConfigurationPost - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            on (bool): Whether the delivery configuration is active. Default value is false.. [optional]  # noqa: E501
            tags ([str]): Tags to associate with the integration. [optional]  # noqa: E501
            name (str): Name to identify the integration. [optional]  # noqa: E501
        """
