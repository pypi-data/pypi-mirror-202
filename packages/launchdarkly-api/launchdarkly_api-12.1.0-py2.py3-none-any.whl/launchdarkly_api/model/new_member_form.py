...
class NewMemberForm(ModelNormal):
    ...
    def _from_openapi_data(cls, email, *args, **kwargs):  # noqa: E501
        """NewMemberForm - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            password (str): The member's password. [optional]  # noqa: E501
            first_name (str): The member's first name. [optional]  # noqa: E501
            last_name (str): The member's last name. [optional]  # noqa: E501
            role (str): The member's built-in role. [optional]  # noqa: E501
            custom_roles ([str]): An array of the member's custom roles. [optional]  # noqa: E501
            team_keys ([str]): An array of the member's teams. [optional]  # noqa: E501
        """
