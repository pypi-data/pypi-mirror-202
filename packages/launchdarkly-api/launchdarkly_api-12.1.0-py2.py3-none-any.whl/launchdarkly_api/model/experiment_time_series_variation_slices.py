...
def lazy_import():
    ...
    globals()['ExperimentTimeSeriesVariationSlice'] = ExperimentTimeSeriesVariationSlice


class ExperimentTimeSeriesVariationSlices(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ExperimentTimeSeriesVariationSlices - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ExperimentTimeSeriesVariationSlice]):  # noqa: E501

        Keyword Args:
            value ([ExperimentTimeSeriesVariationSlice]):  # noqa: E501
