...
class FlagFollowersGetRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([FollowFlagMember],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, links, *args, **kwargs):  # noqa: E501
        """FlagFollowersGetRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            items ([FollowFlagMember]): An array of members who are following this flag. [optional]  # noqa: E501
        """
