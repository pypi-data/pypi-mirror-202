...
class Target(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, values, variation, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            context_kind (str): The context kind of the individual target. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, values, variation, *args, **kwargs):  # noqa: E501
        """Target - a model defined in OpenAPI
