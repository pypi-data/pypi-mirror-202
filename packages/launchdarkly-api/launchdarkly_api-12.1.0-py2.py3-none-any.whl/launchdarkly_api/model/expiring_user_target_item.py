...
def lazy_import():
    ...
    globals()['ResourceIDResponse'] = ResourceIDResponse


class ExpiringUserTargetItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'resource_id': (ResourceIDResponse,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, version, expiration_date, user_key, resource_id, *args, **kwargs):  # noqa: E501
        """ExpiringUserTargetItem - a model defined in OpenAPI
        ...
        Args:
            ...
            resource_id (ResourceIDResponse):
        ...
        Keyword Args:
            ...
            target_type (str): A segment's target type. Included when expiring user targets are updated on a segment.. [optional]  # noqa: E501
            variation_id (str): A unique key used to represent the flag variation. Included when expiring user targets are updated on a feature flag.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, version, expiration_date, user_key, resource_id, *args, **kwargs):  # noqa: E501
        """ExpiringUserTargetItem - a model defined in OpenAPI
