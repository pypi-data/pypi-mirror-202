...
class ApprovalConditionOutput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, notify_member_ids, all_reviews, review_status, *args, **kwargs):  # noqa: E501
        """ApprovalConditionOutput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, notify_member_ids, all_reviews, review_status, *args, **kwargs):  # noqa: E501
        """ApprovalConditionOutput - a model defined in OpenAPI
