...
def lazy_import():
    ...
    globals()['ContextRecord'] = ContextRecord
    globals()['Link'] = Link


class Contexts(ModelNormal):
    ...
    def _from_openapi_data(cls, environment_id, items, *args, **kwargs):  # noqa: E501
        """Contexts - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            total_count (int): The number of contexts. [optional]  # noqa: E501
