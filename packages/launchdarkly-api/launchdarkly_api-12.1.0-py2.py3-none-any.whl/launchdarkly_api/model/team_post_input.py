...
def lazy_import():
    ...
    globals()['PermissionGrantInput'] = PermissionGrantInput


class TeamPostInput(ModelNormal):
    ...
    def _from_openapi_data(cls, key, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            permission_grants ([PermissionGrantInput]): A list of permission grants. Permission grants allow access to a specific action, without having to create or update a custom role.. [optional]  # noqa: E501
        """
