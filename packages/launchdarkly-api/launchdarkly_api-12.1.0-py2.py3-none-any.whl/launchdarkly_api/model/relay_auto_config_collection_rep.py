...
def lazy_import():
    ...
    globals()['RelayAutoConfigRep'] = RelayAutoConfigRep


class RelayAutoConfigCollectionRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([RelayAutoConfigRep],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """RelayAutoConfigCollectionRep - a model defined in OpenAPI

        Args:
            items ([RelayAutoConfigRep]): An array of Relay Proxy configurations
