...
class DesignRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, hypothesis, *args, **kwargs):  # noqa: E501
        """DesignRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            can_reshuffle_traffic (bool): Whether the experiment can reassign traffic to different variations when you increase or decrease the traffic in your experiment audience (true) or keep all traffic assigned to its initial variation (false).. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, hypothesis, *args, **kwargs):  # noqa: E501
        """DesignRep - a model defined in OpenAPI
