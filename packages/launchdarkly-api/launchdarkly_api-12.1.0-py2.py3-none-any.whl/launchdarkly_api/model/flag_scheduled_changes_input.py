...
class FlagScheduledChangesInput(ModelNormal):
    ...
    def _from_openapi_data(cls, instructions, *args, **kwargs):  # noqa: E501
        """FlagScheduledChangesInput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            comment (str): Optional comment describing the update to the scheduled changes. [optional]  # noqa: E501
        """
