...
class ExpandedFlagRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, kind, key, version, creation_date, variations, temporary, tags, links, custom_properties, archived, *args, **kwargs):  # noqa: E501
        """ExpandedFlagRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            maintainer_id (str): The ID of the member who maintains the flag. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, kind, key, version, creation_date, variations, temporary, tags, links, custom_properties, archived, *args, **kwargs):  # noqa: E501
        """ExpandedFlagRep - a model defined in OpenAPI
