...
def lazy_import():
    ...
    globals()['RandomizationUnitInput'] = RandomizationUnitInput


class ExperimentationSettingsPut(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'randomization_units': ([RandomizationUnitInput],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, randomization_units, *args, **kwargs):  # noqa: E501
        """ExperimentationSettingsPut - a model defined in OpenAPI

        Args:
            randomization_units ([RandomizationUnitInput]): An array of randomization units allowed for this project.
        ...
        self.randomization_units = randomization_units
    ...
    @convert_js_args_to_python_args
    def __init__(self, randomization_units, *args, **kwargs):  # noqa: E501
        """ExperimentationSettingsPut - a model defined in OpenAPI
