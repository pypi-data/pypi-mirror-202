...
def lazy_import():
    ...
    globals()['ClientSideAvailabilityPost'] = ClientSideAvailabilityPost
    globals()['CustomProperties'] = CustomProperties
    globals()['Defaults'] = Defaults
    globals()['Variation'] = Variation


class FeatureFlagBody(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'client_side_availability': (ClientSideAvailabilityPost,),  # noqa: E501
    ...
    def _from_openapi_data(cls, name, key, *args, **kwargs):  # noqa: E501
        """FeatureFlagBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): Description of the feature flag. Defaults to an empty string.. [optional]  # noqa: E501
            include_in_snippet (bool): Deprecated, use <code>clientSideAvailability</code>. Whether this flag should be made available to the client-side JavaScript SDK. Defaults to <code>false</code>.. [optional]  # noqa: E501
            client_side_availability (ClientSideAvailabilityPost): [optional]  # noqa: E501
            variations ([Variation]): An array of possible variations for the flag. The variation values must be unique. If omitted, two boolean variations of <code>true</code> and <code>false</code> will be used.. [optional]  # noqa: E501
            temporary (bool): Whether the flag is a temporary flag. Defaults to <code>true</code>.. [optional]  # noqa: E501
            tags ([str]): Tags for the feature flag. Defaults to an empty array.. [optional]  # noqa: E501
            custom_properties (CustomProperties): [optional]  # noqa: E501
