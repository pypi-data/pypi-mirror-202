...
class ActionInput(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'instructions': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ActionInput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            instructions (bool, date, datetime, dict, float, int, list, str, none_type): An array of instructions for the stage. Each object in the array uses the semantic patch format for updating a feature flag.. [optional]  # noqa: E501
        """
