...
class StatementPostData(ModelNormal):
    ...
    def _from_openapi_data(cls, effect, *args, **kwargs):  # noqa: E501
        """StatementPostData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            not_resources ([str]): Targeted resources are the resources NOT in this list. The <code>resources</code> field must be empty to use this field.. [optional]  # noqa: E501
            actions ([str]): Actions to perform on a resource. [optional]  # noqa: E501
            not_actions ([str]): Targeted actions are the actions NOT in this list. The <code>actions</code> field must be empty to use this field.. [optional]  # noqa: E501
        """
