...
class FlagLinkMember(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, id, *args, **kwargs):  # noqa: E501
        """FlagLinkMember - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, id, *args, **kwargs):  # noqa: E501
        """FlagLinkMember - a model defined in OpenAPI
