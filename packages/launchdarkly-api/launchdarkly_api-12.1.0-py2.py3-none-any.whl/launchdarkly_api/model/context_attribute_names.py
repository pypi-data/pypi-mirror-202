...
def lazy_import():
    ...
    globals()['ContextAttributeName'] = ContextAttributeName


class ContextAttributeNames(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'kind': (str,),  # noqa: E501
            'names': ([ContextAttributeName],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, kind, names, *args, **kwargs):  # noqa: E501
        """ContextAttributeNames - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, kind, names, *args, **kwargs):  # noqa: E501
        """ContextAttributeNames - a model defined in OpenAPI
