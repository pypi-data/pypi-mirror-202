...
def lazy_import():
    ...
    globals()['ContextInstanceRecord'] = ContextInstanceRecord
    globals()['Link'] = Link


class ContextInstances(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([ContextInstanceRecord],),  # noqa: E501
    ...
    attribute_map = {
        'environment_id': '_environmentId',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, environment_id, items, *args, **kwargs):  # noqa: E501
        """ContextInstances - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            total_count (int): The number of unique context instances. [optional]  # noqa: E501
            continuation_token (str): An obfuscated string that references the last context instance on the previous page of results. You can use this for pagination, however, we recommend using the <code>next</code> link instead.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, environment_id, items, *args, **kwargs):  # noqa: E501
        """ContextInstances - a model defined in OpenAPI
