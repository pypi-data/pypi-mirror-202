...
class PermissionGrantInput(ModelNormal):
    ...
    attribute_map = {
        'action_set': 'actionSet',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PermissionGrantInput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            action_set (str): A group of related actions to allow. Specify either <code>actionSet</code> or <code>actions</code>. Use <code>maintainTeam</code> to add team maintainers.. [optional] if omitted the server will use the default value of "maintainTeam"  # noqa: E501
            actions ([str]): A list of actions to allow. Specify either <code>actionSet</code> or <code>actions</code>. To learn more, read [Role actions](https://docs.launchdarkly.com/home/members/role-actions).. [optional]  # noqa: E501
            member_ids ([str]): A list of member IDs who receive the permission grant.. [optional]  # noqa: E501
        """
