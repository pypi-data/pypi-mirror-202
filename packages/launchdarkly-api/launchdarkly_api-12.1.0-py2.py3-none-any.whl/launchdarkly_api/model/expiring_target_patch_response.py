...
def lazy_import():
    ...
    globals()['ExpiringTarget'] = ExpiringTarget
    globals()['ExpiringTargetError'] = ExpiringTargetError
    globals()['Link'] = Link


class ExpiringTargetPatchResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ExpiringTarget],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """ExpiringTargetPatchResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            total_instructions (int): [optional]  # noqa: E501
            successful_instructions (int): [optional]  # noqa: E501
            failed_instructions (int): [optional]  # noqa: E501
            errors ([ExpiringTargetError]): [optional]  # noqa: E501
        """
