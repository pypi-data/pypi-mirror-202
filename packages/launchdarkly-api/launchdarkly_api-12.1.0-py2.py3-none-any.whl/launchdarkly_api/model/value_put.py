...
class ValuePut(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ValuePut - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            setting (bool, date, datetime, dict, float, int, list, str, none_type): The variation value to set for the context. Must match the flag's variation type.. [optional]  # noqa: E501
