...
class ContextInstanceRecord(ModelNormal):
    ...
    attribute_map = {
        ...
        'anonymous_kinds': 'anonymousKinds',  # noqa: E501
    ...
    def _from_openapi_data(cls, id, context, *args, **kwargs):  # noqa: E501
        """ContextInstanceRecord - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            last_seen (datetime): Timestamp of the last time an evaluation occurred for this context instance. [optional]  # noqa: E501
            application_id (str): An identifier representing the application where the LaunchDarkly SDK is running. [optional]  # noqa: E501
            anonymous_kinds ([str]): A list of the context kinds this context was associated with that the SDK removed because they were marked as anonymous at flag evaluation. [optional]  # noqa: E501
