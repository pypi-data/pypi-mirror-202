...
def lazy_import():
    ...
    globals()['AllVariationsSummary'] = AllVariationsSummary


class FlagSummary(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'variations': (AllVariationsSummary,),  # noqa: E501
            'prerequisites': (int,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, variations, prerequisites, *args, **kwargs):  # noqa: E501
        """FlagSummary - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, variations, prerequisites, *args, **kwargs):  # noqa: E501
        """FlagSummary - a model defined in OpenAPI
