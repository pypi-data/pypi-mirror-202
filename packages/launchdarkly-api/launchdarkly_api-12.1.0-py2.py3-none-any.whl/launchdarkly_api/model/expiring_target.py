...
class ExpiringTarget(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'context_kind': (str,),  # noqa: E501
            'context_key': (str,),  # noqa: E501
            'resource_id': (ResourceId,),  # noqa: E501
            'target_type': (str,),  # noqa: E501
            'variation_id': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'context_kind': 'contextKind',  # noqa: E501
        'context_key': 'contextKey',  # noqa: E501
        'resource_id': '_resourceId',  # noqa: E501
        'target_type': 'targetType',  # noqa: E501
        'variation_id': 'variationId',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, version, expiration_date, context_kind, context_key, resource_id, *args, **kwargs):  # noqa: E501
        """ExpiringTarget - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            target_type (str): A segment's target type, <code>included</code> or <code>excluded</code>. Included when expiring targets are updated on a segment.. [optional]  # noqa: E501
            variation_id (str): A unique ID used to represent the flag variation. Included when expiring targets are updated on a feature flag.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, version, expiration_date, context_kind, context_key, resource_id, *args, **kwargs):  # noqa: E501
        """ExpiringTarget - a model defined in OpenAPI
