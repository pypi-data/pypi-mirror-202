...
def lazy_import():
    ...
    globals()['SourceFlag'] = SourceFlag


class CreateCopyFlagConfigApprovalRequestRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'source': (SourceFlag,),  # noqa: E501
            'comment': (str,),  # noqa: E501
            'notify_member_ids': ([str],),  # noqa: E501
            'notify_team_keys': ([str],),  # noqa: E501
            'included_actions': ([str],),  # noqa: E501
            'excluded_actions': ([str],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'notify_team_keys': 'notifyTeamKeys',  # noqa: E501
        'included_actions': 'includedActions',  # noqa: E501
        'excluded_actions': 'excludedActions',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, source, *args, **kwargs):  # noqa: E501
        """CreateCopyFlagConfigApprovalRequestRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            comment (str): Optional comment describing the approval request. [optional]  # noqa: E501
            notify_member_ids ([str]): An array of member IDs. These members are notified to review the approval request.. [optional]  # noqa: E501
            notify_team_keys ([str]): An array of team keys. The members of these teams are notified to review the approval request.. [optional]  # noqa: E501
            included_actions ([str]): Optional list of the flag changes to copy from the source environment to the target environment. You may include either <code>includedActions</code> or <code>excludedActions</code>, but not both. If neither are included, then all flag changes will be copied.. [optional]  # noqa: E501
            excluded_actions ([str]): Optional list of the flag changes NOT to copy from the source environment to the target environment. You may include either <code>includedActions</code> or <code>excludedActions</code>, but not both. If neither are included, then all flag changes will be copied.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, source, *args, **kwargs):  # noqa: E501
        """CreateCopyFlagConfigApprovalRequestRequest - a model defined in OpenAPI
