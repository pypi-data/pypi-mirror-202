...
def lazy_import():
    ...
    globals()['AccessAllowedRep'] = AccessAllowedRep
    globals()['AccessDenied'] = AccessDenied


class Access(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'denied': ([AccessDenied],),  # noqa: E501
            'allowed': ([AccessAllowedRep],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, denied, allowed, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, denied, allowed, *args, **kwargs):  # noqa: E501
        """Access - a model defined in OpenAPI
