...
def lazy_import():
    ...
    globals()['ReferenceRep'] = ReferenceRep


class PutBranch(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, head, sync_time, *args, **kwargs):  # noqa: E501
        """PutBranch - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, head, sync_time, *args, **kwargs):  # noqa: E501
        """PutBranch - a model defined in OpenAPI
