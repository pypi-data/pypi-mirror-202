...
def lazy_import():
    ...
    globals()['TreatmentInput'] = TreatmentInput


class TreatmentsInput(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TreatmentsInput - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([TreatmentInput]):  # noqa: E501

        Keyword Args:
            value ([TreatmentInput]):  # noqa: E501
