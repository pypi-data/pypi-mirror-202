...
def lazy_import():
    ...
    globals()['ContextKindRep'] = ContextKindRep
    globals()['Link'] = Link


class ContextKindsCollectionRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ContextKindRep],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, links, *args, **kwargs):  # noqa: E501
        """ContextKindsCollectionRep - a model defined in OpenAPI

        Args:
            items ([ContextKindRep]): An array of context kinds
