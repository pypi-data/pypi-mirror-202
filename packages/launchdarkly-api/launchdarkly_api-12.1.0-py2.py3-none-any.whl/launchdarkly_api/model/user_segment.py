...
def lazy_import():
    ...
    globals()['SegmentTarget'] = SegmentTarget
...
class UserSegment(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'included_contexts': ([SegmentTarget],),  # noqa: E501
            'excluded_contexts': ([SegmentTarget],),  # noqa: E501
            'access': (Access,),  # noqa: E501
            'flags': ([FlagListingRep],),  # noqa: E501
            'unbounded': (bool,),  # noqa: E501
            'unbounded_context_kind': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'included_contexts': 'includedContexts',  # noqa: E501
        'excluded_contexts': 'excludedContexts',  # noqa: E501
        'access': '_access',  # noqa: E501
        'flags': '_flags',  # noqa: E501
        'unbounded': 'unbounded',  # noqa: E501
        'unbounded_context_kind': 'unboundedContextKind',  # noqa: E501
    ...
    def _from_openapi_data(cls, name, tags, creation_date, key, links, rules, version, deleted, generation, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            description (str): A description of the segment's purpose. Defaults to <code>null</code> and is omitted in the response if not provided.. [optional]  # noqa: E501
            included ([str]): An array of keys for included targets. Included individual targets are always segment members, regardless of segment rules. For Big Segments this array is either empty or omitted.. [optional]  # noqa: E501
            excluded ([str]): An array of keys for excluded targets. Segment rules bypass individual excluded targets, so they will never be included based on rules. Excluded targets may still be included explicitly. This value is omitted for Big Segments.. [optional]  # noqa: E501
            included_contexts ([SegmentTarget]): [optional]  # noqa: E501
            excluded_contexts ([SegmentTarget]): [optional]  # noqa: E501
            access (Access): [optional]  # noqa: E501
            flags ([FlagListingRep]): [optional]  # noqa: E501
            unbounded (bool): Whether this is a standard segment (<code>false</code>) or a Big Segment (<code>true</code>). If omitted, the segment is a standard segment.. [optional]  # noqa: E501
            unbounded_context_kind (str): [optional]  # noqa: E501
            unbounded_metadata (SegmentMetadata): [optional]  # noqa: E501
            external (str): The external data store backing this segment. Only applies to Big Segments.. [optional]  # noqa: E501
            external_link (str): The URL for the external data store backing this segment. Only applies to Big Segments.. [optional]  # noqa: E501
            import_in_progress (bool): Whether an import is currently in progress for the specified segment. Only applies to Big Segments.. [optional]  # noqa: E501
        """
