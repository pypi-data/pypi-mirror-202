...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['TriggerWorkflowRep'] = TriggerWorkflowRep


class TriggerWorkflowCollectionRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([TriggerWorkflowRep],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TriggerWorkflowCollectionRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            items ([TriggerWorkflowRep]): An array of flag triggers. [optional]  # noqa: E501
