...
class ApprovalsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_approval_request_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/approval-requests/{id}',
                'operation_id': 'delete_approval_request',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_approval_request_endpoint = _Endpoint(
            settings={
                'response_type': (ExpandableApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/approval-requests/{id}',
        ...
        self.get_approval_requests_endpoint = _Endpoint(
            settings={
                'response_type': (ExpandableApprovalRequestsResponse,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/approval-requests',
                'operation_id': 'get_approval_requests',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.post_approval_request_endpoint = _Endpoint(
            settings={
                'response_type': (ApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/approval-requests',
                'operation_id': 'post_approval_request',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'create_approval_request_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.post_approval_request_apply_endpoint = _Endpoint(
            settings={
                'response_type': (ApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/approval-requests/{id}/apply',
                'operation_id': 'post_approval_request_apply',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.post_approval_request_review_endpoint = _Endpoint(
            settings={
                'response_type': (ApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/approval-requests/{id}/reviews',
                'operation_id': 'post_approval_request_review',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def delete_approval_request(
        ...
        **kwargs
        ...
        """Delete approval request  # noqa: E501

        Delete an approval request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_approval_request(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.delete_approval_request_endpoint.call_with_http_info(**kwargs)
    ...
    def get_approval_request(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_approval_request_endpoint.call_with_http_info(**kwargs)

    def get_approval_requests(
        self,
        **kwargs
    ):
        """List approval requests  # noqa: E501
        ...
        >>> thread = api.get_approval_requests(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_approval_requests_endpoint.call_with_http_info(**kwargs)
    ...
    def post_approval_request(
        ...
        **kwargs
        ...
        """Create approval request  # noqa: E501

        Create an approval request.  This endpoint currently supports creating an approval request for a flag across all environments with the following instructions:  - `addVariation` - `removeVariation` - `updateVariation` - `updateDefaultVariation`  For details on using these instructions, read [Update feature flag](/tag/Feature-flags#operation/patchFeatureFlag).  To create an approval for a flag specific to an environment, use [Create approval request for a flag](/tag/Approvals#operation/postApprovalRequestForFlag).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_approval_request(create_approval_request_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['create_approval_request_request'] = \
            create_approval_request_request
        return self.post_approval_request_endpoint.call_with_http_info(**kwargs)

    def post_approval_request_apply(
        self,
        id,
        post_approval_request_apply_request,
        **kwargs
    ):
        """Apply approval request  # noqa: E501

        Apply an approval request that has been approved.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_approval_request_apply(id, post_approval_request_apply_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_approval_request_apply_request'] = \
            post_approval_request_apply_request
        return self.post_approval_request_apply_endpoint.call_with_http_info(**kwargs)

    def post_approval_request_review(
        self,
        id,
        post_approval_request_review_request,
        **kwargs
    ):
        """Review approval request  # noqa: E501

        Review an approval request by approving or denying changes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_approval_request_review(id, post_approval_request_review_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_approval_request_review_request'] = \
            post_approval_request_review_request
        return self.post_approval_request_review_endpoint.call_with_http_info(**kwargs)
