...
class TeamsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.patch_teams_endpoint = _Endpoint(
            settings={
                'response_type': (BulkEditTeamsRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/teams',
                'operation_id': 'patch_teams',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def patch_teams(
        ...
        **kwargs
        ...
        kwargs['teams_patch_input'] = \
            teams_patch_input
        return self.patch_teams_endpoint.call_with_http_info(**kwargs)
