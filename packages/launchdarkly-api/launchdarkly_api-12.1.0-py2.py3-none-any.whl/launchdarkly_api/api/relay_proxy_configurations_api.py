...
class RelayProxyConfigurationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_relay_auto_config_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/account/relay-auto-configs/{id}',
                'operation_id': 'delete_relay_auto_config',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_relay_proxy_config_endpoint = _Endpoint(
            settings={
                'response_type': (RelayAutoConfigRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/account/relay-auto-configs/{id}',
                'operation_id': 'get_relay_proxy_config',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_relay_proxy_configs_endpoint = _Endpoint(
            settings={
                'response_type': (RelayAutoConfigCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/account/relay-auto-configs',
                'operation_id': 'get_relay_proxy_configs',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_relay_auto_config_endpoint = _Endpoint(
            settings={
                'response_type': (RelayAutoConfigRep,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/account/relay-auto-configs/{id}',
                'operation_id': 'patch_relay_auto_config',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.post_relay_auto_config_endpoint = _Endpoint(
            settings={
                'response_type': (RelayAutoConfigRep,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/account/relay-auto-configs',
                'operation_id': 'post_relay_auto_config',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.reset_relay_auto_config_endpoint = _Endpoint(
            settings={
                'response_type': (RelayAutoConfigRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/account/relay-auto-configs/{id}/reset',
                'operation_id': 'reset_relay_auto_config',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def delete_relay_auto_config(
        self,
        id,
        **kwargs
    ):
        """Delete Relay Proxy config by ID  # noqa: E501

        Delete a Relay Proxy config.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_relay_auto_config(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.delete_relay_auto_config_endpoint.call_with_http_info(**kwargs)

    def get_relay_proxy_config(
        self,
        id,
        **kwargs
    ):
        """Get Relay Proxy config  # noqa: E501

        Get a single Relay Proxy auto config by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['id'] = \
            id
        return self.get_relay_proxy_config_endpoint.call_with_http_info(**kwargs)

    def get_relay_proxy_configs(
        self,
        **kwargs
    ):
        """List Relay Proxy configs  # noqa: E501

        Get a list of Relay Proxy configurations in the account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_relay_proxy_configs_endpoint.call_with_http_info(**kwargs)

    def patch_relay_auto_config(
        self,
        id,
        patch_with_comment,
        **kwargs
    ):
        """Update a Relay Proxy config  # noqa: E501

        Update a Relay Proxy config using the JSON patch format.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_relay_auto_config(id, patch_with_comment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['patch_with_comment'] = \
            patch_with_comment
        return self.patch_relay_auto_config_endpoint.call_with_http_info(**kwargs)

    def post_relay_auto_config(
        self,
        relay_auto_config_post,
        **kwargs
    ):
        ...
        Create a Relay Proxy config.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_relay_auto_config(relay_auto_config_post, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['relay_auto_config_post'] = \
            relay_auto_config_post
        return self.post_relay_auto_config_endpoint.call_with_http_info(**kwargs)

    def reset_relay_auto_config(
        self,
        id,
        **kwargs
    ):
        """Reset Relay Proxy configuration key  # noqa: E501

        Reset a Relay Proxy configuration's secret key with an optional expiry time for the old key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.reset_relay_auto_config(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.reset_relay_auto_config_endpoint.call_with_http_info(**kwargs)
