...
class TeamsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_team_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/teams/{teamKey}',
        ...
        self.get_team_maintainers_endpoint = _Endpoint(
            settings={
                'response_type': (TeamMaintainers,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/teams/{teamKey}/maintainers',
                'operation_id': 'get_team_maintainers',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_team_roles_endpoint = _Endpoint(
            settings={
                'response_type': (TeamCustomRoles,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/teams/{teamKey}/roles',
                'operation_id': 'get_team_roles',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.post_team_endpoint = _Endpoint(
            settings={
                'response_type': (Team,),
                'auth': [
                    'ApiKey'
        ...
        self.post_team_members_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/teams/{teamKey}/members',
    ...
    def delete_team(
        ...
        **kwargs
        ...
        Delete a team by key. To learn more, read [Deleting a team](https://docs.launchdarkly.com/home/teams/managing#deleting-a-team).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_team(team_key, async_req=True)
        >>> result = thread.get()
    ...
    def get_team_maintainers(
        ...
        **kwargs
        ...
        """Get team maintainers  # noqa: E501

        Fetch the maintainers that have been assigned to the team. To learn more, read [Managing team maintainers](https://docs.launchdarkly.com/home/teams/managing#managing-team-maintainers).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_team_maintainers(team_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['team_key'] = \
            team_key
        return self.get_team_maintainers_endpoint.call_with_http_info(**kwargs)
    ...
    def get_team_roles(
        ...
        **kwargs
        ...
        """Get team custom roles  # noqa: E501

        Fetch the custom roles that have been assigned to the team. To learn more, read [Managing team permissions](https://docs.launchdarkly.com/home/teams/managing#managing-team-permissions).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_team_roles(team_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['team_key'] = \
            team_key
        return self.get_team_roles_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_team(
        ...
        **kwargs
        ...
        >>> thread = api.patch_team(team_key, team_patch_input, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['team_key'] = \
            team_key
        kwargs['team_patch_input'] = \
            team_patch_input
        return self.patch_team_endpoint.call_with_http_info(**kwargs)
    ...
    def post_team(
        ...
        **kwargs
        ...
        >>> thread = api.post_team(team_post_input, async_req=True)
        >>> result = thread.get()
    ...
    def post_team_members(
        ...
        **kwargs
        ...
        >>> thread = api.post_team_members(team_key, async_req=True)
        >>> result = thread.get()
