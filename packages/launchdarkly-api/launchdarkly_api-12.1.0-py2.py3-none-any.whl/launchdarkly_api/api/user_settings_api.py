...
class UserSettingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_expiring_flags_for_user_endpoint = _Endpoint(
            settings={
                'response_type': (ExpiringUserTargetGetResponse,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/users/{projectKey}/{userKey}/expiring-user-targets/{environmentKey}',
                'operation_id': 'get_expiring_flags_for_user',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_user_flag_setting_endpoint = _Endpoint(
            settings={
                'response_type': (UserFlagSetting,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags/{featureFlagKey}',
                'operation_id': 'get_user_flag_setting',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_user_flag_settings_endpoint = _Endpoint(
            settings={
                'response_type': (UserFlagSettings,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags',
                'operation_id': 'get_user_flag_settings',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_expiring_flags_for_user_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/users/{projectKey}/{userKey}/expiring-user-targets/{environmentKey}',
                'operation_id': 'patch_expiring_flags_for_user',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.put_flag_setting_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
    ...
    def get_expiring_flags_for_user(
        self,
        project_key,
        user_key,
        environment_key,
        **kwargs
        ...
        Get a list of flags for which the given user is scheduled for removal.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_expiring_flags_for_user(project_key, user_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_expiring_flags_for_user_endpoint.call_with_http_info(**kwargs)

    def get_user_flag_setting(
        self,
        project_key,
        environment_key,
        user_key,
        ...
        **kwargs
        ...
        """Get flag setting for user  # noqa: E501

        Get a single flag setting for a user by flag key. <br /><br />The `_value` is the flag variation that the user receives. The `setting` indicates whether you've explicitly targeted a user to receive a particular variation. For example, if you have turned off a feature flag for a user, this setting will be `false`. The example response indicates that the user `Abbie_Braun` has the `sort.order` flag enabled.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['feature_flag_key'] = \
            feature_flag_key
        return self.get_user_flag_setting_endpoint.call_with_http_info(**kwargs)

    def get_user_flag_settings(
        self,
        project_key,
        environment_key,
        user_key,
        **kwargs
        ...
        kwargs['user_key'] = \
            user_key
        return self.get_user_flag_settings_endpoint.call_with_http_info(**kwargs)

    def patch_expiring_flags_for_user(
        self,
        project_key,
        user_key,
        environment_key,
        ...
        **kwargs
        ...
        kwargs['environment_key'] = \
            environment_key
        kwargs['patch_users_request'] = \
            patch_users_request
        return self.patch_expiring_flags_for_user_endpoint.call_with_http_info(**kwargs)

    def put_flag_setting(
        self,
        project_key,
        environment_key,
        user_key,
        ...
        **kwargs
        ...
        """Update flag settings for user  # noqa: E501

        Enable or disable a feature flag for a user based on their key.  Omitting the `setting` attribute from the request body, or including a `setting` of `null`, erases the current setting for a user.  If you previously patched the flag, and the patch included the user's data, LaunchDarkly continues to use that data. If LaunchDarkly has never encountered the user's key before, it calculates the flag values based on the user key alone.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_flag_setting(project_key, environment_key, user_key, feature_flag_key, value_put, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['value_put'] = \
            value_put
        return self.put_flag_setting_endpoint.call_with_http_info(**kwargs)
