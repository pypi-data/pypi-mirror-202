...
class UsersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_user_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/users/{projectKey}/{environmentKey}/{userKey}',
        ...
        self.get_search_users_endpoint = _Endpoint(
            settings={
                'response_type': (Users,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/user-search/{projectKey}/{environmentKey}',
                'operation_id': 'get_search_users',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_users_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/users/{projectKey}/{environmentKey}',
    ...
    def delete_user(
        ...
        **kwargs
        ...
        Delete a user by key.  # noqa: E501
    ...
    def get_search_users(
        ...
        **kwargs
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_search_users_endpoint.call_with_http_info(**kwargs)
    ...
    def get_user(
        ...
        **kwargs
        ...
        Get a user by key. The `user` object contains all attributes sent in `variation` calls for that key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
