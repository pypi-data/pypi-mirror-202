...
class FlagLinksBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_flag_link_endpoint = _Endpoint(
            settings={
                'response_type': (FlagLinkRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}',
                'operation_id': 'create_flag_link',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_flag_link_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}/{id}',
                'operation_id': 'delete_flag_link',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_flag_links_endpoint = _Endpoint(
            settings={
                'response_type': (FlagLinkCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}',
                'operation_id': 'get_flag_links',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_flag_link_endpoint = _Endpoint(
            settings={
                'response_type': (FlagLinkRep,),
                'auth': [
                    'ApiKey'
    ...
    def create_flag_link(
        ...
        **kwargs
        ...
        """Create flag link  # noqa: E501

        Create a new flag link. Flag links let you reference external resources and associate them with your flags.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_flag_link(project_key, feature_flag_key, flag_link_post, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['feature_flag_key'] = \
            feature_flag_key
        kwargs['flag_link_post'] = \
            flag_link_post
        return self.create_flag_link_endpoint.call_with_http_info(**kwargs)

    def delete_flag_link(
        self,
        project_key,
        feature_flag_key,
        id,
        **kwargs
        ...
        """Delete flag link  # noqa: E501

        Delete a flag link by ID or key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_flag_link(project_key, feature_flag_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.delete_flag_link_endpoint.call_with_http_info(**kwargs)
    ...
    def get_flag_links(
        ...
        **kwargs
        ...
        """List flag links  # noqa: E501

        Get a list of all flag links.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_flag_links(project_key, feature_flag_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['feature_flag_key'] = \
            feature_flag_key
        return self.get_flag_links_endpoint.call_with_http_info(**kwargs)

    def update_flag_link(
        self,
        project_key,
        feature_flag_key,
        id,
        ...
        **kwargs
        ...
        """Update flag link  # noqa: E501

        Update a flag link. The request body must be a valid JSON patch document. To learn more, read [Updates](/#section/Overview/Updates).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_flag_link(project_key, feature_flag_key, id, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.update_flag_link_endpoint.call_with_http_info(**kwargs)
