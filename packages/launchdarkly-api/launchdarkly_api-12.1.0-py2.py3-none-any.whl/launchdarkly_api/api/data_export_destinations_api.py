...
class DataExportDestinationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_destination_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/destinations/{projectKey}/{environmentKey}/{id}',
        ...
        self.get_destinations_endpoint = _Endpoint(
            settings={
                'response_type': (Destinations,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/destinations',
        ...
        self.patch_destination_endpoint = _Endpoint(
            settings={
                'response_type': (Destination,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/destinations/{projectKey}/{environmentKey}/{id}',
                'operation_id': 'patch_destination',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.post_destination_endpoint = _Endpoint(
            settings={
                'response_type': (Destination,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/destinations/{projectKey}/{environmentKey}',
                'operation_id': 'post_destination',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def delete_destination(
        ...
        **kwargs
        ...
        """Delete Data Export destination  # noqa: E501

        Delete a Data Export destination by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_destination(project_key, environment_key, id, async_req=True)
        >>> result = thread.get()
    ...
    def get_destination(
        ...
        **kwargs
        ...
        >>> thread = api.get_destination(project_key, environment_key, id, async_req=True)
        >>> result = thread.get()
    ...
    def get_destinations(
        ...
        **kwargs
        ...
        Get a list of Data Export destinations configured across all projects and environments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def patch_destination(
        ...
        **kwargs
        ...
        """Update Data Export destination  # noqa: E501

        Update a Data Export destination. This requires a JSON Patch representation of the modified destination.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_destination(project_key, environment_key, id, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.patch_destination_endpoint.call_with_http_info(**kwargs)
    ...
    def post_destination(
        ...
        **kwargs
        ...
        kwargs['environment_key'] = \
            environment_key
        kwargs['destination_post'] = \
            destination_post
        return self.post_destination_endpoint.call_with_http_info(**kwargs)
