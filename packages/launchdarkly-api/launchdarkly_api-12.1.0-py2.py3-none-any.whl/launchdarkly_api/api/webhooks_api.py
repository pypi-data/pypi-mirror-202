...
class WebhooksApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_all_webhooks_endpoint = _Endpoint(
            settings={
    ...
    def get_all_webhooks(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_all_webhooks_endpoint.call_with_http_info(**kwargs)
    ...
    def get_webhook(
        ...
        **kwargs
        ...
        Get a single webhook by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def patch_webhook(
        ...
        **kwargs
        ...
        Update a webhook's settings. The request should be a valid JSON Patch document describing the changes to be made to the webhook.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_webhook(id, json_patch, async_req=True)
        >>> result = thread.get()
    ...
    def post_webhook(
        ...
        **kwargs
        ...
        >>> thread = api.post_webhook(webhook_post, async_req=True)
        >>> result = thread.get()
