...
class ContextSettingsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.put_context_flag_setting_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/{contextKind}/{contextKey}/flags/{featureFlagKey}',
                'operation_id': 'put_context_flag_setting',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def put_context_flag_setting(
        ...
        **kwargs
        ...
        kwargs['value_put'] = \
            value_put
        return self.put_context_flag_setting_endpoint.call_with_http_info(**kwargs)
