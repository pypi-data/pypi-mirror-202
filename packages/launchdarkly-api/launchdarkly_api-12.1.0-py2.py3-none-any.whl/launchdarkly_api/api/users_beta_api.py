...
class UsersBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_user_attribute_names_endpoint = _Endpoint(
            settings={
                'response_type': (UserAttributeNamesRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/user-attributes/{projectKey}/{environmentKey}',
                'operation_id': 'get_user_attribute_names',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_user_attribute_names(
        ...
        **kwargs
        ...
        """Get user attribute names  # noqa: E501

        Get all in-use user attributes in the specified environment. The set of in-use attributes typically consists of all attributes seen within the past 30 days.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_user_attribute_names(project_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_user_attribute_names_endpoint.call_with_http_info(**kwargs)
