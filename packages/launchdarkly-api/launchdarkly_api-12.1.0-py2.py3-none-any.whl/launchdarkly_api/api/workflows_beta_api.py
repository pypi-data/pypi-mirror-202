...
class WorkflowsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_workflow_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows/{workflowId}',
        ...
        self.get_custom_workflow_endpoint = _Endpoint(
            settings={
                'response_type': (CustomWorkflowOutput,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows/{workflowId}',
                'operation_id': 'get_custom_workflow',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_workflows_endpoint = _Endpoint(
            settings={
                'response_type': (CustomWorkflowsListingOutput,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows',
    ...
    def delete_workflow(
        ...
        **kwargs
        ...
        Delete a workflow from a feature flag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_workflow(project_key, feature_flag_key, environment_key, workflow_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_custom_workflow(
        ...
        **kwargs
        ...
        """Get custom workflow  # noqa: E501

        Get a specific workflow by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_custom_workflow(project_key, feature_flag_key, environment_key, workflow_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['workflow_id'] = \
            workflow_id
        return self.get_custom_workflow_endpoint.call_with_http_info(**kwargs)
    ...
    def get_workflows(
        ...
        **kwargs
        ...
        Display workflows associated with a feature flag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_workflows(project_key, feature_flag_key, environment_key, async_req=True)
        >>> result = thread.get()
