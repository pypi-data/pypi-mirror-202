...
class WorkflowTemplatesBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_workflow_template_endpoint = _Endpoint(
            settings={
                'response_type': (WorkflowTemplateOutput,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/templates',
            ...
            root_map={
                ...
                'location_map': {
                    'create_workflow_template_input': 'body',
                },
        ...
        self.delete_workflow_template_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/templates/{templateKey}',
        ...
        self.get_workflow_templates_endpoint = _Endpoint(
            settings={
                'response_type': (WorkflowTemplatesListingOutputRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/templates',
                'operation_id': 'get_workflow_templates',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_workflow_template(
        ...
        **kwargs
        ...
        Create a template for a feature flag workflow  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_workflow_template(create_workflow_template_input, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['create_workflow_template_input'] = \
            create_workflow_template_input
    ...
    def delete_workflow_template(
        ...
        **kwargs
        ...
        """Delete workflow template  # noqa: E501

        Delete a workflow template  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_workflow_template(template_key, async_req=True)
        >>> result = thread.get()
    ...
    def get_workflow_templates(
        ...
        **kwargs
        ...
        Get workflow templates belonging to an account, or can optionally return templates_endpoints.workflowTemplateSummariesListingOutputRep when summary query param is true  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_workflow_templates_endpoint.call_with_http_info(**kwargs)
