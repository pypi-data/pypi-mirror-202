...
class ExperimentsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_experimentation_settings_endpoint = _Endpoint(
            settings={
                'response_type': (ExperimentationSettingsRep,),
                'auth': [
                    'ApiKey'
                ],
        ...
        self.get_legacy_experiment_results_endpoint = _Endpoint(
            settings={
                'response_type': (ExperimentResults,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flags/{projectKey}/{featureFlagKey}/experiments/{environmentKey}/{metricKey}',
                'operation_id': 'get_legacy_experiment_results',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.put_experimentation_settings_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    'project_key': 'path',
                    'experimentation_settings_put': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.reset_experiment_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flags/{projectKey}/{featureFlagKey}/experiments/{environmentKey}/{metricKey}/results',
                'operation_id': 'reset_experiment',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def create_experiment(
        ...
        **kwargs
        ...
        Create an experiment. To learn more, read [Creating experiments](https://docs.launchdarkly.com/home/creating-experiments).  # noqa: E501
    ...
    def create_iteration(
        ...
        **kwargs
        ...
        Create an experiment iteration. Experiment iterations let you record experiments in discrete blocks of time. To learn more, read [Starting experiment iterations](https://docs.launchdarkly.com/home/creating-experiments#starting-experiment-iterations).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_experiment_results(
        ...
        **kwargs
        ...
        """Get experiment results  # noqa: E501

        Get results from an experiment for a particular metric.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_legacy_experiment_results(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Get legacy experiment results (deprecated)  # noqa: E501

        Get detailed experiment result data for legacy experiments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_legacy_experiment_results(project_key, feature_flag_key, environment_key, metric_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['metric_key'] = \
            metric_key
        return self.get_legacy_experiment_results_endpoint.call_with_http_info(**kwargs)
    ...
    def put_experimentation_settings(
        ...
        **kwargs
        ...
        >>> thread = api.put_experimentation_settings(project_key, experimentation_settings_put, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_key'] = \
            project_key
        kwargs['experimentation_settings_put'] = \
            experimentation_settings_put
    ...
    def reset_experiment(
        ...
        **kwargs
        ...
        """Reset experiment results  # noqa: E501

        Reset all experiment results by deleting all existing data for an experiment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.reset_experiment(project_key, feature_flag_key, environment_key, metric_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['metric_key'] = \
            metric_key
        return self.reset_experiment_endpoint.call_with_http_info(**kwargs)
