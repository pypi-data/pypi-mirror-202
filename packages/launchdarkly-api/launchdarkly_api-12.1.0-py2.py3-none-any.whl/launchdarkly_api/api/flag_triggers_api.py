...
class FlagTriggersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_trigger_workflow_endpoint = _Endpoint(
            settings={
                'response_type': (TriggerWorkflowRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flags/{projectKey}/{featureFlagKey}/triggers/{environmentKey}',
                'operation_id': 'create_trigger_workflow',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_trigger_workflow_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flags/{projectKey}/{featureFlagKey}/triggers/{environmentKey}/{id}',
                'operation_id': 'delete_trigger_workflow',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_trigger_workflow_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (TriggerWorkflowRep,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/flags/{projectKey}/{featureFlagKey}/triggers/{environmentKey}/{id}',
                'operation_id': 'get_trigger_workflow_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_trigger_workflows_endpoint = _Endpoint(
            settings={
                'response_type': (TriggerWorkflowCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flags/{projectKey}/{featureFlagKey}/triggers/{environmentKey}',
                'operation_id': 'get_trigger_workflows',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_trigger_workflow_endpoint = _Endpoint(
            settings={
                'response_type': (TriggerWorkflowRep,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/flags/{projectKey}/{featureFlagKey}/triggers/{environmentKey}/{id}',
                'operation_id': 'patch_trigger_workflow',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_trigger_workflow(
        ...
        **kwargs
        ...
        """Create flag trigger  # noqa: E501

        Create a new flag trigger.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_trigger_workflow(project_key, environment_key, feature_flag_key, trigger_post, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['trigger_post'] = \
            trigger_post
        return self.create_trigger_workflow_endpoint.call_with_http_info(**kwargs)

    def delete_trigger_workflow(
        self,
        project_key,
        environment_key,
        feature_flag_key,
        ...
        **kwargs
        ...
        """Delete flag trigger  # noqa: E501

        Delete a flag trigger by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_trigger_workflow(project_key, environment_key, feature_flag_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.delete_trigger_workflow_endpoint.call_with_http_info(**kwargs)

    def get_trigger_workflow_by_id(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Get flag trigger by ID  # noqa: E501

        Get a flag trigger by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_trigger_workflow_by_id(project_key, feature_flag_key, environment_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_trigger_workflow_by_id_endpoint.call_with_http_info(**kwargs)
    ...
    def get_trigger_workflows(
        ...
        **kwargs
        ...
        """List flag triggers  # noqa: E501

        Get a list of all flag triggers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_trigger_workflows(project_key, environment_key, feature_flag_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['feature_flag_key'] = \
            feature_flag_key
        return self.get_trigger_workflows_endpoint.call_with_http_info(**kwargs)

    def patch_trigger_workflow(
        self,
        project_key,
        environment_key,
        feature_flag_key,
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        kwargs['flag_trigger_input'] = \
            flag_trigger_input
        return self.patch_trigger_workflow_endpoint.call_with_http_info(**kwargs)
