...
class ScheduledChangesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_flag_config_scheduled_changes_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes/{id}',
                'operation_id': 'delete_flag_config_scheduled_changes',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_feature_flag_scheduled_change_endpoint = _Endpoint(
            settings={
                'response_type': (FeatureFlagScheduledChange,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes/{id}',
                'operation_id': 'get_feature_flag_scheduled_change',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_flag_config_scheduled_changes_endpoint = _Endpoint(
            settings={
                'response_type': (FeatureFlagScheduledChanges,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes',
                'operation_id': 'get_flag_config_scheduled_changes',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_flag_config_scheduled_change_endpoint = _Endpoint(
            settings={
                'response_type': (FeatureFlagScheduledChange,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes/{id}',
                'operation_id': 'patch_flag_config_scheduled_change',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'environment_key': 'path',
                    'id': 'path',
                    'flag_scheduled_changes_input': 'body',
                    'ignore_conflicts': 'query',
                },
                'collection_format_map': {
                }
            },
        ...
        self.post_flag_config_scheduled_changes_endpoint = _Endpoint(
            settings={
                'response_type': (FeatureFlagScheduledChange,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes',
                'operation_id': 'post_flag_config_scheduled_changes',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'feature_flag_key': 'path',
                    'environment_key': 'path',
                    'post_flag_scheduled_changes_input': 'body',
                    'ignore_conflicts': 'query',
                },
                'collection_format_map': {
                }
    ...
    def delete_flag_config_scheduled_changes(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Delete scheduled changes workflow  # noqa: E501

        Delete a scheduled changes workflow.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_flag_config_scheduled_changes(project_key, feature_flag_key, environment_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.delete_flag_config_scheduled_changes_endpoint.call_with_http_info(**kwargs)

    def get_feature_flag_scheduled_change(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Get a scheduled change  # noqa: E501

        Get a scheduled change that will be applied to the feature flag by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_feature_flag_scheduled_change(project_key, feature_flag_key, environment_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_feature_flag_scheduled_change_endpoint.call_with_http_info(**kwargs)

    def get_flag_config_scheduled_changes(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        **kwargs
        ...
        """List scheduled changes  # noqa: E501

        Get a list of scheduled changes that will be applied to the feature flag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_flag_config_scheduled_changes_endpoint.call_with_http_info(**kwargs)

    def patch_flag_config_scheduled_change(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        kwargs['flag_scheduled_changes_input'] = \
            flag_scheduled_changes_input
        return self.patch_flag_config_scheduled_change_endpoint.call_with_http_info(**kwargs)

    def post_flag_config_scheduled_changes(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Create scheduled changes workflow  # noqa: E501

        Create scheduled changes for a feature flag. If the `ignoreConficts` query parameter is false and there are conflicts between these instructions and existing scheduled changes, the request will fail. If the parameter is true and there are conflicts, the request will succeed.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_flag_config_scheduled_changes(project_key, feature_flag_key, environment_key, post_flag_scheduled_changes_input, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        kwargs['post_flag_scheduled_changes_input'] = \
            post_flag_scheduled_changes_input
        return self.post_flag_config_scheduled_changes_endpoint.call_with_http_info(**kwargs)
