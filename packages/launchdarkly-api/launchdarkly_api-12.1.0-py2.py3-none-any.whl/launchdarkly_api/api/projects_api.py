...
class ProjectsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_project_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}',
        ...
        self.get_flag_defaults_by_project_endpoint = _Endpoint(
            settings={
                'response_type': (FlagDefaultsRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flag-defaults',
                'operation_id': 'get_flag_defaults_by_project',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_flag_defaults_by_project_endpoint = _Endpoint(
            settings={
                'response_type': (UpsertPayloadRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flag-defaults',
                'operation_id': 'patch_flag_defaults_by_project',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.post_project_endpoint = _Endpoint(
            settings={
                'response_type': (ProjectRep,),
                'auth': [
                    'ApiKey'
        ...
        self.put_flag_defaults_by_project_endpoint = _Endpoint(
            settings={
                'response_type': (UpsertPayloadRep,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/flag-defaults',
                'operation_id': 'put_flag_defaults_by_project',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'project_key': 'path',
                    'upsert_flag_defaults_payload': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def delete_project(
        ...
        **kwargs
        ...
        Delete a project by key. Use this endpoint with caution. Deleting a project will delete all associated environments and feature flags. You cannot delete the last project in an account.  # noqa: E501
    ...
    def get_flag_defaults_by_project(
        self,
        project_key,
        **kwargs
    ):
        """Get flag defaults for project  # noqa: E501

        Get the flag defaults for a specific project.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_flag_defaults_by_project(project_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_key'] = \
            project_key
        return self.get_flag_defaults_by_project_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_flag_defaults_by_project(
        self,
        project_key,
        json_patch,
        **kwargs
    ):
        """Update flag default for project  # noqa: E501

        Update a flag default. Requires a [JSON Patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes to the flag default.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_flag_defaults_by_project(project_key, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.patch_flag_defaults_by_project_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_project(
        ...
        **kwargs
        ...
        Update a project. Requires a [JSON Patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes to the project.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_project(project_key, json_patch, async_req=True)
        >>> result = thread.get()
    ...
    def post_project(
        ...
        **kwargs
        ...
        Create a new project with the given key and name. Project keys must be unique within an account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_project(project_post, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_post'] = \
            project_post
        return self.post_project_endpoint.call_with_http_info(**kwargs)

    def put_flag_defaults_by_project(
        self,
        project_key,
        upsert_flag_defaults_payload,
        **kwargs
    ):
        """Create or update flag defaults for project  # noqa: E501

        Create or update flag defaults for a project.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_flag_defaults_by_project(project_key, upsert_flag_defaults_payload, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_key'] = \
            project_key
        kwargs['upsert_flag_defaults_payload'] = \
            upsert_flag_defaults_payload
        return self.put_flag_defaults_by_project_endpoint.call_with_http_info(**kwargs)
