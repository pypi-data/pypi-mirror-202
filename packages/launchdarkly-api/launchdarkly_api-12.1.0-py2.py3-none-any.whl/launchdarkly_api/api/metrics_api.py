...
class MetricsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_metric_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/metrics/{projectKey}/{metricKey}',
        ...
        self.get_metrics_endpoint = _Endpoint(
            settings={
                'response_type': (MetricCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/metrics/{projectKey}',
        ...
        self.patch_metric_endpoint = _Endpoint(
            settings={
                'response_type': (MetricRep,),
                'auth': [
                    'ApiKey'
        ...
        self.post_metric_endpoint = _Endpoint(
            settings={
                'response_type': (MetricRep,),
                'auth': [
                    'ApiKey'
    ...
    def delete_metric(
        ...
        **kwargs
        ...
        """Delete metric  # noqa: E501

        Delete a metric by key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_metric(project_key, metric_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['metric_key'] = \
            metric_key
        return self.delete_metric_endpoint.call_with_http_info(**kwargs)
    ...
    def get_metric(
        ...
        **kwargs
        ...
        >>> thread = api.get_metric(project_key, metric_key, async_req=True)
        >>> result = thread.get()
    ...
    def patch_metric(
        ...
        **kwargs
        ...
        >>> thread = api.patch_metric(project_key, metric_key, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.patch_metric_endpoint.call_with_http_info(**kwargs)
    ...
    def post_metric(
        ...
        **kwargs
        ...
        Create a new metric in the specified project. The expected `POST` body differs depending on the specified `kind` property.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_metric(project_key, metric_post, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['metric_post'] = \
            metric_post
        return self.post_metric_endpoint.call_with_http_info(**kwargs)
