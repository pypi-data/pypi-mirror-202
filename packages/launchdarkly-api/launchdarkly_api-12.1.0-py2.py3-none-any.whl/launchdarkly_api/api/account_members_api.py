...
class AccountMembersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_member_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/members/{id}',
        ...
        self.get_member_endpoint = _Endpoint(
            settings={
        ...
        self.patch_member_endpoint = _Endpoint(
            settings={
                'response_type': (Member,),
                'auth': [
                    'ApiKey'
        ...
        self.post_members_endpoint = _Endpoint(
            settings={
                'response_type': (Members,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/members',
                'operation_id': 'post_members',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'new_member_form_list_post',
                ],
                'required': [
                    'new_member_form_list_post',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'new_member_form_list_post': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def delete_member(
        ...
        **kwargs
        ...
        >>> thread = api.delete_member(id, async_req=True)
        >>> result = thread.get()
    ...
    def get_member(
        ...
        **kwargs
        ...
        Get a single account member by member ID.  `me` is a reserved value for the `id` parameter that returns the caller's member information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_member(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_member_endpoint.call_with_http_info(**kwargs)

    def get_members(
        self,
        **kwargs
    ):
        """List account members  # noqa: E501
    ...
    def post_members(
        ...
        **kwargs
        ...
        >>> thread = api.post_members(new_member_form_list_post, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['new_member_form_list_post'] = \
            new_member_form_list_post
        return self.post_members_endpoint.call_with_http_info(**kwargs)
