...
class FollowFlagsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_flag_followers_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers/{memberId}',
                'operation_id': 'delete_flag_followers',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_flag_followers_endpoint = _Endpoint(
            settings={
                'response_type': (FlagFollowersGetRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers',
                'operation_id': 'get_flag_followers',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_followers_by_proj_env_endpoint = _Endpoint(
            settings={
                'response_type': (FlagFollowersByProjEnvGetRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/environments/{environmentKey}/followers',
                'operation_id': 'get_followers_by_proj_env',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.put_flag_followers_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers/{memberId}',
                'operation_id': 'put_flag_followers',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def delete_flag_followers(
        ...
        **kwargs
        ...
        """Remove a member as a follower of a flag in a project and environment  # noqa: E501

        Remove a member as a follower to a flag in a project and environment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_flag_followers(project_key, feature_flag_key, environment_key, member_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['member_id'] = \
            member_id
        return self.delete_flag_followers_endpoint.call_with_http_info(**kwargs)

    def get_flag_followers(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        **kwargs
        ...
        """Get followers of a flag in a project and environment  # noqa: E501

        Get a list of members following a flag in a project and environment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_flag_followers(project_key, feature_flag_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_flag_followers_endpoint.call_with_http_info(**kwargs)

    def get_followers_by_proj_env(
        self,
        project_key,
        environment_key,
        **kwargs
    ):
        """Get followers of all flags in a given project and environment  # noqa: E501

        Get followers of all flags in a given environment and project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_followers_by_proj_env(project_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_followers_by_proj_env_endpoint.call_with_http_info(**kwargs)

    def put_flag_followers(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Add a member as a follower of a flag in a project and environment  # noqa: E501

        Add a member as a follower to a flag in a project and environment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_flag_followers(project_key, feature_flag_key, environment_key, member_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['member_id'] = \
            member_id
        return self.put_flag_followers_endpoint.call_with_http_info(**kwargs)
