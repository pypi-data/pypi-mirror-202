...
class AccessTokensApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_token_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/tokens/{id}',
        ...
        self.get_tokens_endpoint = _Endpoint(
            settings={
                'response_type': (Tokens,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/tokens',
        ...
        self.patch_token_endpoint = _Endpoint(
            settings={
                'response_type': (Token,),
                'auth': [
                    'ApiKey'
        ...
        self.post_token_endpoint = _Endpoint(
            settings={
                'response_type': (Token,),
                'auth': [
                    'ApiKey'
        ...
        self.reset_token_endpoint = _Endpoint(
            settings={
                'response_type': (Token,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/tokens/{id}/reset',
                'operation_id': 'reset_token',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_tokens(
        ...
        **kwargs
        ...
        Fetch a list of all access tokens.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_tokens_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_token(
        ...
        **kwargs
        ...
        """Patch access token  # noqa: E501

        Update an access token's settings. The request should be a valid JSON Patch document describing the changes to be made to the access token.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_token(id, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.patch_token_endpoint.call_with_http_info(**kwargs)
    ...
    def post_token(
        ...
        **kwargs
        ...
        Create a new access token.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_token(access_token_post, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['access_token_post'] = \
            access_token_post
        return self.post_token_endpoint.call_with_http_info(**kwargs)
    ...
    def reset_token(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.reset_token_endpoint.call_with_http_info(**kwargs)
