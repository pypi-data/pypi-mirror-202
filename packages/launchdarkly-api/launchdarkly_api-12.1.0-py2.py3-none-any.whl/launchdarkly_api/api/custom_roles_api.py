...
class CustomRolesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_custom_role_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/roles/{customRoleKey}',
                'operation_id': 'delete_custom_role',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_custom_role_endpoint = _Endpoint(
            settings={
        ...
        self.get_custom_roles_endpoint = _Endpoint(
            settings={
                'response_type': (CustomRoles,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/roles',
                'operation_id': 'get_custom_roles',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_custom_role_endpoint = _Endpoint(
            settings={
                'response_type': (CustomRole,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/roles/{customRoleKey}',
                'operation_id': 'patch_custom_role',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.post_custom_role_endpoint = _Endpoint(
            settings={
                'response_type': (CustomRole,),
                'auth': [
                    'ApiKey'
    ...
    def delete_custom_role(
        ...
        **kwargs
        ...
        kwargs['custom_role_key'] = \
            custom_role_key
        return self.delete_custom_role_endpoint.call_with_http_info(**kwargs)
    ...
    def get_custom_role(
        ...
        **kwargs
        ...
        """Get custom role  # noqa: E501

        Get a single custom role by key or ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_custom_roles(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_custom_roles_endpoint.call_with_http_info(**kwargs)

    def patch_custom_role(
        self,
        custom_role_key,
        patch_with_comment,
        **kwargs
        ...
        Update a single custom role. The request must be a valid JSON Patch document describing the changes to be made to the custom role. To add an element to the `policy` array, set the `path` to `/policy` and then append `/<array index>`. Using `/0` adds to the beginning of the array.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_custom_role(custom_role_key, patch_with_comment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['patch_with_comment'] = \
            patch_with_comment
        return self.patch_custom_role_endpoint.call_with_http_info(**kwargs)
    ...
    def post_custom_role(
        ...
        **kwargs
        ...
        kwargs['custom_role_post'] = \
            custom_role_post
        return self.post_custom_role_endpoint.call_with_http_info(**kwargs)
