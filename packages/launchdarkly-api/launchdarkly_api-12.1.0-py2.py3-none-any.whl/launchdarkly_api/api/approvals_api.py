...
class ApprovalsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_approval_request_for_flag_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{id}',
                'operation_id': 'delete_approval_request_for_flag',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_approval_for_flag_endpoint = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{id}',
                'operation_id': 'get_approval_for_flag',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_approvals_for_flag_endpoint = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestsResponse,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests',
                'operation_id': 'get_approvals_for_flag',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.post_approval_request_apply_for_flag_endpoint = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{id}/apply',
                'operation_id': 'post_approval_request_apply_for_flag',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'environment_key': 'path',
                    'id': 'path',
                    'post_approval_request_apply_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.post_approval_request_for_flag_endpoint = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests',
                'operation_id': 'post_approval_request_for_flag',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'feature_flag_key': 'path',
                    'environment_key': 'path',
                    'create_flag_config_approval_request_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.post_approval_request_review_for_flag_endpoint = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{id}/reviews',
                'operation_id': 'post_approval_request_review_for_flag',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'environment_key': 'path',
                    'id': 'path',
                    'post_approval_request_review_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.post_flag_copy_config_approval_request_endpoint = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'feature_flag_key': 'path',
                    'environment_key': 'path',
                    'create_copy_flag_config_approval_request_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def delete_approval_request_for_flag(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Delete approval request for a flag  # noqa: E501

        Delete an approval request for a feature flag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_approval_request_for_flag(project_key, feature_flag_key, environment_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.delete_approval_request_for_flag_endpoint.call_with_http_info(**kwargs)

    def get_approval_for_flag(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Get approval request for a flag  # noqa: E501

        Get a single approval request for a feature flag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_approval_for_flag(project_key, feature_flag_key, environment_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_approval_for_flag_endpoint.call_with_http_info(**kwargs)

    def get_approvals_for_flag(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        **kwargs
        ...
        """List approval requests for a flag  # noqa: E501

        Get all approval requests for a feature flag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_approvals_for_flag(project_key, feature_flag_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_approvals_for_flag_endpoint.call_with_http_info(**kwargs)

    def post_approval_request_apply_for_flag(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Apply approval request for a flag  # noqa: E501

        Apply an approval request that has been approved.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_approval_request_apply_for_flag(project_key, feature_flag_key, environment_key, id, post_approval_request_apply_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        kwargs['post_approval_request_apply_request'] = \
            post_approval_request_apply_request
        return self.post_approval_request_apply_for_flag_endpoint.call_with_http_info(**kwargs)

    def post_approval_request_for_flag(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Create approval request for a flag  # noqa: E501

        Create an approval request for a feature flag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_approval_request_for_flag(project_key, feature_flag_key, environment_key, create_flag_config_approval_request_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        kwargs['create_flag_config_approval_request_request'] = \
            create_flag_config_approval_request_request
        return self.post_approval_request_for_flag_endpoint.call_with_http_info(**kwargs)

    def post_approval_request_review_for_flag(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Review approval request for a flag  # noqa: E501

        Review an approval request by approving or denying changes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_approval_request_review_for_flag(project_key, feature_flag_key, environment_key, id, post_approval_request_review_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        kwargs['post_approval_request_review_request'] = \
            post_approval_request_review_request
        return self.post_approval_request_review_for_flag_endpoint.call_with_http_info(**kwargs)

    def post_flag_copy_config_approval_request(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        """Create approval request to copy flag configurations across environments  # noqa: E501

        Create an approval request to copy a feature flag's configuration across environments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_flag_copy_config_approval_request(project_key, feature_flag_key, environment_key, create_copy_flag_config_approval_request_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        kwargs['create_copy_flag_config_approval_request_request'] = \
            create_copy_flag_config_approval_request_request
        return self.post_flag_copy_config_approval_request_endpoint.call_with_http_info(**kwargs)
