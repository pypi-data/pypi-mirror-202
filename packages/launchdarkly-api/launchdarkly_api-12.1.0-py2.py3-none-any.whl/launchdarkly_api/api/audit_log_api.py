...
class AuditLogApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_audit_log_entries_endpoint = _Endpoint(
            settings={
                'response_type': (AuditLogEntryListingRepCollection,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/auditlog',
                'operation_id': 'get_audit_log_entries',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_audit_log_entry_endpoint = _Endpoint(
            settings={
                'response_type': (AuditLogEntryRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/auditlog/{id}',
    ...
    def get_audit_log_entries(
        ...
        **kwargs
        ...
        return self.get_audit_log_entries_endpoint.call_with_http_info(**kwargs)
    ...
    def get_audit_log_entry(
        ...
        **kwargs
        ...
        """Get audit log entry  # noqa: E501

        Fetch a detailed audit log entry representation. The detailed representation includes several fields that are not present in the summary representation, including:  - `delta`: the JSON patch body that was used in the request to update the entity - `previousVersion`: a JSON representation of the previous version of the entity - `currentVersion`: a JSON representation of the current version of the entity   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_audit_log_entry(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_audit_log_entry_endpoint.call_with_http_info(**kwargs)
