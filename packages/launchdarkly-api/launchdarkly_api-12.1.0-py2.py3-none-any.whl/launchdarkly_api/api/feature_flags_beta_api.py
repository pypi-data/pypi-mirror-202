...
class FeatureFlagsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_dependent_flags_endpoint = _Endpoint(
            settings={
                'response_type': (MultiEnvironmentDependentFlags,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flags/{projectKey}/{featureFlagKey}/dependent-flags',
                'operation_id': 'get_dependent_flags',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_dependent_flags_by_env_endpoint = _Endpoint(
            settings={
                'response_type': (DependentFlagsByEnvironment,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flags/{projectKey}/{environmentKey}/{featureFlagKey}/dependent-flags',
                'operation_id': 'get_dependent_flags_by_env',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_dependent_flags(
        ...
        **kwargs
        ...
        kwargs['feature_flag_key'] = \
            feature_flag_key
        return self.get_dependent_flags_endpoint.call_with_http_info(**kwargs)

    def get_dependent_flags_by_env(
        self,
        project_key,
        environment_key,
        feature_flag_key,
        **kwargs
        ...
        """List dependent feature flags by environment  # noqa: E501

        > ### Flag prerequisites is an Enterprise feature > > Flag prerequisites is available to customers on an Enterprise plan. To learn more, [read about our pricing](https://launchdarkly.com/pricing/). To upgrade your plan, [contact Sales](https://launchdarkly.com/contact-sales/).  List dependent flags across all environments for the flag specified in the path parameters. A dependent flag is a flag that uses another flag as a prerequisite. To learn more, read [Flag prerequisites](https://docs.launchdarkly.com/home/flags/prerequisites).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_dependent_flags_by_env(project_key, environment_key, feature_flag_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['feature_flag_key'] = \
            feature_flag_key
        return self.get_dependent_flags_by_env_endpoint.call_with_http_info(**kwargs)
