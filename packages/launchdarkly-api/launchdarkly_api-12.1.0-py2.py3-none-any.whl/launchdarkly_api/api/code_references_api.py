...
class CodeReferencesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_branches_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/code-refs/repositories/{repo}/branch-delete-tasks',
        ...
        self.delete_repository_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/code-refs/repositories/{repo}',
        ...
        self.get_branches_endpoint = _Endpoint(
            settings={
                'response_type': (BranchCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/code-refs/repositories/{repo}/branches',
        ...
        self.get_extinctions_endpoint = _Endpoint(
            settings={
                'response_type': (ExtinctionCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/code-refs/extinctions',
                'operation_id': 'get_extinctions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_repositories_endpoint = _Endpoint(
            settings={
                'response_type': (RepositoryCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/code-refs/repositories',
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'with_references_for_default_branch': 'withReferencesForDefaultBranch',
                    'proj_key': 'projKey',
                    'flag_key': 'flagKey',
                },
                'location_map': {
                    'with_branches': 'query',
                    'with_references_for_default_branch': 'query',
                    'proj_key': 'query',
                    'flag_key': 'query',
                },
                'collection_format_map': {
        ...
        self.get_root_statistic_endpoint = _Endpoint(
            settings={
                'response_type': (StatisticsRoot,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/code-refs/statistics',
                'operation_id': 'get_root_statistic',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_statistics_endpoint = _Endpoint(
            settings={
                'response_type': (StatisticCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/code-refs/statistics/{projectKey}',
        ...
        self.patch_repository_endpoint = _Endpoint(
            settings={
                'response_type': (RepositoryRep,),
                'auth': [
                    'ApiKey'
        ...
        self.post_extinction_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
        ...
        self.post_repository_endpoint = _Endpoint(
            settings={
                'response_type': (RepositoryRep,),
                'auth': [
                    'ApiKey'
        ...
        self.put_branch_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
    ...
    def delete_branches(
        ...
        **kwargs
        ...
        """Delete branches  # noqa: E501

        Asynchronously delete a number of branches.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_branches(repo, request_body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['request_body'] = \
            request_body
        return self.delete_branches_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_repository(
        ...
        **kwargs
        ...
        Delete a repository with the specified name.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_branch(
        ...
        **kwargs
        ...
        Get a specific branch in a repository.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_branch(repo, branch, async_req=True)
        >>> result = thread.get()
    ...
    def get_branches(
        ...
        **kwargs
        ...
        Get a list of branches.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_branches(repo, async_req=True)
        >>> result = thread.get()
    ...
    def get_extinctions(
        ...
        **kwargs
        ...
        """List extinctions  # noqa: E501

        Get a list of all extinctions. LaunchDarkly creates an extinction event after you remove all code references to a flag. To learn more, read [Understanding extinction events](https://docs.launchdarkly.com/home/code/code-references#understanding-extinction-events).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_extinctions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_extinctions_endpoint.call_with_http_info(**kwargs)
    ...
    def get_repositories(
        ...
        **kwargs
        ...
        Get a list of connected repositories. Optionally, you can include branch metadata with the `withBranches` query parameter. Embed references for the default branch with `ReferencesForDefaultBranch`. You can also filter the list of code references by project key and flag key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_repositories_endpoint.call_with_http_info(**kwargs)
    ...
    def get_repository(
        ...
        **kwargs
        ...
        Get a single repository by name.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_repository(repo, async_req=True)
        >>> result = thread.get()
    ...
    def get_root_statistic(
        self,
        **kwargs
    ):
        """Get links to code reference repositories for each project  # noqa: E501

        Get links for all projects that have code references.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_root_statistic(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_root_statistic_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_repository(
        ...
        **kwargs
        ...
        Update a repository's settings. The request must be a valid JSON Patch document describing the changes to be made to the repository.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_repository(repo, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.patch_repository_endpoint.call_with_http_info(**kwargs)
    ...
    def post_extinction(
        ...
        **kwargs
        ...
        Create a new extinction.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_extinction(repo, branch, extinction_list_post, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['branch'] = \
            branch
        kwargs['extinction_list_post'] = \
            extinction_list_post
        return self.post_extinction_endpoint.call_with_http_info(**kwargs)
    ...
    def post_repository(
        ...
        **kwargs
        ...
        Create a repository with the specified name.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_repository(repository_post, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['repository_post'] = \
            repository_post
        return self.post_repository_endpoint.call_with_http_info(**kwargs)
    ...
    def put_branch(
        ...
        **kwargs
        ...
        Create a new branch if it doesn't exist, or update the branch if it already exists.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['put_branch'] = \
            put_branch
        return self.put_branch_endpoint.call_with_http_info(**kwargs)
