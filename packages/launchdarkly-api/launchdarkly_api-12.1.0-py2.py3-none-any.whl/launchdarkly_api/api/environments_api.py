...
class EnvironmentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_environments_by_project_endpoint = _Endpoint(
            settings={
                'response_type': (Environments,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/environments',
                'operation_id': 'get_environments_by_project',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.reset_environment_mobile_key_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/environments/{environmentKey}/mobileKey',
        ...
        self.reset_environment_sdk_key_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/environments/{environmentKey}/apiKey',
    ...
    def get_environments_by_project(
        ...
        **kwargs
        ...
        kwargs['project_key'] = \
            project_key
        return self.get_environments_by_project_endpoint.call_with_http_info(**kwargs)
