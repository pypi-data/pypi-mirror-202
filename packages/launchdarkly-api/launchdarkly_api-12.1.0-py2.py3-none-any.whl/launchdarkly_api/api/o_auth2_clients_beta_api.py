...
class OAuth2ClientsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_o_auth2_client_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/oauth/clients',
        ...
        self.delete_o_auth_client_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/oauth/clients/{clientId}',
                'operation_id': 'delete_o_auth_client',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_o_auth_client_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (Client,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/oauth/clients/{clientId}',
                'operation_id': 'get_o_auth_client_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_o_auth_clients_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/oauth/clients',
                'operation_id': 'get_o_auth_clients',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_o_auth_client_endpoint = _Endpoint(
            settings={
                'response_type': (Client,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/oauth/clients/{clientId}',
                'operation_id': 'patch_o_auth_client',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_o_auth2_client(
        ...
        **kwargs
        ...
        """Create a LaunchDarkly OAuth 2.0 client  # noqa: E501

        Create (register) a LaunchDarkly OAuth2 client. OAuth2 clients allow you to build custom integrations using LaunchDarkly as your identity provider.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_o_auth2_client(oauth_client_post, async_req=True)
        >>> result = thread.get()
    ...
    def delete_o_auth_client(
        ...
        **kwargs
        ...
        Delete an existing OAuth 2.0 client by unique client ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_o_auth_client(client_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['client_id'] = \
            client_id
        return self.delete_o_auth_client_endpoint.call_with_http_info(**kwargs)

    def get_o_auth_client_by_id(
        self,
        client_id,
        **kwargs
    ):
        ...
        Get a registered OAuth 2.0 client by unique client ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_o_auth_client_by_id(client_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['client_id'] = \
            client_id
        return self.get_o_auth_client_by_id_endpoint.call_with_http_info(**kwargs)
    ...
    def get_o_auth_clients(
        ...
        **kwargs
        ...
        Get all OAuth 2.0 clients registered by your account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_o_auth_clients(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_o_auth_clients_endpoint.call_with_http_info(**kwargs)

    def patch_o_auth_client(
        self,
        client_id,
        json_patch,
        **kwargs
    ):
        """Patch client by ID  # noqa: E501

        Patch an existing OAuth 2.0 client by client ID. Requires a [JSON Patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes to the client. Only `name`, `description`, and `redirectUri` may be patched.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_o_auth_client(client_id, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.patch_o_auth_client_endpoint.call_with_http_info(**kwargs)
