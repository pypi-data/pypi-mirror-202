...
from launchdarkly_api import rest
from launchdarkly_api.configuration import Configuration
from launchdarkly_api.exceptions import ApiTypeError, ApiValueError, ApiException
from launchdarkly_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.delete_token  # this is an instance of the class Endpoint
        api_instance.delete_token()  # this invokes api_instance.delete_token.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_token.callable or self.callable in this class
