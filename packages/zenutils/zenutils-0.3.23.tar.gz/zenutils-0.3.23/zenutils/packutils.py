...
class RcmPacker(AbstractResultPacker):
    ...
    def pack_error(self, _error_Pu1dvy86uRLpdNu2Czyf, _result_Pu1dvy86uRLpdNu2Czyf=None, **kwargs):
    ...
    def unpack(self, _data_Pu1dvy86uRLpdNu2Czyf, **kwargs):
        ...
        if not _data_Pu1dvy86uRLpdNu2Czyf["code"]:
            ...
            if not "message" in _data_Pu1dvy86uRLpdNu2Czyf:
                ...
                raise BizError(message=_data_Pu1dvy86uRLpdNu2Czyf["message"], code=_data_Pu1dvy86uRLpdNu2Czyf["code"])
