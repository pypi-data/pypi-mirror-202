...
class Scan(Component):
    ...
    frequency_range = FloatIndexCommand('SCNFREQ', 1, 0, RangeDict, 'Hz')
    amplitude_range = FloatIndexCommand('SCNAMP', 1, 0, RangeDict, 'V')
    offset_range = FloatIndexCommand('SCNDC', 1, 0, RangeDict, 'V')
    aux_out1_range = FloatIndexCommand('SCNAUX1', 1, 0, RangeDict, 'V')
    aux_out2_range = FloatIndexCommand('SCNAUX2', 1, 0, RangeDict, 'V')
