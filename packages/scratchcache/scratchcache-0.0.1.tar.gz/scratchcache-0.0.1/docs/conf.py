#!/usr/bin/env python
#
# scratchcache documentation build configuration file, created by sphinx-quickstart.
#
...
version = scratchcache.__version__
# The full version, including alpha/beta/rc tags.
release = scratchcache.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(scratchcache.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "scratchcache/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/scratchcache/blob/%s/%s" % (tag, filename)
...
htmlhelp_basename = "scratchcachedoc"
