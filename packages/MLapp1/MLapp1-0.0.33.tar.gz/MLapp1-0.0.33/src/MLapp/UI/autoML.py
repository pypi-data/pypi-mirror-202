...
from .scaling import genrateInfoCallback, genrateCollapseCallback
...
runButton=dbc.Card([dbc.CardBody([
                            ...
                            dbc.Input(type="number",placeholder="in percentage",value=10, id="percentile",min=1,max=100,persistence=True,persistence_type="memory"),
