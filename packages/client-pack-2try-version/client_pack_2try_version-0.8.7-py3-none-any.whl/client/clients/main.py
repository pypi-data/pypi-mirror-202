...
from PyQt6.QtGui import QStandardItemModel, QStandardItem, QBrush, QColor, QGuiApplication
...
from clients.main_conv import Ui_MainClientWindow
from clients.add_contact import AddContactDialog
from clients.del_contact import DelContactDialog
...
class ClientMainWindow(QMainWindow):
    ...
    def __init__(self, database, transport, keys):
        ...
        # Кнопка "Выход"
        self.ui.menu_exit.triggered.connect(QGuiApplication.exit)
