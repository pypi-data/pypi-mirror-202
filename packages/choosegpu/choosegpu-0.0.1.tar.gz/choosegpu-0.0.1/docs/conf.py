#!/usr/bin/env python
#
# choosegpu documentation build configuration file, created by sphinx-quickstart.
#
...
version = choosegpu.__version__
# The full version, including alpha/beta/rc tags.
release = choosegpu.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(choosegpu.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "choosegpu/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/choosegpu/blob/%s/%s" % (tag, filename)
...
htmlhelp_basename = "choosegpudoc"
