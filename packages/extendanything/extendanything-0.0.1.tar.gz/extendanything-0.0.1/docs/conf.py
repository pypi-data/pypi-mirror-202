#!/usr/bin/env python
#
# extendanything documentation build configuration file, created by sphinx-quickstart.
#
...
version = extendanything.__version__
# The full version, including alpha/beta/rc tags.
release = extendanything.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(extendanything.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "extendanything/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/extendanything/blob/%s/%s" % (tag, filename)
...
htmlhelp_basename = "extendanythingdoc"
