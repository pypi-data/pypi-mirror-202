...
class siamese_cnn(nn.Module):
    ...
    def forward(self,x1,x2):
        ...
        x1 = torch.mean(x1,-1)#16,512
        x1 = x1.reshape(-1,512,1)

        x2 = self.cnn_block(x2)
        x2 = torch.mean(x2,-1)#16,512
        x2 = x2.reshape(-1,1,512)
        
        #print(x1.shape,x2.shape)
        #x = torch.matmul(x1,torch.transpose(x2,-2,-1))
