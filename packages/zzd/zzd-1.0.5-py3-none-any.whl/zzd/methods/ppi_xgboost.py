...
def ppi_xgboost(test_file,train_file,seqs_file,feature_encode,n_jobs=-1,**argv):
    """
    test_file:for pred
...
if __name__ == "__main__":
    ...
    pred = ppi_xgboost(test_file,train_file,seqs_file,feature_encode=['dpc'],pca=False)
