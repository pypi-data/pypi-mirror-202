...
def ppi_knn(test_file,train_file,seqs_file,feature_encode,n_jobs=-1,**argv):
    """
    test_file:for pred
    ...
    model = neighbors.KNeighborsClassifier(n_neighbors=2,weights='distance')
...
if __name__ == "__main__":
    ...
    pred = ppi_knn(test_file,train_file,seqs_file,feature_encode=['dpc'],pca=False)
