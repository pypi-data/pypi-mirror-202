discordapiwebhooks is a Python module that allows you to easily send webhooks to Discord. It supports sending text, images, and files to a Discord server.
