...
class ExpressRoutePort(
    ...
    def __init__(
        ...
        *,
        ...
        :param billing_type: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/express_route_port#billing_type ExpressRoutePort#billing_type}.
