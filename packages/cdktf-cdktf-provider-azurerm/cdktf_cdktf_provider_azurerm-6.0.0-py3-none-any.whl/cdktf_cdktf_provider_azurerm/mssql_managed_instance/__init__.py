...
class MssqlManagedInstance(
    ...
    def put_identity(
        ...
        *,
        ...
        :param identity_ids: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/mssql_managed_instance#identity_ids MssqlManagedInstance#identity_ids}.
        '''
