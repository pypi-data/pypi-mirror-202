...
class DashboardGrafana(
    ...
    def put_identity(
        ...
        *,
        ...
        :param identity_ids: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/dashboard_grafana#identity_ids DashboardGrafana#identity_ids}.
        '''
