...
Extension of [mkdocs-exclude](https://github.com/apenwarr/mkdocs-exclude) plugin to also provide
navigation filtering.

`mkdocs-excluder-plugin` is a
...
1. Install the module using pip: `pip install mkdocs-excluder-plugin`
