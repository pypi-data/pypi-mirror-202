...
def test_constructor_wrong_taxis(example_3d_array_and_dtimes):
    data, dtimes = example_3d_array_and_dtimes
    with pytest.raises(Exception) as e_info:
        CoreFrame(data, dtimes=dtimes, taxis=1)
...
# def test_constructor_table_wrong_taxis(example_2d_array_and_dtimes_and_column_names):
#     data, dtimes, col_names = example_2d_array_and_dtimes_and_column_names
#     with pytest.raises(Exception) as e_info:
#         CoreFrame(data, dtimes=dtimes, col_names=col_names, taxis=1)
