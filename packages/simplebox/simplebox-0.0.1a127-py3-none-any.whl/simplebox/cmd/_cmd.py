...
class CommandPrivate(metaclass=StaticClass):
    ...
    def exec(cmd, cwd: str or Path = None, timeout: int = None, encoding: str = None, **kwargs) -> '_Executor':
        ...
        Usage:
            Command.exec("rm -r /tmp/tmp").input("y").finish()
        """
        return _Executor(cmd, cwd=cwd, timeout=timeout, encoding=encoding, show_log=False, **kwargs)
    ...
    def run(*popenargs, cwd: str or Path = None, input_=None, capture_output=False, timeout=None, check=False,
        ...
        """
        return _Runner(*popenargs, cwd=cwd, input=input_, capture_output=capture_output, timeout=timeout, check=check,
                       encoding=encoding, show_log=False, **kwargs)
    ...
    def runned(*popenargs, cwd: str or Path = None, input_=None, capture_output=False, timeout=None, check=False,
        ...
        Quickly execute the subprocess run and return the result.
        """
        return CommandPrivate.run(*popenargs, cwd=cwd, input=input_, capture_output=capture_output, timeout=timeout,
                                  check=check, encoding=encoding, **kwargs).finish()
...
__all__ = [Command, CommandPrivate]
