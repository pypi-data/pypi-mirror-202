...
class RestFast(object):
    ...
    def response(self, only_body: bool = True, type_reference: Type[Entity] = None) -> Response or Dict:
        """
        ...
        try:
            ...
            if type_reference:
                if type_reference and not issubclass(type_reference, Entity):
                    raise TypeError(f"excepted type 'Entity' or sub-class, got a {type_reference.__name__}")
                return type_reference.get_from_dict(resp.json())
            if only_body:
                return resp.json()
            else:
                return resp
...
class Rest(object):
    ...
    def __init__(self, file: str = None, server_name: str = None, host: str = None, only_body: bool = True,
        ...
        configuration file.
        """
        self.__only_body: Optional[bool] = None
        ...
        self.__initialize(file, server_name, host, only_body, check_status, encoding, description)

    def __initialize(self, file: str = None, server_name: str = None, host: str = None, only_body: bool = True,
                     check_status: bool = False, encoding: str = "utf-8", description: str = None):
    ...
    def soul(self, rest: 'Rest'):
        ...
        """
        self.__only_body, self.__check_status, self.__encoding, self.__server_name, self.__server_list, self.__host, self.__description = rest.only_body, rest.check_status, rest.encoding, rest.server_name, rest.server_list, rest.host, rest.description
    ...
    def request(self, api_name: str = None, server_name: str = None, host: str = None, api: str = None,
                ...
                type_reference: Type[Entity] = None):
        """
        ...
        :param type_reference: type_reference priority is greater than only_body. type_reference will return custom
        entity object.
        ...
        def __inner(func):
            ...
            def __wrapper(*args, **kwargs):
                self.__request(func=func, kwargs=kwargs, api_name=api_name, server_name=server_name, host=host, api=api,
                               ...
                               description=description, type_reference=type_reference)
    ...
    def get(self, api_name: str = None, server_name: str = None, host: str = None, api: str = None,
            ...
            only_body: bool = RestConfig.only_body, description: str = None, type_reference: Type[Entity] = None):
        """
    ...
    def __request(self, func: callable, kwargs: dict, api_name: str = None, server_name: str = None, host: str = None,
        ...
        try:
            ...
            if type_reference:
                kwargs[_Constant.RESPONSE] = type_reference.get_from_dict(resp.json())
            else:
                if only_body_:
                    kwargs[_Constant.RESPONSE] = resp.json()
                else:
                    kwargs[_Constant.RESPONSE] = resp
        except BaseException:
            if resp:
                ...
                kwargs[_Constant.RESPONSE] = resp.content.decode(encoding_)
            else:
                kwargs[_Constant.RESPONSE] = None
        finally:
