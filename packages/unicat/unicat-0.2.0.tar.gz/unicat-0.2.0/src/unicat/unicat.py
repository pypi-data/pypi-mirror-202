...
class Unicat:
    ...
    @property
    def project(self):
        return UnicatProject(self, self.api._project_gid)
    ...
    def get_records(self, gids, *, force=False):
        ...
        records = [UnicatRecord(self, record) for record in result["records"]]
        return records
    ...
    def get_asset_by_pathname(self, pathname):
        if not pathname:
            return None
    ...
    def get_assets(self, gids, *, force=False):
        ...
        assets = [UnicatAsset(self, asset) for asset in result["assets"]]
        return assets
