...
class TeamSettings(
    ...
    def __init__(
        ...
        *,
        ...
        :param team_id: The GitHub team id or the GitHub team slug. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/team_settings#team_id TeamSettings#team_id}
    ...
    def put_review_request_delegation(
        ...
        *,
        ...
        '''
        :param algorithm: The algorithm to use when assigning pull requests to team members. Supported values are 'ROUND_ROBIN' and 'LOAD_BALANCE'. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/team_settings#algorithm TeamSettings#algorithm}
        :param member_count: The number of team members to assign to a pull request. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/team_settings#member_count TeamSettings#member_count}
        :param notify: whether to notify the entire team when at least one member is also assigned to the pull request. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/team_settings#notify TeamSettings#notify}
        '''
