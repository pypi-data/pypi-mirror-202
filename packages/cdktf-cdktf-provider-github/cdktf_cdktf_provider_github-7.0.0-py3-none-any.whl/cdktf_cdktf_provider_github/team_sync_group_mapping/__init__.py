...
class TeamSyncGroupMapping(
    ...
    def __init__(
        ...
        *,
        ...
        :param team_slug: Slug of the team. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/team_sync_group_mapping#team_slug TeamSyncGroupMapping#team_slug}
...
class TeamSyncGroupMappingGroup:
    def __init__(
        ...
        *,
        ...
        '''
        :param group_description: The description of the IdP group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/team_sync_group_mapping#group_description TeamSyncGroupMapping#group_description}
        :param group_id: The ID of the IdP group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/team_sync_group_mapping#group_id TeamSyncGroupMapping#group_id}
        :param group_name: The name of the IdP group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/github/r/team_sync_group_mapping#group_name TeamSyncGroupMapping#group_name}
        '''
        if __debug__:
