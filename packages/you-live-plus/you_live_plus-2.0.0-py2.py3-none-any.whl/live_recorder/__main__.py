...
def arg_parser():
    parser = argparse.ArgumentParser(prog='you-lp', description="version %s : %s"%(version.__version__, version.__descriptrion__))
    parser.add_argument("liver", help="要录制的直播源，如 bili,douyu,kuaishou,acfun,douyin")
    ...
    parser.add_argument("-save_mp4", '-mp4', help="最终转为mp4保存", required=False, action='store_true', default=False)
    global args
