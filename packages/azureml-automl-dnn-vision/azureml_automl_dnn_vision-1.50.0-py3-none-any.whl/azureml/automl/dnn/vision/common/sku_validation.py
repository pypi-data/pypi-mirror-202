...
def validate_gpu_sku(device: str, validate_free_gpu_mem: bool = True, min_gpu_mem: float = MIN_GPU_MEM) -> None:
    ...
    try:
        ...
        for i in range(device_count):
            ...
            elif validate_free_gpu_mem and mem_info.free < min_free_gpu_memory:
                is_valid = False
                per_device_infos.append(
