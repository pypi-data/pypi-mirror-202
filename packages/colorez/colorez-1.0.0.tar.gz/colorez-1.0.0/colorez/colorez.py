...
def color_input(prompt: str, color: int or str = "#FFFFFF") -> str:
    """
...
class Color:
    ...
    """
    def __init__(self, *args, color: int or str = "#FFFFFF", sep: str = " ", end: str = ""):
        """
            end is added to the core string if end == \n making color_print a threadsafe line print
