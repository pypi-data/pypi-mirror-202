...
class Chart(object):
    ...
    def __int__(self, width='1000px', height='400px', title='', render='notebook', jupyter_port=9955):
    ...
    def graph(self, nodes, links, **kwargs):  # 共现网络
        ...
        :param links: [{"source": "节点1", "target": "节点2", "value": "关系", "symbol_size": "词频"} # opts.GraphLink
        :return:
        """
    ...
    def wordcloud(self, data_pair, **kwargs):
        ...
        wc.add(series_name='', data_pair=data_pair, **kwargs)
