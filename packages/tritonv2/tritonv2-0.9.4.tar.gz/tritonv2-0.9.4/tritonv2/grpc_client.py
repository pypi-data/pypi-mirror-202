...
class TritonGRPCClient(TritonClient):
    ...
    def repository_index(self, headers=None):
        ...
        """
        try:
            repository_index_dict = self._client.get_model_repository_index(headers=headers, as_json=True)
    ...
    def repository_model_unload(self, model_name, headers=None, unload_dependents=False):
        """
        unload model
        :param model_name:
        :param headers:
    ...
    def system_shared_memory_register(self, name, key, byte_size, offset=0, headers=None):
        """
    ...
    def cuda_shared_memory_register(self, name, raw_handle, byte_size, device_id, headers=None):
        """
