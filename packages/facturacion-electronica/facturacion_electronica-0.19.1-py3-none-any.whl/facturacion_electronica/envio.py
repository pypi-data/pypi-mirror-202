...
class Envio(object):
    ...
    def Recepciones(self, vals):
        ...
        for recep in vals:
            ...
            respuesta._firma = self.firma_electronica
            envio = respuesta.xml_envio
            respuesta.Emisor = {
                'RUTEmisor': envio.find('SetDTE/Caratula/RutReceptor').text,
            }
            respuesta.Receptor = {
                'RUTRecep': envio.find('SetDTE/Caratula/RutEmisor').text,
            }
    ...
    def RecepcionMer(self, vals):
        ...
        if not vals.get("Emisor"):
            vals["Emisor"] = {
                'RUTEmisor': self._emisor.RUTEmisor,
            }
