...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = PredictionModel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_model_by_version1_oapg(
        self,
    ...
    def _get_model_by_version1_oapg(
        ...
        """
        For getting metadata details of a specific version of a parent model Id
...
class GetModelByVersion1(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_model_by_version1(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_model_by_version1(
        ...
        return self._get_model_by_version1_oapg(
