...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = ProductDesignSuggestResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _suggest_product_design_oapg(
        self,
    ...
    def _suggest_product_design_oapg(
        ...
        """
        For implementing auto suggestions on all attributes of the formulation
...
class SuggestProductDesign(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def suggest_product_design(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def suggest_product_design(
        ...
        return self._suggest_product_design_oapg(
