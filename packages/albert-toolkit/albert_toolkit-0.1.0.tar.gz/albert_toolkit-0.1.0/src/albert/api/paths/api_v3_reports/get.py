...
UpdatedBySchema = schemas.StrSchema
MoNumberSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'updatedBy': typing.Union[UpdatedBySchema, str, ],
        'moNumber': typing.Union[MoNumberSchema, str, ],
    },
    total=False
)
...
request_query_updated_by = api_client.QueryParameter(
    name="updatedBy",
    style=api_client.ParameterStyle.FORM,
    schema=UpdatedBySchema,
    explode=True,
)
request_query_mo_number = api_client.QueryParameter(
    name="moNumber",
    style=api_client.ParameterStyle.FORM,
    schema=MoNumberSchema,
    explode=True,
)
_auth = [
    'jwt',
]
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = ReportList
...
class BaseApi(api_client.Api):
    ...
    def _get_user_reports_oapg(
        ...
        """
        For fetching list of reports created by an user
        ...
        for parameter in (
            ...
            request_query_updated_by,
            request_query_mo_number,
        ):
...
class GetUserReports(BaseApi):
    ...
    def get_user_reports(
        ...
        return self._get_user_reports_oapg(
