...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = MergedDAT


request_body_merged_dat = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _parent_dat_bulk_update_oapg(
        self,
    ...
    def _parent_dat_bulk_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_merged_dat.serialize(body, content_type)
...
class ParentDatBulkUpdate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def parent_dat_bulk_update(
        self,
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonCharsetutf8, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def parent_dat_bulk_update(
        ...
        return self._parent_dat_bulk_update_oapg(
            body=body,
