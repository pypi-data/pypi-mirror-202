...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = Health
...
class BaseApi(api_client.Api):
    @typing.overload
    def _report_inventory_movements_oapg(
        self,
    ...
    def _report_inventory_movements_oapg(
        ...
        """
        For showing inventory movements
...
class ReportInventoryMovements(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def report_inventory_movements(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def report_inventory_movements(
        ...
        return self._report_inventory_movements_oapg(
