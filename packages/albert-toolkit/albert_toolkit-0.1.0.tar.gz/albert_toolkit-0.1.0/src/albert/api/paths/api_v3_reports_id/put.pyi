...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = PutReport


request_body_put_report = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _put_report_by_id_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_put_report.serialize(body, content_type)
...
class PutReportById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def put_report_by_id(
        self,
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonCharsetutf8, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def put_report_by_id(
        ...
        return self._put_report_by_id_oapg(
            body=body,
