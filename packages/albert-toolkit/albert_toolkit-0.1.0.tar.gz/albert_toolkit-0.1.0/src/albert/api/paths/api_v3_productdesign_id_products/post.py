...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = Columns


request_body_columns = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = Columns
...
class BaseApi(api_client.Api):
    @typing.overload
    def _post_pd_columns_id_by_id_oapg(
        self,
    ...
    def _post_pd_columns_id_by_id_oapg(
        ...
        """
        For creating columns in a ProductDesign.
        ...
        if body is not schemas.unset:
            serialized_data = request_body_columns.serialize(body, content_type)
...
class PostPdColumnsIdById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_pd_columns_id_by_id(
        self,
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonCharsetutf8, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def post_pd_columns_id_by_id(
        ...
        return self._post_pd_columns_id_by_id_oapg(
            body=body,
