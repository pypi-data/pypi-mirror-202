...
# body param
SchemaForRequestBodyApplicationJson = Location
...
SchemaFor201ResponseBodyApplicationJson = Location
...
class PostLocation(BaseApi):
    ...
    def post_location(
        ...
        return self._post_location_oapg(
            body=body,
