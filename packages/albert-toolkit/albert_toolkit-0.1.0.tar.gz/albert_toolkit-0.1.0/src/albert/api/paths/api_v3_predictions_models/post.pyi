...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = PredictionModel


request_body_prediction_model = api_client.RequestBody(
    content={
        'application/json; charset=utf-8': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJsonCharsetutf8),
    },
)
SchemaFor201ResponseBodyApplicationJsonCharsetutf8 = PredictionModel
...
class BaseApi(api_client.Api):
    ...
    def _post_models_oapg(
        ...
        """
        For creating a new prediction model in dynamodb.
        ...
        if body is not schemas.unset:
            serialized_data = request_body_prediction_model.serialize(body, content_type)
