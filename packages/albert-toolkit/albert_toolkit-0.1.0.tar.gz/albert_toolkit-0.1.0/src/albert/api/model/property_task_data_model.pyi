...
class PropertyTaskDataModel(
        ...
        class properties:
            ...
            class data(
                        ...
                        class MetaOapg:
                            ...
                            class properties:
                                ...
                                class modelVersion(
                                    ...
                                    pass
                                propertyDataColumnId = schemas.IntSchema
                ...
                def __getitem__(self, i: int) -> MetaOapg.items:
                    return super().__getitem__(i)
            __annotations__ = {
                "propertyDataColumnIds": propertyDataColumnIds,
                "data": data,
            }
    
    propertyDataColumnIds: MetaOapg.properties.propertyDataColumnIds
    data: MetaOapg.properties.data
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["propertyDataColumnIds"]) -> MetaOapg.properties.propertyDataColumnIds: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["propertyDataColumnIds", "data", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["propertyDataColumnIds"]) -> MetaOapg.properties.propertyDataColumnIds: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["propertyDataColumnIds", "data", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        propertyDataColumnIds: typing.Union[MetaOapg.properties.propertyDataColumnIds, list, tuple, ],
        data: typing.Union[MetaOapg.properties.data, list, tuple, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PropertyTaskDataModel':
        return super().__new__(
            cls,
            *_args,
            propertyDataColumnIds=propertyDataColumnIds,
