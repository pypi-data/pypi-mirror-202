...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = MergedDAC


request_body_merged_dac = api_client.RequestBody(
    content={
...
SchemaFor204ResponseBodyApplicationJsonCharsetutf8 = PredictionModels
...
class BaseApi(api_client.Api):
    @typing.overload
    def _parent_dac_bulk_update_oapg(
        self,
    ...
    def _parent_dac_bulk_update_oapg(
        ...
        """
        For updating parent DAT using child DAT.
        ...
        if body is not schemas.unset:
            serialized_data = request_body_merged_dac.serialize(body, content_type)
...
class ParentDacBulkUpdate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def parent_dac_bulk_update(
        self,
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonCharsetutf8, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def parent_dac_bulk_update(
        ...
        return self._parent_dac_bulk_update_oapg(
            body=body,
