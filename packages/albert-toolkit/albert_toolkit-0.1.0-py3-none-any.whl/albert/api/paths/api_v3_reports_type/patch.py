...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = PatchTypes


request_body_patch_types = api_client.RequestBody(
    content={
...
SchemaFor206ResponseBodyApplicationJsonCharsetutf8 = PartialSuccess1
...
class BaseApi(api_client.Api):
    ...
    def _patch_report_type_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patch_types.serialize(body, content_type)
...
class PatchReportType(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_report_type(
        self,
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonCharsetutf8, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def patch_report_type(
        ...
        return self._patch_report_type_oapg(
            body=body,
