...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = MergedInventory


request_body_merged_inventory = api_client.RequestBody(
    content={
...
SchemaFor204ResponseBodyApplicationJsonCharsetutf8 = ProductDesign
...
class ApiResponseFor204(api_client.ApiResponse):
    ...
    body: typing.Union[
        SchemaFor204ResponseBodyApplicationJsonCharsetutf8,
    ]
...
_response_for_204 = api_client.OpenApiResponse(
    ...
    content={
        'application/json; charset=utf-8': api_client.MediaType(
            schema=SchemaFor204ResponseBodyApplicationJsonCharsetutf8),
    },
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _parent_inventories_bulk_update_oapg(
        self,
    ...
    def _parent_inventories_bulk_update_oapg(
        ...
        """
        For updating parent inventories for PDs using child inventories.
        ...
        if body is not schemas.unset:
            serialized_data = request_body_merged_inventory.serialize(body, content_type)
...
class ParentInventoriesBulkUpdate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def parent_inventories_bulk_update(
        self,
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonCharsetutf8, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def parent_inventories_bulk_update(
        ...
        return self._parent_inventories_bulk_update_oapg(
            body=body,
