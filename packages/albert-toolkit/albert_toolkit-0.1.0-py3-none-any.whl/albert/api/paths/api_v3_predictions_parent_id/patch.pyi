...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = PatchPrediction


request_body_patch_prediction = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_predictions_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patch_prediction.serialize(body, content_type)
...
class PatchPredictions(BaseApi):
    ...
    def patch_predictions(
        ...
        return self._patch_predictions_oapg(
            body=body,
