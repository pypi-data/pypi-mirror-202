...
request_body_model_prediction = api_client.RequestBody(
    content={
...
SchemaFor206ResponseBodyApplicationJsonCharsetutf8 = PartialSuccessPost
...
class BaseApi(api_client.Api):
    ...
    def _post_predictions_oapg(
        ...
        """
        For creating a new prediction in dynamodb.
        ...
        if body is not schemas.unset:
            serialized_data = request_body_model_prediction.serialize(body, content_type)
...
class PostPredictions(BaseApi):
    ...
    def post_predictions(
        ...
        return self._post_predictions_oapg(
            body=body,
