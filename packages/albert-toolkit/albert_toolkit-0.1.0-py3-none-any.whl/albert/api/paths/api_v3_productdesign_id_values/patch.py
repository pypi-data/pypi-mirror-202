...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = Values


request_body_values = api_client.RequestBody(
    content={
...
SchemaFor206ResponseBodyApplicationJsonCharsetutf8 = PartialSuccess
...
class BaseApi(api_client.Api):
    ...
    def _patch_pd_cell_value_oapg(
        ...
        """
        For updating values of a cell in a ProductDesign.
        ...
        if body is not schemas.unset:
            serialized_data = request_body_values.serialize(body, content_type)
...
class PatchPdCellValue(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_pd_cell_value(
        self,
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonCharsetutf8, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def patch_pd_cell_value(
        ...
        return self._patch_pd_cell_value_oapg(
            body=body,
