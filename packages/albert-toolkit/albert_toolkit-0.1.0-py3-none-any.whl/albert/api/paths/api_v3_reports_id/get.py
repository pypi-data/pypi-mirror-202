...
# Query params
ViewReportSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'viewReport': typing.Union[ViewReportSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_view_report = api_client.QueryParameter(
    name="viewReport",
...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = Report
...
class BaseApi(api_client.Api):
    ...
    def _get_report_by_id_oapg(
        ...
        """
        For fetching a particular report info
...
class GetReportById(BaseApi):
    ...
    def get_report_by_id(
        ...
        return self._get_report_by_id_oapg(
