...
# body param
SchemaForRequestBodyApplicationJson = Patch


request_body_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _patch_location_by_id_oapg(
        self,
    ...
    def _patch_location_by_id_oapg(
        ...
        """
        For updating specific value of a location
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patch.serialize(body, content_type)
...
class PatchLocationById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_location_by_id(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def patch_location_by_id(
        ...
        return self._patch_location_by_id_oapg(
            body=body,
