...
class FacetWithValueArray(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "type", "parameter", "Value", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "type", "parameter", "Value", ], str]):
        return super().get_item_oapg(name)
