...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = DenormalizedInventories
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_inventories_back_update_oapg(
        self,
...
class GetInventoriesBackUpdate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_inventories_back_update(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_inventories_back_update(
        ...
        return self._get_inventories_back_update_oapg(
