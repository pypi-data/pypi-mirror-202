...
class SchemaForRequestBodyApplicationJsonCharsetutf8(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['DenormalizedInventory']:
            return DenormalizedInventory

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['DenormalizedInventory'], typing.List['DenormalizedInventory']],
    ...
    def __getitem__(self, i: int) -> 'DenormalizedInventory':
        return super().__getitem__(i)


request_body_denormalized_inventory = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _put_inventories_back_update_oapg(
        self,
    ...
    def _put_inventories_back_update_oapg(
        ...
        """
        For updating list inventories denormalized name.
        ...
        if body is not schemas.unset:
            serialized_data = request_body_denormalized_inventory.serialize(body, content_type)
...
class PutInventoriesBackUpdate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def put_inventories_back_update(
        self,
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonCharsetutf8, list, tuple, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def put_inventories_back_update(
        ...
        return self._put_inventories_back_update_oapg(
            body=body,
