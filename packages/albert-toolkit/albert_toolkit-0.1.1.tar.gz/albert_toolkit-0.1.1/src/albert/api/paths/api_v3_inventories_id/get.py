...
SchemaFor200ResponseBodyApplicationJson = Inventory
...
class GetInventoryById(BaseApi):
    ...
    def get_inventory_by_id(
        ...
        return self._get_inventory_by_id_oapg(
