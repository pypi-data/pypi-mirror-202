...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = ReportType


request_body_report_type = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJsonCharsetutf8 = ReportTypeList
...
class BaseApi(api_client.Api):
    ...
    def _post_report_type_oapg(
        ...
        """
        For creating one or multiple Report Types
        ...
        if body is not schemas.unset:
            serialized_data = request_body_report_type.serialize(body, content_type)
...
class PostReportType(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_report_type(
        self,
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonCharsetutf8, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def post_report_type(
        ...
        return self._post_report_type_oapg(
            body=body,
