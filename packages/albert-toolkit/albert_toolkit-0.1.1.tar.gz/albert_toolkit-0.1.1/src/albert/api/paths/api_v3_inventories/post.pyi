...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Inventory']:
            return Inventory

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['Inventory'], typing.List['Inventory']],
    ...
    def __getitem__(self, i: int) -> 'Inventory':
        return super().__getitem__(i)


request_body_inventory = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_inventory_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_inventory.serialize(body, content_type)
...
class PostInventory(BaseApi):
    ...
    def post_inventory(
        ...
        return self._post_inventory_oapg(
            body=body,
