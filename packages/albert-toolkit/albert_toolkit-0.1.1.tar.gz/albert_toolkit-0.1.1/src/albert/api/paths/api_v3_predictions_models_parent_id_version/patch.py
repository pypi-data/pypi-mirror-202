...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = ModelPatch


request_body_model_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_models_oapg(
        ...
        """
        For updating attributes within a particular version under a model id
        ...
        if body is not schemas.unset:
            serialized_data = request_body_model_patch.serialize(body, content_type)
...
class PatchModels(BaseApi):
    ...
    def patch_models(
        ...
        return self._patch_models_oapg(
            body=body,
