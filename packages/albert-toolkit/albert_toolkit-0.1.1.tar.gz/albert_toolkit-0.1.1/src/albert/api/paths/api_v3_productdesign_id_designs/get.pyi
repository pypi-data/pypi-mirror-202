...
class StartKeySchema(
    ...
    pass
UnusedSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'unused': typing.Union[UnusedSchema, bool, ],
    },
    total=False
)
...
request_query_unused = api_client.QueryParameter(
    name="unused",
    style=api_client.ParameterStyle.FORM,
    schema=UnusedSchema,
    explode=True,
...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = PDRows
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_pd_rows_id_by_des_id_oapg(
        self,
    ...
    def _get_pd_rows_id_by_des_id_oapg(
        ...
        """
        For fetching rows in a ProductDesign.
...
class GetPdRowsIdByDesId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_pd_rows_id_by_des_id(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_pd_rows_id_by_des_id(
        ...
        return self._get_pd_rows_id_by_des_id_oapg(
