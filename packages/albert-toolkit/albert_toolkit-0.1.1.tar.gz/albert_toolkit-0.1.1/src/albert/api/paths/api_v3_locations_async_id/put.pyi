...
# body param
SchemaForRequestBodyApplicationJson = PutBackUpdateCompanies


request_body_put_back_update_companies = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _put_loc_back_update_oapg(
        ...
        """
        Update Location denormalized name.
        ...
        if body is not schemas.unset:
            serialized_data = request_body_put_back_update_companies.serialize(body, content_type)
...
class PutLocBackUpdate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def put_loc_back_update(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def put_loc_back_update(
        ...
        return self._put_loc_back_update_oapg(
            body=body,
