...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = Equipment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _report_inventory_equipment_usage_oapg(
        self,
    ...
    def _report_inventory_equipment_usage_oapg(
        ...
        """
        For showing inventory equipment usage
...
class ReportInventoryEquipmentUsage(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def report_inventory_equipment_usage(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def report_inventory_equipment_usage(
        ...
        return self._report_inventory_equipment_usage_oapg(
