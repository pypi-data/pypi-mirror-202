...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = ProductDesign
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_product_design_by_id_oapg(
        self,
    ...
    def _get_product_design_by_id_oapg(
        ...
        """
        For fetching a Productdesign info.
...
class GetProductDesignById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_product_design_by_id(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_product_design_by_id(
        ...
        return self._get_product_design_by_id_oapg(
