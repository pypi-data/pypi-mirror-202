...
SchemaFor200ResponseBodyApplicationJson = GetBackUpdateCompanies
...
class BaseApi(api_client.Api):
    ...
    def _get_loc_back_update_oapg(
        ...
        """
        Fetching list of Locations subrecords for name backupdate.
...
class GetLocBackUpdate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_loc_back_update(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_loc_back_update(
        ...
        return self._get_loc_back_update_oapg(
