...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = CopyReport


request_body_copy_report = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJsonCharsetutf8 = Report
...
class BaseApi(api_client.Api):
    ...
    def _copy_report_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_copy_report.serialize(body, content_type)
