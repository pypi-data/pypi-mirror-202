...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = ReportSearchResult
...
class SearchReports(BaseApi):
    ...
    def search_reports(
        ...
        return self._search_reports_oapg(
