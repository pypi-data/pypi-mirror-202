...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = ProductDesign


request_body_product_design = api_client.RequestBody(
    content={
        'application/json; charset=utf-8': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJsonCharsetutf8),
    },
)
SchemaFor201ResponseBodyApplicationJsonCharsetutf8 = ProductDesign
...
class BaseApi(api_client.Api):
    ...
    def _post_product_design_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_product_design.serialize(body, content_type)
...
class PostProductDesign(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def post_product_design(
        self,
        content_type: typing_extensions.Literal["application/json; charset=utf-8"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJsonCharsetutf8, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def post_product_design(
        ...
        return self._post_product_design_oapg(
            body=body,
