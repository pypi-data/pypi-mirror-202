...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = ProductDesigns
...
class BaseApi(api_client.Api):
    ...
    def _get_product_designs_oapg(
        ...
        """
        For fetching list of ProductDesign.
...
class GetProductDesigns(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_product_designs(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_product_designs(
        ...
        return self._get_product_designs_oapg(
