...
class ApiClient(object):
    ...
    def return_all_jobs(self, organization, order_by, order, system, removed, filter_text, job_search_operation,
                        job_search_text,
                        job_status, job_label, edge, offset, len, executor_type, archived=False, job_tag=None,
                        job_template=None,
        ...
        Args:
            ...
            system (:obj:`bool`).
            filter_text (:obj:`str`).
            job_search_operation (:obj:`str`).
            job_search_text (:obj:`str`).
            job_status (:obj:`str`).
            job_label (:obj:`str`).
            edge (:obj:`bool`).
            offset (:obj:`str`).
