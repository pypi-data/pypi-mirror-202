...
import six
from cythereal_magic.models.file_reputation import FileReputation  # noqa: F401,E501

class AllOfFileReputation(FileReputation):
    ...
    if hasattr(FileReputation, "swagger_types"):
        swagger_types.update(FileReputation.swagger_types)

    attribute_map = {
    }
    if hasattr(FileReputation, "attribute_map"):
        attribute_map.update(FileReputation.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileReputation - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileReputation.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileReputation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileReputation):
            return False
