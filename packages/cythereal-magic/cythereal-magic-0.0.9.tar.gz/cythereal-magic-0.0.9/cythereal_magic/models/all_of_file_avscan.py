...
import six
from cythereal_magic.models.file_avscan import FileAvscan  # noqa: F401,E501

class AllOfFileAvscan(FileAvscan):
    ...
    if hasattr(FileAvscan, "swagger_types"):
        swagger_types.update(FileAvscan.swagger_types)

    attribute_map = {
    }
    if hasattr(FileAvscan, "attribute_map"):
        attribute_map.update(FileAvscan.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileAvscan - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileAvscan.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileAvscan, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileAvscan):
            return False
