...
class File(object):
    ...
    swagger_types = {
        ...
        'genomics': 'AllOfFileGenomics',
        'unpacked_genomics': 'AllOfFileUnpackedGenomics',
        'similarities': 'AllOfFileSimilarities'
    }
    ...
    def __init__(self, public=None, sha1=None, md5=None, sha256=None, sha512=None, filetype=None, object_class=None, filenames=None, create_time=None, match_count=None, upload_time=None, upload_times=None, children=None, parents=None, owned=None, notes=None, tags=None, status=None, pipeline=None, campaign=None, matches=None, av_names=None, scanner_count=None, detection_count=None, evasiveness=None, scan_date=None, token_list=None, threat=None, labels=None, unmapped=None, category=None, categories=None, family=None, families=None, avscan=None, indicators=None, reputation=None, yara=None, procedures=None, unpacked_procedures=None, genomics=None, unpacked_genomics=None, similarities=None):  # noqa: E501
    ...
    def unpacked_genomics(self):
        ...
        :rtype: AllOfFileUnpackedGenomics
        """
    ...
    def unpacked_genomics(self, unpacked_genomics):
        ...
        :type: AllOfFileUnpackedGenomics
        """
