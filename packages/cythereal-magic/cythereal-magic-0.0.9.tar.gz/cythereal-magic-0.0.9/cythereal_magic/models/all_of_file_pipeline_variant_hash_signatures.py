...
class AllOfFilePipelineVariantHashSignatures(PipelineStatusEnum):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFilePipelineVariantHashSignatures - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFilePipelineVariantHashSignatures, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFilePipelineVariantHashSignatures):
            return False
