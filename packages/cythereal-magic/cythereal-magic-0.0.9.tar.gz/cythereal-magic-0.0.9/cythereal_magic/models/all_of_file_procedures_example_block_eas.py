...
import six
from cythereal_magic.models.file_procedure_block import FileProcedureBlock  # noqa: F401,E501

class AllOfFileProceduresExampleBlockEas(FileProcedureBlock):
    ...
    if hasattr(FileProcedureBlock, "swagger_types"):
        swagger_types.update(FileProcedureBlock.swagger_types)

    attribute_map = {
    }
    if hasattr(FileProcedureBlock, "attribute_map"):
        attribute_map.update(FileProcedureBlock.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileProceduresExampleBlockEas - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileProcedureBlock.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileProceduresExampleBlockEas, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileProceduresExampleBlockEas):
            return False
