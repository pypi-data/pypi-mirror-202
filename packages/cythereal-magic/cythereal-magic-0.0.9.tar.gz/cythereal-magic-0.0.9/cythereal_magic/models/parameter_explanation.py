...
class ParameterExplanation(object):
    ...
    def __init__(self, variable='Information about the parameter and how to use it'):  # noqa: E501
        """ParameterExplanation - a model defined in Swagger"""  # noqa: E501
        self._variable = None
    ...
    @property
    def variable(self):
        """Gets the variable of this ParameterExplanation.  # noqa: E501


        :return: The variable of this ParameterExplanation.  # noqa: E501
        :rtype: str
        """
    ...
    def variable(self, variable):
        """Sets the variable of this ParameterExplanation.


        :param variable: The variable of this ParameterExplanation.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ParameterExplanation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ParameterExplanation):
            return False
