...
import six
from cythereal_magic.models.file_genomics import FileGenomics  # noqa: F401,E501

class AllOfFileUnpackedGenomics(FileGenomics):
    ...
    if hasattr(FileGenomics, "swagger_types"):
        swagger_types.update(FileGenomics.swagger_types)

    attribute_map = {
    }
    if hasattr(FileGenomics, "attribute_map"):
        attribute_map.update(FileGenomics.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileUnpackedGenomics - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileGenomics.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileUnpackedGenomics, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileUnpackedGenomics):
            return False
