...
import six
from cythereal_magic.models.file_campaign import FileCampaign  # noqa: F401,E501

class AllOfFileCampaign(FileCampaign):
    ...
    if hasattr(FileCampaign, "swagger_types"):
        swagger_types.update(FileCampaign.swagger_types)

    attribute_map = {
    }
    if hasattr(FileCampaign, "attribute_map"):
        attribute_map.update(FileCampaign.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileCampaign - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileCampaign.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileCampaign, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileCampaign):
            return False
