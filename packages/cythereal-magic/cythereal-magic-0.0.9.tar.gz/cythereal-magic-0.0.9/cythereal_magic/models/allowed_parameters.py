...
class AllowedParameters(object):
    ...
    swagger_types = {
        ...
        'explain': 'bool',
        'download': 'bool',
        'read_mask': 'list[object]',
        'expand_mask': 'list[object]',
        'dynamic_mask': 'list[object]',
        'order_by': 'list[object]',
        'update_mask': 'list[object]',
        'filters': 'Filter'
    }
    ...
    def __init__(self, format=None, explain=True, download=False, read_mask=None, expand_mask=None, dynamic_mask=None, order_by=None, update_mask=None, filters=None):  # noqa: E501
        """AllowedParameters - a model defined in Swagger"""  # noqa: E501
        self._format = None
        self._explain = None
        self._download = None
        self._read_mask = None
        self._expand_mask = None
    ...
    @property
    def format(self):
        """Gets the format of this AllowedParameters.  # noqa: E501


        :return: The format of this AllowedParameters.  # noqa: E501
        :rtype: list[object]
        """
        return self._format
    ...
    def format(self, format):
        """Sets the format of this AllowedParameters.


        :param format: The format of this AllowedParameters.  # noqa: E501
        :type: list[object]
        """
    ...
    @property
    def explain(self):
        """Gets the explain of this AllowedParameters.  # noqa: E501


        :return: The explain of this AllowedParameters.  # noqa: E501
        :rtype: bool
        """
    ...
    def explain(self, explain):
        """Sets the explain of this AllowedParameters.


        :param explain: The explain of this AllowedParameters.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def download(self):
        """Gets the download of this AllowedParameters.  # noqa: E501


        :return: The download of this AllowedParameters.  # noqa: E501
        :rtype: bool
        """
    ...
    def download(self, download):
        """Sets the download of this AllowedParameters.


        :param download: The download of this AllowedParameters.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def read_mask(self):
        """Gets the read_mask of this AllowedParameters.  # noqa: E501


        :return: The read_mask of this AllowedParameters.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def read_mask(self, read_mask):
        """Sets the read_mask of this AllowedParameters.


        :param read_mask: The read_mask of this AllowedParameters.  # noqa: E501
        :type: list[object]
        """
    ...
    def expand_mask(self):
        """Gets the expand_mask of this AllowedParameters.  # noqa: E501


        :return: The expand_mask of this AllowedParameters.  # noqa: E501
        :rtype: list[object]
        """
        return self._expand_mask

    @expand_mask.setter
    def expand_mask(self, expand_mask):
        """Sets the expand_mask of this AllowedParameters.


        :param expand_mask: The expand_mask of this AllowedParameters.  # noqa: E501
        :type: list[object]
        """

        self._expand_mask = expand_mask

    @property
    def dynamic_mask(self):
        """Gets the dynamic_mask of this AllowedParameters.  # noqa: E501


        :return: The dynamic_mask of this AllowedParameters.  # noqa: E501
        :rtype: list[object]
        """
        return self._dynamic_mask

    @dynamic_mask.setter
    def dynamic_mask(self, dynamic_mask):
        """Sets the dynamic_mask of this AllowedParameters.


        :param dynamic_mask: The dynamic_mask of this AllowedParameters.  # noqa: E501
        :type: list[object]
        """
    ...
    @property
    def order_by(self):
        """Gets the order_by of this AllowedParameters.  # noqa: E501


        :return: The order_by of this AllowedParameters.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def order_by(self, order_by):
        """Sets the order_by of this AllowedParameters.


        :param order_by: The order_by of this AllowedParameters.  # noqa: E501
        :type: list[object]
        """
    ...
    def update_mask(self):
        """Gets the update_mask of this AllowedParameters.  # noqa: E501


        :return: The update_mask of this AllowedParameters.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def update_mask(self, update_mask):
        """Sets the update_mask of this AllowedParameters.


        :param update_mask: The update_mask of this AllowedParameters.  # noqa: E501
        :type: list[object]
        """
    ...
    @property
    def filters(self):
        """Gets the filters of this AllowedParameters.  # noqa: E501


        :return: The filters of this AllowedParameters.  # noqa: E501
        :rtype: Filter
        """
    ...
    def filters(self, filters):
        """Sets the filters of this AllowedParameters.


        :param filters: The filters of this AllowedParameters.  # noqa: E501
        :type: Filter
        """
        if filters is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllowedParameters, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllowedParameters):
            return False
