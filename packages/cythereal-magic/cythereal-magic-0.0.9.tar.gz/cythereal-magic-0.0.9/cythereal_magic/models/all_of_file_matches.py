...
import six
from cythereal_magic.models.file_match import FileMatch  # noqa: F401,E501

class AllOfFileMatches(FileMatch):
    ...
    if hasattr(FileMatch, "swagger_types"):
        swagger_types.update(FileMatch.swagger_types)

    attribute_map = {
    }
    if hasattr(FileMatch, "attribute_map"):
        attribute_map.update(FileMatch.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileMatches - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileMatch.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileMatches, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileMatches):
            return False
