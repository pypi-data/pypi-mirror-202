...
class FileReputation(object):
    ...
    """
    swagger_types = {
        'reputation': 'AllOfFileReputationReputation',
        'reputation_data': 'list[DirectReputation]',
        'inferred_reputation': 'AllOfFileReputationInferredReputation',
        'inferred_checked_criteria': 'list[InferredReputation]'
    }

    attribute_map = {
        'reputation': 'reputation',
        'reputation_data': 'reputation_data',
        'inferred_reputation': 'inferred_reputation',
        'inferred_checked_criteria': 'inferred_checked_criteria'
    }

    def __init__(self, reputation=None, reputation_data=None, inferred_reputation=None, inferred_checked_criteria=None):  # noqa: E501
        """FileReputation - a model defined in Swagger"""  # noqa: E501
        self._reputation = None
        self._reputation_data = None
        self._inferred_reputation = None
        self._inferred_checked_criteria = None
        self.discriminator = None
        if reputation is not None:
            self.reputation = reputation
        if reputation_data is not None:
            self.reputation_data = reputation_data
        if inferred_reputation is not None:
            self.inferred_reputation = inferred_reputation
        if inferred_checked_criteria is not None:
            self.inferred_checked_criteria = inferred_checked_criteria

    @property
    def reputation(self):
        """Gets the reputation of this FileReputation.  # noqa: E501


        :return: The reputation of this FileReputation.  # noqa: E501
        :rtype: AllOfFileReputationReputation
        """
        return self._reputation

    @reputation.setter
    def reputation(self, reputation):
        """Sets the reputation of this FileReputation.


        :param reputation: The reputation of this FileReputation.  # noqa: E501
        :type: AllOfFileReputationReputation
        """
    ...
    def reputation_data(self):
        """Gets the reputation_data of this FileReputation.  # noqa: E501


        :return: The reputation_data of this FileReputation.  # noqa: E501
        :rtype: list[DirectReputation]
        """
        return self._reputation_data

    @reputation_data.setter
    def reputation_data(self, reputation_data):
        """Sets the reputation_data of this FileReputation.


        :param reputation_data: The reputation_data of this FileReputation.  # noqa: E501
        :type: list[DirectReputation]
        """

        self._reputation_data = reputation_data

    @property
    def inferred_reputation(self):
        """Gets the inferred_reputation of this FileReputation.  # noqa: E501


        :return: The inferred_reputation of this FileReputation.  # noqa: E501
        :rtype: AllOfFileReputationInferredReputation
        """
        return self._inferred_reputation

    @inferred_reputation.setter
    def inferred_reputation(self, inferred_reputation):
        """Sets the inferred_reputation of this FileReputation.


        :param inferred_reputation: The inferred_reputation of this FileReputation.  # noqa: E501
        :type: AllOfFileReputationInferredReputation
        """

        self._inferred_reputation = inferred_reputation

    @property
    def inferred_checked_criteria(self):
        """Gets the inferred_checked_criteria of this FileReputation.  # noqa: E501


        :return: The inferred_checked_criteria of this FileReputation.  # noqa: E501
        :rtype: list[InferredReputation]
        """
        return self._inferred_checked_criteria

    @inferred_checked_criteria.setter
    def inferred_checked_criteria(self, inferred_checked_criteria):
        """Sets the inferred_checked_criteria of this FileReputation.


        :param inferred_checked_criteria: The inferred_checked_criteria of this FileReputation.  # noqa: E501
        :type: list[InferredReputation]
        """

        self._inferred_checked_criteria = inferred_checked_criteria
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FileReputation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileReputation):
            return False
