...
class PatchedTagRequest(object):
    ...
    def __init__(self, name=None, color='#329db6'):  # noqa: E501
        """PatchedTagRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._color = None
    ...
    @property
    def name(self):
        """Gets the name of this PatchedTagRequest.  # noqa: E501


        :return: The name of this PatchedTagRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PatchedTagRequest.


        :param name: The name of this PatchedTagRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def color(self):
        """Gets the color of this PatchedTagRequest.  # noqa: E501


        :return: The color of this PatchedTagRequest.  # noqa: E501
        :rtype: str
        """
        return self._color
    ...
    def color(self, color):
        """Sets the color of this PatchedTagRequest.


        :param color: The color of this PatchedTagRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchedTagRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchedTagRequest):
            return False
