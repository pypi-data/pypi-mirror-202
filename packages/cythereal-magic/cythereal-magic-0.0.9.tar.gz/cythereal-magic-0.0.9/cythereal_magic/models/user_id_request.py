...
class UserIdRequest(object):
    ...
    def __init__(self, id=None):  # noqa: E501
        """UserIdRequest - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this UserIdRequest.  # noqa: E501


        :return: The id of this UserIdRequest.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UserIdRequest.


        :param id: The id of this UserIdRequest.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserIdRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserIdRequest):
            return False
