...
import six
from cythereal_magic.models.match_type_enum import MatchTypeEnum  # noqa: F401,E501

class AllOfFileMatchMatchType(MatchTypeEnum):
    ...
    if hasattr(MatchTypeEnum, "swagger_types"):
        swagger_types.update(MatchTypeEnum.swagger_types)

    attribute_map = {
    }
    if hasattr(MatchTypeEnum, "attribute_map"):
        attribute_map.update(MatchTypeEnum.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileMatchMatchType - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        MatchTypeEnum.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileMatchMatchType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileMatchMatchType):
            return False
