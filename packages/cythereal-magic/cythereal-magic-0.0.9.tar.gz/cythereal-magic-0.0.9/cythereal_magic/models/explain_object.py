...
class ExplainObject(object):
    ...
    swagger_types = {
        ...
        'query_parameters': 'ParameterExplanation',
        'body_parameters': 'ParameterExplanation'
    }
    ...
    def __init__(self, version=None, method=None, endpoint='/v2/swagger/', documentation='https://api.magic.cythereal.com/<api>/swagger/#<doc_path>', allowed_parameters=None, query_parameters=None, body_parameters=None):  # noqa: E501
        """ExplainObject - a model defined in Swagger"""  # noqa: E501
        self._version = None
        self._method = None
        self._endpoint = None
    ...
    @property
    def version(self):
        """Gets the version of this ExplainObject.  # noqa: E501


        :return: The version of this ExplainObject.  # noqa: E501
        :rtype: VersionEnum
        """
    ...
    def version(self, version):
        """Sets the version of this ExplainObject.


        :param version: The version of this ExplainObject.  # noqa: E501
        :type: VersionEnum
        """
        if version is None:
    ...
    @property
    def method(self):
        """Gets the method of this ExplainObject.  # noqa: E501


        :return: The method of this ExplainObject.  # noqa: E501
        :rtype: MethodEnum
        """
        return self._method
    ...
    def method(self, method):
        """Sets the method of this ExplainObject.


        :param method: The method of this ExplainObject.  # noqa: E501
        :type: MethodEnum
        """
        if method is None:
    ...
    @property
    def endpoint(self):
        """Gets the endpoint of this ExplainObject.  # noqa: E501


        :return: The endpoint of this ExplainObject.  # noqa: E501
        :rtype: str
        """
    ...
    def endpoint(self, endpoint):
        """Sets the endpoint of this ExplainObject.


        :param endpoint: The endpoint of this ExplainObject.  # noqa: E501
        :type: str
        """
    ...
    def documentation(self):
        """Gets the documentation of this ExplainObject.  # noqa: E501


        :return: The documentation of this ExplainObject.  # noqa: E501
        :rtype: str
        """
    ...
    def documentation(self, documentation):
        """Sets the documentation of this ExplainObject.


        :param documentation: The documentation of this ExplainObject.  # noqa: E501
        :type: str
        """
    ...
    def allowed_parameters(self):
        """Gets the allowed_parameters of this ExplainObject.  # noqa: E501


        :return: The allowed_parameters of this ExplainObject.  # noqa: E501
        :rtype: AllowedParameters
        """
        return self._allowed_parameters

    @allowed_parameters.setter
    def allowed_parameters(self, allowed_parameters):
        """Sets the allowed_parameters of this ExplainObject.


        :param allowed_parameters: The allowed_parameters of this ExplainObject.  # noqa: E501
        :type: AllowedParameters
        """
        if allowed_parameters is None:
            raise ValueError("Invalid value for `allowed_parameters`, must not be `None`")  # noqa: E501

        self._allowed_parameters = allowed_parameters

    @property
    def query_parameters(self):
        """Gets the query_parameters of this ExplainObject.  # noqa: E501


        :return: The query_parameters of this ExplainObject.  # noqa: E501
        :rtype: ParameterExplanation
        """
        return self._query_parameters

    @query_parameters.setter
    def query_parameters(self, query_parameters):
        """Sets the query_parameters of this ExplainObject.


        :param query_parameters: The query_parameters of this ExplainObject.  # noqa: E501
    ...
    def body_parameters(self):
        """Gets the body_parameters of this ExplainObject.  # noqa: E501


        :return: The body_parameters of this ExplainObject.  # noqa: E501
        :rtype: ParameterExplanation
        """
    ...
    def body_parameters(self, body_parameters):
        """Sets the body_parameters of this ExplainObject.


        :param body_parameters: The body_parameters of this ExplainObject.  # noqa: E501
        :type: ParameterExplanation
        """
        if body_parameters is None:
            raise ValueError("Invalid value for `body_parameters`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ExplainObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExplainObject):
            return False
