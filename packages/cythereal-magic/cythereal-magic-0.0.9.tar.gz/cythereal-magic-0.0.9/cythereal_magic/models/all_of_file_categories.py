...
import six
from cythereal_magic.models.file_labels import FileLabels  # noqa: F401,E501

class AllOfFileCategories(FileLabels):
    ...
    if hasattr(FileLabels, "swagger_types"):
        swagger_types.update(FileLabels.swagger_types)

    attribute_map = {
    }
    if hasattr(FileLabels, "attribute_map"):
        attribute_map.update(FileLabels.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileCategories - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileLabels.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileCategories, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileCategories):
            return False
