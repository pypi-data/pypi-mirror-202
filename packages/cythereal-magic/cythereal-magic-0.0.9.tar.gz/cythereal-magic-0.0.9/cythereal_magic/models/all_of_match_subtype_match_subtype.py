...
import six
from cythereal_magic.models.match_subtype_enum import MatchSubtypeEnum  # noqa: F401,E501

class AllOfMatchSubtypeMatchSubtype(MatchSubtypeEnum):
    ...
    if hasattr(MatchSubtypeEnum, "swagger_types"):
        swagger_types.update(MatchSubtypeEnum.swagger_types)

    attribute_map = {
    }
    if hasattr(MatchSubtypeEnum, "attribute_map"):
        attribute_map.update(MatchSubtypeEnum.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfMatchSubtypeMatchSubtype - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        MatchSubtypeEnum.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfMatchSubtypeMatchSubtype, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfMatchSubtypeMatchSubtype):
            return False
