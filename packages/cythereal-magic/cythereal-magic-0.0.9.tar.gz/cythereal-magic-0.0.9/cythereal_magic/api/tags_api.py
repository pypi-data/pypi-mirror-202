...
class TagsApi(object):
    ...
    def bulk_tag_operation_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['color2', 'color', 'explain', 'format', 'download', 'filename', 'no_links', 'uri', 'action', 'force', 'read_mask', 'update_mask']  # noqa: E501
    ...
    def bulk_tag_operation_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'explain', 'format', 'download', 'filename', 'no_links', 'uri', 'action', 'force', 'read_mask', 'update_mask']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def create_tag_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['name2', 'color2', 'name', 'color', 'explain', 'format', 'download', 'filename', 'no_links', 'uri']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TagObjectResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def delete_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'no_links', 'uri', 'force', 'filters', 'order_by', 'page_count', 'page_size', 'skip_count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'no_links', 'uri', 'filters', 'order_by', 'read_mask', 'page_count', 'page_size', 'skip_count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[TagListResponse]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_tag_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'name2', 'color2', 'name', 'color', 'explain', 'format', 'download', 'filename', 'no_links', 'uri', 'update_mask']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['color2', 'color', 'explain', 'format', 'download', 'filename', 'no_links', 'uri', 'update_mask', 'filters', 'order_by', 'page_count', 'page_size', 'skip_count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'explain', 'format', 'download', 'filename', 'no_links', 'uri', 'update_mask', 'filters', 'order_by', 'page_count', 'page_size', 'skip_count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
