...
class YaraApi(object):
    ...
    def create_yara(self, files2, name2, unpacked2, config2, include_all2, files, name, unpacked, config, include_all, **kwargs):  # noqa: E501
        """Create Yara Rule based on specific file hashes  # noqa: E501

           Create Yara Rule based on specific file hashes           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_yara(files2, name2, unpacked2, config2, include_all2, files, name, unpacked, config, include_all, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[str] files2: (required)
        :param str name2: (required)
        :param bool unpacked2: (required)
        :param object config2: (required)
        :param bool include_all2: (required)
        ...
        if kwargs.get('async_req'):
            return self.create_yara_with_http_info(files2, name2, unpacked2, config2, include_all2, files, name, unpacked, config, include_all, **kwargs)  # noqa: E501
        else:
            (data) = self.create_yara_with_http_info(files2, name2, unpacked2, config2, include_all2, files, name, unpacked, config, include_all, **kwargs)  # noqa: E501
            return data

    def create_yara_with_http_info(self, files2, name2, unpacked2, config2, include_all2, files, name, unpacked, config, include_all, **kwargs):  # noqa: E501
        """Create Yara Rule based on specific file hashes  # noqa: E501

           Create Yara Rule based on specific file hashes           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_yara_with_http_info(files2, name2, unpacked2, config2, include_all2, files, name, unpacked, config, include_all, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['files2', 'name2', 'unpacked2', 'config2', 'include_all2', 'files', 'name', 'unpacked', 'config', 'include_all', 'explain', 'format', 'download', 'filename', 'no_links', 'uri', 'strict']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'files2' is set
        if ('files2' not in params or
                params['files2'] is None):
            raise ValueError("Missing the required parameter `files2` when calling `create_yara`")  # noqa: E501
        # verify the required parameter 'name2' is set
        if ('name2' not in params or
                params['name2'] is None):
            raise ValueError("Missing the required parameter `name2` when calling `create_yara`")  # noqa: E501
        # verify the required parameter 'unpacked2' is set
        if ('unpacked2' not in params or
                params['unpacked2'] is None):
            raise ValueError("Missing the required parameter `unpacked2` when calling `create_yara`")  # noqa: E501
        # verify the required parameter 'config2' is set
        if ('config2' not in params or
                params['config2'] is None):
            raise ValueError("Missing the required parameter `config2` when calling `create_yara`")  # noqa: E501
        # verify the required parameter 'include_all2' is set
        if ('include_all2' not in params or
                params['include_all2'] is None):
            raise ValueError("Missing the required parameter `include_all2` when calling `create_yara`")  # noqa: E501
        # verify the required parameter 'files' is set
        if ('files' not in params or
                params['files'] is None):
            raise ValueError("Missing the required parameter `files` when calling `create_yara`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `create_yara`")  # noqa: E501
        # verify the required parameter 'unpacked' is set
        if ('unpacked' not in params or
                params['unpacked'] is None):
            raise ValueError("Missing the required parameter `unpacked` when calling `create_yara`")  # noqa: E501
        # verify the required parameter 'config' is set
        if ('config' not in params or
                params['config'] is None):
            raise ValueError("Missing the required parameter `config` when calling `create_yara`")  # noqa: E501
        # verify the required parameter 'include_all' is set
        if ('include_all' not in params or
                params['include_all'] is None):
            raise ValueError("Missing the required parameter `include_all` when calling `create_yara`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='YaraResponse',  # noqa: E501
    ...
    def create_yara(self, body, **kwargs):  # noqa: E501
        """Create Yara Rule based on specific file hashes  # noqa: E501

           Create Yara Rule based on specific file hashes           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_yara(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param YaraRequest body: (required)
        :param bool explain:  Shows the explain for this endpoint 
        :param str format:  Format of the response from this endpoint 
        :param bool download:  Determines whether to download the response. (Content-Disposition:\"attachment\" vs \"inline\") 
        :param str filename: If download is True, this sets the name of the file. (Content-Disposition:\"attachment; filename=`filename`\")
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_yara_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_yara_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_yara_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create Yara Rule based on specific file hashes  # noqa: E501

           Create Yara Rule based on specific file hashes           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_yara_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'explain', 'format', 'download', 'filename', 'no_links', 'uri', 'strict']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_yara`")  # noqa: E501
    ...
    def yara_procedure_matches_with_http_info(self, binary_id, **kwargs):  # noqa: E501
        ...
        all_params = ['binary_id', 'explain', 'format', 'download', 'filename', 'no_links', 'uri', 'read_mask', 'expand_mask']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
