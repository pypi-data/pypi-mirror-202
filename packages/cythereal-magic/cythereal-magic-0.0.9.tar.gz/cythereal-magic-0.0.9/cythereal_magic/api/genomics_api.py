...
class GenomicsApi(object):
    ...
    def compare_files(self, **kwargs):  # noqa: E501
        """Takes in a list of files and sends back comparison results (slow)  # noqa: E501

           Takes in a list of files and sends back comparison results (slow)           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.compare_files(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.compare_files_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.compare_files_with_http_info(**kwargs)  # noqa: E501
            return data

    def compare_files_with_http_info(self, **kwargs):  # noqa: E501
        """Takes in a list of files and sends back comparison results (slow)  # noqa: E501

           Takes in a list of files and sends back comparison results (slow)           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.compare_files_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'no_links', 'uri', 'unpacked', 'files']  # noqa: E501
