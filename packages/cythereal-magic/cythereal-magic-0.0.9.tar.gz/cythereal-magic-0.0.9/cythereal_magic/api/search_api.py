...
class SearchApi(object):
    ...
    def count_search_results(self, **kwargs):  # noqa: E501
        ...
        :param str query: Search query to look for
        :return: None
    ...
    def count_search_results_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'no_links', 'uri', 'query']  # noqa: E501
    ...
    def search_files(self, **kwargs):  # noqa: E501
        ...
        :param int page_size:
        :param bool search_exact: Whether an exact match is required in a search
        :param str search_query: Search query to look for
        :param str search_type: Value type with which to search
    ...
    def search_files_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'no_links', 'uri', 'page_count', 'page_size', 'search_exact', 'search_query', 'search_type', 'skip_count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
