...
class EmailsApi(object):
    ...
    def get_email(self, email_id, **kwargs):  # noqa: E501
        """Retrieves information for a single email  # noqa: E501
        ...
        :param object email_id: (required)
    ...
    def get_email_with_http_info(self, email_id, **kwargs):  # noqa: E501
        ...
        all_params = ['email_id', 'explain', 'format', 'download', 'filename', 'expand_mask', 'read_mask']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('email_id' not in params or
                                                       params['email_id'] is None):  # noqa: E501
