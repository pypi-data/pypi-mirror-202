...
class FilesApi(object):
    ...
    def add_payload(self, binary_id, payload_id, **kwargs):  # noqa: E501
        ...
        :param object download:  Determines whether to download the response. (Content-Disposition:\"attachment\" vs \"inline\") 
        :param object filename: If download is True, this sets the name of the file. (Content-Disposition:\"attachment; filename=`filename`\")
        :param object force: Forces a payload to be added, even if one already exists
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def create_file_job(self, binary_id, job, **kwargs):  # noqa: E501
        ...
        :param object download:  Determines whether to download the response. (Content-Disposition:\"attachment\" vs \"inline\") 
        :param object filename: If download is True, this sets the name of the file. (Content-Disposition:\"attachment; filename=`filename`\")
        :param object force: Forces a job to be run, even if previously successful
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_file_reputation(self, binary_id, **kwargs):  # noqa: E501
        ...
        :param object download:  Determines whether to download the response. (Content-Disposition:\"attachment\" vs \"inline\") 
        :param object filename: If download is True, this sets the name of the file. (Content-Disposition:\"attachment; filename=`filename`\")
        :param object verbose: Whether to include all files that infer reputation
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_file_yara(self, binary_id, **kwargs):  # noqa: E501
        ...
        :param object download:  Determines whether to download the response. (Content-Disposition:\"attachment\" vs \"inline\") 
        :param object filename: If download is True, this sets the name of the file. (Content-Disposition:\"attachment; filename=`filename`\")
        :param object config: The config of parameters to use when generating a yara rule
        :param object include_all: Whether to include all procedures
        :param object unpacked: Whether to use unpacked or original binaries
        :param object name: The name of the yara rule
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_file_genomics(self, binary_id, **kwargs):  # noqa: E501
        ...
        :param object download:  Determines whether to download the response. (Content-Disposition:\"attachment\" vs \"inline\") 
        :param object filename: If download is True, this sets the name of the file. (Content-Disposition:\"attachment; filename=`filename`\")
        :param object no_libs: Whether to include library procedures
        :param object page_count:
        :param object page_size:
        :param object skip_count:
        :return: None
    ...
    def list_file_similarities(self, binary_id, **kwargs):  # noqa: E501
        ...
        :param object filename: If download is True, this sets the name of the file. (Content-Disposition:\"attachment; filename=`filename`\")
        :param object max_threshold: Only similarity matches at value equal or below max_threshold will be considered
        :param object method: Method to use to find similarities
        :param object min_threshold: Only similarity matches at value equal or above min_threshold will be considered
        :param object page_count:
        :param object page_size:
        :param object skip_count:
    ...
    def search_for_file(self, query, search_type, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param object query: Search query to look for (required)
        :param object search_type: Value type with which to search (required)
        :param object explain:  Shows the explain for this endpoint 
        :param object format:  Format of the response from this endpoint 
        :param object download:  Determines whether to download the response. (Content-Disposition:\"attachment\" vs \"inline\") 
        :param object filename: If download is True, this sets the name of the file. (Content-Disposition:\"attachment; filename=`filename`\")
    ...
    def search_for_file_with_http_info(self, query, search_type, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('search_type' not in params or
                                                       params['search_type'] is None):  # noqa: E501
