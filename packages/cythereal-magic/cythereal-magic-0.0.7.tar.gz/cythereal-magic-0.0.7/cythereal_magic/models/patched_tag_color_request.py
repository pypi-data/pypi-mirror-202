...
class PatchedTagColorRequest(object):
    ...
    def __init__(self, color='#329db6'):  # noqa: E501
        """PatchedTagColorRequest - a model defined in Swagger"""  # noqa: E501
        self._color = None
    ...
    @property
    def color(self):
        """Gets the color of this PatchedTagColorRequest.  # noqa: E501


        :return: The color of this PatchedTagColorRequest.  # noqa: E501
        :rtype: str
        """
        return self._color
    ...
    def color(self, color):
        """Sets the color of this PatchedTagColorRequest.


        :param color: The color of this PatchedTagColorRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchedTagColorRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchedTagColorRequest):
            return False
