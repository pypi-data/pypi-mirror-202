...
class NoteRequest(object):
    ...
    @property
    def note(self):
        """Gets the note of this NoteRequest.  # noqa: E501


        :return: The note of this NoteRequest.  # noqa: E501
        :rtype: str
        """
        return self._note
    ...
    @note.setter
    def note(self, note):
        """Sets the note of this NoteRequest.


        :param note: The note of this NoteRequest.  # noqa: E501
        :type: str
        """
        if note is None:
