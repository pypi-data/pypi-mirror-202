...
class BulkRequest(object):
    ...
    @property
    def ids(self):
        """Gets the ids of this BulkRequest.  # noqa: E501


        :return: The ids of this BulkRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._ids
    ...
    @ids.setter
    def ids(self, ids):
        """Sets the ids of this BulkRequest.


        :param ids: The ids of this BulkRequest.  # noqa: E501
        :type: list[str]
        """
        if ids is None:
