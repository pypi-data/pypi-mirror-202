...
class Yara(object):
    ...
    def __init__(self, files=None, name=None, rule='', magic_yara_id=None, magic_criteria_id=None):  # noqa: E501
        """Yara - a model defined in Swagger"""  # noqa: E501
        self._files = None
        self._name = None
        self._rule = None
    ...
    @property
    def files(self):
        """Gets the files of this Yara.  # noqa: E501


        :return: The files of this Yara.  # noqa: E501
        :rtype: list[str]
        """
        return self._files
    ...
    def files(self, files):
        """Sets the files of this Yara.


        :param files: The files of this Yara.  # noqa: E501
        :type: list[str]
        """
        if files is None:
    ...
    @property
    def name(self):
        """Gets the name of this Yara.  # noqa: E501


        :return: The name of this Yara.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this Yara.  # noqa: E501
        :type: str
        """
    ...
    @property
    def rule(self):
        """Gets the rule of this Yara.  # noqa: E501


        :return: The rule of this Yara.  # noqa: E501
        :rtype: str
        """
        return self._rule
    ...
    @rule.setter
    def rule(self, rule):
        """Sets the rule of this Yara.


        :param rule: The rule of this Yara.  # noqa: E501
        :type: str
        """
        if rule is None:
    ...
    def magic_yara_id(self):
        """Gets the magic_yara_id of this Yara.  # noqa: E501


        :return: The magic_yara_id of this Yara.  # noqa: E501
        :rtype: str
        """
    ...
    def magic_yara_id(self, magic_yara_id):
        """Sets the magic_yara_id of this Yara.


        :param magic_yara_id: The magic_yara_id of this Yara.  # noqa: E501
        :type: str
        """
        if magic_yara_id is None:
            raise ValueError("Invalid value for `magic_yara_id`, must not be `None`")  # noqa: E501

        self._magic_yara_id = magic_yara_id

    @property
    def magic_criteria_id(self):
        """Gets the magic_criteria_id of this Yara.  # noqa: E501


        :return: The magic_criteria_id of this Yara.  # noqa: E501
        :rtype: str
        """
    ...
    def magic_criteria_id(self, magic_criteria_id):
        """Sets the magic_criteria_id of this Yara.


        :param magic_criteria_id: The magic_criteria_id of this Yara.  # noqa: E501
        :type: str
        """
        if magic_criteria_id is None:
            raise ValueError("Invalid value for `magic_criteria_id`, must not be `None`")  # noqa: E501
