...
class YaraApi(object):
    ...
    def create_yara_with_http_info(self, files2, name2, unpacked2, config2, include_all2, files, name, unpacked, config, include_all, **kwargs):  # noqa: E501
        ...
        all_params = ['files2', 'name2', 'unpacked2', 'config2', 'include_all2', 'files', 'name', 'unpacked', 'config', 'include_all', 'explain', 'format', 'download', 'filename', 'strict']  # noqa: E501
    ...
    def create_yara_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'explain', 'format', 'download', 'filename', 'strict']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def yara_procedure_matches_with_http_info(self, binary_id, **kwargs):  # noqa: E501
        ...
        all_params = ['binary_id', 'explain', 'format', 'download', 'filename', 'read_mask', 'expand_mask']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
