...
import six
from cythereal_magic.models.file_similarity import FileSimilarity  # noqa: F401,E501

class AllOfFileSimilarities(FileSimilarity):
    ...
    if hasattr(FileSimilarity, "swagger_types"):
        swagger_types.update(FileSimilarity.swagger_types)

    attribute_map = {
    }
    if hasattr(FileSimilarity, "attribute_map"):
        attribute_map.update(FileSimilarity.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileSimilarities - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileSimilarity.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileSimilarities, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileSimilarities):
            return False
