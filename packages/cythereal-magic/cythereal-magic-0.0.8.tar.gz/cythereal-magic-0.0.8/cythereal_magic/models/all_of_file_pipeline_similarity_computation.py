...
import six
from cythereal_magic.models.pipeline_status_enum import PipelineStatusEnum  # noqa: F401,E501

class AllOfFilePipelineSimilarityComputation(PipelineStatusEnum):
    ...
    if hasattr(PipelineStatusEnum, "swagger_types"):
        swagger_types.update(PipelineStatusEnum.swagger_types)

    attribute_map = {
    }
    if hasattr(PipelineStatusEnum, "attribute_map"):
        attribute_map.update(PipelineStatusEnum.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFilePipelineSimilarityComputation - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        PipelineStatusEnum.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFilePipelineSimilarityComputation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFilePipelineSimilarityComputation):
            return False
