...
import six
from cythereal_magic.models.criteria_enum import CriteriaEnum  # noqa: F401,E501

class AllOfInferredReputationCriteria(CriteriaEnum):
    ...
    if hasattr(CriteriaEnum, "swagger_types"):
        swagger_types.update(CriteriaEnum.swagger_types)

    attribute_map = {
    }
    if hasattr(CriteriaEnum, "attribute_map"):
        attribute_map.update(CriteriaEnum.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfInferredReputationCriteria - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        CriteriaEnum.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfInferredReputationCriteria, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfInferredReputationCriteria):
            return False
