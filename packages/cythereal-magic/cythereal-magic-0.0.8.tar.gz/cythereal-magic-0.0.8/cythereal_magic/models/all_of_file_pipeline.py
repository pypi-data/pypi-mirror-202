...
import six
from cythereal_magic.models.file_pipeline import FilePipeline  # noqa: F401,E501

class AllOfFilePipeline(FilePipeline):
    ...
    if hasattr(FilePipeline, "swagger_types"):
        swagger_types.update(FilePipeline.swagger_types)

    attribute_map = {
    }
    if hasattr(FilePipeline, "attribute_map"):
        attribute_map.update(FilePipeline.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFilePipeline - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FilePipeline.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFilePipeline, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFilePipeline):
            return False
