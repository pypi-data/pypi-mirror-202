...
class FileUploadRequest(object):
    ...
    def __init__(self, filedata=None, password=None, tags=None, notes=None):  # noqa: E501
        """FileUploadRequest - a model defined in Swagger"""  # noqa: E501
        self._filedata = None
        self._password = None
        self._tags = None
        self._notes = None
    ...
    @property
    def filedata(self):
        """Gets the filedata of this FileUploadRequest.  # noqa: E501


        :return: The filedata of this FileUploadRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def filedata(self, filedata):
        """Sets the filedata of this FileUploadRequest.


        :param filedata: The filedata of this FileUploadRequest.  # noqa: E501
        :type: list[str]
        """
        if filedata is None:
            raise ValueError("Invalid value for `filedata`, must not be `None`")  # noqa: E501

        self._filedata = filedata

    @property
    def password(self):
        """Gets the password of this FileUploadRequest.  # noqa: E501

        This will be applied to ALL uploaded files  # noqa: E501

        :return: The password of this FileUploadRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this FileUploadRequest.

        This will be applied to ALL uploaded files  # noqa: E501

        :param password: The password of this FileUploadRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this FileUploadRequest.  # noqa: E501

        List of tags to apply to file  # noqa: E501

        :return: The tags of this FileUploadRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this FileUploadRequest.

        List of tags to apply to file  # noqa: E501

        :param tags: The tags of this FileUploadRequest.  # noqa: E501
        :type: list[str]
        """
        if tags is None:
    ...
    @property
    def notes(self):
        """Gets the notes of this FileUploadRequest.  # noqa: E501

        List of notes to apply to file  # noqa: E501

        :return: The notes of this FileUploadRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this FileUploadRequest.

        List of notes to apply to file  # noqa: E501

        :param notes: The notes of this FileUploadRequest.  # noqa: E501
        :type: list[str]
        """
        if notes is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FileUploadRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileUploadRequest):
            return False
