...
class CriteriaEnum(object):
    ...
    allowed enum values
    """
    DIRECT_LABEL_CHECK = "direct_label_check"
    INFERRED_LABEL_CHECK = "inferred_label_check"
    AV_DETECTIONS = "av_detections"
    MANUALLY_DEFINED = "manually_defined"
    DEFAULT = "default"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """CriteriaEnum - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CriteriaEnum, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CriteriaEnum):
            return False
