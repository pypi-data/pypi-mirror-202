...
class FilePipeline(object):
    ...
    """
    swagger_types = {
        'dashboard_campaign': 'AllOfFilePipelineDashboardCampaign',
        'dashboard_report': 'AllOfFilePipelineDashboardReport',
        'ioc_handler': 'AllOfFilePipelineIocHandler',
        'proc_hash_signatures': 'AllOfFilePipelineProcHashSignatures',
        'similarity_computation': 'AllOfFilePipelineSimilarityComputation',
        'srl_juice': 'AllOfFilePipelineSrlJuice',
        'srl_scanners': 'AllOfFilePipelineSrlScanners',
        'srl_unpacker': 'AllOfFilePipelineSrlUnpacker',
        'variant_hash_signatures': 'AllOfFilePipelineVariantHashSignatures',
        'web_request_handler': 'AllOfFilePipelineWebRequestHandler'
    }

    attribute_map = {
        'dashboard_campaign': 'dashboard_campaign',
        'dashboard_report': 'dashboard_report',
        'ioc_handler': 'ioc_handler',
        'proc_hash_signatures': 'proc_hash_signatures',
        'similarity_computation': 'similarity_computation',
        'srl_juice': 'srlJuice',
        'srl_scanners': 'srlScanners',
        'srl_unpacker': 'srlUnpacker',
        'variant_hash_signatures': 'variant_hash_signatures',
        'web_request_handler': 'webRequestHandler'
    }

    def __init__(self, dashboard_campaign=None, dashboard_report=None, ioc_handler=None, proc_hash_signatures=None, similarity_computation=None, srl_juice=None, srl_scanners=None, srl_unpacker=None, variant_hash_signatures=None, web_request_handler=None):  # noqa: E501
        """FilePipeline - a model defined in Swagger"""  # noqa: E501
        self._dashboard_campaign = None
        self._dashboard_report = None
        self._ioc_handler = None
        self._proc_hash_signatures = None
        self._similarity_computation = None
        self._srl_juice = None
        self._srl_scanners = None
        self._srl_unpacker = None
        self._variant_hash_signatures = None
        self._web_request_handler = None
        self.discriminator = None
        if dashboard_campaign is not None:
            self.dashboard_campaign = dashboard_campaign
        if dashboard_report is not None:
            self.dashboard_report = dashboard_report
        if ioc_handler is not None:
            self.ioc_handler = ioc_handler
        if proc_hash_signatures is not None:
            self.proc_hash_signatures = proc_hash_signatures
        if similarity_computation is not None:
            self.similarity_computation = similarity_computation
        if srl_juice is not None:
            self.srl_juice = srl_juice
        if srl_scanners is not None:
            self.srl_scanners = srl_scanners
        if srl_unpacker is not None:
            self.srl_unpacker = srl_unpacker
        if variant_hash_signatures is not None:
            self.variant_hash_signatures = variant_hash_signatures
        if web_request_handler is not None:
            self.web_request_handler = web_request_handler

    @property
    def dashboard_campaign(self):
        """Gets the dashboard_campaign of this FilePipeline.  # noqa: E501


        :return: The dashboard_campaign of this FilePipeline.  # noqa: E501
        :rtype: AllOfFilePipelineDashboardCampaign
        """
        return self._dashboard_campaign

    @dashboard_campaign.setter
    def dashboard_campaign(self, dashboard_campaign):
        """Sets the dashboard_campaign of this FilePipeline.


        :param dashboard_campaign: The dashboard_campaign of this FilePipeline.  # noqa: E501
        :type: AllOfFilePipelineDashboardCampaign
        """

        self._dashboard_campaign = dashboard_campaign

    @property
    def dashboard_report(self):
        """Gets the dashboard_report of this FilePipeline.  # noqa: E501


        :return: The dashboard_report of this FilePipeline.  # noqa: E501
        :rtype: AllOfFilePipelineDashboardReport
        """
        return self._dashboard_report

    @dashboard_report.setter
    def dashboard_report(self, dashboard_report):
        """Sets the dashboard_report of this FilePipeline.


        :param dashboard_report: The dashboard_report of this FilePipeline.  # noqa: E501
        :type: AllOfFilePipelineDashboardReport
        """

        self._dashboard_report = dashboard_report

    @property
    def ioc_handler(self):
        """Gets the ioc_handler of this FilePipeline.  # noqa: E501


        :return: The ioc_handler of this FilePipeline.  # noqa: E501
        :rtype: AllOfFilePipelineIocHandler
        """
        return self._ioc_handler

    @ioc_handler.setter
    def ioc_handler(self, ioc_handler):
        """Sets the ioc_handler of this FilePipeline.


        :param ioc_handler: The ioc_handler of this FilePipeline.  # noqa: E501
        :type: AllOfFilePipelineIocHandler
        """

        self._ioc_handler = ioc_handler

    @property
    def proc_hash_signatures(self):
        """Gets the proc_hash_signatures of this FilePipeline.  # noqa: E501


        :return: The proc_hash_signatures of this FilePipeline.  # noqa: E501
        :rtype: AllOfFilePipelineProcHashSignatures
        """
        return self._proc_hash_signatures

    @proc_hash_signatures.setter
    def proc_hash_signatures(self, proc_hash_signatures):
        """Sets the proc_hash_signatures of this FilePipeline.


        :param proc_hash_signatures: The proc_hash_signatures of this FilePipeline.  # noqa: E501
        :type: AllOfFilePipelineProcHashSignatures
        """

        self._proc_hash_signatures = proc_hash_signatures

    @property
    def similarity_computation(self):
        """Gets the similarity_computation of this FilePipeline.  # noqa: E501


        :return: The similarity_computation of this FilePipeline.  # noqa: E501
        :rtype: AllOfFilePipelineSimilarityComputation
        """
        return self._similarity_computation

    @similarity_computation.setter
    def similarity_computation(self, similarity_computation):
        """Sets the similarity_computation of this FilePipeline.


        :param similarity_computation: The similarity_computation of this FilePipeline.  # noqa: E501
        :type: AllOfFilePipelineSimilarityComputation
        """

        self._similarity_computation = similarity_computation

    @property
    def srl_juice(self):
        """Gets the srl_juice of this FilePipeline.  # noqa: E501


        :return: The srl_juice of this FilePipeline.  # noqa: E501
        :rtype: AllOfFilePipelineSrlJuice
        """
        return self._srl_juice

    @srl_juice.setter
    def srl_juice(self, srl_juice):
        """Sets the srl_juice of this FilePipeline.


        :param srl_juice: The srl_juice of this FilePipeline.  # noqa: E501
        :type: AllOfFilePipelineSrlJuice
        """

        self._srl_juice = srl_juice

    @property
    def srl_scanners(self):
        """Gets the srl_scanners of this FilePipeline.  # noqa: E501


        :return: The srl_scanners of this FilePipeline.  # noqa: E501
        :rtype: AllOfFilePipelineSrlScanners
        """
        return self._srl_scanners

    @srl_scanners.setter
    def srl_scanners(self, srl_scanners):
        """Sets the srl_scanners of this FilePipeline.


        :param srl_scanners: The srl_scanners of this FilePipeline.  # noqa: E501
        :type: AllOfFilePipelineSrlScanners
        """

        self._srl_scanners = srl_scanners

    @property
    def srl_unpacker(self):
        """Gets the srl_unpacker of this FilePipeline.  # noqa: E501


        :return: The srl_unpacker of this FilePipeline.  # noqa: E501
        :rtype: AllOfFilePipelineSrlUnpacker
        """
        return self._srl_unpacker

    @srl_unpacker.setter
    def srl_unpacker(self, srl_unpacker):
        """Sets the srl_unpacker of this FilePipeline.


        :param srl_unpacker: The srl_unpacker of this FilePipeline.  # noqa: E501
        :type: AllOfFilePipelineSrlUnpacker
        """

        self._srl_unpacker = srl_unpacker

    @property
    def variant_hash_signatures(self):
        """Gets the variant_hash_signatures of this FilePipeline.  # noqa: E501


        :return: The variant_hash_signatures of this FilePipeline.  # noqa: E501
        :rtype: AllOfFilePipelineVariantHashSignatures
        """
        return self._variant_hash_signatures

    @variant_hash_signatures.setter
    def variant_hash_signatures(self, variant_hash_signatures):
        """Sets the variant_hash_signatures of this FilePipeline.


        :param variant_hash_signatures: The variant_hash_signatures of this FilePipeline.  # noqa: E501
        :type: AllOfFilePipelineVariantHashSignatures
        """

        self._variant_hash_signatures = variant_hash_signatures

    @property
    def web_request_handler(self):
        """Gets the web_request_handler of this FilePipeline.  # noqa: E501


        :return: The web_request_handler of this FilePipeline.  # noqa: E501
        :rtype: AllOfFilePipelineWebRequestHandler
        """
        return self._web_request_handler

    @web_request_handler.setter
    def web_request_handler(self, web_request_handler):
        """Sets the web_request_handler of this FilePipeline.


        :param web_request_handler: The web_request_handler of this FilePipeline.  # noqa: E501
        :type: AllOfFilePipelineWebRequestHandler
        """

        self._web_request_handler = web_request_handler
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FilePipeline, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FilePipeline):
            return False
