...
import six
from cythereal_magic.models.file_procedures import FileProcedures  # noqa: F401,E501

class AllOfFileGenomicsProcedures(FileProcedures):
    ...
    if hasattr(FileProcedures, "swagger_types"):
        swagger_types.update(FileProcedures.swagger_types)

    attribute_map = {
    }
    if hasattr(FileProcedures, "attribute_map"):
        attribute_map.update(FileProcedures.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileGenomicsProcedures - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileProcedures.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfFileGenomicsProcedures, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfFileGenomicsProcedures):
            return False
