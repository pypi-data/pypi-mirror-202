...
class UsersApi(object):
    ...
    def update_account_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['first_name2', 'last_name2', 'name2', 'is_public2', 'first_name', 'last_name', 'name', 'is_public', 'explain', 'format', 'download', 'filename', 'update_mask']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_account_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'explain', 'format', 'download', 'filename', 'update_mask']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
