...
class IndicatorRequest(object):
    ...
    swagger_types = {
        'value': 'str',
        'type': 'OneOfIndicatorRequestType'
    }
    ...
    def __init__(self, value=None, type=None):  # noqa: E501
        """IndicatorRequest - a model defined in Swagger"""  # noqa: E501
        self._value = None
        self._type = None
    ...
    @property
    def value(self):
        """Gets the value of this IndicatorRequest.  # noqa: E501


        :return: The value of this IndicatorRequest.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this IndicatorRequest.


        :param value: The value of this IndicatorRequest.  # noqa: E501
        :type: str
        """
        if value is None:
    ...
    @property
    def type(self):
        """Gets the type of this IndicatorRequest.  # noqa: E501


        :return: The type of this IndicatorRequest.  # noqa: E501
        :rtype: OneOfIndicatorRequestType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this IndicatorRequest.


        :param type: The type of this IndicatorRequest.  # noqa: E501
        :type: OneOfIndicatorRequestType
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IndicatorRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IndicatorRequest):
            return False
