...
class FileLabels(object):
    ...
    def __init__(self, ground_truth=None, inferred=None):  # noqa: E501
        """FileLabels - a model defined in Swagger"""  # noqa: E501
    ...
    def ground_truth(self):
        """Gets the ground_truth of this FileLabels.  # noqa: E501


        :return: The ground_truth of this FileLabels.  # noqa: E501
        :rtype: list[Label]
        """
    ...
    def ground_truth(self, ground_truth):
        """Sets the ground_truth of this FileLabels.


        :param ground_truth: The ground_truth of this FileLabels.  # noqa: E501
        :type: list[Label]
        """
        if ground_truth is None:
            raise ValueError("Invalid value for `ground_truth`, must not be `None`")  # noqa: E501

        self._ground_truth = ground_truth

    @property
    def inferred(self):
        """Gets the inferred of this FileLabels.  # noqa: E501


        :return: The inferred of this FileLabels.  # noqa: E501
        :rtype: list[Label]
        """
    ...
    def inferred(self, inferred):
        """Sets the inferred of this FileLabels.


        :param inferred: The inferred of this FileLabels.  # noqa: E501
        :type: list[Label]
        """
        if inferred is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileLabels):
            return False
