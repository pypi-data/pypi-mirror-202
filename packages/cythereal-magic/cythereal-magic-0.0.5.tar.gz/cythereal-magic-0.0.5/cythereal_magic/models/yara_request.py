...
class YaraRequest(object):
    ...
    def __init__(self, files=None, name=None, unpacked=None, config=None, include_all=None):  # noqa: E501
        """YaraRequest - a model defined in Swagger"""  # noqa: E501
        self._files = None
        self._name = None
        self._unpacked = None
        self._config = None
    ...
    @property
    def files(self):
        """Gets the files of this YaraRequest.  # noqa: E501


        :return: The files of this YaraRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._files
    ...
    def files(self, files):
        """Sets the files of this YaraRequest.


        :param files: The files of this YaraRequest.  # noqa: E501
        :type: list[str]
        """
        if files is None:
    ...
    @property
    def name(self):
        """Gets the name of this YaraRequest.  # noqa: E501


        :return: The name of this YaraRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this YaraRequest.


        :param name: The name of this YaraRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def unpacked(self):
        """Gets the unpacked of this YaraRequest.  # noqa: E501


        :return: The unpacked of this YaraRequest.  # noqa: E501
        :rtype: bool
        """
        return self._unpacked

    @unpacked.setter
    def unpacked(self, unpacked):
        """Sets the unpacked of this YaraRequest.


        :param unpacked: The unpacked of this YaraRequest.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def config(self):
        """Gets the config of this YaraRequest.  # noqa: E501


        :return: The config of this YaraRequest.  # noqa: E501
        :rtype: OneOfYaraRequestConfig
        """
        return self._config

    @config.setter
    def config(self, config):
        """Sets the config of this YaraRequest.


        :param config: The config of this YaraRequest.  # noqa: E501
        :type: OneOfYaraRequestConfig
        """
    ...
    def include_all(self):
        """Gets the include_all of this YaraRequest.  # noqa: E501


        :return: The include_all of this YaraRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def include_all(self, include_all):
        """Sets the include_all of this YaraRequest.


        :param include_all: The include_all of this YaraRequest.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(YaraRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, YaraRequest):
            return False
