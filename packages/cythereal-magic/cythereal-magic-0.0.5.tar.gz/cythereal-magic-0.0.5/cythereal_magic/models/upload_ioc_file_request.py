...
class UploadIocFileRequest(object):
    ...
    def __init__(self, filedata=None):  # noqa: E501
        """UploadIocFileRequest - a model defined in Swagger"""  # noqa: E501
        self._filedata = None
    ...
    @property
    def filedata(self):
        """Gets the filedata of this UploadIocFileRequest.  # noqa: E501

        CSV or text file containing IoCs  # noqa: E501

        :return: The filedata of this UploadIocFileRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def filedata(self, filedata):
        """Sets the filedata of this UploadIocFileRequest.

        CSV or text file containing IoCs  # noqa: E501

        :param filedata: The filedata of this UploadIocFileRequest.  # noqa: E501
        :type: str
        """
        if filedata is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UploadIocFileRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadIocFileRequest):
            return False
