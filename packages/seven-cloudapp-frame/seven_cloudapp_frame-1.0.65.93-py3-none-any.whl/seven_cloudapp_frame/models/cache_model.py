...
@LastEditTime: 2023-03-28 15:54:27
...
class CacheModel(BaseModel):
    ...
    def __redis_init(self, decode_responses=True):
        """
        ...
        redis_cli = RedisHelper.redis_init(config_dict=cache_redis, decode_responses=decode_responses)
        return redis_cli
