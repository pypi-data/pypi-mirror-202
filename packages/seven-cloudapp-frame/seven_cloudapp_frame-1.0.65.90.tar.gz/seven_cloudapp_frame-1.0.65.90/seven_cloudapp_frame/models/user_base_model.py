...
@LastEditTime: 2023-04-10 17:52:52
    ...
    def update_user_telephone(self, open_id, telephone="", code=""):
        ...
        if code:
            ...
            if invoke_result_data.success == False:
                return invoke_result_data
            telephone = invoke_result_data.data
        UserAccountModel(context=self.context).update_table("telephone=%s","open_id=%s",params=[telephone, open_id])
        DependencyKey.user_account(open_id)
        return invoke_result_data