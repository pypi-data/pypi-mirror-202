...
import StratifiedGroupKFoldRequiresGroups
import requests
import os
...
def test_version_number_not_yet_on_pypi():
    ...
    if is_pr_targeting_master:
        ...
        assert (
            requests.get(
                "https://pypi.org/pypi/StratifiedGroupKFoldRequiresGroups/{}/json".format(
                    StratifiedGroupKFoldRequiresGroups.__version__
                )
            ).status_code
            == 404
