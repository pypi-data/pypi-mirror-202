        ...
        for c in mal_sql:
            ...
            try:
                ...
                for i in error_message:
                    ...
                    try:
                        if my_regex:
                            print(CYAN + "true: " + str(i) + " " +
                                  str(my_regex.span()) + " " + new_url)
                            my_list.append(
                                str(i) + " " + str(my_regex.span()) + " " + new_url)
                            break
            ...
            try:
                ...
                for i in error_message:
                    ...
                    try:
                        if my_regex:
                            print(CYAN + "true cookies: " + str(i) + " " +
                                  str(my_regex.span()) + " " + j + " (" + c + ")")
                            my_list.append(
                                "cookies: " + str(i) + " " + str(my_regex.span()) + " " + j + " (" + c + ")")
                            break
            ...
            form_input = form_scanner(
                clean, secure=secure, tor=tor, parse="input")
                    ...
                    for ii in mal_sql:
                        try:
                            ...
                            if name[0] in activity:
                                ...
                                if action[0] != "":
                                    if j.endswith(
                                            "/") and action[0] != links + "/" or j.endswith("/") and action[0] != links:
                                ...
                                print(
                                    CYAN + "checking: " + str(my_link) + " " + str(mal_dict))
                                # prevent dos attacks
                                time.sleep(delay)
                                ...
                                if tor:
                                    ...
                                    if method[0].lower() == "get":
                                        get = web_session.get(my_link, params=mal_dict, verify=False, headers={
                                                              "User-Agent": return_user_agent()}, timeout=(5, 30)).text

                                    if method[0].lower() == "post":
                                        post = web_session.post(my_link, data=mal_dict, verify=False, headers={
                                                                "User-Agent": return_user_agent()}, timeout=(5, 30)).text
                                        ...
                                        if method[0].lower() == "get":
                                            ...
                                            if get_regex:
                                                print(CYAN +
                                                      ...
                                                      str(j))
                                                my_list.append(
                                                    str(mal_dict) + " " + str(my_regex.span()) + " " + str(j))
                                                break
