...
def osint(username, delay=1, tor=False):
    ...
    type_dict = {
        ...
        "Patreon": "status_code",
        "PCGamer": "The specified member cannot be found. Please enter a member's entire name.[False]",
    ...
    if " " not in username:
        for i in range(len(list(website_dict.values()))):
            time.sleep(delay)
            try:
                print(CYAN + "Checking: " + list(website_dict)
                      [i] + " (" + username + ")")
                ...
                if list(type_dict.values())[i] == "status_code":
                    ...
                    if my_request == 200:
                        print(CYAN + "True: " + list(website_dict)
                              [i] + " (" + username + ")")
                        my_list.append(
                            list(website_dict)[i] + " (" + username + ")")
                ...
                if list(type_dict.values())[i] != "status_code":
                    ...
                    if parse not in my_request and "[False]" in list(type_dict.values())[
                            i]:
                        print(CYAN + "True: " + list(website_dict)
                              [i] + " (" + username + ")")
                        my_list.append(
                    ...
                    if parse in my_request and "[True]" in list(
                            type_dict.values())[i]:
                        print(CYAN + "True: " + list(website_dict)
                              [i] + " (" + username + ")")
                        my_list.append(
        ...
        for i in range(len(list(website_dict.values()))):
            for new_name in username_list:
                ...
                try:
                    ...
                    print("Checking: " + list(website_dict)
                          [i] + " (" + new_name + ")")
