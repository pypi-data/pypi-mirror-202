...
{'': ['*'],
 ...
 'ibis.backends.tests': ['snapshots/test_generic/test_many_subqueries/bigquery/*',
                         ...
                         'snapshots/test_string/test_rlike/bigquery/*',
                         'snapshots/test_string/test_rlike/clickhouse/*',
                         'snapshots/test_string/test_rlike/duckdb/*',
                         'snapshots/test_string/test_rlike/impala/*',
                         'snapshots/test_string/test_rlike/mysql/*',
                         'snapshots/test_string/test_rlike/postgres/*',
                         'snapshots/test_string/test_rlike/snowflake/*',
                         'snapshots/test_string/test_rlike/sqlite/*',
                         'snapshots/test_string/test_rlike/trino/*'],
 ...
 'ibis.tests.sql': ['snapshots/test_compiler/test_agg_and_non_agg_filter/*',
                    ...
                    'snapshots/test_sqlalchemy/test_order_by/ascending/*',
                    'snapshots/test_sqlalchemy/test_order_by/column/*',
                    'snapshots/test_sqlalchemy/test_order_by/mixed/*',
...
extras_require = \
{':python_version < "3.9"': ['importlib-resources>=5,<6'],
 'all': ['black>=22.1.0,<24',
         ...
         'requests>=2,<3',
         'shapely>=1.6,!=1.8.*,<3',
         'snowflake-connector-python>=2.7.10,<4',
         'snowflake-sqlalchemy>=1.4.1,<2',
         'sqlalchemy>=1.4,<3',
         'sqlalchemy-views>=0.3.1,<1',
         'trino[sqlalchemy]>=0.319,<1'],
 ...
 'duckdb': ['duckdb>=0.3.3,<1',
            ...
            'sqlalchemy>=1.4,<3',
            'sqlalchemy-views>=0.3.1,<1'],
 'geospatial': ['GeoAlchemy2>=0.6.3,<1,!=0.13.0',
                'geopandas>=0.6,<1',
                'shapely>=1.6,!=1.8.*,<3'],
 ...
 'polars': ['polars>=0.14.18,<1', 'pyarrow>=2,<12'],
 'postgres': ['psycopg2>=2.8.4,<3',
              'sqlalchemy>=1.4,<3',
              'sqlalchemy-views>=0.3.1,<1'],
 'pyspark': ['pyarrow>=2,<12', 'pyspark>=3,<4', 'sqlalchemy>=1.4,<3'],
 'snowflake': ['snowflake-connector-python>=2.7.10,<4',
               'snowflake-sqlalchemy>=1.4.1,<2',
               'sqlalchemy-views>=0.3.1,<1'],
