...
class EnrollRuleGroup(models.Model):
    """ Enroll_EnrollRuleGroup 报名规则组表 """

    class Meta:
        db_table = 'enroll_rule_group'
        verbose_name_plural = '报名规则组表'
    ...
    classify_id = models.IntegerField(verbose_name='分类ID', blank=True, null=True, help_text='')
...
class EnrollRuleValuate(models.Model):
    ...
    field_choices = [
        ...
        ("initiator_again_price", "initiator_again_price(发起人追补单价)"),
    ]
...
class Enroll(models.Model):
    ...
    region_code = models.CharField(verbose_name='行政区划编码', max_length=20, blank=True, null=True, help_text='详见GB/T2260《中华人民共和国行政区划代码》、GB/T10114《县以下行政区划代码编制规则》')
    ...
    enroll_rule_group = models.ForeignKey(
        verbose_name='报名规则组',
        to=EnrollRuleValuate,
        db_column='enroll_rule_group_id', related_name='+', unique=False, blank=True, null=True,
    ...
    count = models.IntegerField(verbose_name='总数量', blank=True, null=True, help_text='', default=0, )
    unit = models.CharField(verbose_name='单位', max_length=255, blank=True, null=True, help_text='')
    fee = models.DecimalField(verbose_name='小费', max_digits=32, decimal_places=2, default=0, db_index=True, blank=True, null=True, help_text='')
    ...
    amount = models.DecimalField(verbose_name='总收/付金额', max_digits=32, decimal_places=2, db_index=True, default=0, blank=True, null=True, help_text='')
    paid_amount = models.DecimalField(verbose_name='已收/付金额', max_digits=32, decimal_places=2, db_index=True, default=0, blank=True, null=True, help_text='')
    unpaid_amount = models.DecimalField(verbose_name='未收/付金额', max_digits=32, decimal_places=2, db_index=True, default=0, blank=True, null=True, help_text='补差价')
    ...
    finance_invoicing_code = models.CharField(verbose_name='备注', max_length=255, blank=True, null=True, default="UnInvoice", help_text='')
...
class EnrollExtendField(models.Model):
    ...
    field_index = models.IntegerField(verbose_name='原有字段', blank=True, null=True, help_text='')
...
class EnrollSubitem(models.Model):
    ...
    price = models.DecimalField(verbose_name='分项单价', max_digits=32, decimal_places=8, default=0, db_index=True, blank=True, null=True, help_text='清单单价')
    ...
    amount = models.DecimalField(verbose_name='分项小计', max_digits=32, decimal_places=8, default=0, db_index=True, blank=True, null=True, help_text='')
...
class EnrollRecord(models.Model):
    ...
    enroll_auth_status = models.IntegerField(verbose_name='报名权限状态ID', blank=True, null=True, help_text='')
    enroll_pay_status = models.IntegerField(verbose_name='报名支付状态ID', blank=True, null=True, help_text='')
    ...
    score = models.FloatField(verbose_name='评分', blank=True, null=True, help_text='', default=5)
    ...
    finish_time = models.DateTimeField(verbose_name='完成时间', blank=True, null=True, help_text='')
    again_price = models.DecimalField(verbose_name='追加价格', max_digits=10, decimal_places=2, db_index=True, blank=True, null=True, default=0, help_text='')
    again_fee = models.DecimalField(verbose_name='追加消费', max_digits=10, decimal_places=2, db_index=True, blank=True, null=True, default=0, help_text='')
    initiator_again_price = models.DecimalField(verbose_name='发起人追补单价', max_digits=10, decimal_places=2, db_index=True, blank=True, null=True, default=0, help_text='')
    estimated_time = models.DateTimeField(verbose_name='预估（完成）时间', blank=True, null=True, help_text='')
    update_time = models.DateTimeField(verbose_name='预估（完成）时间', blank=True, null=False, help_text='', default=now())
    field_1 = models.CharField(verbose_name='字段1', max_length=255, blank=True, null=True, help_text='')
    field_2 = models.CharField(verbose_name='字段2', max_length=255, blank=True, null=True, help_text='')
    field_3 = models.CharField(verbose_name='字段3', max_length=255, blank=True, null=True, help_text='')
    field_4 = models.CharField(verbose_name='字段4', max_length=255, blank=True, null=True, help_text='')
...
class EnrollRecordExtendField(models.Model):
    """ EnrollSubitemExtendField 报名扩展字段表 """
    id = models.AutoField(verbose_name='ID', primary_key=True, null=False, help_text='清单单价')
    field_index = models.CharField(verbose_name='映射的字段索引', max_length=32, blank=True, null=True, help_text='')
    field = models.CharField(verbose_name='自定义字段', max_length=32, blank=True, null=True, help_text='')
    ...
    class Meta:
        db_table = 'enroll_record_extend_field'
        verbose_name_plural = '报名分项表'
        # 联合约束   其中goods和user不能重复
        unique_together = ["field_index", "field"]
        # 联合索引
        index_together = ["field_index", "field"]
...
class EnrollSubitemRecord(models.Model):
    ...
    reply = models.CharField(verbose_name='填写回复原因', max_length=255, blank=True, null=True, default=5, help_text='')
    remark = models.CharField(verbose_name='备注', max_length=255, blank=True, null=True, help_text='')
