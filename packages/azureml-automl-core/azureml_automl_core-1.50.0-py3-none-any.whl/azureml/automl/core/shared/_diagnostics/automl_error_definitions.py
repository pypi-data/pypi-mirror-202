...
class TimeseriesInvalidDateOffset(ArgumentInvalid):
    @property
    def message_format(self) -> str:
        return AutoMLErrorStrings.TIMESERIES_INVALID_DATE_OFFSET
...
class LargeDataAlgorithmsUnsupported(NotSupported):
    @property
    def message_format(self) -> str:
        return AutoMLErrorStrings.LARGE_DATA_ALGORITHMS_UNSUPPORTED
...
class UnsupportedValueInLabelColumn(NotSupported):
    @property
    def message_format(self) -> str:
        return AutoMLErrorStrings.UNSUPPORTED_VALUE_IN_LABEL
...
@error_decorator(use_parent_error_code=True)
class TimeSeriesUnsupportedTimeSequenceForStationaryFeaturizer(BadData):
    @property
    def message_format(self) -> str:
        return AutoMLErrorStrings.TIMESERIES_UNSUPPORTED_TIME_SEQUENCE_STATIONARY_FEATURIZER
...
@error_decorator(use_parent_error_code=True)
class DatasetContainsNan(BadData):
    @property
    def message_format(self):
        return AutoMLErrorStrings.DATASET_CONTAINS_NAN
...
class TimeseriesExtensionDatesMisaligned(BadData):
    @property
    def message_format(self):
        return AutoMLErrorStrings.TIMESERIES_EXTENSION_DATE_MISALIGNED
...
class ForecastSeriesNotInTrain(BadData):
    @property
    def message_format(self):
        return AutoMLErrorStrings.FORECAST_SERIES_NOT_IN_TRAIN
...
class ArimaxExtensionDataMissingColumns(BadData):
    @property
    def message_format(self):
        return AutoMLErrorStrings.ARIMAX_EXTENSION_DATA_MISSING_COLUMNS


class DatasetUserError(BadData):
    @property
    def message_format(self):
        return AutoMLErrorStrings.DATASET_USER_ERROR
...
class ForecastPredictionTimesMisaligned(TimeseriesDfFrequencyError):
    @property
    def message_format(self):
        return AutoMLErrorStrings.FORECAST_MISALIGNED_TIMES
...
class TimeseriesExtensionMissingValues(MissingData):
    @property
    def message_format(self):
        return AutoMLErrorStrings.TIMESERIES_EXTENSION_HAS_NAN
...
class RollingForecastMissingTargetColumn(MissingData):
    @property
    def message_format(self):
        return AutoMLErrorStrings.ROLLING_FORECAST_MISSING_TARGET_COLUMN
...
class RollingForecastMissingTargetValues(MissingData):
    @property
    def message_format(self):
        return AutoMLErrorStrings.ROLLING_FORECAST_MISSING_TARGET_VALUES
...
class NonBooleanValueInIndicatorColDictionary(AutoMLInternal):
    @property
    def message_format(self) -> str:
        return AutoMLErrorStrings.FORECAST_DISTRIBUTED_WRONG_INDICATOR_TYPE
...
class GenericFitError(Data):
    @property
    def message_format(self):
        return AutoMLErrorStrings.GENERIC_FIT_EXCEPTION
...
class GenericPredictError(Data):
    @property
    def message_format(self):
        return AutoMLErrorStrings.GENERIC_PREDICT_EXCEPTION
...
class TCNExtraColumnInPrediction(BadData):
    @property
    def message_format(self) -> str:
        return AutoMLErrorStrings.TCN_EXTRA_COLUMN_IN_TEST_SET
