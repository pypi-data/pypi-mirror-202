                    ...
                    def prepare_tsad_items(metrics, pipeline_name, metric_name):
                        try:
                            ...
                            if metric_name == 'holdout':
                                ...
                                return list({x: chosen_obj['tsad_metrics'][metric_name][x] for x in
                                             chosen_obj['tsad_metrics'][metric_name]}.items())
                        except Exception as e:
                            return []
...
def validate_additional_params_for_optimizer(params):
    expected_params = [
        ...
        'scorer_fairness_weight', 'use_flight', 'incremental_learning', 'enable_early_stop', 'early_stop_window_size'
    ]
