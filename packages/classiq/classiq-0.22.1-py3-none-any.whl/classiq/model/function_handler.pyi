...
from classiq.interface.generator.expressions import Expression as Expression
from classiq.interface.generator.function_call import FunctionCall as FunctionCall, WireName as WireName
...
from classiq.quantum_functions.function_library import FunctionDeclaration as FunctionDeclaration, FunctionLibrary as FunctionLibrary, QuantumFunction as QuantumFunction
...
class FunctionHandler(abc.ABC, metaclass=abc.ABCMeta):
    ...
    def apply(self, function_name: Union[str, FunctionDeclaration, QuantumFunction], in_wires: Optional[SupportedInputArgs] = ..., out_wires: Optional[SupportedInputArgs] = ..., is_inverse: bool = ..., assign_zero_ios: bool = ..., release_by_inverse: bool = ..., control_states: Optional[Union[ControlState, Iterable[ControlState]]] = ..., should_control: bool = ..., power: int = ..., call_name: Optional[str] = ..., parameters_dict: Optional[Dict[str, ParameterFloatType]] = ...) -> Dict[IOName, QReg]: ...
