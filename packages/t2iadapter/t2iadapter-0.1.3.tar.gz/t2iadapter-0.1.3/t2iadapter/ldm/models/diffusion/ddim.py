...
from t2iadapter.ldm.modules.diffusionmodules.util import make_ddim_sampling_parameters, make_ddim_timesteps, noise_like, \
    extract_into_tensor
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.:
            if append_to_context is not None:
                model_output = self.model.apply_model(
                    x, t, torch.cat([c, append_to_context], dim=1), features_adapter=features_adapter)
            else:
