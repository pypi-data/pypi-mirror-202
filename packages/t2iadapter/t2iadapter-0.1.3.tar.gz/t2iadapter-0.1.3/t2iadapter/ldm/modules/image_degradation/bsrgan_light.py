...
import t2iadapter.ldm.modules.image_degradation.utils_image as util
"""
# --------------------------------------------
# Super-Resolution
# --------------------------------------------
...
def degradation_bsrgan_variant(image, sf=4, isp_model=None, up=False):
    ...
    if up:
        image = cv2.resize(
            image, (w1, h1), interpolation=cv2.INTER_CUBIC)  # todo: random, as above? want to condition on it then
    example = {"image": image}
    return example
