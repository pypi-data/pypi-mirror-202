...
import open_clip
import re
from t2iadapter.ldm.util import default, count_params
...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self,
                 ...
                 max_length=77,
                 freeze=True,
                 layer="last"):  # clip-vit-base-patch32
        super().__init__()
...
class FrozenCLIPT5Encoder(AbstractEncoder):
    ...
    def __init__(self,
                 clip_version="/root/.cache/t2iadapter/openai/clip-vit-large-patch14",
...
class WebUIFrozenCLIPEmebedder(AbstractEncoder):
    ...
    def tokenize_line(self, line):
        ...
        for tokens, (text, weight) in zip(tokenized, parsed):
            ...
            while i < len(tokens):
                ...
                elif self.comma_padding_backtrack != 0 and max(
                        len(remade_tokens), 1
                ) % 75 == 0 and last_comma != -1 and len(remade_tokens) - last_comma <= self.comma_padding_backtrack:
                    last_comma += 1
    ...
    def process_tokens(self, remade_batch_tokens, batch_multipliers):
        remade_batch_tokens = [[self.tokenizer.bos_token_id] + x[:75] + [self.tokenizer.eos_token_id]
