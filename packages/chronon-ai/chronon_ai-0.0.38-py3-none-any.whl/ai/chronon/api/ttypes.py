...
class MetaData(object):
    ...
    def __init__(self, name=None, online=None, production=None, customJson=None, dependencies=None, tableProperties=None, outputNamespace=None, team=None, modeToEnvMap=None, consistencyCheck=None, samplePercent=None, offlineSchedule=None, consistencySamplePercent=None,):
        self.name = name
        self.online = online
...
class JoinPart(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i121 in range(_size117):
                        ...
                        self.keyMapping[_key122] = _val123
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.keyMapping is not None:
            ...
            for kiter124, viter125 in self.keyMapping.items():
...
class ExternalPart(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i130 in range(_size126):
                        ...
                        self.keyMapping[_key131] = _val132
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.keyMapping is not None:
            oprot.writeFieldBegin('keyMapping', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.keyMapping))
            for kiter133, viter134 in self.keyMapping.items():
...
class Join(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i139 in range(_size135):
                        _elem140 = JoinPart()
                        _elem140.read(iprot)
                        self.joinParts.append(_elem140)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i158 in range(_size154):
                        _elem159 = ExternalPart()
                        _elem159.read(iprot)
                        self.onlineExternalParts.append(_elem159)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i164 in range(_size160):
                        _elem165 = BootstrapPart()
                        _elem165.read(iprot)
                        self.bootstrapParts.append(_elem165)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i176 in range(_size172):
                        _elem177 = Derivation()
                        _elem177.read(iprot)
                        self.derivations.append(_elem177)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.skewKeys is not None:
            ...
            for kiter179, viter180 in self.skewKeys.items():
                oprot.writeString(kiter179.encode('utf-8') if sys.version_info[0] == 2 else kiter179)
                oprot.writeListBegin(TType.STRING, len(viter180))
                for iter181 in viter180:
        ...
        if self.onlineExternalParts is not None:
            ...
            for iter182 in self.onlineExternalParts:
                iter182.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.bootstrapParts is not None:
            ...
            for iter183 in self.bootstrapParts:
                iter183.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.derivations is not None:
            ...
            for iter185 in self.derivations:
                iter185.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class BootstrapPart(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i190 in range(_size186):
                        ...
                        self.keyColumns.append(_elem191)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.keyColumns is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.keyColumns))
            for iter192 in self.keyColumns:
