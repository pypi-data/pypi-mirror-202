...
class ServiceController(BaseController):
    ...
    def generate_config_from_file(
        ...
        *,
        ...
        # If either project name or project id was specified in the config file,
        # project_id should already be filled in here. Otherwise, project_id is None, so
        # fill in project id with the default project id.
