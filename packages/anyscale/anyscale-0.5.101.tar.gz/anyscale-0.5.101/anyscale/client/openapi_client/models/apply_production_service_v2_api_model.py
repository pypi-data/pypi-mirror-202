...
class ApplyProductionServiceV2APIModel(object):
    ...
    def __init__(self, name=None, description=None, project_id=None, version=None, canary_percent=None, canary_weight=None, ray_serve_config=None, build_id=None, compute_config_id=None, rollout_strategy=None, ray_gcs_external_storage_config=None, local_vars_configuration=None):  # noqa: E501
        """ApplyProductionServiceV2APIModel - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this ApplyProductionServiceV2APIModel.  # noqa: E501

        Name of the Service  # noqa: E501

        :return: The name of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ApplyProductionServiceV2APIModel.

        Name of the Service  # noqa: E501

        :param name: The name of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this ApplyProductionServiceV2APIModel.  # noqa: E501

        Description of the Service  # noqa: E501

        :return: The description of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ApplyProductionServiceV2APIModel.

        Description of the Service  # noqa: E501

        :param description: The description of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def project_id(self):
        """Gets the project_id of this ApplyProductionServiceV2APIModel.  # noqa: E501

        Id of the project this Service will start clusters in  # noqa: E501

        :return: The project_id of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        """Sets the project_id of this ApplyProductionServiceV2APIModel.

        Id of the project this Service will start clusters in  # noqa: E501

        :param project_id: The project_id of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def version(self):
        """Gets the version of this ApplyProductionServiceV2APIModel.  # noqa: E501
        ...
        :return: The version of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this ApplyProductionServiceV2APIModel.

        A version string that represents the version for this service. Will be populated with the hash of the config if not specified.  # noqa: E501

        :param version: The version of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :type: str
        """
    ...
    def canary_percent(self):
        """Gets the canary_percent of this ApplyProductionServiceV2APIModel.  # noqa: E501
        ...
        :return: The canary_percent of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :rtype: int
        """
    ...
    def canary_percent(self, canary_percent):
        """Sets the canary_percent of this ApplyProductionServiceV2APIModel.

        A manual target percent for this service. If this field is not set, the service will automatically roll out. If set, this should be a number between 0 and 100. The newly created version will have weight `canary_percent` and the existing version will have `100 - canary_percent`.  # noqa: E501

        :param canary_percent: The canary_percent of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :type: int
        """
    ...
    def canary_weight(self):
        """Gets the canary_weight of this ApplyProductionServiceV2APIModel.  # noqa: E501

        DEPRECATED: please use 'canary_percent'.  # noqa: E501

        :return: The canary_weight of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :rtype: int
        """
    ...
    def canary_weight(self, canary_weight):
        """Sets the canary_weight of this ApplyProductionServiceV2APIModel.

        DEPRECATED: please use 'canary_percent'.  # noqa: E501

        :param canary_weight: The canary_weight of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :type: int
        """
    ...
    def ray_serve_config(self):
        """Gets the ray_serve_config of this ApplyProductionServiceV2APIModel.  # noqa: E501
        ...
        :return: The ray_serve_config of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :rtype: object
        """
    ...
    def ray_serve_config(self, ray_serve_config):
        """Sets the ray_serve_config of this ApplyProductionServiceV2APIModel.

        The Ray Serve config to use for this service. This config defines your Ray Serve application, and will be passed directly to Ray Serve. You can learn more about Ray Serve config files here: https://docs.ray.io/en/latest/serve/production-guide/config.html  # noqa: E501

        :param ray_serve_config: The ray_serve_config of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :type: object
        """
    ...
    @property
    def build_id(self):
        """Gets the build_id of this ApplyProductionServiceV2APIModel.  # noqa: E501

        The id of the cluster env build. This id will determine the docker image your Service is run using.  # noqa: E501

        :return: The build_id of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :rtype: str
        """
    ...
    def build_id(self, build_id):
        """Sets the build_id of this ApplyProductionServiceV2APIModel.

        The id of the cluster env build. This id will determine the docker image your Service is run using.  # noqa: E501

        :param build_id: The build_id of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :type: str
        """
    ...
    def compute_config_id(self):
        """Gets the compute_config_id of this ApplyProductionServiceV2APIModel.  # noqa: E501
        ...
        :return: The compute_config_id of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :rtype: str
        """
    ...
    def compute_config_id(self, compute_config_id):
        """Sets the compute_config_id of this ApplyProductionServiceV2APIModel.

        The id of the compute configuration that you want to use. This id will specify the resources required for your ServiceThe compute template includes a `cloud_id` that must be fixed for each service.  # noqa: E501

        :param compute_config_id: The compute_config_id of this ApplyProductionServiceV2APIModel.  # noqa: E501
        :type: str
        """
    ...
    def rollout_strategy(self):
        """Gets the rollout_strategy of this ApplyProductionServiceV2APIModel.  # noqa: E501
        ...
        :return: The rollout_strategy of this ApplyProductionServiceV2APIModel.  # noqa: E501
    ...
    def rollout_strategy(self, rollout_strategy):
        """Sets the rollout_strategy of this ApplyProductionServiceV2APIModel.

        Strategy for rollout. The ROLLOUT strategy will deploy your Ray Serve configuration onto a newly started cluster, and then shift traffic over to the new cluster. You can manually control the speed of the rollout using the canary_weight configuration. The IN_PLACE strategy will use Ray Serve in place upgrade to update your existing cluster in place. When using this rollout strategy, you may only change the ray_serve_config field. You cannot partially shift traffic or rollback an in place upgrade. In place upgrades are faster and riskier than rollouts, and we recommend only using them for relatively safe changes (for example, increasing the number of replicas on a Ray Serve deployment). Default strategy is ROLLOUT.  # noqa: E501

        :param rollout_strategy: The rollout_strategy of this ApplyProductionServiceV2APIModel.  # noqa: E501
    ...
    def ray_gcs_external_storage_config(self):
        """Gets the ray_gcs_external_storage_config of this ApplyProductionServiceV2APIModel.  # noqa: E501
        ...
        :return: The ray_gcs_external_storage_config of this ApplyProductionServiceV2APIModel.  # noqa: E501
    ...
    def ray_gcs_external_storage_config(self, ray_gcs_external_storage_config):
        """Sets the ray_gcs_external_storage_config of this ApplyProductionServiceV2APIModel.

        Config for the Ray GCS to connect to external storage. If populated, head node fault tolerance will be enabled for this service.  # noqa: E501

        :param ray_gcs_external_storage_config: The ray_gcs_external_storage_config of this ApplyProductionServiceV2APIModel.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApplyProductionServiceV2APIModel):
            return False
