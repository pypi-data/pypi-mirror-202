...
class MiniCloud(object):
    ...
    def __init__(self, id=None, name=None, provider=None, is_k8s=False, is_aioa=False, cluster_management_stack_version=None, local_vars_configuration=None):  # noqa: E501
