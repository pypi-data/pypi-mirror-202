...
class ExperimentalWorkspace(object):
    ...
    def __init__(self, name=None, description=None, project_id=None, cloud_id=None, compute_config_id=None, base_snapshot=None, template_url=None, id=None, created_at=None, creator_id=None, creator_email=None, organization_id=None, is_deleted=None, cluster_id=None, environment_id=None, current_state=None, integration_execution_details_id=None, state=None, integration_details=None, local_vars_configuration=None):  # noqa: E501
