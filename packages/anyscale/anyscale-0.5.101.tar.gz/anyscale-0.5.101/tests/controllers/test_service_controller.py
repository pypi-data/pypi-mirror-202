...
def test_generate_config_no_project_id(mock_auth_api_client) -> None:
    service_controller = ServiceController()
    ...
    with patch(
        ...
        "anyscale.controllers.service_controller.infer_project_id",
        new=Mock(return_value=default_project_id),
    ):
        config = service_controller.generate_config_from_file(
            "test_ser8vice_config_file",
        )
