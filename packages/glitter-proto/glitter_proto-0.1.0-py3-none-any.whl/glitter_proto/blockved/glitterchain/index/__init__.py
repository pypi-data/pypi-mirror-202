...
class MsgBase(ServiceBase):
    ...
    async def sql_exec(self) -> "SqlExecResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def sql_grant(self) -> "SqlGrantResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
...
class QueryBase(ServiceBase):
    ...
    async def sql_query(self) -> "SqlQueryResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def simple_sql_query(self) -> "SimpleSqlQueryResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def sql_list_tables(self) -> "SqlListTablesResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def sql_list_databases(self) -> "SqlListDatabasesResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
