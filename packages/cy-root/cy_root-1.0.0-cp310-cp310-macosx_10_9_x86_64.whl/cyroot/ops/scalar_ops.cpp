...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            "cyroot",
            "/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/pip-build-env-83c9i940/overlay/lib/python3.10/site-packages/numpy/core/include",
            "cyroot/utils",
            "cyroot/ops"
        ],
        "language": "c++",
...
static int __pyx_pymod_exec_scalar_ops(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_scalar_ops},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initscalar_ops(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initscalar_ops(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_scalar_ops(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_scalar_ops(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_scalar_ops(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'scalar_ops' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_scalar_ops(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("scalar_ops", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
