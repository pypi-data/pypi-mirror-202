...
def collect_env():
    ...
    if cuda_available:
        ...
        from comfy_controlnet_preprocessors.uniformer.mmcv.utils.parrots_wrapper import _get_cuda_home
    ...
    try:
        from comfy_controlnet_preprocessors.uniformer.mmcv.ops import get_compiler_version, get_compiling_cuda_version
    except ModuleNotFoundError:
