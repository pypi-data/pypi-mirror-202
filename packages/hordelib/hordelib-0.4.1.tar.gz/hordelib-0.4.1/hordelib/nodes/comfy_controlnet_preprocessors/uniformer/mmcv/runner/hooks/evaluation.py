...
from comfy_controlnet_preprocessors.uniformer.mmcv.utils import is_seq_of
...
class EvalHook(Hook):
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from comfy_controlnet_preprocessors.uniformer.mmcv.engine import single_gpu_test
...
class DistEvalHook(EvalHook):
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from comfy_controlnet_preprocessors.uniformer.mmcv.engine import multi_gpu_test
