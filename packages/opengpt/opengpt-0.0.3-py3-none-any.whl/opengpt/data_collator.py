...
class DataCollatorWithPadding(object):
    ...
    def __call__(self, instances):
        input_ids, labels, attention_mask = tuple([torch.tensor(instance[key][0:self.max_seq_len]) for instance in instances] for key in ("input_ids", "labels", "attention_mask"))
        batch = {}
