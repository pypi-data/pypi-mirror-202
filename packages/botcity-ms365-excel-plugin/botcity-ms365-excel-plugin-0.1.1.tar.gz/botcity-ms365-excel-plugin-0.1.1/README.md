# BotCity Microsoft 365 Excel Plugin - Python
...
[![First Automation](https://botcity.dev/github/readme/python-plugins/ms365excel-plugin.png)](https://documentation.botcity.dev/plugins/)
