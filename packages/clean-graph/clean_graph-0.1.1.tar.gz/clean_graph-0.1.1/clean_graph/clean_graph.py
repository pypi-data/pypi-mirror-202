...
class GeneralGraph:
    """
    The class GeneralGraph is for general variables and general functions related to these variables. This provides unity.
    ...
    barwidths         = dict()   # Collection of default barwidths to use in graphs
    
    # Variables with direct value assignment, public variables for all instances
    fontsize          = 12       # All text in a graph has the same height
    font              = 'Arial'  # All text in a graph has the same font. Default font of matplotlib is 'DejaVu Sans'.
    ...
    barshift          = 0        # The barshift for the main part of the graph. This value will be overruled with barshift_value if there are other relevant scenario's available
    barshift_leftside = 0        # The barshift for the left side part of the graph. This value will be overruled with barshift_value if there are relevant scenario's available
    ...
    font              = 'DejaVu Sans'  # All text in a graph has the same font. Default font of matplotlib is 'DejaVu Sans'.
    ...
    def _other_variables(self):
        ...
        self.delta_base_value = dict()      # Base_values for the delta graphs. Delta_name is the key for the value
        ...
        self.ax               = dict()      # Dictionary of matplotlib-subplot-axes
                                            ...
                                            # self.ax["main"] contains axes-object for main subplot for actual, forecast and deltagraphs
        ...
        self.ax_order         = ["left", "PY", "PL", "main", "sum", "average", "comment"]  #### Order of the subplots. Not all subplots are in every graph available
    ...
    def _fill_default_barwidths(self):
        """
        Assigns the default barwidth of graphs into the dictionary variable barwidths 
