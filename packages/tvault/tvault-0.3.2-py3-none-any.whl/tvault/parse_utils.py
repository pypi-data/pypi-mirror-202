...
def extract_diff(prev_model, cur_model):
    ...
    if len(changes) > 0:
        ...
        for e in filter_model_diff:
            if e.startswith("+ "):
                color_model_diff.append("\x1b[1;32m" + e + "\x1b[0m")
            elif e.startswith("- "):
                color_model_diff.append("\x1b[1;31m" + e + "\x1b[0m")
            else:
        ...
        if p_module in cur_model["src"].keys():
            ...
            if len(changes) > 0:
                ...
                for e in filter_class_diff:
                    if e.startswith("+ "):
                        color_class_diff.append("\x1b[1;32m" + e + "\x1b[0m")
                    elif e.startswith("- "):
                        color_class_diff.append("\x1b[1;31m" + e + "\x1b[0m")
                    else:
        ...
        if p_func in cur_model["external_func"].keys():
            ...
            if len(changes) > 0:
                ...
                for e in filter_func_diff:
                    if e.startswith("+ "):
                        color_func_diff.append("\x1b[1;32m" + e + "\x1b[0m")
                    elif e.startswith("- "):
                        color_func_diff.append("\x1b[1;31m" + e + "\x1b[0m")
                    else:
    ...
    if len(changes) > 0:
        ...
        for e in filter_opt_diff:
            if e.startswith("+ "):
                color_opt_diff.append("\x1b[1;32m" + e + "\x1b[0m")
            elif e.startswith("- "):
                color_opt_diff.append("\x1b[1;31m" + e + "\x1b[0m")
            else:
