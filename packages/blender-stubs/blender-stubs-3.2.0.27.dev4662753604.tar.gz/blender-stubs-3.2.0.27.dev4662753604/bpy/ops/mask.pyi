...
def add_feather_vertex(location: mathutils.Vector = (0.0, 0.0)) -> None:
...
def add_vertex(location: mathutils.Vector = (0.0, 0.0)) -> None:
...
def primitive_circle_add(size: float = 100.0, location: mathutils.Vector = (0.0, 0.0)) -> None:
...
def primitive_square_add(size: float = 100.0, location: mathutils.Vector = (0.0, 0.0)) -> None:
