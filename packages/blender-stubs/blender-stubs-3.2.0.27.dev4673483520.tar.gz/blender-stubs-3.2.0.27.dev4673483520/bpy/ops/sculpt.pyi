...
def color_filter(start_mouse: typing.Tuple[int, int] = (0, 0), area_normal_radius: float = 0.25, strength: float = 1.0, iteration_count: int = 1, event_history: typing.Union[typing.Sequence[OperatorStrokeElement], typing.Mapping[str, OperatorStrokeElement], bpy.types.bpy_prop_collection] = None, type: str = 'HUE', fill_color: mathutils.Color = (0.0, 0.0, 0.0)) -> None:
...
def expand(target: str = 'MASK', falloff_type: str = 'GEODESIC', invert: bool = False, use_mask_preserve: bool = False, use_falloff_gradient: bool = False, use_modify_active: bool = False, use_reposition_pivot: bool = True, max_geodesic_move_preview: int = 10000, use_auto_mask: bool = False, normal_falloff_smooth: int = 2) -> None:
...
def face_set_edit(active_face_set: int = 1, mode: str = 'GROW', strength: float = 1.0, modify_hidden: bool = True) -> None:
...
def mask_from_cavity(mix_mode: str = 'MIX', mix_factor: float = 1.0, settings_source: str = 'OPERATOR', factor: float = 0.5, blur_steps: int = 2, use_curve: bool = False, invert: bool = False) -> None:
...
def trim_box_gesture(xmin: int = 0, xmax: int = 0, ymin: int = 0, ymax: int = 0, wait_for_input: bool = True, use_front_faces_only: bool = False, use_limit_to_segment: bool = False, trim_mode: str = 'DIFFERENCE', use_cursor_depth: bool = False, trim_orientation: str = 'VIEW', trim_extrude_mode: str = 'FIXED') -> None:
...
def trim_lasso_gesture(path: typing.Union[typing.Sequence[OperatorMousePath], typing.Mapping[str, OperatorMousePath], bpy.types.bpy_prop_collection] = None, use_front_faces_only: bool = False, use_limit_to_segment: bool = False, trim_mode: str = 'DIFFERENCE', use_cursor_depth: bool = False, trim_orientation: str = 'VIEW', trim_extrude_mode: str = 'FIXED') -> None:
