...
def addon_install(overwrite: bool = True, target: str = '', filepath: str = '', filter_folder: bool = True, filter_python: bool = True, filter_glob: str = '*args.py;*args.zip') -> None:
...
def script_directory_add(directory: str = '', filter_folder: bool = True) -> None:
...
def script_directory_remove(index: int = 0) -> None:
