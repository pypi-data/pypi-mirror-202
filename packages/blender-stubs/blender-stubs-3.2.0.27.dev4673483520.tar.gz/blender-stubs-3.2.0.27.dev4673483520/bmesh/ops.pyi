...
def join_triangles(bm: bmesh.types.BMesh, faces: typing.List[typing.Any] = [], cmp_seam: bool = False, cmp_sharp: bool = False, cmp_uvs: bool = False, cmp_vcols: bool = False, cmp_materials: bool = False, angle_face_threshold: float = 0, angle_shape_threshold: float = 0) -> typing.Dict[str, typing.Any]:
...
def bevel(bm: bmesh.types.BMesh, geom: typing.List[typing.Any] = [], offset: float = 0, offset_type: str = 'OFFSET', profile_type: str = 'SUPERELLIPSE', segments: int = 0, profile: float = 0, affect: str = 'VERTICES', clamp_overlap: bool = False, material: int = 0, loop_slide: bool = False, mark_seam: bool = False, mark_sharp: bool = False, harden_normals: bool = False, face_strength_mode: str = 'NONE', miter_outer: str = 'SHARP', miter_inner: str = 'SHARP', spread: float = 0, smoothresh: float = 0, custom_profile: bpy.types.bpy_struct = None, vmesh_method: str = 'ADJ') -> typing.Dict[str, typing.Any]:
