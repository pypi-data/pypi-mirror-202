...
class SaveBatchnorm1d(nn.BatchNorm1d):
    ...
    def forward(self, tensor: torch.Tensor) -> torch.Tensor:
        ...
        Args:
            tensor: Tensor of shape [batch_size, sequence_length] or [sequence_length] representing the input graph
                to the model.
        Returns:
            Tensor of shape [batch_size, sequence_length, output_dim] representing the output (normalized graph) of the model.
        """
