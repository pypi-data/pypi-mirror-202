...
def text_classification(pred_data, ref_data=None, k_nearest_neighbours=None, thread_ratio=None, lang=None, index_name=None, created_index=None):
    ...
    ref_data : DataFrame or a tuple of DataFrame,
        ...
        Otherwise if ``ref_data`` is a tuple of DataFrame, the it should be
    ...
    Result on a SAP HANA on-premisen instance:
...
def get_related_doc(pred_data, ref_data=None, top=None, threshold=None, lang='EN', index_name=None, thread_ratio=None, created_index=None):
    ...
    ref_data : DataFrame or a tuple of DataFrame,
        ...
        If ``ref_data`` is a tuple of DataFrame, then it should be corresponding to
...
def get_related_term(pred_data, ref_data=None, top=None, threshold=None, lang='EN', index_name=None, thread_ratio=None, created_index=None):
    ...
    ref_data : DataFrame or a tuple of DataFrame
        ...
        If ``ref_data`` is a tuple of DataFrame, the it should be corresponding to
    ...
    lang : str, optional
        Specify the language type. SAP HANA cloud instance currently supports 'EN', 'DE', 'ES', 'FR' and 'RU'.
        If None, auto detection will be applied.
...
def get_suggested_term(pred_data, ref_data=None, top=None, threshold=None, lang='EN', index_name=None, thread_ratio=None, created_index=None):
    ...
    ref_data : Da0taFrame or a tuple of DataFrame
        Specify the reference data.
