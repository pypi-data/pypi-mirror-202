...
class BodySetLbMode(object):
    ...
    def __init__(self, mode=None, _configuration=None):  # noqa: E501
        """BodySetLbMode - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def mode(self):
        """Gets the mode of this BodySetLbMode.  # noqa: E501


        :return: The mode of this BodySetLbMode.  # noqa: E501
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this BodySetLbMode.


        :param mode: The mode of this BodySetLbMode.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BodySetLbMode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BodySetLbMode):
            return False
