...
class BodySetAccountRateLimit(object):
    ...
    def __init__(self, enabled=None, account_rate_limit=None, _configuration=None):  # noqa: E501
        """BodySetAccountRateLimit - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._enabled = None
        self._account_rate_limit = None
        self.discriminator = None

        self.enabled = enabled
        if account_rate_limit is not None:
            self.account_rate_limit = account_rate_limit

    @property
    def enabled(self):
        """Gets the enabled of this BodySetAccountRateLimit.  # noqa: E501


        :return: The enabled of this BodySetAccountRateLimit.  # noqa: E501
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this BodySetAccountRateLimit.


        :param enabled: The enabled of this BodySetAccountRateLimit.  # noqa: E501
        :type: bool
        """
    ...
    def account_rate_limit(self):
        """Gets the account_rate_limit of this BodySetAccountRateLimit.  # noqa: E501


        :return: The account_rate_limit of this BodySetAccountRateLimit.  # noqa: E501
        :rtype: int
        """
        return self._account_rate_limit

    @account_rate_limit.setter
    def account_rate_limit(self, account_rate_limit):
        """Sets the account_rate_limit of this BodySetAccountRateLimit.


        :param account_rate_limit: The account_rate_limit of this BodySetAccountRateLimit.  # noqa: E501
        :type: int
        """

        self._account_rate_limit = account_rate_limit
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BodySetAccountRateLimit, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BodySetAccountRateLimit):
            return False
