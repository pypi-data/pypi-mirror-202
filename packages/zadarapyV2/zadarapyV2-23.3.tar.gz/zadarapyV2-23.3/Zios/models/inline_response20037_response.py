...
class InlineResponse20037Response(object):
    ...
    swagger_types = {
        'message': 'str',
        'status': 'int',
        'user': 'InlineResponse20037ResponseUser'
    }
    ...
    @property
    def user(self):
        """Gets the user of this InlineResponse20037Response.  # noqa: E501


        :return: The user of this InlineResponse20037Response.  # noqa: E501
        :rtype: InlineResponse20037ResponseUser
        """
        return self._user

    @user.setter
    def user(self, user):
        """Sets the user of this InlineResponse20037Response.


        :param user: The user of this InlineResponse20037Response.  # noqa: E501
        :type: InlineResponse20037ResponseUser
        """
