...
class InlineResponse20036Response(object):
    ...
    swagger_types = {
        'message': 'str',
        'user': 'InlineResponse20036ResponseUser',
        'status': 'int'
    }
    ...
    @property
    def user(self):
        """Gets the user of this InlineResponse20036Response.  # noqa: E501


        :return: The user of this InlineResponse20036Response.  # noqa: E501
        :rtype: InlineResponse20036ResponseUser
        """
        return self._user

    @user.setter
    def user(self, user):
        """Sets the user of this InlineResponse20036Response.


        :param user: The user of this InlineResponse20036Response.  # noqa: E501
        :type: InlineResponse20036ResponseUser
        """
