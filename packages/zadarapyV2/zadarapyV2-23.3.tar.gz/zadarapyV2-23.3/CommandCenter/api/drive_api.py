...
class DriveApi(object):
    ...
    def get_all_drives(self, cloud_name, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str cloud_name: TODO (required)
        :param int per_page: The number of drives to be returned in one page 30
        :param int page: Page number to be queried i.e 2
    ...
    def get_all_drives_with_http_info(self, cloud_name, **kwargs):  # noqa: E501
        ...
        all_params = ['cloud_name', 'per_page', 'page']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
