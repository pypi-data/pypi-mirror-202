...
def neutralize_stock(
    stock_series: StockSeries | PctChangeSeries,
...
def neutralize_index(index_series: IndexSeries, by: IndexSeries, columns: None | list = None, proportion: float = 1.0):
...
def neutralize_series(series: np.ndarray, by: np.ndarray, proportion: float = 1.0):
