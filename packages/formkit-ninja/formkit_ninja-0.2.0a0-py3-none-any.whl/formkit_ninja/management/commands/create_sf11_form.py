...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Created schemas for SF11"))
    ...
    # yield SelectNode(
    #     key="district_select",
    #     html_id="district_select",
    #     name="district",
    #     label="$pgettext('sf23_priority', Municipality)",
    #     options=[
    #         dict(value="----", label="", attrs=dict(disabled=True)),
    #         *(dict(value=f"{d.pk}", label=d.district_name) for d in zDistrict.objects.all()),
    #     ],
    # )
    ...
    #     html_id="suco_select",
    #     name="suco",
    #     label="$pgettext('sf23_priority', Suco)",
    #     if_condition=f"$get(subdistrict_select).value === '{subdistrict_pk}' && $get(district_select).value === '{sd_lookup[str(subdistrict_pk)]}'",
    #     options=[*get_options(suco_list)],
    # )
