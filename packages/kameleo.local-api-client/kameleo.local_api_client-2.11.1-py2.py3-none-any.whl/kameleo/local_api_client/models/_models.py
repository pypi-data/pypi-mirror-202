...
class BaseProfile(_serialization.Model):
    ...
    :ivar plugins: A list of plugins included in the profile. Required.
    :vartype plugins: list[str]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword plugins: A list of plugins included in the profile. Required.
        :paramtype plugins: list[str]
...
class CreateProfileRequest(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype notes: str
    :ivar launcher: The mode how the profile should be launched. It determines which browser to
     launch. This cannot be modified after creation. Possible values are 'automatic', 'chrome',
     'chromium', 'firefox', 'edge', 'external'.
    ...
    def __init__(
        ...
        *,
        ...
        plugins: "_models.PluginSpoofingTypePluginIListMultiLevelChoice",
        ...
        **kwargs: Any
        ...
        :paramtype notes: str
        :keyword launcher: The mode how the profile should be launched. It determines which browser to
         launch. This cannot be modified after creation. Possible values are 'automatic', 'chrome',
         'chromium', 'firefox', 'edge', 'external'.
...
class LoadProfileRequest(_serialization.Model):
    """Tells where the profile should be loaded from.

    All required parameters must be populated in order to send to Azure.

    :ivar path: The path where the profile should be loaded from. Required.
    :vartype path: str
    """
    ...
    def __init__(self, *, path: str, **kwargs: Any) -> None:
        """
        :keyword path: The path where the profile should be loaded from. Required.
        :paramtype path: str
        """
        super().__init__(**kwargs)
        self.path = path
...
class PluginSpoofingTypePluginIListMultiLevelChoice(_serialization.Model):
    """PluginSpoofingTypePluginIListMultiLevelChoice.

    All required parameters must be populated in order to send to Azure.

    :ivar value: Tells the mode how the Plugins will be spoofed.
     'enabled': Enable plugins spoofing. A list can be provided to EXCLUDE plugins from the plugins
     of the base profile.
     'disabled': Disable plugins spoofing. Required. Known values are: "enabled" and "disabled".
    :vartype value: str or ~kameleo.local_api_client.models.PluginSpoofingType
    :ivar extra:
    :vartype extra: list[str]
    """
    ...
    def __init__(
        self, *, value: Union[str, "_models.PluginSpoofingType"], extra: Optional[List[str]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: Tells the mode how the Plugins will be spoofed.
         'enabled': Enable plugins spoofing. A list can be provided to EXCLUDE plugins from the plugins
         of the base profile.
         'disabled': Disable plugins spoofing. Required. Known values are: "enabled" and "disabled".
        :paramtype value: str or ~kameleo.local_api_client.models.PluginSpoofingType
        :keyword extra:
        :paramtype extra: list[str]
        """
        super().__init__(**kwargs)
...
class ProfilePreview(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar last_known_path: An absolute path where the related .kameleo profile file was accessed
     lastly. This is updated when a profile is saved to a .kameleo file, or loaded from a .kameleo
     file.
    :vartype last_known_path: str
    :ivar device: Required.
    :vartype device: ~kameleo.local_api_client.models.Device
    :ivar os: Required.
    :vartype os: ~kameleo.local_api_client.models.Os
    ...
    :ivar launcher: The mode how the profile should be launched. It determines which browser to
     launch. This cannot be modified after creation. Possible values are 'automatic', 'chrome',
     'chromium', 'firefox', 'edge', 'external'. Required.
    :vartype launcher: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword last_known_path: An absolute path where the related .kameleo profile file was accessed
         lastly. This is updated when a profile is saved to a .kameleo file, or loaded from a .kameleo
         file.
        :paramtype last_known_path: str
        :keyword device: Required.
        :paramtype device: ~kameleo.local_api_client.models.Device
        :keyword os: Required.
        :paramtype os: ~kameleo.local_api_client.models.Os
...
class SaveProfileRequest(_serialization.Model):
    """Tells where the profile should be saved.

    All required parameters must be populated in order to send to Azure.

    :ivar path: The path where the profile should be saved. Required.
    :vartype path: str
    """
    ...
    def __init__(self, *, path: str, **kwargs: Any) -> None:
        """
        :keyword path: The path where the profile should be saved. Required.
        :paramtype path: str
        """
        super().__init__(**kwargs)
        self.path = path
...
class TestProxyRequest(_serialization.Model):
    """TestProxyRequest.
    ...
    def __init__(
        self, *, value: Union[str, "_models.ProxyConnectionType"], extra: "_models.Server", **kwargs: Any
    ) -> None:
        """
        :keyword value: Proxy connection settings of the profiles. Possible values:
         'none': Direct connection without any proxy.
...
class TestProxyResponse(_serialization.Model):
    """TestProxyResponse.

    All required parameters must be populated in order to send to Azure.

    :ivar is_valid_proxy: Tells weather the proxy is valid or not. Required.
    :vartype is_valid_proxy: bool
    :ivar message: A written message about the result of the test. Required.
    :vartype message: str
    """
    ...
    def __init__(self, *, is_valid_proxy: bool, message: str, **kwargs: Any) -> None:
        """
        :keyword is_valid_proxy: Tells weather the proxy is valid or not. Required.
        :paramtype is_valid_proxy: bool
        :keyword message: A written message about the result of the test. Required.
        :paramtype message: str
        """
        super().__init__(**kwargs)
        self.is_valid_proxy = is_valid_proxy
