...
class Storage:
    ...
    def __init__(self, path: Path):
        ...
        try:
            ...
            print(f"Error: could not create directory: {str(e)}", file=sys.stderr)
            sys.exit(2)
    ...
    def write(self, content: str, *path: str) -> None:
        ...
        try:
            *subpath, name = path
            ...
            print(f"Error: unable to write content to storage: {str(e)}", file=sys.stderr)
            sys.exit(2)
    ...
    def read(self, *path: str) -> str:
        ...
        try:
            ...
            print(f"Error: unable to read content from storage: {str(e)}", file=sys.stderr)
            sys.exit(2)
    ...
    def read_json(self, *path: str) -> Dict[Any, Any]:
        ...
        try:
            ...
            print(f"Error: could not read JSON data from storage: {str(e)}", file=sys.stderr)
            sys.exit(2)
    ...
    def exists(self, *path: str) -> bool:
        ...
        try:
            ...
            print(f"Error: could check if file exists: {str(e)}", file=sys.stderr)
            sys.exit(2)
    ...
    def remove(self, *path: str) -> None:
        ...
        try:
            ...
            print(f"Error: could not remove file from storage: {str(e)}", file=sys.stderr)
            sys.exit(2)
    ...
    def remove_all(self) -> None:
        ...
        try:
            ...
            print(f"Error: could not remove all files from storage: {str(e)}", file=sys.stderr)
            sys.exit(2)
    ...
    def copy_file(self, source: str, destination: str) -> None:
        ...
        try:
            ...
            print(f"Error: unable to copy file within storage: {str(e)}", file=sys.stderr)
            sys.exit(2)
    ...
    def move_file(self, source: str, destination: str) -> None:
        ...
        try:
            ...
            print(f"Error: unable to move file within storage: {str(e)}", file=sys.stderr)
            sys.exit(2)
