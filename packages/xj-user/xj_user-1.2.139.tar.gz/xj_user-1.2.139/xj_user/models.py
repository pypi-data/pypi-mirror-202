...
class DetailInfo(models.Model):
    ...
    real_name = models.CharField(verbose_name='真实姓名', max_length=255, blank=True, null=True, db_index=True,
                                 help_text='实名认证后的真名')
    sex = models.CharField(verbose_name='性别', max_length=1, blank=True, null=True, help_text='0未知 1男 2女', choices=sex_choices)
...
class UserSsoServe(models.Model):
    ...
    platform_user =models.ForeignKey(BaseInfo, verbose_name='用户', on_delete=models.DO_NOTHING, db_column='platform_user_id',
                             help_text='')
    class Meta:
