...
class PayerPayeeAdditionalData(
    schemas.DictSchema
):
    ...
    Contains the type of transfer for the payer and payee relationship
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class transfer_type(
                ...
                @schemas.classproperty
                def DEBIT_OR_CREDIT(cls):
                    return cls("DEBIT_OR_CREDIT")
            __annotations__ = {
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["transfer_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["transfer_type", ], str]):
