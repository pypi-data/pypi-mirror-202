...
class TFGroupViTCrossAttentionLayer(tf.keras.layers.Layer):
    def __init__(self, config: GroupViTVisionConfig, **kwargs):
        ...
        self.norm_post = tf.keras.layers.LayerNormalization(
...
class TFGroupViTTokenAssign(tf.keras.layers.Layer):
    def __init__(
        ...
        **kwargs,
        ...
        self.norm_tokens = tf.keras.layers.LayerNormalization(
        ...
        self.norm_new_x = tf.keras.layers.LayerNormalization(
...
class TFGroupViTStage(tf.keras.layers.Layer):
    ...
    def concat_x(
        self, x: tf.Tensor, group_token: Optional[tf.Tensor] = None
    ) -> tf.Tensor:
        ...
        input_signature=[
            {
                "input_ids": tf.TensorSpec((None, None), tf.int64, name="input_ids"),
                "pixel_values": tf.TensorSpec(
                    (None, None, None, None), tf.float64, name="pixel_values"
                ),
                "attention_mask": tf.TensorSpec(
                    (None, None), tf.int64, name="attention_mask"
                ),
