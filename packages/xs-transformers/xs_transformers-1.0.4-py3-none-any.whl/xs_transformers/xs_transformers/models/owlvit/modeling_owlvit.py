...
class OwlViTModel(OwlViTPreTrainedModel):
    ...
    def forward(
        ...
        return_base_image_embeds = (
            return_base_image_embeds if return_base_image_embeds is not None else False
        )
        ...
        # normalized features
        image_embeds_norm = image_embeds / torch.linalg.norm(
        ...
        logits_per_text = (
            torch.matmul(text_embeds_norm, image_embeds_norm.t()) * logit_scale
        )
