...
class TFCamembertEncoder(tf.keras.layers.Layer):
    def __init__(self, config: CamembertConfig, **kwargs):
        ...
        self.config = config
        self.layer = [
            TFCamembertLayer(config, name=f"layer_._{i}")
...
class TFCamembertMainLayer(tf.keras.layers.Layer):
    ...
    def __init__(self, config, add_pooling_layer=True, **kwargs):
        ...
        self.pooler = (
            TFCamembertPooler(config, name="pooler") if add_pooling_layer else None
        )
...
class TFCamembertForMaskedLM(TFCamembertPreTrainedModel, TFMaskedLanguageModelingLoss):
    ...
    def __init__(self, config, *inputs, **kwargs):
        ...
        self.roberta = TFCamembertMainLayer(
            config, add_pooling_layer=False, name="roberta"
        )
        self.lm_head = TFCamembertLMHead(
            config, self.roberta.embeddings, name="lm_head"
        )
