...
class GenerationMixin:
    ...
    def _prepare_attention_mask_for_generation(
        ...
        **model_kwargs,
        ...
        # print("_prepare_attention_mask_for_generation: ", inputs.shape, pad_token_id, eos_token_id)
        # print(model_kwargs)
        if (
            "input_hidden_state" in model_kwargs
            and model_kwargs["input_hidden_state"] is not None
        ):
            # print("return by input_hidden_state")
            return torch.ones(
                model_kwargs["input_hidden_state"].shape[:2],
                dtype=torch.long,
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        # KH add
        # 0. check input_hidden_state in model_kwargs
        if "input_hidden_state" in model_kwargs:
            # print("prepare_encoder_decoder_kwargs_for_generation with input_hidden_state")
            from .modeling_outputs import BaseModelOutputWithPastAndCrossAttentions

            encoder_outputs = BaseModelOutputWithPastAndCrossAttentions(
                last_hidden_state=model_kwargs["input_hidden_state"],
            )
    ...
    def _expand_inputs_for_generation(
        ...
        **model_kwargs,
        ...
        if is_encoder_decoder:
            ...
            # if "input_hidden_state" in model_kwargs:
            # print("we get input_hidden_state")
            # print("input_hidden_state: ", model_kwargs["input_hidden_state"])
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        # print("0: generate() call")
        self._validate_model_class()
        self._validate_model_kwargs(model_kwargs.copy())
        # print("generation_utils.py: model_kwargs: ", model_kwargs)
        ...
        # print("3. Define other model kwargs")
        ...
        # if self.config.is_encoder_decoder and "encoder_outputs" not in model_kwargs and "input_hidden_state" not in model_kwargs:
        ...
        if self.config.is_encoder_decoder:
            # print("self.config.is_encoder_decoder: ", decoder_start_token_id, model_kwargs)
        ...
        # print("beam gen mode: ", is_beam_gen_mode)
        ...
        if is_greedy_gen_mode:
            ...
            # print("beam search: ", model_kwargs)
        ...
        **model_kwargs,
        ...
        while True:
            ...
            context_hidden = (
                ...
                .expand(-1, top_k, -1, -1)
                .reshape(bsz * top_k, seqlen, embed_dim)
            )
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            # print("check prepare_inputs_for_generation: ", input_ids, model_kwargs)
            model_inputs = self.prepare_inputs_for_generation(input_ids, **model_kwargs)

            # forward pass to get next token
            # print("check greedy input: ", model_inputs)
            outputs = self(
                **model_inputs,
                return_dict=True,
                output_attentions=output_attentions,
