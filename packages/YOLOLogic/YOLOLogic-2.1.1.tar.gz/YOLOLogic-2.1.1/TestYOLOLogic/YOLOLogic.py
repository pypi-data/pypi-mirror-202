...
__date__      = '2023-April-14'   
__url__       = 'https://engineering.purdue.edu/kak/distYOLO/YOLOLogic-2.1.1.html'
...
CHANGE LOG:
  ...
  Version 2.1.1:  
    ...
    With this version, what was previously the RegionProposalNetwork module is now
    the YOLOLogic module. This name change reflects the fact that the educational
    purpose of the module has shifted from constructing region proposal networks
    to carrying out multi-instance object detection in images using the YOLO
    logic.  This change in the primary focus of the module has entailed
    reorganizing the code base.  I have moved some of the code in the main
    YOLOLogic class to the inner class RPN.  The old region-proposal demos are
    still available through the RPN inner class.  All the YOLO based multi-object
    detection code demoed by the script 'multi_instance_object_detection.py' in
    the Examples directory of the distribution.  And all the region-proposal code
    is demoed by the scripts in the ExamplesRegionProposals subdirectory of the
    distribution.
...
#______________________  Private Methods of the YOLOLogic Class  ________________
