#!/usr/bin/env python
#
# enum_mixins documentation build configuration file, created by sphinx-quickstart.
#
...
version = enum_mixins.__version__
# The full version, including alpha/beta/rc tags.
release = enum_mixins.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(enum_mixins.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "enum_mixins/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/enum-mixins/blob/%s/%s" % (tag, filename)
...
htmlhelp_basename = "enum_mixinsdoc"
