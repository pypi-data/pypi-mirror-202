...
class DBConnectionPool(object):
    ...
    def __init__(self, host:str, port:int, threadNum:int=10, userid:str=None, password:str=None, loadBalance:bool=False, highAvailability:bool=False, compress:bool=False,
        ...
        if protocol == PROTOCOL_ARROW and compress:
            raise RuntimeError(f"The Arrow protocol does not support compression.")

        self.pool = ddbcpp.dbConnectionPoolImpl(host, port, threadNum, userid, password, loadBalance, highAvailability, compress, reConnect, python, protocol)
        self.host = host
        self.port = port
        self.userid = userid
...
class session(object):
    ...
    def __init__(self, host:Optional[str]=None, port:Optional[int]=None, userid:Optional[str]="", password:Optional[str]="",
                 ...
                 keepAliveTime:int=30, enableChunkGranularityConfig:bool=False, compress:bool=False, enablePickle:bool=None, protocol:int=PROTOCOL_DEFAULT,
        ...
        self.cpp = ddbcpp.sessionimpl(enableSSL, enableASYNC, keepAliveTime, compress, python, protocol)
        self.host = host
        self.port = port
        self.userid = userid
        self.password=password
    ...
    def subscribe(self, host:str, port:int, handler:Callable, tableName:str, actionName:str=None, offset:int=-1, resub:bool=False, 
                  filter=None, msgAsTable:bool=False, batchSize:int=0, throttle:float=1.0,
