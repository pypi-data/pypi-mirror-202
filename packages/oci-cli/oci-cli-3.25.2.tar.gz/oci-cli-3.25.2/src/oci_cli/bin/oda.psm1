...
function GetOciSubcommands_oda() {
    $ociSubcommands = @{
        ...
        'oda management' = 'authentication-provider bot channel digital-assistant digital-assistant-parameter skill skill-parameter translator'
...
function GetOciCommandsToLongParams_oda() {
    $ociCommandsToLongParams = @{
        ...
        'oda management authentication-provider get' = 'authentication-provider-id from-json help oda-instance-id'
        ...
        'oda management channel get' = 'channel-id from-json help oda-instance-id'
        ...
        'oda management channel update' = 'channel-id defined-tags description force freeform-tags from-json help if-match max-wait-seconds oda-instance-id session-expiry-duration-in-milliseconds type wait-for-state wait-interval-seconds'
        'oda management channel update-channel-update-android-channel-details' = 'bot-id channel-id defined-tags description force freeform-tags from-json help if-match is-client-authentication-enabled max-token-expiration-time-in-minutes max-wait-seconds oda-instance-id session-expiry-duration-in-milliseconds wait-for-state wait-interval-seconds'
        'oda management channel update-channel-update-app-event-channel-details' = 'channel-id defined-tags description event-sink-bot-ids force freeform-tags from-json help if-match max-wait-seconds oda-instance-id outbound-url session-expiry-duration-in-milliseconds wait-for-state wait-interval-seconds'
        'oda management channel update-channel-update-application-channel-details' = 'channel-id defined-tags description force freeform-tags from-json help if-match is-authenticated-user-id max-wait-seconds oda-instance-id outbound-url session-expiry-duration-in-milliseconds wait-for-state wait-interval-seconds'
        'oda management channel update-channel-update-cortana-channel-details' = 'bot-id channel-id defined-tags description force freeform-tags from-json help if-match max-wait-seconds msa-app-id msa-app-password oda-instance-id session-expiry-duration-in-milliseconds wait-for-state wait-interval-seconds'
        'oda management channel update-channel-update-facebook-channel-details' = 'app-secret bot-id channel-id defined-tags description force freeform-tags from-json help if-match max-wait-seconds oda-instance-id page-access-token session-expiry-duration-in-milliseconds wait-for-state wait-interval-seconds'
        ...
        'oda management channel update-channel-update-ms-teams-channel-details' = 'bot-id channel-id defined-tags description force freeform-tags from-json help if-match max-wait-seconds msa-app-id msa-app-password oda-instance-id session-expiry-duration-in-milliseconds wait-for-state wait-interval-seconds'
        'oda management channel update-channel-update-oss-channel-details' = 'auth-token bootstrap-servers channel-id defined-tags description event-sink-bot-ids force freeform-tags from-json help if-match inbound-message-topic max-wait-seconds oda-instance-id outbound-message-topic sasl-mechanism security-protocol session-expiry-duration-in-milliseconds stream-pool-id tenancy-name user-name wait-for-state wait-interval-seconds'
        'oda management channel update-channel-update-osvc-channel-details' = 'authentication-provider-name bot-id channel-id channel-service defined-tags description force freeform-tags from-json help host if-match max-wait-seconds oda-instance-id password port session-expiry-duration-in-milliseconds total-session-count user-name wait-for-state wait-interval-seconds'
        'oda management channel update-channel-update-service-cloud-channel-details' = 'channel-id client-type defined-tags description domain-name force freeform-tags from-json help host-name-prefix if-match max-wait-seconds oda-instance-id password session-expiry-duration-in-milliseconds user-name wait-for-state wait-interval-seconds'
        'oda management channel update-channel-update-slack-channel-details' = 'auth-error-url auth-success-url bot-id channel-id client-id client-secret defined-tags description force freeform-tags from-json help if-match max-wait-seconds oda-instance-id session-expiry-duration-in-milliseconds signing-secret wait-for-state wait-interval-seconds'
        'oda management channel update-channel-update-twilio-channel-details' = 'account-sid auth-token bot-id channel-id defined-tags description force freeform-tags from-json help if-match is-mms-enabled max-wait-seconds oda-instance-id original-connectors-url phone-number session-expiry-duration-in-milliseconds wait-for-state wait-interval-seconds'
        ...
        'oda management channel update-channel-update-webhook-channel-details' = 'bot-id channel-id defined-tags description force freeform-tags from-json help if-match max-wait-seconds oda-instance-id outbound-url payload-version session-expiry-duration-in-milliseconds wait-for-state wait-interval-seconds'
        ...
        'oda management digital-assistant get' = 'digital-assistant-id from-json help oda-instance-id'
        'oda management digital-assistant list' = 'all category digital-assistant-id from-json help lifecycle-details lifecycle-state limit name namespace oda-instance-id page page-size platform-version sort-by sort-order version-parameterconflict'
        ...
        'oda management digital-assistant-parameter get' = 'digital-assistant-id from-json help oda-instance-id parameter-name'
        ...
        'oda management skill get' = 'from-json help oda-instance-id skill-id'
        'oda management skill list' = 'all category from-json help lifecycle-details lifecycle-state limit name namespace oda-instance-id page page-size platform-version skill-id sort-by sort-order version-parameterconflict'
        ...
        'oda management skill-parameter get' = 'from-json help oda-instance-id parameter-name skill-id'
        ...
        'oda management translator get' = 'from-json help oda-instance-id translator-id'
        ...
        'oda odapackage package list' = 'all display-name from-json help is-latest-skill-only limit name oda-instance-id page page-size resource-type sort-by sort-order'
