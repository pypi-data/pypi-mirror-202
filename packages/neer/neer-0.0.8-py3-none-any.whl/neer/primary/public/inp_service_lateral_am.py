...
class InpServiceLateralAm(PrimaryBase):
    __tablename__ = 'inp_service_lateral_am'
    ...
    roughness = Column(VARCHAR(191), autoincrement=False)
    loss_coef = Column(VARCHAR(191), autoincrement=False)
