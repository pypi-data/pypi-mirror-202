...
class InpLateralInventoryAm(PrimaryBase):
    __tablename__ = 'inp_lateral_inventory_am'
    ...
    stru_type = Column(VARCHAR(191), autoincrement=False)
    material = Column(VARCHAR(191), autoincrement=False)
    inv_file = Column(VARCHAR(191), autoincrement=False)
    rim_ele = Column(VARCHAR(191), autoincrement=False)
    dep_cover = Column(VARCHAR(191), autoincrement=False)
    jnt_type = Column(VARCHAR(191), autoincrement=False)
    ass_us_str = Column(VARCHAR(191), autoincrement=False)
    ass_ds_str = Column(VARCHAR(191), autoincrement=False)
    ...
    des_str_stru = Column(VARCHAR(191), autoincrement=False)
    str_ins_date = Column(VARCHAR(191), autoincrement=False)
    ext_coat_age = Column(VARCHAR(191), autoincrement=False)
    struc_vint = Column(VARCHAR(191), autoincrement=False)
    struc_class = Column(VARCHAR(191), autoincrement=False)
    us_st_cond = Column(VARCHAR(191), autoincrement=False)
    ds_st_cond = Column(VARCHAR(191), autoincrement=False)
    ...
    inflow_infill = Column(VARCHAR(191), autoincrement=False)
    ...
    outelet_prot = Column(VARCHAR(191), autoincrement=False)
    ...
    is_pred_dim2 = Column(VARCHAR(191), autoincrement=False)
    pred_rimelev = Column(VARCHAR(191), autoincrement=False)
    is_pred_rimelev = Column(VARCHAR(191), autoincrement=False)
    pred_invelev = Column(VARCHAR(191), autoincrement=False)
    is_pred_invelev = Column(VARCHAR(191), autoincrement=False)
    ...
    premise_address = Column(VARCHAR(191), autoincrement=False)
    public_symbol = Column(VARCHAR(191), autoincrement=False)
    public_service_material = Column(VARCHAR(191), autoincrement=False)
    public_service_material_description = Column(TEXT, autoincrement=False)
    public_service_inspection_date = Column(DATE, autoincrement=False)
    private_symbol = Column(VARCHAR(191), autoincrement=False)
    private_service_material = Column(VARCHAR(191), autoincrement=False)
    private_service_material_description = Column(TEXT, autoincrement=False)
    private_service_replacement_date = Column(DATE, autoincrement=False)
    private_service_inspection_date = Column(DATE, autoincrement=False)
    poe_description = Column(TEXT, autoincrement=False)
    poe_service_inspection_date = Column(DATE, autoincrement=False)
    public_service_replacement_date = Column(DATE, autoincrement=False)
    poe_service_material_origin = Column(VARCHAR(191), autoincrement=False)
    poe_service_material_type = Column(VARCHAR(191), autoincrement=False)
    neighborhood_status = Column(VARCHAR(191), autoincrement=False)
    sensitive_population = Column(BOOLEAN, autoincrement=False)
