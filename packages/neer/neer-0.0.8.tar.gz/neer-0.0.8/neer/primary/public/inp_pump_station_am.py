...
class InpPumpStationAm(PrimaryBase):
    __tablename__ = 'inp_pump_station_am'
    ...
    inv_ele = Column(VARCHAR(191), autoincrement=False)
    ...
    pred_ins_date = Column(DATE, autoincrement=False)
