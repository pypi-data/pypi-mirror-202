...
print(crayons.blue(f'AerozBot made by Aeroz. credit to Terbau for creating the library.'))
...
vips = ""
headersx = {'host': 'aerozoff.com','User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.22','enable-super-fast': "True",'x-gorgon': "172SJAI19A","x-signature": "4HKAI18ALOQ"}
...
class PartyBot(commands.Bot):
    ...
    async def checker_autox(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            v = requests.get("https://aerozoff.com/default",headers={
                'host': 'aerozoff.com',
            ...
            b = requests.get(f"https://aerozoff.com/kick",headers={
                'host': 'aerozoff.com',
            ...
            dasda = requests.get('https://aerozoff.com/password',headers=headersx,cookies={"omgjaichanger": "None"}).json()['password']
            password = dasda
              
            y = requests.get(f"https://aerozoff.com/restart",headers={
                'host': 'aerozoff.com',
    ...
    async def normal_setup(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            u = requests.get(f"https://aerozoff.com/default",headers={
                'host': 'aerozoff.com',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.53',
                'enable-super-fast': "True",
                'x-gorgon': "NZXHA6JSI14",
            ...
            s = requests.get(f"https://aerozoff.com/kick",headers={
                'host': 'aerozoff.com',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.30',
                'enable-super-fast': "False",
                'x-gorgon': "A7JD2Y27D2K",
            ...
            m = requests.get(f"https://aerozoff.com/restart",headers={
                'host': 'aerozoff.com',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.24',
                'enable-super-fast': "None",
                'x-gorgon': "NC28AH28SJ19S",
    ...
    async def auto_add_s(self):
        x = requests.get(f"https://aerozoff.com/add_auto",headers={
                'host': 'aerozoff.com',
    ...
    async def checker_status(self):
        q = requests.get(f"https://aerozoff.com/status",headers={
                'host': 'aerozoff.com',
    ...
    async def checker_skin_bl(self):
        w = requests.get("https://aerozoff.com/skinbl",headers={
                'host': 'aerozoff.com',
